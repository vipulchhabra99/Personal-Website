...
module.exports = (function(e) {
    ...
    var l = (function() {
      ...
      return (
        ...
        (t._getState = function() {
          return this._states.length || i(!1), this._states[this._states.length - 1];
        }),
        e
      );
    })();
  ...
  function(e, t, n) {
    ...
    var r = n(2),
      ...
      l = a.getNullableType,
      u = a.isType,
      c = (a.print, a.typeFromAST),
      p = a.GraphQLInterfaceType,
      f = a.GraphQLList,
      d = a.GraphQLObjectType,
      h = (a.GraphQLSchema, a.GraphQLUnionType),
      m = 'id',
      y = 'ID';
    function v(e) {
      var t = T(e);
      return t instanceof p || t instanceof h;
    }
    function T(e) {
      return i(o(e));
    }
    function g(e, t) {
      return (function(e) {
        if (e instanceof d) return e.getInterfaces();
        return [];
      })(e).some(function(e) {
        return e.toString() === t;
      });
    ...
    e.exports = {
      assertTypeWithFields: function(e) {
        return e instanceof d || e instanceof p || r(!1), e;
      },
      ...
      getSingularType: function(e) {
        for (var t = e; t instanceof f; ) t = t.ofType;
        return t;
      },
      ...
      hasID: function(e, t) {
        var n = T(t);
        n instanceof d || n instanceof p || r(!1);
        var i = e.getType(y),
          a = n.getFields()[m];
        return a && T(a.type) === i;
      },
      implementsInterface: g,
      isAbstractType: v,
    ...
    e.exports = function(e) {
      ...
      return (
        e.forEach(function(e) {
          'Literal' !== e.value.kind && r(!1), (t[e.name] = e.value.value);
        }),
        t
      );
    };
      ...
      u = (function() {
        function e(e, t) {
          ...
          if (
            ...
            this._filesystem.statSync(e).isDirectory() || o(!1);
        ...
        return (
          ...
          (t._addGenerated = function(e) {
            this._files.has(e) && o(!1), this._files.add(e);
          }),
          e
        );
      })();
    ...
    var M = (function() {
      ...
      return (
            ...
            return {
              ...
              type: (function(e) {
                if (
                  !(function(e) {
                    var t = E(e);
                    return t instanceof _ || t instanceof P;
                  })(e)
                )
        ...
        (t._transformNonNullLiteral = function(e, t) {
          ...
          if (r instanceof _ || r instanceof P) {
          ...
          if (x)
            switch (S.kind) {
              case d.REQUEST:
                var N = S.params,
                  _ = (N.id, N.text),
                  C = (0, s.default)(N, ['id', 'text']);
                null == _ && f(!1),
                  (A.params = { text: _ }),
                  (S = (0, a.default)({}, S, {
                    params: (0, a.default)({ id: yield x(_, y), text: null }, C),
                  }));
                break;
              case d.FRAGMENT:
                break;
  ...
  function(e, t, n) {
    ...
    e.exports = function(e) {
      ...
      if ('MatchField' === e.kind) {
        ...
        return 'string' != typeof n && r(!1), 'M:' + n;
      }
      ...
      Object.keys(k)
        ...
        .forEach(function(e) {
          var t = k[e],
            n = t.component,
            r = t.fragment;
          _.push(''.concat(r, ':').concat(n));
        });
      var C = (null !== (n = r.alias) && void 0 !== n ? n : r.name) + '('.concat(_.join(','), ')');
      return {
        kind: 'MatchField',
        alias: r.alias,
        args: [
              ...
              p = (p = p.replace(
                (0, i.default)({}, l, {
                  metadata: (0, i.default)({}, l.metadata || {}, {
                    refetch: {
                      connection: null !== (f = C) && void 0 !== f ? f : null,
                      operation: o,
  ...
  function(e, t, n) {
    ...
    function u(e) {
      var t = e.mask,
        n = e.plural;
      return (
        void 0 !== n && 'boolean' != typeof n && s(!1),
        void 0 !== t && 'boolean' != typeof t && s(!1),
        { mask: t, plural: n }
      );
    }
    function c(e) {
      var t = e.mask;
      return void 0 !== t && 'boolean' != typeof t && s(!1), { mask: t };
    }
    e.exports = {
      RELAY: o,
      SCHEMA_EXTENSION:
  ...
  function(e, t, n) {
    ...
    e.exports = {
      ...
      intersectionTypeAnnotation: function(e) {
        return e.length > 0 || r(!1), 1 === e.length ? e[0] : i.intersectionTypeAnnotation(e);
      },
      ...
      unionTypeAnnotation: function(e) {
        return e.length > 0 || r(!1), 1 === e.length ? e[0] : i.unionTypeAnnotation(e);
      },
    };
  },
  function(e, t, n) {
  ...
  function(e, t, n) {
    ...
    e.exports = {
      ...
      getIdentifierForArgumentValue: _,
      getLiteralArgumentValues: C,
      isEquivalentType: O,
      nullthrows: D,
      Parser: E,
      Validator: A,
            ...
            return u.asyncContext(
              ...
              i(function*() {
                try {
                  ...
                  l &&
                    l.forEach(function(e) {
                      t.parsers[e] || c(!1), (h = h.merge(t.parsers[e].documents()));
                    });
                  ...
                  try {
                    for (
                      ...
                      var k = A.value,
                        ...
                        O = void 0;
                      try {
                        for (var D, I = N[Symbol.iterator](); !(_ = (D = I.next()).done); _ = !0) {
                          var L = D.value;
                          d(k.getPath(L)) || c(!1);
                        }
                      } catch (e) {
                  ...
                  var F = t.onComplete;
                  null != F && F(Array.from(x.values()));
                  var M = s.combineChanges(Array.from(x.values()));
                  return (
                    s.printChanges(M, { onlyValidate: t.onlyValidate }),
                    s.hasChanges(M) ? 'HAS_CHANGES' : 'NO_CHANGES'
                  );
                } catch (e) {
      ...
      for (var n in e)
        if (!l[n]) {
          ...
          r && 'object' == typeof r && 'string' == typeof r.type
            ...
            : Array.isArray(r) &&
              r.forEach(function(e) {
                e && 'object' == typeof e && 'string' == typeof e.type && h(e, t);
              });
        }
    }
    e.exports = {
        ...
        var t = [],
          n = {
            CallExpression: function(e) {
              var r = e.callee;
              if (
                ('Identifier' === r.type && o[r.name]) ||
                ('MemberExpression' === r.kind &&
                  'Identifier' === r.object.type &&
                  'Relay' === r.object.value &&
                ...
                'ObjectExpression' === i.type
                  ? i.properties.forEach(function(e) {
                      ('ObjectProperty' !== e.type ||
                        ...
                        'TaggedTemplateExpression' !== e.value.type) &&
                        d(!1),
                        u(e.value.tag) || d(!1),
                        t.push({
                          keyName: e.key.name,
                          template: p(e.value.quasi),
                          sourceLocationOffset: f(e.value.quasi),
                        });
                    })
                  : ((i && 'TaggedTemplateExpression' === i.type) || d(!1),
                    u(i.tag) || d(!1),
                    t.push({
                      keyName: null,
                      template: p(i.quasi),
                      sourceLocationOffset: f(i.quasi),
                    }));
                for (var a = 2; a < e.arguments.length; a++) h(e.arguments[a], n);
              } else m(e, n);
            },
  ...
  function(e, t, n) {
        ...
        'of' !== this.state.value || this.curContext() !== F.parenStatement
          ? ((this.state.exprAllowed = !1),
            (e !== u._let && e !== u._const && e !== u._var) ||
              (C.test(this.input.slice(this.state.end)) && (this.state.exprAllowed = !0)),
    ...
    var J = (function(e) {
          ...
          return (
            ...
            (n.processComment = function(e) {
              if (!('Program' === e.type && e.body.length > 0)) {
                ...
                for (
                  s.length > 0 && U(s).start >= e.start && (t = s.pop());
                  s.length > 0 && U(s).start >= e.start;

                )
                  n = s.pop();
                if ((!n && t && (n = t), t && this.state.leadingComments.length > 0)) {
                  var l = U(this.state.leadingComments);
                ...
                if (n) {
                  if (n.leadingComments)
                    if (
                      ...
                      U(n.leadingComments).end <= e.start
                    )
                  ...
                  if (U(this.state.leadingComments).end <= e.start) {
                ...
                (this.state.commentPreviousNode = e),
                  r &&
                    (r.length && r[0].start >= e.start && U(r).end <= e.end
                      ? (e.innerComments = r)
      ...
      W = { decBinOct: [46, 66, 69, 79, 95, 98, 101, 111], hex: [46, 88, 95, 120] },
      G = { bin: [48, 49] };
    (G.oct = G.bin.concat([50, 51, 52, 53, 54, 55])),
      (G.dec = G.oct.concat([56, 57])),
      (G.hex = G.dec.concat([65, 66, 67, 68, 69, 70, 97, 98, 99, 100, 101, 102]));
    var Q = (function(e) {
        function t() {
          return e.apply(this, arguments) || this;
        }
          ...
          return (
                ...
                this.state.tokens.push(
                  new (function(e) {
                    (this.type = e.type),
                      ...
                      (this.start = e.start),
                      (this.end = e.end),
                      (this.loc = new K(e.startLoc, e.endLoc));
                  })(this.state),
                ),
            ...
            (n.readToken_plus_min = function(e) {
              ...
              if (t === e)
                return 45 === t &&
                  ...
                  C.test(this.input.slice(this.state.lastTokEnd, this.state.pos))
            ...
            (n.readRegexp = function() {
              for (var e, t, n = this.state.pos; ; ) {
                ...
                if ((C.test(r) && this.raise(n, 'Unterminated regular expression'), e)) e = !1;
                else {
                  if ('[' === r) t = !0;
                  else if (']' === r && t) t = !1;
                  else if ('/' === r && !t) break;
            ...
            (n.readInt = function(e, t) {
              for (
                var n = this.state.pos,
                  r = 16 === e ? W.hex : W.decBinOct,
                  i = 16 === e ? G.hex : 10 === e ? G.dec : 8 === e ? G.oct : G.bin,
                  a = 0,
                  s = 0,
                  o = null == t ? 1 / 0 : t;
                s < o;
            ...
            (n.braceIsBlock = function(e) {
              ...
              return e === u._return
                ? C.test(this.input.slice(this.state.lastTokEnd, this.state.start))
                : e === u._else ||
                    e === u.semi ||
                    e === u.eof ||
                    e === u.parenR ||
      ...
      writeAll: function(e) {
        ...
        return u.asyncContext(
          ...
          i(function*() {
            ...
            try {
              for (
                var q, K = (t.generatedDirectories || [])[Symbol.iterator]();
                !(R = (q = K.next()).done);
                R = !0
              ) {
                var U = q.value;
            ...
            try {
              ...
              var G;
              try {
                G = JSON.parse(e.message);
              } catch (e) {}
              if (G && 'GraphQL2Exception' === G.name && G.message)
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      N = n(176),
      _ = N.transformScalarType,
      C = N.transformInputType,
      O = n(1),
    ...
    function I(e, t, n, r) {
      var i = e.key,
        ...
        l = e.nodeType,
        u = e.nodeSelections;
      l && (s = _(l, t, j([Array.from(m(u).values())], t, n))),
      ...
      if (
        ...
        !(function() {
          var e = new Set(),
            r = function(r) {
              l.push(
                K((0, a.default)(Array.from(s.values())).concat((0, a.default)(o[r]))).map(function(
                  i,
                ) {
        ...
        var p = K(Array.from(u.values())).map(function(e) {
              ...
              leave: {
                  ...
                  var r = (function(e, t) {
                      return x(
                        ...
                        S(
                          e.argumentDefinitions.map(function(e) {
                            var n = y.objectTypeProperty(y.identifier(e.name), C(e.type, t));
                    ...
                    i = (function(e) {
                      return Object.keys(e.generatedInputObjectTypes).map(function(t) {
                        ...
                        return 'string' == typeof n && h(!1), x(t, n);
                      });
                    })(t),
                ...
                Fragment: function(e) {
                  ...
                  return (
                    ...
                    y.program(
                      (0, a.default)(U(t)).concat((0, a.default)(J(t)), [
                        b(f, 'relay-runtime'),
                        l,
                        x(e.name, p),
                      ]),
  ...
  function(e, t, n) {
    ...
    t.METHOD_TYPES = N;
    const _ = r.FLIPPED_ALIAS_KEYS.ObjectMember;
    t.OBJECTMEMBER_TYPES = _;
    const C = r.FLIPPED_ALIAS_KEYS.Property;
    t.PROPERTY_TYPES = C;
    ...
    const K = r.FLIPPED_ALIAS_KEYS.JSX;
    t.JSX_TYPES = K;
  ...
  function(e, t, n) {
    ...
    function O(e, t) {
      ...
      if (null != B && 'string' != typeof B) {
        ...
        throw f(
          'Expected the '.concat(_, ' argument to ') +
    ...
    e.exports = {
      ...
      transform: function(e) {
        return s.transform(e, { Fragment: C, LinkedField: O, MatchField: O, Root: C }, function(e) {
  ...
  function(e, t, n) {
    ...
    function d(e, t) {
      if (
        ...
        return r || i(!1), this.traverse(e, r);
      }
      return null;
    }
    function h(e, t) {
          ...
          return (function(e, t, n) {
            ...
            a.parse(new a.Source(r, n, s)).definitions.forEach(function(e) {
              ...
              if ('OperationDefinition' === e.kind) {
                ...
                (r && n.startsWith(t)) || c(!1);
              } else 'FragmentDefinition' === e.kind && (i ? n !== t + '_' + i && c(!1) : n.startsWith(t) || c(!1));
            });
          })(e, l, n);
        });
      }
