...
module.exports = (function(e) {
  ...
  function(e, t, n) {
    ...
    var r = n(9),
      i = n(2),
      a = n(94).createUserError,
      s = n(20).OrderedMap,
      o = (function() {
        function e(e, t) {
          (this._isMutable = !1),
            (this._documents = new s()),
            (this._withTransform = new WeakMap()),
            (this.serverSchema = e),
            (this.clientSchema = t || e);
        }
        var t = e.prototype;
        return (
          (t.documents = function() {
            return this._documents.toArray();
          }),
          (t.forEachDocument = function(e) {
            this._documents.forEach(e);
          }),
          (t.replace = function(e) {
            return this._update(
              this._documents.update(e.name, function(t) {
                return (
                  t ||
                    i(
                      !1,
                      'GraphQLCompilerContext: Expected to replace existing node %s, butone was not found in the context.',
                      e.name,
                    ),
                  e
                );
              ...
              this._documents.update(e.name, function(t) {
                return (
                  t &&
                    i(
                      !1,
                      'GraphQLCompilerContext: Duplicate document named `%s`. GraphQL fragments and roots must have unique names.',
                      e.name,
                    ),
                  e
                );
          ...
          (t.applyTransforms = function(e, t) {
            var n = this;
            return r.run('applyTransforms', function() {
              return e.reduce(function(e, n) {
                return e.applyTransform(n, t);
              }, n);
            });
          }),
          (t.applyTransform = function(e, t) {
            var n = this._withTransform.get(e);
            if (!n) {
              var i = process.hrtime();
              n = r.instrument(e)(this);
              var a = process.hrtime(i),
                s = Math.round((1e9 * a[0] + a[1]) / 1e6);
              t && t.reportTime(e.name, s), this._withTransform.set(e, n);
            }
            return n;
          }),
          (t.get = function(e) {
          ...
          (t.getFragment = function(e) {
            var t = this._get(e);
            if ('Fragment' !== t.kind) {
              var n = e.substring(0, e.lastIndexOf('_'));
              throw a(
                'GraphQLCompilerContext: Cannot find fragment `%s`. Please make sure the fragment exists in `%s`.',
                e,
                n,
              );
            }
          ...
          (t.getRoot = function(e) {
            ...
            return (
              'Root' !== t.kind &&
                i(!1, 'GraphQLCompilerContext: Expected `%s` to be a root, got `%s`.', e, t.kind),
              t
            );
          }),
          (t.remove = function(e) {
          ...
          (t.withMutations = function(e) {
            var t = this._update(this._documents.asMutable());
            t._isMutable = !0;
            var n = e(t);
            return (
              (n._isMutable = !1),
              (n._documents = n._documents.asImmutable()),
              this._documents === n._documents ? this : n
            );
          }),
          (t._get = function(e) {
            var t = this._documents.get(e);
            return t || i(!1, 'GraphQLCompilerContext: Unknown document `%s`.', e), t;
          }),
          (t._update = function(t) {
            var n = this._isMutable ? this : new e(this.serverSchema, this.clientSchema);
            return (n._documents = t), n;
          }),
          e
        );
      })();
  ...
  function(e, t, n) {
    ...
    var r = n(0)(n(4)),
      i = n(2),
      a = n(10),
      s = a.createCombinedError,
      o = a.eachWithErrors;
    var l = (function() {
      function e(e, t) {
        (this._context = e), (this._states = []), (this._visitor = t);
      }
      var t = e.prototype;
      return (
        ...
        (t.visit = function(e, t) {
          this._states.push(t);
          var n = this._visit(e);
          return this._states.pop(), n;
        }),
        (t.traverse = function(e, t) {
          this._states.push(t);
          var n = this._traverse(e);
          return this._states.pop(), n;
        }),
        (t._visit = function(e) {
          var t = this._visitor[e.kind];
          if (t) {
        ...
        (t._traverse = function(e) {
          var t;
          switch (e.kind) {
            case 'Argument':
              t = this._traverseChildren(e, null, ['value']);
              break;
            case 'Literal':
            ...
            case 'Variable':
              ...
              break;
            case 'Defer':
              t = this._traverseChildren(e, ['selections'], ['if']);
              break;
            case 'Stream':
              t = this._traverseChildren(e, ['selections'], ['if', 'initialCount']);
              break;
            case 'Directive':
              t = this._traverseChildren(e, ['args']);
              break;
            case 'MatchBranch':
              (t = this._traverseChildren(e, ['selections'])).selections.length || (t = null);
              break;
            case 'FragmentSpread':
            case 'ScalarField':
              t = this._traverseChildren(e, ['args', 'directives']);
              break;
            case 'LinkedField':
              (t = this._traverseChildren(e, ['args', 'directives', 'selections'])).selections
                .length || (t = null);
              break;
            case 'ListValue':
              t = this._traverseChildren(e, ['items']);
              break;
            case 'MatchField':
              t = this._traverseChildren(e, ['args', 'directives', 'selections']);
              break;
            case 'ObjectFieldValue':
              t = this._traverseChildren(e, null, ['value']);
              break;
            case 'ObjectValue':
              t = this._traverseChildren(e, ['fields']);
              break;
            case 'Condition':
              (t = this._traverseChildren(e, ['directives', 'selections'], ['condition']))
                .selections.length || (t = null);
              break;
            case 'InlineFragment':
              (t = this._traverseChildren(e, ['directives', 'selections'])).selections.length ||
                (t = null);
              break;
            case 'Fragment':
            case 'Root':
              t = this._traverseChildren(e, ['argumentDefinitions', 'directives', 'selections']);
              break;
            case 'Request':
              t = this._traverseChildren(e, null, ['fragment', 'root']);
              break;
            case 'SplitOperation':
              t = this._traverseChildren(e, ['selections']);
              break;
            default:
              i(!1, 'GraphQLIRTransformer: Unknown kind `%s`.', e.kind);
          }
          return t;
        }),
        (t._traverseChildren = function(e, t, n) {
          var a,
            s = this;
          return (
            t &&
        ...
        (t._map = function(e) {
          ...
          return (
            e.forEach(function(r, i) {
              var a = n._visit(r);
              (t || a !== r) && ((t = t || e.slice(0, i)), a && t.push(a));
            }),
            t || e
          );
        }),
        (t._getState = function() {
          return (
            this._states.length ||
              i(
                !1,
                'GraphQLIRTransformer: Expected a current state to be set but found none. This is usually the result of mismatched number of pushState()/popState() calls.',
              ),
        ...
        return e.withMutations(function(t) {
          var i = t,
            a = o(e.documents(), function(e) {
              var t;
              if (void 0 === n) t = r.visit(e, void 0);
              else {
                var a = n(e);
                null != a && (t = r.visit(e, a));
              }
              t ? t !== e && (i = i.replace(t)) : (i = i.remove(e.name));
            });
          if (null != a && 0 !== a.length) throw s(a);
          return i;
        });
      },
    };
  ...
  function(e, t, n) {
    ...
    var r = n(2),
      i = n(43),
      a = n(1),
      s = a.assertAbstractType,
      o = a.getNamedType,
      l = a.getNullableType,
      u = a.isType,
      c = a.print,
      p = a.typeFromAST,
      f = a.GraphQLInterfaceType,
      d = a.GraphQLList,
      h = a.GraphQLObjectType,
      m = (a.GraphQLSchema, a.GraphQLUnionType),
      y = 'id',
      v = 'ID';
    function T(e) {
      var t = g(e);
      return t instanceof f || t instanceof m;
    }
    function g(e) {
      return i(o(e));
    }
    function S(e, t) {
      return (function(e) {
        if (e instanceof h) return e.getInterfaces();
        return [];
      })(e).some(function(e) {
        return e.toString() === t;
      });
    ...
    e.exports = {
      assertTypeWithFields: function(e) {
        return (
          e instanceof h ||
            e instanceof f ||
            r(!1, 'GraphQLSchemaUtils: Expected type `%s` to be an object or interface type.', e),
          e
        );
      },
      canHaveSelections: function(e) {
        return e instanceof h || e instanceof f;
      },
      getNullableType: l,
      getRawType: g,
      getSingularType: function(e) {
        for (var t = e; t instanceof d; ) t = t.ofType;
        return t;
      },
      getTypeFromAST: function(e, t) {
        var n = p(e, t);
        return u(n) || r(!1, 'GraphQLSchemaUtils: Unknown type `%s`.', c(t)), n;
      },
      hasID: function(e, t) {
        var n = g(t);
        n instanceof h ||
          ...
          r(
            !1,
            'GraphQLSchemaUtils.hasID(): Expected a concrete type or interface, got type `%s`.',
            t,
          );
        var i = e.getType(v),
          a = n.getFields()[y];
      ...
      isSchemaDefinitionAST: function(e) {
        return (
          'SchemaDefinition' === e.kind ||
          'ScalarTypeDefinition' === e.kind ||
          'ObjectTypeDefinition' === e.kind ||
          'InterfaceTypeDefinition' === e.kind ||
          'UnionTypeDefinition' === e.kind ||
          'EnumTypeDefinition' === e.kind ||
          'InputObjectTypeDefinition' === e.kind ||
          'DirectiveDefinition' === e.kind ||
          'ScalarTypeExtension' === e.kind ||
          'ObjectTypeExtension' === e.kind ||
          'InterfaceTypeExtension' === e.kind ||
          'UnionTypeExtension' === e.kind ||
          'EnumTypeExtension' === e.kind ||
          'InputObjectTypeExtension' === e.kind
        );
      },
      mayImplement: function(e, t, n) {
        var r = g(t);
        return (
          r.toString() === n ||
          S(r, n) ||
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.isTSConstructSignatureDeclaration = function(e, t) {
        ...
        if ('TSConstructSignatureDeclaration' === e.type)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isBinary = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('Binary' === n || 'BinaryExpression' === n || 'LogicalExpression' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isBlock = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('Block' === n || 'BlockStatement' === n || 'Program' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isConditional = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('Conditional' === n || 'ConditionalExpression' === n || 'IfStatement' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isWhile = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('While' === n || 'DoWhileStatement' === n || 'WhileStatement' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isFor = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('For' === n || 'ForInStatement' === n || 'ForStatement' === n || 'ForOfStatement' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      (t.isForXStatement = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('ForXStatement' === n || 'ForInStatement' === n || 'ForOfStatement' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isTSEntityName = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('TSEntityName' === n || 'Identifier' === n || 'TSQualifiedName' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isMethod = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('Method' === n || 'ObjectMethod' === n || 'ClassMethod' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      (t.isObjectMember = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('ObjectMember' === n || 'ObjectMethod' === n || 'ObjectProperty' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isUnaryLike = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('UnaryLike' === n || 'UnaryExpression' === n || 'SpreadElement' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isClass = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('Class' === n || 'ClassDeclaration' === n || 'ClassExpression' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isFlowPredicate = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('FlowPredicate' === n || 'DeclaredPredicate' === n || 'InferredPredicate' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
      ...
      (t.isPrivate = function(e, t) {
        if (!e) return !1;
        const n = e.type;
        if ('Private' === n || 'ClassPrivateProperty' === n || 'PrivateName' === n)
          return void 0 === t || (0, r.default)(e, t);
        return !1;
      }),
  ...
  function(e, t, n) {
    ...
    var r = n(15),
      ...
      a = !1,
      s = [
        { ph: 'M', pid: 0, tid: 0, name: 'process_name', args: { name: 'relay-compiler' } },
        { ph: 'M', pid: 0, tid: 0, name: 'thread_name', args: { name: 'relay-compiler' } },
      ],
      o = [];
    function l(e, t) {
      if (!a) return e;
    ...
    function f() {
      var e = process.hrtime(p);
      return 0 | (1e6 * e[0] + Math.round(e[1] / 1e3));
    }
    function d(e) {
      var t = { ph: 'B', name: e, pid: 0, tid: 0, ts: f() };
      return s.push(t), o.push(t), s.length - 1;
    }
    var h = 0;
    function m(e) {
      return (
        s.push({ ph: 'b', name: e, cat: 'wait', id: h++, pid: 0, tid: 0, ts: f() }), s.length - 1
      );
    }
    function y(e) {
      var t = s[e];
      'b' !== t.ph
        ? ('B' !== t.ph && i(!1, 'Begin trace phase'),
          o.pop() !== t &&
            i(
              !1,
              'GraphQLCompilerProfiler: The profile trace %s ended before nested traces. If it is async, try using Profile.waitFor or Profile.profileWait.',
              t.name,
            ),
          t !== s[s.length - 1]
            ? s.push({ ph: 'E', name: t.name, pid: t.pid, tid: t.tid, ts: f() })
            : (s[e] = { ph: 'X', name: t.name, pid: t.pid, tid: t.tid, ts: t.ts, dur: f() - t.ts }))
        : s.push({ ph: 'e', cat: t.cat, name: t.name, id: t.id, pid: t.pid, tid: t.tid, ts: f() });
    }
    e.exports = {
      enable: function() {
        a = !0;
  ...
  function(e, t, n) {
    'use strict';
    var r = n(1).GraphQLError;
    function i(e, t, n) {
      var i,
        s = e;
      if (null != t) {
        var o = a(t);
        s = 0 === o.length ? e : [e].concat(o).join('\n\n') + '\n';
      }
      var l = new r('Internal Error: '.concat(s), null !== (i = n) && void 0 !== i ? i : []);
      return new Error(l.message);
    }
    function a(e) {
      var t = [],
        n = !0,
      ...
      try {
        for (var o, u = e[Symbol.iterator](); !(n = (o = u.next()).done); n = !0) {
          for (var c = o.value, p = c; 'Derived' === p.kind; ) p = p.source;
          switch (p.kind) {
            case 'Source':
              var f = p === c ? 'Source: ' : 'Source (derived): ';
              t.push(f + s(p.source, l(p.source, p.start)));
              break;
            case 'Generated':
              t.push('Source: (generated)');
              break;
            case 'Unknown':
              t.push('Source: (unknown)');
              break;
            default:
              throw i("RelayCompilerError: cannot print location '".concat(String(p), "'."));
          }
        }
      } catch (e) {
        (r = !0), (a = e);
    ...
    function l(e, t) {
      for (var n, r = /\r\n|[\n\r]/g, i = 1, a = t + 1; (n = r.exec(e.body)) && n.index < t; )
        (i += 1), (a = t + 1 - (n.index + n[0].length));
      return { line: i, column: a };
    }
    e.exports = {
      createCombinedError: function(e, t) {
        var n = null != t ? ''.concat(t, ': ') : '';
        return new Error(
          ''.concat(n, 'Encountered ').concat(e.length, ' error(s):\n') +
            e
              .map(function(e) {
                return String(e)
                  .split('\n')
                  .map(function(e, t) {
                    return 0 === t ? '- '.concat(e) : '  '.concat(e);
                  })
                  .join('\n');
              })
              .join('\n'),
      ...
      createCompilerError: i,
      createNonRecoverableUserError: function(e, t, n) {
        var i,
          s = e;
        if (null != t) {
          var o = a(t);
        ...
        var l = new r(s, null !== (i = n) && void 0 !== i ? i : []);
        return new Error(l.message);
      },
      createUserError: function(e, t, n) {
        var i,
          s = e;
        if (null != t) {
          var o = a(t);
        ...
        return new r(s, null !== (i = n) && void 0 !== i ? i : []);
      },
      eachWithErrors: function(e, t) {
        var n = [],
          i = !0,
          a = !1,
          s = void 0;
  ...
  function(e, t, n) {
    ...
    const fe = { isReactComponent: i.default, isCompatTag: a.default, buildChildren: s.default };
    t.react = fe;
  },
  function(e, t, n) {
    'use strict';
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      n(127);
    var i = n(16);
    (0, r().default)(i.VISITOR_KEYS),
      (0, r().default)(i.ALIAS_KEYS),
      (0, r().default)(i.FLIPPED_ALIAS_KEYS),
      (0, r().default)(i.NODE_FIELDS),
      (0, r().default)(i.BUILDER_KEYS),
      (0, r().default)(i.DEPRECATED_KEYS);
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.assertNodeOrValueType = function(...e) {
        function t(t, n, i) {
          let a = !1;
          for (const t of e)
            if (c(i) === t || (0, r.default)(t, i)) {
              a = !0;
              break;
            }
          if (!a)
            throw new TypeError(
              `Property ${n} of ${t.type} expected node to be of a type ${JSON.stringify(e)} ` +
                `but instead got ${JSON.stringify(i && i.type)}`,
            );
        }
      ...
      (t.default = function(e, t = {}) {
        const n = (t.inherits && g[t.inherits]) || {},
          r = t.fields || n.fields || {},
          p = t.visitor || n.visitor || [],
          f = t.aliases || n.aliases || [],
          d = t.builder || n.builder || t.visitor || [];
        t.deprecatedAlias && (u[t.deprecatedAlias] = e);
        for (const e of p.concat(d)) r[e] = r[e] || {};
        for (const e in r) {
          const t = r[e];
          -1 === d.indexOf(e) && (t.optional = !0),
            void 0 === t.default
              ? (t.default = null)
              : t.validate || (t.validate = v(c(t.default)));
        }
        (i[e] = t.visitor = p),
          (l[e] = t.builder = d),
          (o[e] = t.fields = r),
    ...
    function f(e) {
      return 'string' == typeof e ? y(e) : y(...e);
    }
    function d(e) {
      return T(v('array'), m(e));
    }
    function h(e) {
      return d(f(e));
    }
    function m(e) {
      function t(t, n, r) {
        if (Array.isArray(r)) for (let i = 0; i < r.length; i++) e(t, `${n}[${i}]`, r[i]);
      }
      return (t.each = e), t;
    }
    function y(...e) {
    ...
    function v(e) {
      function t(t, n, r) {
        if (!(c(r) === e))
          throw new TypeError(`Property ${n} expected type of ${e} but got ${c(r)}`);
      }
      return (t.type = e), t;
    }
    function T(...e) {
  ...
  function(e, t, n) {
    ...
    const f = ['void', 'throw', ...u, ...c, ...p];
    t.UNARY_OPERATORS = f;
    t.INHERIT_KEYS = {
      optional: ['typeAnnotation', 'typeParameters', 'returnType'],
      force: ['start', 'loc', 'end'],
    };
    const d = Symbol.for('var used to be block scoped');
    t.BLOCK_SCOPED_SYMBOL = d;
    const h = Symbol.for('should not be considered a local binding');
    t.NOT_LOCAL_BINDING = h;
  },
  function(e, t) {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e) {
        return (
          'string' == typeof e &&
          !r().default.keyword.isReservedWordES6(e, !0) &&
          ('await' !== e && r().default.keyword.isIdentifierNameES6(e))
        );
      });
  },
  function(e, t, n) {
    ...
    function a(e, t) {
      return e && 'string' == typeof e.type && 'CommentLine' !== e.type && 'CommentBlock' !== e.type
        ? o(e, t)
        : e;
    }
    function s(e, t) {
      return Array.isArray(e) ? e.map(e => a(e, t)) : a(e, t);
    }
    function o(e, t = !0) {
      if (!e) return e;
      const { type: n } = e,
      ...
      if ('Identifier' === n) a.name = e.name;
        ...
        for (const o of Object.keys(r.NODE_FIELDS[n])) i(e, o) && (a[o] = t ? s(e[o], !0) : e[o]);
      }
      return (
        i(e, 'loc') && (a.loc = e.loc),
        i(e, 'leadingComments') && (a.leadingComments = e.leadingComments),
        i(e, 'innerComments') && (a.innerComments = e.innerCmments),
        i(e, 'trailingComments') && (a.trailingComments = e.trailingComments),
        i(e, 'extra') && (a.extra = Object.assign({}, e.extra)),
        a
      );
    }
  },
    ...
    e.exports = function(e) {
      ...
      return (
        e.forEach(function(e) {
          'Literal' !== e.value.kind &&
            r(!1, 'getLiteralArgumentValues(): Expected all args to be literals.'),
    ...
    function i(e, t, n) {
      ...
      for (; a.length; ) {
        ...
        if ((0, r.isIdentifier)(e))
          if (t) {
            (s[e.name] = s[e.name] || []).push(e);
          } else s[e.name] = e;
        else if ((0, r.isExportDeclaration)(e))
          (0, r.isDeclaration)(e.declaration) && a.push(e.declaration);
        else {
          if (n) {
      ...
      a = (function() {
        function e(e) {
          (this._documents = new Map()),
            (this._baseDir = e.baseDir),
            (this._parse = r.instrument(e.parse, 'ASTCache.parseFn'));
        }
        var t = e.prototype;
        return (
          (t.documents = function() {
            return i(this._documents);
          }),
          (t.parseFiles = function(e) {
            var t = this,
              n = i();
            return (
              e.forEach(function(e) {
                if (e.exists) {
                  var r = (function() {
                    try {
                      return t._parse(t._baseDir, e);
                    } catch (t) {
                      throw new Error('Parse error: '.concat(t, ' in "').concat(e.relPath, '"'));
                    }
                  })();
                  r
                    ? ((n = n.set(e.relPath, r)), t._documents.set(e.relPath, r))
                    : t._documents.delete(e.relPath);
                } else t._documents.delete(e.relPath);
              }),
              n
            );
          }),
      ...
      u = (function() {
        function e(e, t) {
          var r = this,
            ...
            a = t.onlyValidate;
          if (
            ((this._filesystem = i || n(21)),
            (this.onlyValidate = a),
            this._filesystem.existsSync(e))
          )
            this._filesystem.statSync(e).isDirectory() ||
              o(!1, 'Expected `%s` to be a directory.', e);
          else if (!this.onlyValidate) {
            for (var s = [e], u = l.dirname(e); !this._filesystem.existsSync(u); )
              s.unshift(u), (u = l.dirname(u));
            s.forEach(function(e) {
              return r._filesystem.mkdirSync(e);
            });
          }
          (this._files = new Set()),
            (this.changes = { deleted: [], updated: [], created: [], unchanged: [] }),
            (this._dir = e);
        }
        (e.combineChanges = function(e) {
          var t = { deleted: [], updated: [], created: [], unchanged: [] };
          return (
            e.forEach(function(e) {
              var n, r, i, s;
              (n = t.deleted).push.apply(n, (0, a.default)(e.changes.deleted)),
                (r = t.updated).push.apply(r, (0, a.default)(e.changes.updated)),
                (i = t.created).push.apply(i, (0, a.default)(e.changes.created)),
                (s = t.unchanged).push.apply(s, (0, a.default)(e.changes.unchanged));
            }),
            t
          );
        }),
          ...
          (e.printChanges = function(e, t) {
            s.run('CodegenDirectory.printChanges', function() {
              var n = [];
              function r(e, t) {
                t.length > 0 &&
                  (n.push(e + ':'),
              ...
              t.onlyValidate
                ? (r('Missing', e.created), r('Out of date', e.updated), r('Extra', e.deleted))
                : (r('Created', e.created),
                  r('Updated', e.updated),
                  r('Deleted', e.deleted),
                  n.push('Unchanged: '.concat(e.unchanged.length, ' files'))),
                console.log(n.join('\n'));
            });
          }),
          (e.getAddedRemovedFiles = function(e) {
            ...
            return (
              e.forEach(function(e) {
                e.changes.created.forEach(function(n) {
                  t.push(e.getPath(n));
                }),
                  e.changes.deleted.forEach(function(t) {
                    n.push(e.getPath(t));
                  });
              }),
              { added: t, removed: n }
          ...
          (e.sourceControlAddRemove = (function() {
            var t = i(function*(t, n) {
              var r = e.getAddedRemovedFiles(n),
                i = r.added,
                a = r.removed;
              t.addRemove(i, a);
            });
        ...
        var t = e.prototype;
        return (
          (t.printChanges = function() {
            e.printChanges(this.changes, { onlyValidate: this.onlyValidate });
          }),
          (t.read = function(e) {
            var t = l.join(this._dir, e);
            return this._filesystem.existsSync(t) ? this._filesystem.readFileSync(t, 'utf8') : null;
          }),
          (t.markUnchanged = function(e) {
            this._addGenerated(e), this.changes.unchanged.push(e);
          }),
          (t.markUpdated = function(e) {
            this._addGenerated(e), this.changes.updated.push(e);
          }),
          (t.writeFile = function(e, t) {
            var n = this;
            s.run('CodegenDirectory.writeFile', function() {
              n._addGenerated(e);
              var r = l.join(n._dir, e);
              n._filesystem.existsSync(r)
                ? n._filesystem.readFileSync(r, 'utf8') === t
                  ? n.changes.unchanged.push(e)
                  : (n._writeFile(r, t), n.changes.updated.push(e))
                : (n._writeFile(r, t), n.changes.created.push(e));
            });
          }),
          (t._writeFile = function(e, t) {
            this.onlyValidate || this._filesystem.writeFileSync(e, t, 'utf8');
          }),
          (t.deleteExtraFiles = function(e) {
            var t = this;
            s.run('CodegenDirectory.deleteExtraFiles', function() {
              t._filesystem.readdirSync(t._dir).forEach(function(n) {
                if (!(t._files.has(n) || /^\./.test(n) || (null != e && e.test(n)))) {
                  if (!t.onlyValidate)
                    try {
                      t._filesystem.unlinkSync(l.join(t._dir, n));
                    } catch (e) {
                      throw new Error(
                        'CodegenDirectory: Failed to delete `' + n + '` in `' + t._dir + '`.',
                      );
                    }
                  t.changes.deleted.push(n);
                }
              });
            });
          }),
          (t.getPath = function(e) {
            return l.join(this._dir, e);
          }),
          (t._addGenerated = function(e) {
            this._files.has(e) &&
              o(!1, 'CodegenDirectory: Tried to generate `%s` twice in `%s`.', e, this._dir),
              this._files.add(e);
          }),
          e
        );
  ...
  function(e, t, n) {
    ...
    var o = (function() {
      function e() {
        ...
        (this._client = new i.Client()), (this._attemptLimit = Math.max(Math.min(a, e), 0));
      }
      e.isAvailable = function() {
        return new Promise(function(t) {
          ...
          n.on('error', function() {
            ...
            n.hasCapability('relative_root').then(
              function(e) {
                t(e), n.end();
              },
              function() {
      ...
      return (
        (t._command = function() {
          ...
          return new Promise(function(t, r) {
            e._client.command(n, function(e, n) {
              e ? r(e) : t(n);
            });
          });
        }),
        (t.command = (function() {
          var e = r(function*() {
            ...
            for (;;)
              try {
                return e++, yield this._command.apply(this, n);
              } catch (t) {
                if (e > this._attemptLimit) throw t;
                yield s(500 * Math.pow(2, e)), this._client.end(), (this._client = new i.Client());
              }
          });
          return function() {
            return e.apply(this, arguments);
        ...
        (t.watchProject = (function() {
          var e = r(function*(e) {
            var t = yield this.command('watch-project', e);
            return (
              'warning' in t && console.error('Warning:', t.warning),
              { root: t.watch, relativePath: t.relative_path }
            );
          });
          return function(t) {
            return e.apply(this, arguments);
  ...
  function(e, t, n) {
    'use strict';
    var r = n(2),
      i = n(45).DEFAULT_HANDLE_KEY,
      a = n(1),
      s = a.GraphQLEnumType,
      o = a.GraphQLInputObjectType,
      l = a.GraphQLScalarType,
      u = a.GraphQLList,
      c = a.GraphQLNonNull,
      p = '  ';
    function f(e, t, n) {
      ...
      var a = i.map(function(e) {
        return (function e(t, n) {
          ...
          var a;
          if ('LinkedField' === t.kind) (a = d(t, i)), (a += f(t, n + p));
          else if ('MatchField' === t.kind) (a = d(t, i)), (a += f(t, n + p));
          else if ('MatchBranch' === t.kind)
            a = t.selections
              .map(function(t) {
                return e(t, n);
              })
              .join('\n' + n + p);
          else if ('ScalarField' === t.kind) a = d(t, i);
          else if ('InlineFragment' === t.kind)
            (a = '... on ' + t.typeCondition.toString()),
              (a += i),
              (a += h(t.directives)),
              (a += f(t, n + p));
          else if ('FragmentSpread' === t.kind)
            (a = '...' + t.name),
              (a += i),
              (a += (function(e) {
                var t = m(e);
                if (!t.length) return '';
                return ' @arguments'.concat(t);
              })(t.args)),
              (a += h(t.directives));
          else if ('Condition' === t.kind) {
            var s = y(t.condition);
            null == s &&
              r(!1, 'GraphQLIRPrinter: Expected a variable for condition, got a literal `null`.');
            var o = t.passingValue ? ' @include' : ' @skip';
            (o += '(if: ' + s + ')'), (o += i);
            var l = t.selections.map(function(t) {
              return e(t, n, o);
            });
            a = l.join('\n' + p);
          } else if ('Stream' === t.kind) {
            var u,
              c,
              v = ' @stream(label: "'.concat(t.label, '"');
            if (null !== t.if)
              v += ', if: '.concat(null !== (u = y(t.if)) && void 0 !== u ? u : '');
            if (null !== t.initialCount)
              v += ', initial_count: '.concat(
                null !== (c = y(t.initialCount)) && void 0 !== c ? c : '',
              );
            (v += ')'), (v += i);
            var T = t.selections.map(function(t) {
              return e(t, n, v);
            });
            a = T.join('\n' + p);
          } else if ('Defer' === t.kind) {
            var g,
              S = ' @defer(label: "'.concat(t.label, '"');
            if (null !== t.if)
              S += ', if: '.concat(null !== (g = y(t.if)) && void 0 !== g ? g : '');
            (S += ')'), (S += i);
            var x = t.selections.map(function(t) {
              return e(t, n, S);
            });
            a = x.join('\n' + p);
          } else r(!1, 'GraphQLIRPrinter: Unknown selection kind `%s`.', t.kind);
          return a;
        })(e, t, n);
      });
      return a.length
    ...
    function d(e) {
      ...
      return (
        (null != e.alias ? e.alias + ': ' + e.name : e.name) +
        m(e.args) +
        t +
        h(e.directives) +
        (function(e) {
          if (!e.handles) return '';
          var t = e.handles.map(function(e) {
            var t = e.key === i ? '' : ', key: "'.concat(e.key, '"'),
              n =
                null == e.filters
                  ? ''
                  : ', filters: '.concat(JSON.stringify(Array.from(e.filters).sort()));
    ...
    function m(e) {
      ...
      return (
        e.forEach(function(e) {
          var n = y(e.value, e.type);
          null != n && t.push(e.name + ': ' + n);
        }),
        t.length ? '(' + t.join(', ') + ')' : ''
      );
    }
    function y(e, t) {
      if ((t instanceof c && (t = t.ofType), 'Variable' === e.kind)) return '$' + e.variableName;
      if ('ObjectValue' === e.kind) {
        t instanceof o || r(!1, 'GraphQLIRPrinter: Need an InputObject type to print objects.');
        var n = t.getFields();
        return (
          '{' +
          e.fields
            .map(function(e) {
              var t = y(e.value, n[e.name].type);
              return null == t ? null : e.name + ': ' + t;
            })
            .filter(Boolean)
            .join(', ') +
          '}'
      ...
      if ('ListValue' === e.kind) {
        t instanceof u || r(!1, 'GraphQLIRPrinter: Need a type in order to print arrays.');
        var i = t.ofType;
        return '['.concat(
          e.items
            .map(function(e) {
      ...
      return null != e.value ? v(e.value, t) : null;
    }
    function v(e, t) {
      if ((t instanceof c && (t = t.ofType), t instanceof s)) {
        var n = t.serialize(e);
        return (
          'string' != typeof n &&
            r(
      ...
      if ('object' == typeof e && null != e) {
        ...
        t instanceof o || r(!1, 'GraphQLIRPrinter: Need an InputObject type to print objects.');
        var f = t.getFields();
        for (var d in e) e.hasOwnProperty(d) && p.push(d + ': ' + v(e[d], f[d].type));
        return '{' + p.join(', ') + '}';
      }
      return t instanceof u && null != e ? v(e, t.ofType) : JSON.stringify(e);
    }
    e.exports = {
      print: function(e) {
        switch (e.kind) {
          case 'Fragment':
            return (
              'fragment '.concat(e.name, ' on ').concat(String(e.type)) +
              (function(e) {
                var t;
                return (
                  e.forEach(function(e) {
                    if ('LocalArgumentDefinition' === e.kind) {
                      t = t || [];
                      var n = ''.concat(e.name, ': {type: "').concat(e.type.toString(), '"');
                      null != e.defaultValue &&
                        (n += ', defaultValue: '.concat(v(e.defaultValue, e.type))),
                        (n += '}'),
                        t.push(n);
                    }
                  }),
          ...
          case 'Root':
            return (
              ''.concat(e.operation, ' ').concat(e.name) +
              (function(e) {
                var t = e.map(function(e) {
                  var t = '$'.concat(e.name, ': ').concat(e.type.toString());
                  return null != e.defaultValue && (t += ' = ' + v(e.defaultValue, e.type)), t;
                });
                return t.length ? '(\n'.concat(p).concat(t.join('\n' + p), '\n)') : '';
              })(e.argumentDefinitions) +
              h(e.directives) +
          ...
          case 'SplitOperation':
            return (
              'SplitOperation '.concat(e.name, ' on ').concat(String(e.type)) + f(e, '') + '\n'
            );
          default:
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      a = r(n(7)),
      s = n(9),
      o = n(45).DEFAULT_HANDLE_KEY,
      l = n(6),
      u = l.getNullableType,
      c = l.getTypeFromAST,
      p = l.isExecutableDefinitionAST,
      f = n(10),
      d = f.createCombinedError,
      h = f.createCompilerError,
      m = f.createUserError,
      y = f.eachWithErrors,
      v = n(101).getFieldDefinitionLegacy,
      T = n(1),
      g = T.assertCompositeType,
      S = T.assertInputType,
      x = T.assertOutputType,
      b = T.extendSchema,
      E = T.getNamedType,
      P = T.GraphQLEnumType,
      A = T.GraphQLID,
      w = T.GraphQLInputObjectType,
      k = T.GraphQLList,
      N = T.GraphQLNonNull,
      C = T.GraphQLScalarType,
      _ = T.isLeafType,
      O = T.isTypeSubTypeOf,
      D = T.parse,
      I = T.parseType,
    ...
    var F = (function() {
      function e(e, t) {
        var n = this;
        (this._definitions = new Map()), (this._getFieldDefinition = v), (this._schema = e);
        var r = new Set();
        if (
          (t.forEach(function(e) {
            if (p(e)) {
              var t = V(e);
              if (n._definitions.has(t)) return void r.add(t);
              n._definitions.set(t, e);
            }
          }),
          r.size)
        )
          throw new Error(
            'RelayParser: Encountered duplicate defintitions for one or more documents: each document must have a unique name. Duplicated documents:\n' +
      ...
      return (
        (t.transform = function() {
          ...
          if (
            (null ==
              (e = y(this._definitions, function(e) {
                var n = e[0],
                  i = e[1],
                  a = t._buildArgumentDefinitions(i);
                r.set(n, { definition: i, variableDefinitions: a });
              })) &&
              (e = y(r.values(), function(e) {
                var i = e.definition,
                  a = e.variableDefinitions,
                  s = (function(e, t, n, r, i) {
                    return new M(e, t, n, r, i).transform();
                  })(t._schema, t._getFieldDefinition, r, i, a);
                n.push(s);
              })),
            null != e && 0 !== e.length)
          )
            throw d(e, 'RelayParser');
          return n;
        }),
        (t._buildArgumentDefinitions = function(e) {
          switch (e.kind) {
            ...
            default:
              throw h("Unexpected ast kind '".concat(e.kind, "'."), [e]);
          }
        }),
        (t._buildFragmentArgumentDefinitions = function(e) {
          var t = this,
            n = (e.directives || []).filter(function(e) {
              return 'argumentDefinitions' === V(e);
            });
          if (!n.length) return new Map();
          if (1 !== n.length)
            throw m(
              'Directive @'.concat('argumentDefinitions', ' may be defined at most once per ') +
                'fragment.',
              null,
              n,
            );
          var r = n[0],
            i = r.arguments;
          if (null == r || !Array.isArray(i)) return new Map();
          if (!i.length)
            throw m(
              'Directive @'.concat('argumentDefinitions', ' requires arguments: remove the ') +
          ...
          return (
            i.forEach(function(e) {
              var n = V(e),
                r = a.get(n);
              if (null != r)
                throw m("Duplicate definition for variable '$".concat(n, "'."), null, [r.ast, e]);
              var i = j(e.value, e);
              if (
                Array.isArray(i) ||
                'object' != typeof i ||
                ...
                throw m(
                  "Expected definition for variable '$".concat(n, "' to be an object ") +
                    "with the shape: '{type: string, defaultValue?: mixed, nonNull?: boolean, list?: boolean}'.",
                  null,
                  [e.value],
                );
              var s = Object.keys(i).filter(function(e) {
                return 'type' !== e && 'defaultValue' !== e && 'nonNull' !== e && 'list' !== e;
              });
              if (0 !== s.length) {
                var o = "'" + s.join("', '") + "'";
                throw m(
                  "Expected definition for variable '$".concat(n, "' to be an object ") +
                    "with the following shape: '{type: string, defaultValue?: mixed, nonNull?: boolean, list?: boolean}', got unknown key(s) " +
                    ''.concat(o, '.'),
                  null,
                  [e],
                );
              }
              var l = I(String(i.type)),
                u = S(c(t._schema, l));
              a.set(n, {
                ast: e,
                defaultValue: null != i.defaultValue ? i.defaultValue : null,
                defined: !0,
                name: n,
                type: u,
              });
        ...
        (t._buildOperationArgumentDefinitions = function(e) {
          var t = this,
            n = new Map();
          return (
            (e.variableDefinitions || []).forEach(function(e) {
              var r = V(e.variable),
                i = S(c(t._schema, e.type)),
                a = e.defaultValue ? j(e.defaultValue, e) : null,
                s = n.get(r);
              if (null != s)
                throw m("Duplicate definition for variable '$".concat(r, "'."), null, [s.ast, e]);
              n.set(r, { ast: e, defaultValue: a, defined: !0, name: r, type: i });
            }),
            n
          );
        }),
    ...
    var M = (function() {
      function e(e, t, n, r, i) {
        (this._definition = r),
          (this._entries = n),
          (this._getFieldDefinition = t),
          (this._schema = e),
          (this._variableDefinitions = i),
      ...
      return (
        (t.transform = function() {
          ...
          switch (e.kind) {
            ...
            default:
              throw h('Unsupported definition type '.concat(e.kind), [e]);
          }
        }),
        (t._getErrorContext = function() {
          var e = 'document `'.concat(V(this._definition), '`');
          return (
            this._definition.loc &&
              this._definition.loc.source &&
              (e += ' file: `'.concat(this._definition.loc.source.name, '`')),
            e
          );
        }),
        (t._recordAndVerifyVariableReference = function(e, t, n) {
          if (null != n) {
            var r = this._variableDefinitions.get(t);
            if (null != r) {
              var i = r.type;
              if ((null != r.defaultValue && (i = new N(u(i))), !O(this._schema, i, n)))
                throw m(
                  "Variable '$"
                    .concat(t, "' was defined as type '")
                    .concat(String(r.type), "' but used in a location expecting the type '")
                    .concat(String(n), "'"),
                  null,
                  [r.ast, e],
                );
            } else {
              var a = this._unknownVariables.get(t);
              if (a && a.type) {
                var s = a.type,
                  o = a.ast;
                if (!O(this._schema, n, s) && !O(this._schema, s, n))
                  throw m(
                    "Variable '$"
                      .concat(t, "' was used in locations expecting the conflicting types '")
                      .concat(String(s), "' and '")
                      .concat(String(n), "'. Source: ")
                      .concat(this._getErrorContext()),
                    null,
                    [o, e],
                  );
                O(this._schema, n, s) && this._unknownVariables.set(t, { ast: e, type: n });
              } else this._unknownVariables.set(t, { ast: e, type: n });
            }
          } else
            this._variableDefinitions.has(t) ||
              this._unknownVariables.has(t) ||
              this._unknownVariables.set(t, { ast: e, type: null });
        }),
        (t._transformFragment = function(e) {
          var t = this._transformDirectives(
              (e.directives || []).filter(function(e) {
                return 'argumentDefinitions' !== V(e);
              }),
            ),
            n = g(c(this._schema, e.typeCondition)),
            r = this._transformSelections(e.selectionSet, n),
            i = (0, a.default)(R(this._variableDefinitions)),
            s = !0,
            o = !1,
            l = void 0;
          try {
            for (
              var u, p = this._unknownVariables[Symbol.iterator]();
              !(s = (u = p.next()).done);
              s = !0
            ) {
              var f = u.value,
        ...
        (t._transformOperation = function(e) {
          var t,
            n,
            r = V(e),
            i = this._transformDirectives(e.directives || []);
          switch (e.operation) {
            case 'query':
              (n = 'query'), (t = g(this._schema.getQueryType()));
              break;
            case 'mutation':
              (n = 'mutation'), (t = g(this._schema.getMutationType()));
              break;
            case 'subscription':
              (n = 'subscription'), (t = g(this._schema.getSubscriptionType()));
              break;
            default:
              throw (e.operation,
              h(
                "Unknown ast kind '"
                  .concat(e.operation, "'. Source: ")
                  .concat(this._getErrorContext(), '.'),
                null,
                [e],
              ));
          ...
          if (!e.selectionSet)
            throw m(
              'Expected operation to have selections. Source: '.concat(this._getErrorContext()),
              null,
              [e],
            );
          var a = this._transformSelections(e.selectionSet, t),
            s = R(this._variableDefinitions);
          if (0 !== this._unknownVariables.size)
            throw m(
              "Query '".concat(r, "' references undefined variables."),
              null,
              Array.from(this._unknownVariables.values(), function(e) {
                return e.ast;
              }),
            );
          return {
        ...
        (t._transformSelections = function(e, t) {
          var n = this;
          return e.selections.map(function(e) {
            var r;
            if ('Field' === e.kind) r = n._transformField(e, t);
            else if ('FragmentSpread' === e.kind) r = n._transformFragmentSpread(e, t);
            else {
              if ('InlineFragment' !== e.kind)
                throw (e.kind,
                h(
                  "Unknown ast kind '"
                    .concat(e.kind, "'. Source: ")
                    .concat(n._getErrorContext(), '.'),
                  [e],
                ));
              r = n._transformInlineFragment(e, t);
            }
            var a = n._splitConditions(r.directives),
              s = a[0],
              o = a[1],
              l = (function(e, t) {
                var n = t;
                return (
                  e.forEach(function(e) {
                    n = [(0, i.default)({}, e, { selections: n })];
                  }),
                  n
                );
              })(s, [(0, i.default)({}, r, { directives: o })]);
            if (1 !== l.length)
              throw h(
                'Expected exactly one condition node. Source: '.concat(n._getErrorContext()),
                null,
                e.directives,
              );
            return l[0];
        ...
        (t._transformInlineFragment = function(e, t) {
          var n = g(e.typeCondition ? c(this._schema, e.typeCondition) : t),
            r = this._transformDirectives(e.directives || []),
            i = this._transformSelections(e.selectionSet, n);
          return {
            kind: 'InlineFragment',
            directives: r,
            loc: B(e.loc),
        ...
        (t._transformFragmentSpread = function(e, t) {
          var n = this,
            r = V(e),
            i = q(e.directives || [], function(e) {
              return 'arguments' !== V(e);
            }),
            a = i[0],
            s = i[1];
          if (s.length > 1)
            throw m(
              ...
              ) + 'Source: '.concat(this._getErrorContext()),
              null,
              s,
            );
          var o,
            l = this._entries.get(r),
            u = null === l || void 0 === l ? void 0 : l.variableDefinitions;
          s.length &&
            (o = (s[0].arguments || []).map(function(e) {
              var t,
                i,
                a = V(e),
                s = e.value,
                o = null != u ? u.get(a) : null,
                l =
                  null !== (t = null === o || void 0 === o ? void 0 : o.type) && void 0 !== t
                    ? t
                    : null;
              if ('Variable' === s.kind)
                return {
                  ...
                  metadata: null,
                  name: a,
                  value: n._transformVariable(s, null),
                  type: null,
                };
              if (null == l)
                throw m(
                  'Literal @'.concat('arguments', ' values are only supported when the ') +
                    'argument is defined with @'.concat('argumentDefinitions', '. Check ') +
                    "the definition of fragment '".concat(r, "'."),
                  null,
                  [
                    e.value,
                    null === (i = n._entries.get(r)) || void 0 === i ? void 0 : i.definition,
                  ].filter(Boolean),
                );
              var c = n._transformValue(s, l);
              return {
                kind: 'Argument',
                loc: B(e.loc),
                metadata: null,
          ...
          var c = this._transformDirectives(a);
          return {
            kind: 'FragmentSpread',
            args: o || [],
            metadata: null,
        ...
        (t._transformField = function(e, t) {
          var n = V(e),
            r = this._getFieldDefinition(this._schema, t, n, e);
          if (null == r)
            throw m(
              "Unknown field '"
                .concat(n, "' on type '")
                .concat(String(t), "'. Source: ")
                .concat(this._getErrorContext()),
              null,
              [e],
            );
          var i = e.alias ? e.alias.value : null,
            a = this._transformArguments(e.arguments || [], r.args),
            s = q(e.directives || [], function(e) {
              return '__clientField' !== V(e);
            }),
            o = s[0],
            l = s[1],
            u = this._transformDirectives(o),
            c = x(r.type),
            p = this._transformHandle(n, a, l);
          if (_(E(c))) {
            if (e.selectionSet && e.selectionSet.selections && e.selectionSet.selections.length)
              throw m(
                "Expected no selections for scalar field '"
                  .concat(n, "'. Source: ")
                  .concat(this._getErrorContext()),
                null,
                [e],
            ...
            return {
              ...
              type: (function(e) {
                if (
                  !(function(e) {
                    var t = E(e);
                    return t instanceof C || t instanceof P;
                  })(e)
                )
                  throw m("Expected a scalar field type, got type '".concat(String(e), "'."));
                return e;
              })(c),
            };
          }
          var f = e.selectionSet ? this._transformSelections(e.selectionSet, c) : null;
          if (null == f || 0 === f.length)
            throw m(
              "Expected at least one selection for non-scalar field '"
                .concat(n, "' on type '")
                .concat(String(c), "'. Source: ")
                .concat(this._getErrorContext(), '.'),
              null,
              [e],
            );
        ...
        (t._transformHandle = function(e, t, n) {
          var r,
            i = this;
          return (
            n.forEach(function(n) {
              var a = (n.arguments || []).find(function(e) {
                return 'handle' === V(e);
              });
              if (a) {
                var s,
                ...
                if ('string' != typeof c)
                  throw m(
                    'Expected a string literal argument for the @'.concat(
                      '__clientField',
                      ' directive. ',
                    ) + 'Source: '.concat(i._getErrorContext()),
                    null,
                    [a.value],
                  );
                s = c;
                var p = (n.arguments || []).find(function(e) {
                  return 'key' === V(e);
                });
                if (p) {
                  var f = j(p.value, p);
                ...
                var d = (n.arguments || []).find(function(e) {
                  return 'filters' === V(e);
                });
                if (d) {
                  var h = j(d.value, d);
                  if (
                    ...
                    throw m(
                      "Expected an array of argument names on field '".concat(e, "'. ") +
                        'Source: '.concat(i._getErrorContext()),
                      null,
                      [d.value],
                    );
                ...
                (r = r || []).push({ name: s, key: l, filters: u });
              }
            }),
            r
          );
        }),
        (t._transformDirectives = function(e) {
          var t = this;
          return e.map(function(e) {
            ...
            if (null == r)
              throw m(
                "Unknown directive '".concat(n, "'. Source: ").concat(t._getErrorContext()),
                null,
                [e],
              );
            var i = t._transformArguments(e.arguments || [], r.args);
            return { kind: 'Directive', loc: B(e.loc), metadata: null, name: n, args: i };
          });
        }),
        (t._transformArguments = function(e, t) {
          var n = this;
          return e.map(function(e) {
            var r = V(e),
              i = t.find(function(e) {
            ...
            if (null == i)
              throw m(
                "Unknown argument '".concat(r, "'. Source: ").concat(n._getErrorContext()),
                null,
                [e],
              );
            var a = n._transformValue(e.value, i.type);
            return {
              kind: 'Argument',
              loc: B(e.loc),
              metadata: null,
        ...
        (t._splitConditions = function(e) {
          ...
          return [
            r
                ...
                if (null == r || 'if' !== r.name)
                  throw m(
                    "Expected an 'if' argument to @"
                      .concat(e.name, '. Source: ')
                      .concat(t._getErrorContext()),
                    [e.loc],
                  );
                if ('Variable' !== r.value.kind && 'Literal' !== r.value.kind)
                  throw m(
                    "Expected the 'if' argument to @"
                      .concat(e.name, ' to be a variable or literal. Source: ')
                      .concat(t._getErrorContext()),
                    [e.loc],
                  );
                return {
              ...
              .sort(function(e, t) {
                return 'Variable' === e.condition.kind && 'Variable' === t.condition.kind
                  ? e.condition.variableName < t.condition.variableName
                    ? -1
                    : e.condition.variableName > t.condition.variableName
                    ? 1
                    : 0
                  : 'Variable' === e.condition.kind
                  ? 1
                  : 'Variable' === t.condition.kind
                  ? -1
                  : 0;
              }),
            i,
        ...
        (t._transformVariable = function(e, t) {
          var n = V(e);
          return (
            this._recordAndVerifyVariableReference(e, n, t),
            { kind: 'Variable', loc: B(e.loc), metadata: null, variableName: n, type: t }
          );
        }),
        (t._transformValue = function(e, t) {
          if ('Variable' === e.kind) return this._transformVariable(e, t);
          if ('NullValue' === e.kind) {
            if (t instanceof N)
              throw m("Expected a value matching type '".concat(String(t), "'."), null, [e]);
            return { kind: 'Literal', loc: B(e.loc), metadata: null, value: null };
          }
          return this._transformNonNullLiteral(e, t);
        }),
        (t._transformNonNullLiteral = function(e, t) {
          var n = this,
            r = u(t);
          if (r instanceof k) {
            if ('ListValue' !== e.kind) return this._transformValue(e, r.ofType);
            var i = S(r.ofType),
              a = [],
              s = [],
              o = !0;
            return (
              e.values.forEach(function(e) {
                var t = n._transformValue(e, i);
                'Literal' === t.kind && a.push(t.value), s.push(t), (o = o && 'Literal' === t.kind);
              }),
              o
                ? { kind: 'Literal', loc: B(e.loc), metadata: null, value: a }
                : { kind: 'ListValue', loc: B(e.loc), metadata: null, items: s }
            );
          }
          if (r instanceof w) {
            var l = r;
            ...
            return (
              e.fields.forEach(function(e) {
                var r = V(e),
                  i = l.getFields()[r];
                if (null == i)
                  throw m("Uknown field '".concat(r, "' on type '").concat(String(t), "'."), null, [
                    e,
                  ]);
                var a = S(i.type),
                  s = n._transformValue(e.value, a);
                'Literal' === s.kind && (c[e.name.value] = s.value),
                  p.push({
              ...
              f
                ? { kind: 'Literal', loc: B(e.loc), metadata: null, value: c }
                : { kind: 'ObjectValue', loc: B(e.loc), metadata: null, fields: p }
            );
          }
          if (r === A) {
            if ('IntValue' === e.kind)
            ...
            if ('StringValue' === e.kind)
              return { kind: 'Literal', loc: B(e.loc), metadata: null, value: e.value };
            throw m(
              "Invalid value, expected a value matching type '".concat(String(t), "'."),
              null,
              [e],
            );
          }
          if (r instanceof C || r instanceof P) {
            var d = r.parseLiteral(e);
            if (null == d)
              throw m("Expected a value matching type '".concat(String(t), "'."), null, [e]);
            return { kind: 'Literal', loc: B(e.loc), metadata: null, value: d };
          }
          throw h(
            "Unsupported type '".concat(String(t), "' for input value, expected a GraphQLList, ") +
    ...
    function j(e, t) {
      switch (e.kind) {
        ...
        case 'Variable':
          throw m('Unexpected variable where a literal (static) value is required.', null, [e, t]);
        default:
          throw (e.kind, h("Unknown ast kind '".concat(e.kind, "'."), [e]));
      }
    }
    function R(e) {
    ...
    function B(e) {
      return null == e
        ? { kind: 'Unknown' }
        : { kind: 'Source', start: e.start, end: e.end, source: e.source };
    }
    function V(e) {
      var t,
        n = null === (t = e.name) || void 0 === t ? void 0 : t.value;
      if ('string' != typeof n) throw h("Expected ast node to have a 'name'.", null, [e]);
      return n;
    }
    function q(e, t) {
      for (var n = [], r = [], i = 0; i < e.length; i++) {
        var a = e[i];
        t(a) ? n.push(a) : r.push(a);
      }
      return [n, r];
    }
    e.exports = {
      parse: function(e, t, n) {
        var r = D(new L(t, n));
        return (e = b(e, r, { assumeValid: !0 })), new F(e, r.definitions).transform();
      },
      transform: function(e, t) {
        return s.run('RelayParser.transform', function() {
          return new F(e, t).transform();
        });
      },
    };
  },
  ...
  function(e, t, n) {
    ...
    (0, a.default)('ArrayExpression', {
      fields: {
        elements: {
          validate: (0, a.chain)(
            ...
            (0, a.assertEach)((0, a.assertNodeOrValueType)('null', 'Expression', 'SpreadElement')),
          ),
          default: [],
        },
      },
      ...
      (0, a.default)('BinaryExpression', {
        builder: ['operator', 'left', 'right'],
        fields: {
          operator: { validate: (0, a.assertOneOf)(...i.BINARY_OPERATORS) },
      ...
      (0, a.default)('BreakStatement', {
        visitor: ['label'],
        fields: { label: { validate: (0, a.assertNodeType)('Identifier'), optional: !0 } },
        ...
        fields: {
          ...
          arguments: {
            validate: (0, a.chain)(
              (0, a.assertValueType)('array'),
              (0, a.assertEach)(
                (0, a.assertNodeType)('Expression', 'SpreadElement', 'JSXNamespacedName'),
              ),
            ),
          },
      ...
      (0, a.default)('CatchClause', {
        visitor: ['param', 'body'],
        fields: {
          param: { validate: (0, a.assertNodeType)('Identifier'), optional: !0 },
      ...
      (0, a.default)('File', {
        ...
        visitor: ['program'],
        fields: { program: { validate: (0, a.assertNodeType)('Program') } },
      }),
      (0, a.default)('ForInStatement', {
        visitor: ['left', 'right', 'body'],
        aliases: ['Scopable', 'Statement', 'For', 'BlockParent', 'Loop', 'ForXStatement'],
        fields: {
          left: { validate: (0, a.assertNodeType)('VariableDeclaration', 'LVal') },
          right: { validate: (0, a.assertNodeType)('Expression') },
          body: { validate: (0, a.assertNodeType)('Statement') },
        },
      }),
    ...
    const s = {
      params: {
        validate: (0, a.chain)(
          (0, a.assertValueType)('array'),
          (0, a.assertEach)((0, a.assertNodeType)('LVal')),
        ),
      },
      generator: { default: !1, validate: (0, a.assertValueType)('boolean') },
      async: { validate: (0, a.assertValueType)('boolean'), default: !1 },
    };
    t.functionCommon = s;
    const o = {
      returnType: {
        validate: (0, a.assertNodeType)('TypeAnnotation', 'TSTypeAnnotation', 'Noop'),
        optional: !0,
      },
      typeParameters: {
    ...
    t.functionTypeAnnotationCommon = o;
    ...
    (t.patternLikeCommon = u),
      (0, a.default)('Identifier', {
        ...
        fields: Object.assign({}, u, {
          name: {
            validate: (0, a.chain)(function(e, t, n) {
              (0, r.default)(n);
      ...
      (0, a.default)('NullLiteral', { aliases: ['Expression', 'Pureish', 'Literal', 'Immutable'] }),
      ...
      (0, a.default)('RegExpLiteral', {
        ...
        fields: {
          ...
          flags: { validate: (0, a.assertValueType)('string'), default: '' },
        },
      }),
      (0, a.default)('LogicalExpression', {
        ...
        aliases: ['Binary', 'Expression'],
        fields: {
          operator: { validate: (0, a.assertOneOf)(...i.LOGICAL_OPERATORS) },
          left: { validate: (0, a.assertNodeType)('Expression') },
          right: { validate: (0, a.assertNodeType)('Expression') },
        },
      }),
      (0, a.default)('MemberExpression', {
        ...
        fields: {
          ...
          property: {
            validate: (function() {
              const e = (0, a.assertNodeType)('Identifier', 'PrivateName'),
      ...
      (0, a.default)('Program', {
        ...
        fields: {
          ...
          sourceType: { validate: (0, a.assertOneOf)('script', 'module'), default: 'script' },
          interpreter: {
        ...
        fields: {
          properties: {
            validate: (0, a.chain)(
              (0, a.assertValueType)('array'),
              (0, a.assertEach)(
                (0, a.assertNodeType)('ObjectMethod', 'ObjectProperty', 'SpreadElement'),
              ),
            ),
          },
        },
      ...
      (0, a.default)('ObjectMethod', {
        ...
        fields: Object.assign({}, s, o, {
          ...
          computed: { validate: (0, a.assertValueType)('boolean'), default: !1 },
          key: {
            validate: (function() {
              const e = (0, a.assertNodeType)('Identifier', 'StringLiteral', 'NumericLiteral'),
                t = (0, a.assertNodeType)('Expression');
              return function(n, r, i) {
                (n.computed ? t : e)(n, r, i);
              };
      ...
      (0, a.default)('ObjectProperty', {
        ...
        fields: {
          ...
          shorthand: { validate: (0, a.assertValueType)('boolean'), default: !1 },
          decorators: {
            validate: (0, a.chain)(
              (0, a.assertValueType)('array'),
              (0, a.assertEach)((0, a.assertNodeType)('Decorator')),
      ...
      (0, a.default)('RestElement', {
        ...
        fields: Object.assign({}, u, { argument: { validate: (0, a.assertNodeType)('LVal') } }),
      }),
      (0, a.default)('ReturnStatement', {
        visitor: ['argument'],
        aliases: ['Statement', 'Terminatorless', 'CompletionStatement'],
        fields: { argument: { validate: (0, a.assertNodeType)('Expression'), optional: !0 } },
      }),
      ...
      (0, a.default)('TryStatement', {
        ...
        fields: {
          ...
          handler: { optional: !0, validate: (0, a.assertNodeType)('CatchClause') },
          finalizer: { optional: !0, validate: (0, a.assertNodeType)('BlockStatement') },
        },
      }),
      (0, a.default)('UnaryExpression', {
        ...
        fields: {
          ...
          operator: { validate: (0, a.assertOneOf)(...i.UNARY_OPERATORS) },
        },
        visitor: ['argument'],
      ...
      (0, a.default)('UpdateExpression', {
        ...
        fields: {
          prefix: { default: !1 },
          argument: { validate: (0, a.assertNodeType)('Expression') },
          operator: { validate: (0, a.assertOneOf)(...i.UPDATE_OPERATORS) },
        },
        visitor: ['argument'],
        aliases: ['Expression'],
      }),
      ...
      (0, a.default)('WhileStatement', {
        ...
        fields: {
          test: { validate: (0, a.assertNodeType)('Expression') },
          body: { validate: (0, a.assertNodeType)('BlockStatement', 'Statement') },
        },
      }),
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t, n) {
        if (!t) return !1;
        if (!(0, i.default)(t.type, e)) return !1;
  ...
  function(e, t, n) {
    ...
    (0, r.default)('AssignmentPattern', {
      ...
      fields: Object.assign({}, i.patternLikeCommon, {
        left: { validate: (0, r.assertNodeType)('Identifier', 'ObjectPattern', 'ArrayPattern') },
        right: { validate: (0, r.assertNodeType)('Expression') },
        decorators: {
          validate: (0, r.chain)(
      ...
      (0, r.default)('ArrayPattern', {
        ...
        fields: Object.assign({}, i.patternLikeCommon, {
          elements: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)((0, r.assertNodeType)('PatternLike')),
            ),
          },
          decorators: {
            validate: (0, r.chain)(
      ...
      (0, r.default)('ArrowFunctionExpression', {
        ...
        fields: Object.assign({}, i.functionCommon, i.functionTypeAnnotationCommon, {
          expression: { validate: (0, r.assertValueType)('boolean') },
          body: { validate: (0, r.assertNodeType)('BlockStatement', 'Expression') },
        }),
      }),
    ...
    const a = {
      ...
      body: { validate: (0, r.assertNodeType)('ClassBody') },
      superClass: { optional: !0, validate: (0, r.assertNodeType)('Expression') },
      superTypeParameters: {
        validate: (0, r.assertNodeType)(
      ...
      implements: {
        validate: (0, r.chain)(
          (0, r.assertValueType)('array'),
          (0, r.assertEach)(
            (0, r.assertNodeType)('TSExpressionWithTypeArguments', 'ClassImplements'),
          ),
        ),
        optional: !0,
      },
    ...
    (0, r.default)('ClassDeclaration', {
      ...
      fields: Object.assign({}, a, {
        declare: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
        abstract: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
        id: { validate: (0, r.assertNodeType)('Identifier'), optional: !0 },
        decorators: {
          validate: (0, r.chain)(
            (0, r.assertValueType)('array'),
            (0, r.assertEach)((0, r.assertNodeType)('Decorator')),
      ...
      (0, r.default)('ClassExpression', {
        ...
        fields: Object.assign({}, a, {
          id: { optional: !0, validate: (0, r.assertNodeType)('Identifier') },
          body: { validate: (0, r.assertNodeType)('ClassBody') },
          superClass: { optional: !0, validate: (0, r.assertNodeType)('Expression') },
          decorators: {
            validate: (0, r.chain)(
      ...
      (0, r.default)('ExportAllDeclaration', {
        ...
        fields: { source: { validate: (0, r.assertNodeType)('StringLiteral') } },
      }),
      ...
      (0, r.default)('ExportNamedDeclaration', {
        ...
        aliases: ['Statement', 'Declaration', 'ModuleDeclaration', 'ExportDeclaration'],
        fields: {
          declaration: { validate: (0, r.assertNodeType)('Declaration'), optional: !0 },
          specifiers: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)(
          ...
          source: { validate: (0, r.assertNodeType)('StringLiteral'), optional: !0 },
        },
      }),
      (0, r.default)('ExportSpecifier', {
        ...
        fields: {
          local: { validate: (0, r.assertNodeType)('Identifier') },
          exported: { validate: (0, r.assertNodeType)('Identifier') },
        },
      }),
      (0, r.default)('ForOfStatement', {
        ...
        aliases: ['Scopable', 'Statement', 'For', 'BlockParent', 'Loop', 'ForXStatement'],
        fields: {
          left: { validate: (0, r.assertNodeType)('VariableDeclaration', 'LVal') },
          right: { validate: (0, r.assertNodeType)('Expression') },
          body: { validate: (0, r.assertNodeType)('Statement') },
          await: { default: !1, validate: (0, r.assertValueType)('boolean') },
        },
      }),
      (0, r.default)('ImportDeclaration', {
        ...
        fields: {
          ...
          source: { validate: (0, r.assertNodeType)('StringLiteral') },
        },
      }),
      (0, r.default)('ImportDefaultSpecifier', {
        visitor: ['local'],
        aliases: ['ModuleSpecifier'],
        fields: { local: { validate: (0, r.assertNodeType)('Identifier') } },
      }),
      ...
      (0, r.default)('ImportSpecifier', {
        ...
        fields: {
          local: { validate: (0, r.assertNodeType)('Identifier') },
          imported: { validate: (0, r.assertNodeType)('Identifier') },
          importKind: { validate: (0, r.assertOneOf)(null, 'type', 'typeof') },
        },
      }),
      (0, r.default)('MetaProperty', {
        ...
        aliases: ['Expression'],
        fields: {
          meta: { validate: (0, r.assertNodeType)('Identifier') },
          property: { validate: (0, r.assertNodeType)('Identifier') },
        },
      });
    const s = {
      abstract: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
      accessibility: {
        validate: (0, r.chain)(
          ...
          (0, r.assertOneOf)('public', 'private', 'protected'),
        ),
        optional: !0,
      },
      static: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
      computed: { default: !1, validate: (0, r.assertValueType)('boolean') },
      optional: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
      key: {
        validate: (0, r.chain)(
          (function() {
    ...
    t.classMethodOrPropertyCommon = s;
    const o = Object.assign({}, i.functionCommon, s, {
      kind: {
        validate: (0, r.chain)(
          (0, r.assertValueType)('string'),
          (0, r.assertOneOf)('get', 'set', 'method', 'constructor'),
        ),
        default: 'method',
      },
      access: {
    ...
    (t.classMethodOrDeclareMethodCommon = o),
      ...
      (0, r.default)('ObjectPattern', {
        ...
        fields: Object.assign({}, i.patternLikeCommon, {
          properties: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)((0, r.assertNodeType)('RestElement', 'ObjectProperty')),
            ),
          },
        }),
      }),
      (0, r.default)('SpreadElement', {
        ...
        fields: { argument: { validate: (0, r.assertNodeType)('Expression') } },
      }),
      (0, r.default)('Super', { aliases: ['Expression'] }),
      (0, r.default)('TaggedTemplateExpression', {
        visitor: ['tag', 'quasi'],
        aliases: ['Expression'],
        fields: {
          tag: { validate: (0, r.assertNodeType)('Expression') },
          quasi: { validate: (0, r.assertNodeType)('TemplateLiteral') },
          typeParameters: {
            validate: (0, r.assertNodeType)(
              'TypeParameterInstantiation',
              'TSTypeParameterInstantiation',
      ...
      (0, r.default)('TemplateElement', {
        builder: ['value', 'tail'],
        fields: { value: {}, tail: { validate: (0, r.assertValueType)('boolean'), default: !1 } },
      }),
      (0, r.default)('TemplateLiteral', {
        ...
        fields: {
          quasis: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)((0, r.assertNodeType)('TemplateElement')),
            ),
          },
          expressions: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)((0, r.assertNodeType)('Expression')),
            ),
          },
        },
      }),
      (0, r.default)('YieldExpression', {
        ...
        fields: {
          delegate: { validate: (0, r.assertValueType)('boolean'), default: !1 },
          argument: { optional: !0, validate: (0, r.assertNodeType)('Expression') },
        },
      });
  },
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.ObjectPattern = t.ObjectExpression = function(e) {
        ...
        this.token('{'),
          ...
          t.length &&
            (this.space(), this.printList(t, e, { indent: !0, statement: !0 }), this.space());
        this.token('}');
      }),
      ...
      (t.ObjectProperty = function(e) {
        if ((this.printJoin(e.decorators, e), e.computed))
          ...
          if (
            r().isAssignmentPattern(e.value) &&
            r().isIdentifier(e.key) &&
      ...
      (t.ArrayPattern = t.ArrayExpression = function(e) {
        ...
        for (let r = 0; r < t.length; r++) {
          const i = t[r];
          i
            ? (r > 0 && this.space(), this.print(i, e), r < n - 1 && this.token(','))
            : this.token(',');
        }
        this.token(']');
      }),
  ...
  function(e, t, n) {
    ...
    var r = n(42),
      i = n(9),
      a = n(6),
      s = a.isExecutableDefinitionAST,
      o = a.isSchemaDefinitionAST,
      l = n(1),
      u = l.extendSchema,
      c = l.parse,
      p = l.print,
    ...
    function d(e, t, n, i) {
      ...
      var o = { kind: 'Document', definitions: a };
      return r.validate(o, e, n), i(e, a);
    }
    function h(e) {
      var t = [];
      return (
    ...
    function y(e, t, n) {
      ...
      r || ((r = {}), m.set(e, r));
      var i = r[t];
      return i || ((i = n()), (r[t] = i)), i;
    }
    e.exports = {
      convertASTDocuments: function(e, t, n, r) {
        return i.run('ASTConvert.convertASTDocuments', function() {
          var i = h(t),
            a = [];
          return (
            t.forEach(function(e) {
      ...
      convertASTDocumentsWithBase: function(e, t, n, r, a) {
        return i.run('ASTConvert.convertASTDocumentsWithBase', function() {
          var i = h(t),
            o = h(n),
            l = new Map(),
            u = new Map();
          i.forEach(function(e) {
            if (s(e)) {
              var t = e.name && e.name.value;
              if (t) {
                if (u.has(t)) throw new Error("Duplicate definition of '".concat(t, "'."));
                u.set(t, e);
              }
            }
          });
          ...
          for (
            ...
            var p = c.pop(),
              m = p.name && p.name.value;
            if (m)
              if (l.has(m)) {
                if (l.get(m) !== p) throw new Error("Duplicate definition of '".concat(m, "'."));
              } else
                l.set(m, p),
                  f(p, {
      ...
      extendASTSchema: function(e, t) {
        return i.run('ASTConvert.extendASTSchema', function() {
          var n = [];
          if (
            (t.forEach(function(e) {
              e.definitions.forEach(function(e) {
          ...
          return y(e, r, function() {
            return u(e, { kind: 'Document', definitions: n }, { assumeValid: !0 });
          });
        });
      },
      transformASTSchema: function(e, t) {
        return i.run('ASTConvert.transformASTSchema', function() {
  ...
  function(e, t, n) {
    ...
    var r = n(9),
      ...
      a = n(1),
      s = a.formatError,
      o = a.FragmentsOnCompositeTypesRule,
      l = a.KnownArgumentNamesRule,
      u = a.KnownTypeNamesRule,
      c = a.LoneAnonymousOperationRule,
      p = a.NoUnusedVariablesRule,
      f = a.PossibleFragmentSpreadsRule,
      d = a.UniqueArgumentNamesRule,
      h = a.UniqueFragmentNamesRule,
      m = a.UniqueInputFieldNamesRule,
      y = a.UniqueOperationNamesRule,
      v = a.UniqueVariableNamesRule,
      T = a.validate,
      g = a.ValuesOfCorrectTypeRule,
      S = a.VariablesAreInputTypesRule,
      x = a.VariablesInAllowedPositionRule;
    e.exports = {
      GLOBAL_RULES: [l, p, d, h, m, y, v],
      LOCAL_RULES: [o, u, c, f, g, S, x],
      validate: r.instrument(function(e, t, n) {
        var r = T(t, e, n);
        if (r && r.length > 0) {
          var a = r.map(s),
            o = r.map(function(e) {
            ...
            l = new Error(
              i.format('You supplied a GraphQL document with validation errors:\n%s', o.join('\n')),
            );
          throw ((l.validationErrors = a), l);
        }
  ...
  function(e, t, n) {
    ...
    function p() {
      return (p = r(function*(e, t, n) {
        return yield a.waitFor(
          'Watchman:query',
          r(function*() {
            var r = new i(c),
              a = yield Promise.all([r.watchProject(e), d(r)]),
              s = a[0],
              o = a[1],
              l = yield r.command('query', s.root, {
                expression: t,
                fields: o,
                relative_root: s.relativePath,
              });
            return r.end(), b(new Set(), e, n, l.files);
          }),
        );
    ...
    function f() {
      return (f = r(function*(e, t) {
        return yield a.waitFor(
          ...
          r(function*() {
            var n = new i(),
              r = yield n.watchProject(e),
              a = yield n.command('query', r.root, {
                expression: t,
                fields: ['name'],
                relative_root: r.relativePath,
              });
            return n.end(), a.files;
          }),
        );
      })).apply(this, arguments);
    }
    ...
    function h() {
      return (h = r(function*(e) {
        var t = ['name', 'exists'];
        return (yield e.hasCapability('field-content.sha1hex')) && t.push('content.sha1hex'), t;
      })).apply(this, arguments);
    }
    function m() {
      return (m = r(function*(e, t, n) {
        var r = t.map(function(e) {
          return { name: e, exists: !0, 'content.sha1hex': null };
        });
        return b(new Set(), e, n, r);
      })).apply(this, arguments);
    }
    function y(e, t, n) {
    ...
    function v() {
      return (v = r(function*(e, t, n) {
        return yield a.waitFor(
          'Watchman:subscribe',
          r(function*() {
            var r = new i(),
              a = yield r.watchProject(e);
            yield (function(e, t, n, r, i) {
              return T.apply(this, arguments);
            })(r, a.root, a.relativePath, t, n);
          }),
        );
      })).apply(this, arguments);
    }
    function T() {
      return (T = r(function*(e, t, n, r, i) {
        e.on('subscription', function(e) {
          e.subscription === u && i(e);
        });
        var a = yield d(e);
        yield e.command('subscribe', t, u, { expression: r, fields: a, relative_root: n });
      })).apply(this, arguments);
    }
    function g(e, t, n, r) {
    ...
    function S() {
      return (S = r(function*(e, t, n, r) {
        var i = new Set();
        yield y(e, t, function(t) {
          t.files && ((i = b(i, e, n, t.files)), r(i));
        });
      })).apply(this, arguments);
    }
    function x() {
      return (x = r(function*(e, t, n, i) {
        var a = !1,
          s = !1,
          o = null;
        g(
    ...
    function b(e, t, n, r) {
      ...
      return (
        ...
        r.forEach(function(e) {
          ...
          c && i.set(r, { exists: !1, relPath: r });
        }),
        new Set(i.values())
      );
    }
    e.exports = {
      queryDirectories: function(e, t) {
        return f.apply(this, arguments);
      },
      queryFiles: function(e, t, n) {
        return p.apply(this, arguments);
      },
      queryFilepaths: function(e, t, n) {
        return m.apply(this, arguments);
      },
      watch: y,
      watchFiles: g,
      watchCompile: function(e, t, n, r) {
      ...
      generate: function(e) {
        switch (e.kind) {
          ...
          case 'Request':
            return {
              kind: 'Request',
              fragment: i.generate(e.fragment),
        ...
        throw a("RelayCodeGenerator: Unknown AST kind '".concat(e.kind, "'."), [e.loc]);
      },
    };
  },
  function(e, t, n) {
    ...
    e.exports = {
      ...
      postProcess: function(e, t) {
        return e.replace(/"@@MODULE_START@@(.*?)@@MODULE_END@@"/g, function(e, n) {
          return t(n);
        });
      },
    };
  ...
  function(e, t, n) {
    ...
    var r = n(0)(n(7)),
      ...
      o = i.validate;
    var l = a,
      u = (0, r.default)(s).concat([
        function(e) {
          return {
            Field: function(e) {
              if (e.alias && 'id' === e.alias.value && 'id' !== e.name.value)
                throw new Error(
                  'RelayValidator: Relay does not allow aliasing fields to `id`. This name is reserved for the globally unique `id` field on `Node`.',
                );
            },
          };
        },
      ]);
    e.exports = { GLOBAL_RULES: l, LOCAL_RULES: u, validate: o };
  },
  function(e, t, n) {
    'use strict';
    var r = n(0)(n(7)),
    ...
    e.exports = function(e, t, n) {
      return a.run('GraphQLCompiler.compile', function() {
        var i = e.applyTransforms(
            (0, r.default)(t.commonTransforms).concat((0, r.default)(t.fragmentTransforms)),
            n,
          ),
          a = e.applyTransforms(
            (0, r.default)(t.commonTransforms).concat(
              (0, r.default)(t.queryTransforms),
              (0, r.default)(t.printTransforms),
            ),
            n,
          ),
          o = e.applyTransforms(
            (0, r.default)(t.commonTransforms).concat(
              (0, r.default)(t.queryTransforms),
              (0, r.default)(t.codegenTransforms),
            ),
            n,
          ),
          u = [],
          ...
          f = void 0;
        try {
          for (var d, h = o.documents()[Symbol.iterator](); !(c = (d = h.next()).done); c = !0) {
            var m = d.value;
            if ('Root' === m.kind) {
              var y = i.getRoot(m.name);
              u.push(
                s.generate({
                  kind: 'Request',
                  fragment: {
                    kind: 'Fragment',
                    argumentDefinitions: y.argumentDefinitions,
                    directives: y.directives,
                    loc: { kind: 'Derived', source: m.loc },
                    metadata: null,
                    name: y.name,
                    selections: y.selections,
                    type: y.type,
                  },
                  id: null,
                  loc: m.loc,
        ...
        var v = !0,
          ...
          g = void 0;
        try {
          for (var S, x = i.documents()[Symbol.iterator](); !(v = (S = x.next()).done); v = !0) {
            var b = S.value;
            'Fragment' === b.kind && u.push(s.generate(b));
          }
        } catch (e) {
          (T = !0), (g = e);
        } finally {
  ...
  function(e, t, n) {
    ...
    e.exports = function(e, t) {
      for (
        var n = [e],
          a = new r(t.serverSchema, t.clientSchema).add(e),
          s = {
            FragmentSpread: function(e) {
              !(function(e) {
                var r = e.name;
                if (!a.get(r)) {
                  var i = t.getFragment(r);
                  (a = a.add(i)), n.push(i);
                }
              })(e);
            },
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      p = n(104),
      f = n(2),
      d = (n(26), n(19).RelayConcreteNode);
    function h(e) {
      return "require('".concat(e, "')");
    }
    function m() {
      return (m = i(function*(e, t, n, r, i, m, y, v) {
        var T,
          g = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : h,
          S = t,
          x = i,
          b = ('Request' === S.kind ? S.params.name : S.name) + '.graphql',
          E = (null != m && m.length > 0 ? b + '.' + m : b) + '.' + v,
          P = (function(e) {
            switch (e.kind) {
              case d.FRAGMENT:
              ...
              case d.SPLIT_OPERATION:
                return 'NormalizationSplitOperation';
              default:
                f(!1, 'Unexpected GeneratedNode kind: `%s`.', e.kind);
            }
          })(S),
          A = {};
        S.kind === d.REQUEST && (T = S.params.text);
        var w = null;
        if (S.kind === d.REQUEST) {
          var k = l.run('RelayFileWriter:compareHash', function() {
            var t = e.read(E),
              n = u.createHash('md5');
            return (
              n.update('cache-breaker-9'),
              n.update(JSON.stringify(S)),
              n.update(y),
              r && n.update(r),
              x && n.update('persisted'),
              (w = n.digest('hex')),
              (function(e) {
                if (null == e || 0 === e.length) return null;
                if (/<<<<<|>>>>>/.test(e)) return null;
                var t = e.match(/@relayHash (\w{32})\b/m);
                return t && t[1];
              })(t)
            );
          });
          if (w === k) return e.markUnchanged(E), null;
          if (e.onlyValidate) return e.markUpdated(E), null;
          if (x)
            switch (S.kind) {
              case d.REQUEST:
                var N = S.params,
                  C = (N.id, N.text),
                  _ = (0, s.default)(N, ['id', 'text']);
                null == C &&
                  f(!1, 'writeRelayGeneratedFile: Expected `text` in order to persist query'),
                  (A.params = { text: C }),
                  (S = (0, a.default)({}, S, {
                    params: (0, a.default)({ id: yield x(C, y), text: null }, _),
                  }));
                break;
              case d.FRAGMENT:
                break;
        ...
        var O = p('(node/*: any*/)', A),
          D = n({
            ...
            docText: T,
            typeText: r,
            hash: w ? '@relayHash '.concat(w) : null,
            concreteText: o.postProcess(c(S), g),
            devOnlyAssignments: O,
            sourceHash: y,
          });
        return e.writeFile(E, D), S;
      })).apply(this, arguments);
    }
        ...
        var t,
          ...
          r =
            'Request' === e.kind
              ? [
                  e.params.name,
                  null === (t = e.params.metadata) || void 0 === t ? void 0 : t.derivedFrom,
                ]
              : 'SplitOperation' === e.kind
              ? [e.name, null === (n = e.metadata) || void 0 === n ? void 0 : n.derivedFrom]
              : [e.name, null],
          i = r[1];
        return 'string' == typeof i ? i : r[0];
      },
      getSourceDefinitionName: function(e) {
        var t,
          n =
            'Request' === e.kind || 'Root' === e.kind || 'SplitOperation' === e.kind
              ? null === (t = e.metadata) || void 0 === t
                ? void 0
                : t.derivedFrom
              : null;
        return 'string' == typeof n ? n : e.name;
      },
    };
  },
  function(e, t, n) {
    ...
    function p(e, t, n) {
      ...
      if (!r) {
        const i = c(u, e, t);
        if (i) for (let t = 0; t < i.length && !(r = p(i[t], e, n)); t++);
      }
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t, n) {
        ...
        const i = Array.isArray(t) ? t : t.split('.'),
          a = [];
        let s;
        for (s = e; (0, r.isMemberExpression)(s); s = s.object) a.push(s.property);
        if ((a.push(s), a.length < i.length)) return !1;
        if (!n && a.length > i.length) return !1;
        for (let e = 0, t = a.length - 1; e < i.length; e++, t--) {
          const n = a[t];
          let s;
          if ((0, r.isIdentifier)(n)) s = n.name;
          else {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t, n) {
        if (!e) return;
        const i = r.NODE_FIELDS[e.type];
        if (!i) return;
        const a = i[t];
        if (!a || !a.validate) return;
        if (a.optional && null == n) return;
        a.validate(e, t, n);
      });
    var r = n(13);
  },
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function e(t) {
        ...
        for (let o = 0; o < t.length; o++) {
          ...
          if (l && !(s.indexOf(l) >= 0)) {
            ...
            if ((0, r.isFlowBaseAnnotation)(l)) i[l.type] = l;
              ...
              a.indexOf(l.types) < 0 && ((t = t.concat(l.types)), a.push(l.types));
                ...
                r.typeParameters
                  ? l.typeParameters &&
                    (r.typeParameters.params = e(
                      r.typeParameters.params.concat(l.typeParameters.params),
                    ))
                  : (r = l.typeParameters);
              } else n[t] = l;
            } else s.push(l);
        ...
        for (const e in i) s.push(i[e]);
        for (const e in n) s.push(n[e]);
        return s;
      });
    var r = n(8);
  },
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e) {
        (e = (e = (e = (e += '').replace(/[^a-zA-Z0-9$_]/g, '-')).replace(/^[-0-9]+/, '')).replace(
          /[-\s]+(.)?/g,
          function(e, t) {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t = {}) {
        ...
        for (const t in e) '_' === t[0] && null != e[t] && (e[t] = void 0);
        const a = Object.getOwnPropertySymbols(e);
        for (const t of a) e[t] = null;
      });
    ...
    function i(e) {
      if (e.declaration) {
        ...
        (t.length || (!t.length && !n)) &&
          ...
          this.token('}')),
          e.source && (this.space(), this.word('from'), this.space(), this.print(e.source, e)),
          this.semicolon();
      }
    }
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.ExportSpecifier = function(e) {
        this.print(e.local, e),
          e.exported &&
            ...
            (this.space(), this.word('as'), this.space(), this.print(e.exported, e));
      }),
      ...
      (t.ExportNamedDeclaration = function(e) {
        this.format.decoratorsBeforeExport &&
          r().isClassDeclaration(e.declaration) &&
      ...
      (t.ImportDeclaration = function(e) {
        ...
        if (t && t.length) {
          ...
          t.length &&
            (this.token('{'), this.space(), this.printList(t, e), this.space(), this.token('}')),
            this.space(),
            this.word('from'),
            this.space();
        }
  ...
  function(e, t, n) {
    ...
    var r = n(0)(n(4)),
      ...
      l = n(10),
      u = l.createUserError,
      c = l.createCompilerError,
      p = a.getRawType,
      f = a.isAbstractType;
    function d(e, t) {
      var n = t.parentType,
        i =
          'Condition' === e.kind || 'Defer' === e.kind || 'Stream' === e.kind
            ? n
            : 'InlineFragment' === e.kind
            ? e.typeCondition
            : e.type;
      if (null == i) throw c('FlattenTransform: Expected a parent type.', [e.loc]);
      var a = new Map(),
        s = h(a, e, t, i) ? (0, r.default)({}, e, { selections: Array.from(a.values()) }) : e;
      t.parentType = i;
      var o = this.traverse(s, t);
      return (t.parentType = n), o;
    }
    function h(e, t, n, i) {
      var a = !1;
      return (
          ...
          if (
            ...
            (function(e, t, n) {
              return (
                ...
                e.typeCondition.name === p(n).name ||
                (t.flattenAbstractTypes && f(e.typeCondition))
              );
            })(t, n, i)
          )
            return (a = !0), void h(e, t, n, i);
          var s = o(t),
            l = e.get(s);
          if (l)
            if (((a = !0), 'InlineFragment' === l.kind)) {
              if ('InlineFragment' !== t.kind)
                throw c(
                  "FlattenTransform: Expected an InlineFragment, got a '".concat(t.kind, "'"),
                  [t.loc],
                );
              e.set(s, (0, r.default)({}, l, { selections: m(l, t, n, t.typeCondition) }));
            } else if ('Condition' === l.kind) {
              if ('Condition' !== t.kind)
                throw c("FlattenTransform: Expected a Condition, got a '".concat(t.kind, "'"), [
                  t.loc,
                ]);
              e.set(s, (0, r.default)({}, l, { selections: m(l, t, n, i) }));
            } else if ('FragmentSpread' === l.kind);
            else if ('MatchField' === l.kind || 'MatchBranch' === l.kind);
            else if ('Defer' === l.kind) {
              if ('Defer' !== t.kind)
                throw c("FlattenTransform: Expected a Defer, got a '".concat(t.kind, "'"), [t.loc]);
              e.set(s, (0, r.default)({ kind: 'Defer' }, l, { selections: m(l, t, n, i) }));
            } else if ('Stream' === l.kind) {
              if ('Stream' !== t.kind)
                throw c("FlattenTransform: Expected a Stream, got a '".concat(t.kind, "'"), [
                  t.loc,
                ]);
              e.set(s, (0, r.default)({ kind: 'Stream' }, l, { selections: m(l, t, n, i) }));
            } else if ('LinkedField' === l.kind) {
              if ('LinkedField' !== t.kind)
                throw c("FlattenTransform: Expected a LinkedField, got a '".concat(t.kind, "'"), [
                  t.loc,
                ]);
              y(t, l),
                e.set(
                  s,
                  (0, r.default)({ kind: 'LinkedField' }, l, {
                    handles: v(l, t),
                    selections: m(l, t, n, t.type),
                  }),
                );
            } else {
              if ('ScalarField' !== l.kind)
                throw (l.kind, c("FlattenTransform: Unknown kind '".concat(l.kind, "'")));
              if ('ScalarField' !== t.kind)
                throw c("FlattenTransform: Expected a ScalarField, got a '".concat(t.kind, "'"), [
                  t.loc,
                ]);
              y(t, l), e.set(s, (0, r.default)({ kind: 'ScalarField' }, l, { handles: v(t, l) }));
            }
          else e.set(s, t);
        }),
        a
    ...
    function m(e, t, n, r) {
      var i = new Map();
      return h(i, e, n, r), h(i, t, n, r), Array.from(i.values());
    }
    function y(e, t) {
      var n;
      if (
            ...
            (function(e, t) {
              return (
                ...
                e.every(function(e, n) {
                  ...
                  return (
                    e.name === r.name &&
                    e.value.kind === r.value.kind &&
                    e.value.variableName === r.value.variableName &&
                    s(e.value.value, r.value.value)
                  );
                })
              );
            })(e.args, t.args)
        ...
        throw u(
          'Expected all fields on the same parent with ' +
            "the name or alias '".concat(
              null !== (n = e.alias) && void 0 !== n ? n : e.name,
              "' to have the same name and arguments.",
            ),
          [e.loc, t.loc],
        );
    }
    function v(e, t) {
      if (!e.handles) return t.handles;
      if (!t.handles) return e.handles;
      var n = new Map();
      return (
        e.handles.concat(t.handles).forEach(function(e) {
          return n.set(e.name + e.key, e);
        }),
        Array.from(n.values())
      );
    }
    e.exports = {
      transformWithOptions: function(e) {
        return function(t) {
          return (function(e, t) {
            var n = {
              flattenAbstractTypes: !(!t || !t.flattenAbstractTypes),
  ...
  function(e, t, n) {
    ...
    var r = n(2),
      ...
      s = i.printDirectives;
    e.exports = function(e) {
      if ('LinkedField' === e.kind || 'ScalarField' === e.kind)
        return 0 === e.directives.length
          ? e.alias || e.name
          : (e.alias || e.name) + s(e.directives);
      if ('FragmentSpread' === e.kind)
        return 0 === e.args.length ? '...' + e.name : '...' + e.name + a(e.args);
      if ('MatchField' === e.kind) {
        var t,
          n = null === (t = e.metadata) || void 0 === t ? void 0 : t.storageKey;
        return (
          'string' != typeof n &&
            r(
              !1,
      ...
      return 'MatchBranch' === e.kind
        ...
        ? 'S:' + e.label
        : 'InlineFragment' === e.kind
        ? 'I:' + e.typeCondition.name
        : 'Condition' === e.kind
        ? 'C:' +
          ('Variable' === e.condition.kind
            ? '$' + e.condition.variableName
            : String(e.condition.value)) +
          String(e.passingValue)
        : void r(!1, 'getIdentifierForSelection: Unexpected kind `%s`.', e.kind);
    };
  },
  function(e, t, n) {
    'use strict';
    ...
    function l(e, t) {
      ...
      if (0 === t.reachableArguments.length) return n;
      var i = (function(e, t, n) {
        var r = new Map();
        t.argumentDefinitions.forEach(function(e) {
          r.set(e.name, e);
        });
        var i = [];
        if (
          (n.forEach(function(t) {
            ...
            if (s) {
              var l = (function(e, t, n) {
                return t.kind !== n.kind || t.name !== n.name || t.defaultValue !== n.defaultValue
                  ? null
                  : o(e, n.type, t.type)
                  ? n
                  : o(e, t.type, n.type)
              ...
              null === l
                ? i.push('Variable `$'.concat(n.name, '` in `').concat(a, '`'))
                : r.set(l.name, l);
            } else r.set(n.name, n);
          }),
          i.length)
          ...
          throw new Error(
            'RelayMaskTransform: Cannot unmask one or more fragments in ' +
              '`'.concat(t.name, '`, the following variables are referenced more ') +
      ...
      })(this.getContext().serverSchema, e, t.reachableArguments);
      return (0, r.default)({}, n, { argumentDefinitions: i });
    }
    function u(e, t) {
      if (
        !(function(e) {
          return Boolean(e.metadata && !1 === e.metadata.mask);
        })(e)
      )
        return e;
      0 !== e.args.length &&
        a(
          !1,
          'RelayMaskTransform: Cannot unmask fragment spread `%s` with arguments. Use the `ApplyFragmentArgumentTransform` before flattening',
          e.name,
        );
      var n = this.getContext().getFragment(e.name),
        r = {
          kind: 'InlineFragment',
          directives: e.directives,
          loc: { kind: 'Derived', source: e.loc },
          metadata: e.metadata,
          selections: n.selections,
          typeCondition: n.type,
        };
      n.argumentDefinitions.find(function(e) {
        return 'LocalArgumentDefinition' === e.kind;
      }) &&
        a(
          !1,
          'RelayMaskTransform: Cannot unmask fragment spread `%s` because it has local argument definition.',
          e.name,
        );
      var i = !0,
        s = !1,
      ...
      try {
        for (
          var l, u = n.argumentDefinitions[Symbol.iterator]();
          !(i = (l = u.next()).done);
          i = !0
        ) {
          var c = l.value;
          t.reachableArguments.push({ argDef: c, source: e.name });
        }
      } catch (e) {
        (s = !0), (o = e);
      } finally {
      ...
      return this.traverse(r, t);
    }
    e.exports = {
      transform: function(e) {
        return i.transform(e, { FragmentSpread: u, Fragment: l }, function() {
          return { reachableArguments: [] };
        });
      },
    };
  },
  function(e, t, n) {
    ...
    var r = n(5),
      ...
      a = n(77),
      s = n(6).getRawType,
      o = n(10).createUserError,
      l = n(1),
      u = l.GraphQLObjectType,
      c = l.GraphQLScalarType,
      p = l.GraphQLInterfaceType,
      f = l.GraphQLUnionType,
      d = l.GraphQLList,
      h = l.GraphQLString,
      m = l.getNullableType,
      y = 'supported',
      ...
      g = 'js';
    function S(e, t) {
      return this.traverse(e, e.typeCondition);
    }
    function x(e, t) {
      var n,
        r = this.traverse(e, e.type);
      if (
        null ==
        r.directives.find(function(e) {
          return 'match' === e.name;
        })
      )
        return r;
      var l = s(t);
      if (!(l instanceof p || l instanceof u))
        throw o(
          '@match may only be used on fields whose parent type is an interface ' +
            "or object, field '".concat(e.name, "' has invalid type '").concat(String(t), "'"),
          [e.loc],
        );
      var S = this.getContext(),
        x = S.serverSchema.getType(v);
      if (null == x || !(x instanceof c))
        throw new Error(
          "RelayMatchTransform: Expected schema to define a scalar '".concat(v, "' type."),
        );
      var b = l.getFields()[r.name].args.find(function(e) {
          e.name;
          return y;
        }),
        E = null != b ? m(b.type) : null,
        P = null != E && E instanceof d ? E.ofType : null;
      if (null == b || null == E || null == P || m(P) !== h)
        throw new Error(
          'RelayMatchTransform: @match used on an incompatible ' +
            "field '".concat(r.name, "'. @match may only ") +
            "be used with fields that can accept '".concat(y, "' ") +
      ...
      if (!(A instanceof f))
        throw new Error(
          'RelayMatchTransform: You are trying to apply @match ' +
            "directive to a field '".concat(r.name, "' that has unsupported ") +
            "output type. '".concat(r.name, "' output type should be union ") +
        ...
        if ('FragmentSpread' !== e.kind)
          throw new Error(
            'RelayMatchTransform: all selections in a @match field should be ' +
              "fragment spreads, got '".concat(e.kind, "'."),
          );
        var r = S.getFragment(e.name);
        if (!(r.type instanceof u))
          throw new Error(
            'RelayMatchTransform: all fragment spreads in a @match field should be for fragments on an object type. Union or interface type ' +
              "'".concat(r.type.name, "' for '...").concat(r.name, "' is not supported."),
          );
        var s = r.type;
        if (w.has(s))
          throw new Error(
            'RelayMatchTransform: Each "match" type has to appear at-most once. ' +
              "Type '".concat(s.name, "' was matched in both ") +
              "'...".concat(e.name, "' and '...").concat(w.get(s) || '(unknown)', "'."),
          );
        if ((w.set(s, e.name), !A.getTypes().includes(s)))
          throw new Error(
            "RelayMatchTransform: Unsupported type '".concat(s.toString(), "' in ") +
              'the list of matches in the @match. Type ' +
              '"'.concat(s.toString(), '" does not belong to the union ') +
              '"'.concat(A.toString(), '".'),
          );
        var o = s.getFields()[g],
          l = o
            ? o.args.find(function(e) {
                return e.name === T;
              })
            : null;
        if (null == o || null == l || m(l.type) !== h || o.type.name !== x.name)
          throw new Error(
            "RelayMatchTransform: expcted type '"
              .concat(s.name, "' to have a '")
              .concat(g, '(')
              .concat(T, ': String!): ')
              .concat(v, "' field ."),
          );
        var c = e.directives.find(function(e) {
          return 'module' === e.name;
        });
        if (null == c || 1 !== e.directives.length)
          throw new Error(
            "RelayMatchTransform: Fragment spreads in a @match field must have a '@module' directive and no other directives, got invalid directives " +
              "on fragment spread '...".concat(e.name, "'"),
          );
        var p = i(c.args);
        k[String(s)] = { component: p.name, fragment: e.name };
        var f = a(e.name) + '.graphql',
          d = {
            ...
            args: [
              {
                ...
                value: {
                  kind: 'Literal',
                  loc:
                    null !== (t = null === (n = c.args[0]) || void 0 === n ? void 0 : n.loc) &&
                    void 0 !== t
                      ? t
                      : c.loc,
                  metadata: {},
            ...
            kind: 'ScalarField',
            loc: c.loc,
            metadata: { storageKey: '__match_component' },
            name: g,
            type: x,
          },
          y = {
            ...
            args: [
              {
                ...
                name: T,
                type: l.type,
                value: { kind: 'Literal', loc: e.loc, metadata: {}, value: f },
                loc: e.loc,
                metadata: {},
              },
            ],
            ...
            kind: 'ScalarField',
            loc: e.loc,
            metadata: { storageKey: '__match_fragment' },
            name: g,
            type: x,
          };
        N.push({
      ...
      Object.keys(k)
        ...
        .forEach(function(e) {
          var t = k[e],
            n = t.component,
            r = t.fragment;
          C.push(''.concat(r, ':').concat(n));
        });
      var _ = (null !== (n = r.alias) && void 0 !== n ? n : r.name) + '('.concat(C.join(','), ')');
      return {
        kind: 'MatchField',
        alias: r.alias,
        args: [
    ...
    e.exports = {
      ...
      transform: function(e) {
        return r.transform(e, { LinkedField: x, InlineFragment: S }, function(e) {
          return e.type;
        });
      },
    };
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      c = n(26),
      p = n(10),
      f = p.createCombinedError,
      d = p.createCompilerError,
      h = p.createUserError,
      m = p.eachWithErrors,
      y = n(1),
      v = y.getNullableType,
      T = y.GraphQLID,
      g = y.GraphQLInterfaceType,
      S = y.GraphQLList,
      x = y.GraphQLNonNull,
      b = y.GraphQLObjectType,
      E = (y.GraphQLSchema, 'Viewer'),
      P = 'viewer',
      A = 'Node',
      w = 'node';
    function k(e) {
    ...
    function N(e) {
      ...
      try {
        for (
          var a, s = e.argumentDefinitions[Symbol.iterator]();
          !(n = (a = s.next()).done);
          n = !0
        ) {
          var o = a.value;
          'LocalArgumentDefinition' === o.kind &&
            t.push({
              kind: 'Argument',
              loc: { kind: 'Derived', source: o.loc },
              metadata: null,
              name: o.name,
              type: o.type,
              value: {
    ...
    e.exports = {
      ...
      transform: function(e) {
        var t = e.serverSchema,
          n = t.getQueryType();
        if (null == n) throw h('Expected the schema to define a query type.');
        var r = (function(e) {
            var t = new Map(),
              n = m(e.documents(), function(e) {
                if ('Fragment' === e.kind) {
                  var n = (function(e) {
                    ...
                    if ('string' != typeof n) {
                      ...
                      throw d(
                        "Expected the 'name' argument of @refetchable to be a string, got '".concat(
                          String(n),
                          "'.",
                        ),
                        [
                          null !== (r = null === i || void 0 === i ? void 0 : i.loc) && void 0 !== r
                            ? r
                            : t.loc,
                        ],
                      );
            ...
            if (null != n && 0 !== n.length) throw f(n, 'RelayRefetchableFragmentTransform');
            var r = l(e);
            return new Map(
              Array.from(t.entries(), function(e) {
                var t = e[0],
                  n = e[1];
                return [t, r.getFragment(n.name)];
              }),
            );
          })(e),
          p = e,
          y = m(r, function(e) {
            ...
            if (u(l.type, n))
              r = (function(e, t, n) {
                var r = c(e.getQueryType());
                return {
                  path: [],
                  node: {
                    argumentDefinitions: k(t.argumentDefinitions),
                    directives: [],
                    kind: 'Root',
                    loc: { kind: 'Derived', source: t.loc },
                    metadata: null,
                    name: n,
                    operation: 'query',
                    selections: [N(t)],
              ...
              r = (function(e, t, n) {
                ...
                if (
                  ...
                  throw h(
                    "Invalid use of @refetchable on fragment '".concat(
                      t.name,
              ...
              if (
                !(
                  String(l.type) === A ||
                  (l.type instanceof b &&
                    l.type.getInterfaces().some(function(e) {
                      return String(e) === A;
                    }))
                )
              )
              ...
              r = (function(e, t, n) {
                ...
                if (
                  !(
                    ...
                    'id' === s.args[0].name &&
                    u(v(s.args[0].type), T) &&
                    ((t.type instanceof g && u(t.type, i)) ||
                      (t.type instanceof b &&
                        t.type.getInterfaces().some(function(e) {
                          return u(e, i);
                        })))
                  )
                )
                ...
                _ = (function(e) {
                  ...
                  if (
                        ...
                        enter: function(i) {
                          if (
                            ...
                            (n = i),
                              (r = t.map(function(e) {
                                var t;
                                return null !== (t = e.alias) && void 0 !== t ? t : e.name;
                              }));
                          }
                        },
                      },
                    ...
                    var i = null,
                      ...
                      o = C(n, 'last');
                    if (a || o) {
                      if (!a || !o || 'Variable' !== a.value.kind || 'Variable' !== o.value.kind)
                        throw h(
                          "Invalid use of @refetchable with @connection in fragment '".concat(
                            e.name,
                          ...
                          [
                            n.loc,
                            a && 'Variable' !== a.value.kind ? a.value.loc : null,
                            o && 'Variable' !== o.value.kind ? o.value.loc : null,
                          ].filter(Boolean),
                        );
                      i = { count: o.value.variableName, cursor: a.value.variableName };
                    }
                    var l = null,
                      u = C(n, 'after'),
                      c = C(n, 'first');
                    if (u || c) {
                      if (!u || !c || 'Variable' !== u.value.kind || 'Variable' !== c.value.kind)
                        throw h(
                          "Invalid use of @refetchable with @connection in fragment '".concat(
                            e.name,
                          ...
                          [
                            n.loc,
                            u && 'Variable' !== u.value.kind ? u.value.loc : null,
                            c && 'Variable' !== c.value.kind ? c.value.loc : null,
                          ].filter(Boolean),
                        );
                      l = { count: c.value.variableName, cursor: u.value.variableName };
                    }
                    return { forward: l, backward: i, path: r };
                  }
                })(l);
              p = (p = p.replace(
                (0, i.default)({}, l, {
                  metadata: (0, i.default)({}, l.metadata || {}, {
                    refetch: {
                      connection: null !== (f = _) && void 0 !== f ? f : null,
                      operation: o,
                      fragmentPathInResult: m,
                    },
                  }),
                }),
              )).add(
                (0, i.default)({}, y, {
                  metadata: (0, i.default)({}, y.metadata || {}, { derivedFrom: l.name }),
                }),
              );
            }
          });
        if (null != y && y.length) throw f(y, 'RelayRefetchableFragmentTransform');
        return p;
      },
    };
  },
  function(e, t, n) {
    ...
    function c(e, t, n) {
      ...
      var a = new Map();
      return (
        n.argumentDefinitions.forEach(function(e) {
          'LocalArgumentDefinition' === e.kind && a.set(e.name, e);
        }),
        t.set(r, a),
        p(e, t, a, n),
        t.set(r, a),
      ...
      a.visit(r, {
        FragmentSpread: function(r) {
          ...
          var s = !0,
            ...
            l = void 0;
          try {
            for (var u, p = a.values()[Symbol.iterator](); !(s = (u = p.next()).done); s = !0) {
              var f = u.value;
              'RootArgumentDefinition' !== f.kind || n.has(f.name) || n.set(f.name, f);
            }
          } catch (e) {
            (o = !0), (l = e);
          } finally {
        ...
        Argument: function(e) {
          ...
          var t = e.value;
          return null != e.type || null != t.type
            ? (n.has(t.variableName) ||
                n.set(t.variableName, {
                  kind: 'RootArgumentDefinition',
                  loc: { kind: 'Derived', source: e.loc },
                  metadata: null,
                  name: t.variableName,
        ...
        Condition: function(e) {
          var t;
          if ('Variable' === e.condition.kind) {
            var r = e.condition,
              i = null !== (t = r.type) && void 0 !== t ? t : new l(u);
            n.has(r.variableName) ||
              n.set(r.variableName, {
                kind: 'RootArgumentDefinition',
                loc: { kind: 'Derived', source: e.loc },
                metadata: null,
                name: r.variableName,
    ...
    e.exports = function(e) {
      var t = new Map();
      return new i(e.serverSchema, e.clientSchema).addAll(
        Array.from(e.documents(), function(n) {
          switch (n.kind) {
            case 'Fragment':
              var i = c(e, t, n);
              return (0, r.default)({}, n, { argumentDefinitions: Array.from(i.values()) });
            case 'Root':
              return (function(e, t, n) {
                var i = new Map(),
                  a = new Map(),
                ...
                try {
                  for (
                    var c, f = n.argumentDefinitions.entries()[Symbol.iterator]();
                    !(o = (c = f.next()).done);
                    o = !0
                  ) {
                    var d = c.value,
                      h = d[0],
                      m = d[1];
                    'LocalArgumentDefinition' === m.kind && a.set(h, m);
                  }
                } catch (e) {
                  (l = !0), (u = e);
                } finally {
                ...
                return (
                  p(e, t, i, n),
                  (0, r.default)({}, n, {
                    argumentDefinitions: Array.from(i.values(), function(e) {
                      var t, n;
                      ...
                      return {
                        defaultValue:
                          null !== (t = null === r || void 0 === r ? void 0 : r.defaultValue) &&
                          void 0 !== t
                            ? t
                            : null,
                        kind: 'LocalArgumentDefinition',
            ...
            case 'SplitOperation':
              return n;
            default:
              throw s("inferRootArgumentDefinitions: Unsupported kind '".concat(n.kind, "'."));
          }
        }),
      );
    };
  ...
  function(e, t, n) {
    'use strict';
    var r = n(6).getRawType,
      i = n(1),
      a = i.GraphQLNonNull,
      s = i.GraphQLList;
    e.exports = function e(t, n) {
      if (t === n) return !0;
      if (t instanceof a && n instanceof a) return e(t.ofType, n.ofType);
      if (t instanceof s && n instanceof s) return e(t.ofType, n.ofType);
      if (t.constructor.name === n.constructor.name) {
        var i = r(t),
          o = r(n);
  ...
  function(e, t, n) {
    ...
    function l(e) {
      return function(t) {
        var n = t.directives.find(function(e) {
          return e.name === o;
        });
        if (!n) return this.traverse(t);
        var i = a(n.args),
          s = e(i);
        return this.traverse(
          (0, r.default)({}, t, {
            directives: t.directives.filter(function(e) {
              return e !== n;
            }),
            metadata: (0, r.default)({}, t.metadata || {}, s),
          }),
        );
      };
    }
    function u(e) {
      ...
      return (
        void 0 !== n &&
          ...
          s(
            !1,
            'RelayRelayDirectiveTransform: Expected the "plural" argument to @relay to be a boolean literal if specified.',
          ),
        void 0 !== t &&
          'boolean' != typeof t &&
          s(
            !1,
            'RelayRelayDirectiveTransform: Expected the "mask" argument to @relay to be a boolean literal if specified.',
          ),
        { mask: t, plural: n }
      );
    }
    ...
    e.exports = {
      ...
      transform: function(e) {
        return i.transform(e, { Fragment: l(u), FragmentSpread: l(c) });
      },
    };
  },
  function(e, t, n) {
    ...
    e.exports = {
      anyTypeAlias: function(e) {
        return i.typeAlias(i.identifier(e), null, i.anyTypeAnnotation());
      },
      exactObjectTypeAnnotation: function(e) {
        var t = i.objectTypeAnnotation(e);
        return (t.exact = !0), t;
      },
      exportType: function(e, t) {
        return i.exportNamedDeclaration(i.typeAlias(i.identifier(e), null, t), [], null);
      },
      importTypes: function(e, t) {
        var n = i.importDeclaration(
          e.map(function(e) {
            return i.importSpecifier(i.identifier(e), i.identifier(e));
          }),
          i.stringLiteral(t),
        );
        return (n.importKind = 'type'), n;
      },
      intersectionTypeAnnotation: function(e) {
        return (
          e.length > 0 ||
            r(!1, 'RelayFlowBabelFactories: cannot create an intersection of 0 types'),
          1 === e.length ? e[0] : i.intersectionTypeAnnotation(e)
        );
      },
      lineComments: function() {
        for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n];
        return t.map(function(e) {
          return { type: 'CommentLine', value: ' ' + e };
        });
      },
      readOnlyArrayOfType: function(e) {
        return i.genericTypeAnnotation(
          i.identifier('$ReadOnlyArray'),
          i.typeParameterInstantiation([e]),
        );
      },
      readOnlyObjectTypeProperty: function(e, t) {
        var n = i.objectTypeProperty(i.identifier(e), t);
        return (n.variance = i.variance('plus')), n;
      },
      ...
      unionTypeAnnotation: function(e) {
        return (
          e.length > 0 || r(!1, 'RelayFlowBabelFactories: cannot create a union of 0 types'),
          1 === e.length ? e[0] : i.unionTypeAnnotation(e)
        );
      },
    };
  },
  function(e, t, n) {
    ...
    e.exports = function e(t) {
      switch (t.kind) {
        case 'Variable':
          return { variable: t.variableName };
        case 'Literal':
          return { value: t.value };
        case 'ListValue':
          return {
            list: t.items.map(function(t) {
              return e(t);
            }),
          };
        case 'ObjectValue':
          return {
            object: t.fields.map(function(t) {
              return { name: t.name, value: e(t.value) };
            }),
          };
        default:
          r(!1, 'getIdentifierForArgumentValue(): Unsupported AST kind `%s`.', t.kind);
      }
    };
  },
  function(e, t, n) {
    'use strict';
    e.exports = {
      hasUnaliasedSelection: function(e, t) {
        return e.selections.some(function(e) {
          return 'ScalarField' === e.kind && null == e.alias && e.name === t;
        });
      },
    };
  },
  function(e, t, n) {
    ...
    var r = n(28),
      ...
      D = n(43),
      I = n(52),
      L = n(202).SourceControlMercurial,
      F = n(53),
      M = F.getReaderSourceDefinitionName,
      j = F.getSourceDefinitionName,
      R = P(u.find);
    e.exports = {
      ASTConvert: i,
      CodegenDirectory: a,
      ...
      Profiler: p,
      SchemaUtils: v,
      SourceControlMercurial: L,
      WatchmanClient: T,
      filterContextForNode: k,
      getIdentifierForArgumentValue: C,
      getLiteralArgumentValues: _,
      isEquivalentType: O,
      nullthrows: D,
      Parser: E,
      Validator: A,
      ...
      MultiReporter: y,
      Runner: s,
      compileRelayArtifacts: w,
      formatGeneratedModule: N,
      convertASTDocuments: i.convertASTDocuments,
      transformASTSchema: i.transformASTSchema,
      getReaderSourceDefinitionName: M,
      getSourceDefinitionName: j,
      writeRelayGeneratedFile: I,
    };
  },
  function(e, t) {
    e.exports = function(e) {
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      d = (function() {
        function e(e) {
          var t = this;
          for (var n in ((this.parsers = {}),
          (this.parserConfigs = e.parserConfigs),
          (this.writerConfigs = e.writerConfigs),
          (this.onlyValidate = e.onlyValidate),
          (this.onComplete = e.onComplete),
          (this._reporter = e.reporter),
          (this._sourceControl = e.sourceControl),
          (this.parserWriters = {}),
          e.parserConfigs))
            this.parserWriters[n] = new Set();
          var r = function(n) {
            var r = e.writerConfigs[n];
            r.baseParsers &&
              r.baseParsers.forEach(function(e) {
                return t.parserWriters[e].add(n);
              }),
              t.parserWriters[r.parser].add(n);
          };
          for (var i in e.writerConfigs) r(i);
        }
        var t = e.prototype;
        return (
          (t.compileAll = (function() {
            var e = i(function*() {
              for (var e in ((this.parsers = {}), this.parserConfigs))
                try {
              ...
              var t = !1;
              for (var n in this.writerConfigs) {
                var r = yield this.write(n);
                if ('ERROR' === r) return 'ERROR';
                'HAS_CHANGES' === r && (t = !0);
              }
              return t ? 'HAS_CHANGES' : 'NO_CHANGES';
            });
            return function() {
              return e.apply(this, arguments);
            };
          ...
          (t.compile = (function() {
            var e = i(function*(e) {
              var t = this,
                n = this.writerConfigs[e],
                r = [n.parser];
              return (
                n.baseParsers &&
                  n.baseParsers.forEach(function(e) {
                    return r.push(e);
                  }),
                yield u.asyncContext('CodegenRunner:parseEverything', function() {
                  return Promise.all(
                    r.map(function(e) {
                      return t.parseEverything(e);
                    }),
                  );
                }),
                yield this.write(e)
          ...
          (t.getDirtyWriters = function(e) {
            var t = this;
            return u.asyncContext(
              'CodegenRunner:getDirtyWriters',
              i(function*() {
                var n = new Set();
                for (var r in t.writerConfigs) {
                  var a = t.writerConfigs[r],
                    s = !0,
                    o = !1,
                    c = void 0;
                  try {
                ...
                return (
                  yield Promise.all(
                    Object.keys(t.parserConfigs).map(function(r) {
                      return u.waitFor(
                        'Watchman:query',
                        i(function*() {
                          var i = new l(),
                            a = t.parserConfigs[r],
                            s = yield i.watchProject(a.baseDir),
                            o = e.map(function(e) {
                              return p.relative(a.baseDir, e);
                            }),
                            u = {
                              expression: ['allof', a.watchmanExpression, ['name', o, 'wholename']],
                              fields: ['exists'],
                              relative_root: s.relativePath,
                            },
                            c = yield i.command('query', s.root, u);
                          i.end(),
                            c.files.length > 0 &&
                              t.parserWriters[r].forEach(function(e) {
                                return n.add(e);
                              });
                        }),
                      );
          ...
          (t.parseEverything = (function() {
            var e = i(function*(e) {
              if (!this.parsers[e]) {
                var t = this.parserConfigs[e];
                this.parsers[e] = t.getParser(t.baseDir);
                var n,
                  r = t.getFileFilter ? t.getFileFilter(t.baseDir) : h;
                if (t.filepaths && t.watchmanExpression)
                  throw new Error(
                    'Provide either `watchmanExpression` or `filepaths` but not both.',
                  );
                if (t.watchmanExpression)
                  n = yield o.queryFiles(t.baseDir, t.watchmanExpression, r);
                else {
                  if (!t.filepaths)
                    throw new Error(
                      'Either `watchmanExpression` or `filepaths` is required to query files',
                    );
                  n = yield o.queryFilepaths(t.baseDir, t.filepaths, r);
                }
                this.parseFileChanges(e, n);
              }
            });
            return function(t) {
              return e.apply(this, arguments);
          ...
          (t.parseFileChanges = function(e, t) {
            var n = this;
            return u.run('CodegenRunner.parseFileChanges', function() {
              n.parsers[e].parseFiles(t);
            });
          }),
          (t.write = function(e) {
            var t = this;
            return u.asyncContext(
              ...
              i(function*() {
                try {
                  t._reporter.reportMessage('\nWriting '.concat(e));
                  var n = t.writerConfigs[e],
                    r = n.writeFiles,
                    i = n.parser,
                    l = n.baseParsers,
                    d = n.isGeneratedFile,
                  ...
                  l &&
                    l.forEach(function(e) {
                      t.parsers[e] ||
                        c(!1, 'Trying to access an uncompiled base parser config: %s', e),
                        (h = h.merge(t.parsers[e].documents()));
                    });
                  var m = t.parserConfigs[i],
                    y = m.baseDir,
                    v = m.generatedDirectoriesWatchmanExpression,
                    T = [];
                  if (v)
                    T = (yield o.queryDirectories(y, v)).map(function(e) {
                      return p.join(y, e);
                    });
                  var g = t.parsers[i].documents(),
                    S = u.run('getSchema', function() {
                      return t.parserConfigs[i].getSchema();
                    }),
                    x = yield r({
                      onlyValidate: t.onlyValidate,
                      schema: S,
                      documents: g,
                      baseDocuments: h,
                      generatedDirectories: T,
                      sourceControl: t._sourceControl,
                      reporter: t._reporter,
                    }),
                    b = !0,
                    E = !1,
                    P = void 0;
                  try {
                    for (
                      var A, w = x.values()[Symbol.iterator]();
                      !(b = (A = w.next()).done);
                      b = !0
                    ) {
                      var k = A.value,
                        N = (0, a.default)(k.changes.created).concat(
                          (0, a.default)(k.changes.updated),
                          (0, a.default)(k.changes.deleted),
                          (0, a.default)(k.changes.unchanged),
                        ),
                        C = !0,
                        _ = !1,
                        O = void 0;
                      try {
                        for (var D, I = N[Symbol.iterator](); !(C = (D = I.next()).done); C = !0) {
                          var L = D.value,
                            F = k.getPath(L);
                          d(F) ||
                            c(
                              !1,
                              'CodegenRunner: %s returned false for isGeneratedFile, but was in generated directory',
                              F,
                            );
                        }
                      } catch (e) {
                  ...
                  var M = t.onComplete;
                  null != M && M(Array.from(x.values()));
                  var j = s.combineChanges(Array.from(x.values()));
                  return (
                    s.printChanges(j, { onlyValidate: t.onlyValidate }),
                    s.hasChanges(j) ? 'HAS_CHANGES' : 'NO_CHANGES'
                  );
                } catch (e) {
                  return t._reporter.reportError('CodegenRunner.write', e), 'ERROR';
                }
              }),
            );
          }),
          ...
          (t.watch = (function() {
            var e = i(function*(e) {
              var t = this,
                n = this.parserConfigs[e];
              if (!n.watchmanExpression)
                throw new Error('`watchmanExpression` is required to watch files');
              var r = !0;
              yield o.watchCompile(
                n.baseDir,
                n.watchmanExpression,
                n.getFileFilter ? n.getFileFilter(n.baseDir) : h,
                (function() {
                  var n = i(function*(n) {
                    if (
                      (t.parsers[e] || c(!1, 'Trying to watch an uncompiled parser config: %s', e),
                      r)
                    )
                      r = !1;
                    else {
                      var i = [];
                      t.parserWriters[e].forEach(function(e) {
                        return i.push(e);
                      });
                      try {
                        t.parsers[e] ? t.parseFileChanges(e, n) : yield t.parseEverything(e),
                          yield Promise.all(
                            i.map(function(e) {
                              return t.write(e);
                            }),
                        ...
                        t._reporter.reportError('CodegenRunner.watch', e);
                      }
                      t._reporter.reportMessage('Watching for changes to '.concat(e, '...'));
                    }
                  });
                  return function(e) {
  ...
  function(e, t, n) {
    ...
    var r = n(28),
      ...
      l = s.Source;
    function u(e, t) {
      var n = i.readFileSync(a.join(e, t.relPath), 'utf8');
      return o(new l(n, t.relPath), { experimentalFragmentVariables: !0 });
    }
    e.exports = {
      parseFile: u,
      getParser: function(e) {
        return new r({ baseDir: e, parse: u });
      },
    };
  },
  function(e, t, n) {
    ...
    var o = Object.create(null, {
        createFragmentContainer: { value: !0 },
        createPaginationContainer: { value: !0 },
        createRefetchContainer: { value: !0 },
      }),
      l = {
        comments: !0,
        end: !0,
    ...
    function c(e) {
      ...
      return (
        (t && 1 === t.length) ||
          h(!1, 'FindGraphQLTags: Substitutions are not allowed in graphql tags.'),
        t[0]
      );
    }
    function p(e) {
      return c(e).value.raw;
    }
    function f(e) {
      var t = c(e).loc.start;
      return { line: t.line, column: t.column + 1 };
    }
    function d(e, t) {
      if (null == t) return '(source unavailable)';
      var n = e.split('\n').slice(t.start.line - 1, t.end.line);
      return (
        (n[0] = n[0].slice(t.start.column)),
        (n[n.length - 1] = n[n.length - 1].slice(0, t.end.column)),
        n.join('\n')
      );
    }
    function h(e, t) {
      if (!e) {
        for (var n = arguments.length, r = new Array(n > 2 ? n - 2 : 0), i = 2; i < n; i++)
          r[i - 2] = arguments[i];
        throw new Error(a.format.apply(a, [t].concat(r)));
      }
    }
    function m(e, t) {
      var n = t[e.type];
    ...
    function y(e, t) {
      for (var n in e)
        if (!l[n]) {
          var r = e[n];
          r && 'object' == typeof r && 'string' == typeof r.type
            ? m(r, t)
            : Array.isArray(r) &&
              r.forEach(function(e) {
                e && 'object' == typeof e && 'string' == typeof e.type && m(e, t);
              });
        }
    }
    e.exports = {
        ...
        var t = [],
          n = {
            CallExpression: function(r) {
              var i = r.callee;
              if (
                ('Identifier' === i.type && o[i.name]) ||
                ('MemberExpression' === i.kind &&
                  'Identifier' === i.object.type &&
                  'Relay' === i.object.value &&
                ...
                'ObjectExpression' === a.type
                  ? a.properties.forEach(function(n) {
                      ('ObjectProperty' !== n.type ||
                        ...
                        'TaggedTemplateExpression' !== n.value.type) &&
                        h(
                          !1,
                          'FindGraphQLTags: `%s` expects fragment definitions to be `key: graphql`.',
                          r.callee.name,
                        ),
                        u(n.value.tag) ||
                          h(
                            !1,
                            'FindGraphQLTags: `%s` expects fragment definitions to be tagged with `graphql`, got `%s`.',
                            r.callee.name,
                            d(e, n.value.tag.loc),
                          ),
                        t.push({
                          keyName: n.key.name,
                          template: p(n.value.quasi),
                          sourceLocationOffset: f(n.value.quasi),
                        });
                    })
                  : ((a && 'TaggedTemplateExpression' === a.type) ||
                      h(
                        !1,
                        'FindGraphQLTags: `%s` expects a second argument of fragment definitions.',
                        r.callee.name,
                      ),
                    u(a.tag) ||
                      h(
                    ...
                    t.push({
                      keyName: null,
                      template: p(a.quasi),
                      sourceLocationOffset: f(a.quasi),
                    }));
                for (var s = 2; s < r.arguments.length; s++) m(r.arguments[s], n);
              } else y(r, n);
            },
            TaggedTemplateExpression: function(e) {
              u(e.tag) &&
                t.push({
                  ...
                  sourceLocationOffset: f(e.quasi),
                });
            },
          };
        return m(i.parse(e, s), n), t;
  ...
  function(e, t, n) {
    ...
    function r(e) {
      ...
      function r(t, n) {
        try {
          ...
          Promise.resolve(o ? s.wrapped : s).then(
            function(e) {
              o ? r('next', e) : i(a.done ? 'return' : 'normal', e);
            },
            function(e) {
              r('throw', e);
            },
      ...
      (this._invoke = function(e, i) {
        return new Promise(function(a, s) {
          var o = { key: e, arg: i, resolve: a, reject: s, next: null };
          n ? (n = n.next = o) : ((t = n = o), r(e, i));
        });
      }),
    ...
    function o(e, t) {
      return void 0 === t && (t = {}), new s(e, Object.assign({}, t, { keyword: e }));
    }
    function l(e, t) {
      return new s(e, { beforeExpr: a, binop: t });
    }
    var u = {
        ...
        eof: new s('eof'),
        bracketL: new s('[', { beforeExpr: a, startsExpr: !0 }),
        bracketR: new s(']'),
        braceL: new s('{', { beforeExpr: a, startsExpr: !0 }),
        braceBarL: new s('{|', { beforeExpr: a, startsExpr: !0 }),
        braceR: new s('}'),
        braceBarR: new s('|}'),
        parenL: new s('(', { beforeExpr: a, startsExpr: !0 }),
        parenR: new s(')'),
        comma: new s(',', { beforeExpr: a }),
        semi: new s(';', { beforeExpr: a }),
        colon: new s(':', { beforeExpr: a }),
        doubleColon: new s('::', { beforeExpr: a }),
        dot: new s('.'),
        question: new s('?', { beforeExpr: a }),
        questionDot: new s('?.'),
        arrow: new s('=>', { beforeExpr: a }),
        template: new s('template'),
        ellipsis: new s('...', { beforeExpr: a }),
        backQuote: new s('`', { startsExpr: !0 }),
        dollarBraceL: new s('${', { beforeExpr: a, startsExpr: !0 }),
        at: new s('@'),
        hash: new s('#'),
        interpreterDirective: new s('#!...'),
        eq: new s('=', { beforeExpr: a, isAssign: !0 }),
        assign: new s('_=', { beforeExpr: a, isAssign: !0 }),
        incDec: new s('++/--', { prefix: !0, postfix: !0, startsExpr: !0 }),
        bang: new s('!', { beforeExpr: a, prefix: !0, startsExpr: !0 }),
        tilde: new s('~', { beforeExpr: a, prefix: !0, startsExpr: !0 }),
        pipeline: new l('|>', 0),
        nullishCoalescing: new l('??', 1),
        logicalOR: new l('||', 1),
        logicalAND: new l('&&', 2),
        bitwiseOR: new l('|', 3),
        bitwiseXOR: new l('^', 4),
        ...
        relational: new l('</>', 7),
        bitShift: new l('<</>>', 8),
        plusMin: new s('+/-', { beforeExpr: a, binop: 9, prefix: !0, startsExpr: !0 }),
        modulo: new l('%', 10),
        star: new l('*', 10),
        slash: new l('/', 10),
        exponent: new s('**', { beforeExpr: a, binop: 11, rightAssociative: !0 }),
      },
      c = {
        break: new o('break'),
        case: new o('case', { beforeExpr: a }),
        catch: new o('catch'),
        continue: new o('continue'),
        debugger: new o('debugger'),
        default: new o('default', { beforeExpr: a }),
        do: new o('do', { isLoop: !0, beforeExpr: a }),
        else: new o('else', { beforeExpr: a }),
        finally: new o('finally'),
        for: new o('for', { isLoop: !0 }),
        function: new o('function', { startsExpr: !0 }),
        if: new o('if'),
        return: new o('return', { beforeExpr: a }),
        switch: new o('switch'),
        throw: new o('throw', { beforeExpr: a, prefix: !0, startsExpr: !0 }),
        try: new o('try'),
        var: new o('var'),
        let: new o('let'),
        const: new o('const'),
        while: new o('while', { isLoop: !0 }),
        with: new o('with'),
        new: new o('new', { beforeExpr: a, startsExpr: !0 }),
        this: new o('this', { startsExpr: !0 }),
        super: new o('super', { startsExpr: !0 }),
        class: new o('class'),
        extends: new o('extends', { beforeExpr: a }),
        export: new o('export'),
        import: new o('import', { startsExpr: !0 }),
        yield: new o('yield', { beforeExpr: a, startsExpr: !0 }),
        null: new o('null', { startsExpr: !0 }),
        true: new o('true', { startsExpr: !0 }),
        false: new o('false', { startsExpr: !0 }),
        in: new o('in', { beforeExpr: a, binop: 7 }),
        instanceof: new o('instanceof', { beforeExpr: a, binop: 7 }),
        typeof: new o('typeof', { beforeExpr: a, prefix: !0, startsExpr: !0 }),
        void: new o('void', { beforeExpr: a, prefix: !0, startsExpr: !0 }),
        delete: new o('delete', { beforeExpr: a, prefix: !0, startsExpr: !0 }),
      };
    function p(e) {
    ...
    var d = {
        6: f('enum await'),
        strict: f('implements interface let package private protected public static yield'),
        strictBind: f('eval arguments'),
      },
      h = f(
    ...
    function b(e) {
      return e < 65
        ...
        : e <= 90 ||
            (e < 97
              ? 95 === e
              : e <= 122 || (e <= 65535 ? e >= 170 && v.test(String.fromCharCode(e)) : x(e, g)));
    }
    function E(e) {
      return e < 48
        ? 36 === e
    ...
    var L = function(e, t, n, r) {
      ...
      F = {
        braceStatement: new L('{', !1),
        braceExpression: new L('{', !0),
        templateQuasi: new L('${', !0),
        parenStatement: new L('(', !1),
        parenExpression: new L('(', !0),
        template: new L('`', !0, !0, function(e) {
          return e.readTmplToken();
        }),
        functionExpression: new L('function', !0),
      };
    (u.parenR.updateContext = u.braceR.updateContext = function() {
      if (1 !== this.state.context.length) {
        var e = this.state.context.pop();
        e === F.braceStatement && this.curContext() === F.functionExpression
      ...
      (u.name.updateContext = function(e) {
        'of' !== this.state.value || this.curContext() !== F.parenStatement
          ? ((this.state.exprAllowed = !1),
            (e !== u._let && e !== u._const && e !== u._var) ||
              (_.test(this.input.slice(this.state.end)) && (this.state.exprAllowed = !0)),
            this.state.isIterator && (this.state.isIterator = !1))
          : (this.state.exprAllowed = !e.beforeExpr);
      }),
      (u.braceL.updateContext = function(e) {
        this.state.context.push(this.braceIsBlock(e) ? F.braceStatement : F.braceExpression),
          (this.state.exprAllowed = !0);
      }),
      ...
      (u.parenL.updateContext = function(e) {
        ...
        this.state.context.push(t ? F.parenStatement : F.parenExpression),
          (this.state.exprAllowed = !0);
      }),
      (u.incDec.updateContext = function() {}),
      (u._function.updateContext = function(e) {
        this.state.exprAllowed &&
          !this.braceIsBlock(e) &&
          this.state.context.push(F.functionExpression),
          (this.state.exprAllowed = !1);
      }),
      (u.backQuote.updateContext = function() {
        this.curContext() === F.template
          ? this.state.context.pop()
          : this.state.context.push(F.template),
          (this.state.exprAllowed = !1);
      });
    var M = /^[\da-fA-F]+$/,
      j = /^\d+$/;
    ...
    function B(e) {
      ...
      if ('JSXMemberExpression' === e.type) return B(e.object) + '.' + B(e.property);
      throw new Error('Node had unexpected type: ' + e.type);
    }
    (F.j_oTag = new L('<tag', !1)),
      (F.j_cTag = new L('</tag', !1)),
      (F.j_expr = new L('<tag>...</tag>', !0, !0)),
      (u.jsxName = new s('jsxName')),
      (u.jsxText = new s('jsxText', { beforeExpr: !0 })),
      (u.jsxTagStart = new s('jsxTagStart', { startsExpr: !0 })),
      (u.jsxTagEnd = new s('jsxTagEnd')),
      (u.jsxTagStart.updateContext = function() {
        this.state.context.push(F.j_expr),
          this.state.context.push(F.j_oTag),
          (this.state.exprAllowed = !1);
      }),
      (u.jsxTagEnd.updateContext = function(e) {
        var t = this.state.context.pop();
        (t === F.j_oTag && e === u.slash) || t === F.j_cTag
          ? (this.state.context.pop(), (this.state.exprAllowed = this.curContext() === F.j_expr))
          : (this.state.exprAllowed = !0);
      });
    var V = {
      sourceType: 'script',
    ...
    var J = (function(e) {
        ...
        return (
          ...
          (t.prototype.raise = function(e, t, n) {
            var r = void 0 === n ? {} : n,
              i = r.missingPluginNames,
              a = r.code,
              s = (function(e, t) {
                var n,
                  r = 1,
                  i = 0;
                for (O.lastIndex = 0; (n = O.exec(e)) && n.index < t; ) r++, (i = O.lastIndex);
                return new q(r, t - i);
              })(this.input, e);
            t += ' (' + s.line + ':' + s.column + ')';
            ...
            (n.processComment = function(e) {
              if (!('Program' === e.type && e.body.length > 0)) {
                var t,
                  ...
                  i,
                  a,
                  s = this.state.commentStack;
                if (this.state.trailingComments.length > 0)
                  this.state.trailingComments[0].start >= e.end
                    ? ((r = this.state.trailingComments), (this.state.trailingComments = []))
                    : (this.state.trailingComments.length = 0);
                else if (s.length > 0) {
                  var o = K(s);
                  o.trailingComments &&
                    o.trailingComments[0].start >= e.end &&
                    ((r = o.trailingComments), delete o.trailingComments);
                }
                for (
                  s.length > 0 && K(s).start >= e.start && (t = s.pop());
                  s.length > 0 && K(s).start >= e.start;

                )
                  n = s.pop();
                if ((!n && t && (n = t), t && this.state.leadingComments.length > 0)) {
                  var l = K(this.state.leadingComments);
                  if ('ObjectProperty' === t.type) {
                    if (l.start >= e.start && this.state.commentPreviousNode) {
                      for (a = 0; a < this.state.leadingComments.length; a++)
                        this.state.leadingComments[a].end < this.state.commentPreviousNode.end &&
                ...
                if (n) {
                  if (n.leadingComments)
                    if (
                      ...
                      K(n.leadingComments).end <= e.start
                    )
                      (e.leadingComments = n.leadingComments), delete n.leadingComments;
                    else
                      for (i = n.leadingComments.length - 2; i >= 0; --i)
                        if (n.leadingComments[i].end <= e.start) {
                          e.leadingComments = n.leadingComments.splice(0, i + 1);
                          break;
                        }
                } else if (this.state.leadingComments.length > 0)
                  if (K(this.state.leadingComments).end <= e.start) {
                    ...
                    var c = this.state.leadingComments.slice(0, i);
                    c.length && (e.leadingComments = c),
                      0 === (r = this.state.leadingComments.slice(i)).length && (r = null);
                  }
                (this.state.commentPreviousNode = e),
                  r &&
                    (r.length && r[0].start >= e.start && K(r).end <= e.end
                      ? (e.innerComments = r)
          ...
          (function() {
            ...
            return (
              (t.isReservedWord = function(e) {
                return 'await' === e ? this.inModule : d[6](e);
              }),
          ...
          (t.clone = function(t) {
            ...
            return (
              Object.keys(this).forEach(function(e) {
                var i = n[e];
                (t && 'context' !== e) || !Array.isArray(i) || (i = i.slice()), (r[e] = i);
              }),
              r
            );
          }),
      ...
      W = { bin: [48, 49] };
    (W.oct = W.bin.concat([50, 51, 52, 53, 54, 55])),
      (W.dec = W.oct.concat([56, 57])),
      (W.hex = W.dec.concat([65, 66, 67, 68, 69, 70, 97, 98, 99, 100, 101, 102]));
    var Q = (function(e) {
        function t() {
          return e.apply(this, arguments) || this;
        }
        ...
        return (
          ...
          (n.hasPrecedingLineBreak = function() {
            return _.test(this.input.slice(this.state.lastTokEnd, this.state.start));
          }),
          ...
          (n.unexpected = function(e, t) {
            ...
            'string' != typeof t && (t = 'Unexpected token, expected "' + t.label + '"'),
        ...
        (function(e) {
          function t(t, n) {
            var r;
            return (
              ((r = e.call(this) || this).state = new X()),
              r.state.init(t, n),
              (r.isLookahead = !1),
              r
            );
          ...
          return (
            ...
            (n.readToken = function(e) {
              b(e) || 92 === e ? this.readWord() : this.getTokenFromCode(e);
            }),
            (n.pushComment = function(e, t, n, r, i, a) {
              var s = {
              ...
              this.isLookahead ||
                (this.options.tokens && this.state.tokens.push(s),
                this.state.comments.push(s),
                this.addComment(s));
            }),
            (n.skipBlockComment = function() {
              ...
              for (
                -1 === r && this.raise(this.state.pos - 2, 'Unterminated comment'),
                  this.state.pos = r + 2,
                  O.lastIndex = n;
                (e = O.exec(this.input)) && e.index < this.state.pos;

              )
                ++this.state.curLine, (this.state.lineStart = e.index + e[0].length);
              this.pushComment(
                !0,
            ...
            (n.skipLineComment = function(e) {
              var t = this.state.pos,
                n = this.state.curPosition(),
                r = this.input.charCodeAt((this.state.pos += e));
            ...
            (n.readToken_dot = function() {
              ...
              if (e >= 48 && e <= 57) this.readNumber(!0);
              else {
            ...
            (n.readToken_interpreter = function() {
            ...
            (n.readToken_mult_modulo = function(e) {
              var t = 42 === e ? u.star : u.modulo,
                n = 1,
                r = this.input.charCodeAt(this.state.pos + 1),
                i = this.state.exprAllowed;
              42 === e &&
                42 === r &&
                (n++, (r = this.input.charCodeAt(this.state.pos + 2)), (t = u.exponent)),
                61 !== r || i || (n++, (t = u.assign)),
                this.finishOp(t, n);
            }),
            (n.readToken_pipe_amp = function(e) {
              var t = this.input.charCodeAt(this.state.pos + 1);
              if (t !== e) {
                if (124 === e) {
                  if (62 === t) return void this.finishOp(u.pipeline, 2);
                  if (125 === t && this.hasPlugin('flow'))
                    return void this.finishOp(u.braceBarR, 2);
                }
                61 !== t
            ...
            (n.readToken_plus_min = function(e) {
              var t = this.input.charCodeAt(this.state.pos + 1);
              if (t === e)
                return 45 === t &&
                  !this.inModule &&
                  62 === this.input.charCodeAt(this.state.pos + 2) &&
                  _.test(this.input.slice(this.state.lastTokEnd, this.state.pos))
              ...
              switch (e) {
                ...
                case 123:
                  ...
                  124 === this.input.charCodeAt(this.state.pos + 1)
                    ...
                    : (++this.state.pos, this.finishToken(u.braceL)));
                case 125:
            ...
            (n.readRegexp = function() {
              for (var e, t, n = this.state.pos; ; ) {
                ...
                if ((_.test(r) && this.raise(n, 'Unterminated regular expression'), e)) e = !1;
                else {
                  if ('[' === r) t = !0;
                  else if (']' === r && t) t = !1;
                  else if ('/' === r && !t) break;
              ...
              this.finishToken(u.regexp, { pattern: i, flags: a });
            }),
            (n.readInt = function(e, t) {
              for (
                var n = this.state.pos,
                  r = 16 === e ? G.hex : G.decBinOct,
                  i = 16 === e ? W.hex : 10 === e ? W.dec : 8 === e ? W.oct : W.bin,
                  a = 0,
                  s = 0,
                  o = null == t ? 1 / 0 : t;
                s < o;
                ...
                if (this.hasPlugin('numericSeparator')) {
                  var c = this.input.charCodeAt(this.state.pos - 1),
                    p = this.input.charCodeAt(this.state.pos + 1);
                  if (95 === l) {
                    -1 === i.indexOf(p) &&
                      this.raise(this.state.pos, 'Invalid or unexpected token'),
                      (r.indexOf(c) > -1 || r.indexOf(p) > -1 || Number.isNaN(p)) &&
                        this.raise(this.state.pos, 'Invalid or unexpected token'),
                      ++this.state.pos;
                    continue;
                  }
                ...
                if (
                  (u = l >= 97 ? l - 97 + 10 : l >= 65 ? l - 65 + 10 : Y(l) ? l - 48 : 1 / 0) >= e
                )
                  break;
                ++this.state.pos, (a = a * e + u);
              }
              return this.state.pos === n || (null != t && this.state.pos - n !== t) ? null : a;
            }),
            (n.readRadixNumber = function(e) {
              var t = this.state.pos,
                n = !1;
              this.state.pos += 2;
              var r = this.readInt(e);
              if (
                (null == r && this.raise(this.state.start + 2, 'Expected number in radix ' + e),
                this.hasPlugin('bigInt') &&
                  110 === this.input.charCodeAt(this.state.pos) &&
                  (++this.state.pos, (n = !0)),
                b(this.input.codePointAt(this.state.pos)) &&
                  this.raise(this.state.pos, 'Identifier directly after number'),
                n)
              ) {
                var i = this.input.slice(t, this.state.pos).replace(/[_n]/g, '');
                this.finishToken(u.bigint, i);
              } else this.finishToken(u.num, r);
            }),
            (n.readNumber = function(e) {
              var t = this.state.pos,
              ...
              46 !== a ||
                ...
                (69 !== a && 101 !== a) ||
                  n ||
                  ((43 !== (a = this.input.charCodeAt(++this.state.pos)) && 45 !== a) ||
                    ++this.state.pos,
                ...
                this.hasPlugin('bigInt') &&
                  110 === a &&
                  ((r || n) && this.raise(t, 'Invalid BigIntLiteral'), ++this.state.pos, (i = !0)),
                b(this.input.codePointAt(this.state.pos)) &&
                  this.raise(this.state.pos, 'Identifier directly after number');
              var s,
                o = this.input.slice(t, this.state.pos).replace(/[_n]/g, '');
              i
                ? this.finishToken(u.bigint, o)
                : (r
                    ? (s = parseFloat(o))
                    : n && 1 !== o.length
                    ? this.state.strict
                      ? this.raise(t, 'Invalid number')
                      : (s = /[89]/.test(o) ? parseInt(o, 10) : parseInt(o, 8))
                    : (s = parseInt(o, 10)),
                  this.finishToken(u.num, s));
            }),
            (n.readCodePoint = function(e) {
              var t;
            ...
            (n.readString = function(e) {
              for (var t = '', n = ++this.state.pos, r = this.hasPlugin('jsonStrings'); ; ) {
                this.state.pos >= this.input.length &&
            ...
            (n.readTmplToken = function() {
              for (var e = '', t = this.state.pos, n = !1; ; ) {
                ...
                if (96 === r || (36 === r && 123 === this.input.charCodeAt(this.state.pos + 1)))
                  return this.state.pos === this.state.start && this.match(u.template)
                    ? 36 === r
                      ? ((this.state.pos += 2), void this.finishToken(u.dollarBraceL))
                      : (++this.state.pos, void this.finishToken(u.backQuote))
                    : ((e += this.input.slice(t, this.state.pos)),
                      void this.finishToken(u.template, n ? null : e));
                if (92 === r) {
                  e += this.input.slice(t, this.state.pos);
                  var i = this.readEscapedChar(!0);
                  null === i ? (n = !0) : (e += i), (t = this.state.pos);
                } else if (D(r)) {
                    ...
                    if ((o > 255 && ((s = s.slice(0, -1)), (o = parseInt(s, 8))), o > 0)) {
                      ...
                      this.state.strict
                        ...
                        : this.state.containsOctal ||
                          ((this.state.containsOctal = !0), (this.state.octalPosition = a));
                    }
            ...
            (n.readWord1 = function() {
              ...
              for (var e = '', t = !0, n = this.state.pos; this.state.pos < this.input.length; ) {
                var r = this.input.codePointAt(this.state.pos);
                if (E(r)) this.state.pos += r <= 65535 ? 1 : 2;
                else if (this.state.isIterator && 64 === r) this.state.pos += 1;
                else {
                  if (92 !== r) break;
                  ...
                  (t ? b : E)(a, !0) || this.raise(i, 'Invalid Unicode escape'),
            ...
            (n.braceIsBlock = function(e) {
              if (e === u.colon) {
                ...
                if (t === F.braceStatement || t === F.braceExpression) return !t.isExpr;
              }
              return e === u._return
                ? _.test(this.input.slice(this.state.lastTokEnd, this.state.start))
                : e === u._else ||
                    e === u.semi ||
                    e === u.eof ||
                    e === u.parenR ||
                    (e === u.braceL
                      ? this.curContext() === F.braceStatement
                      : e === u.relational || !this.state.exprAllowed);
            }),
            (n.updateContext = function(e) {
              var t,
                n = this.state.type;
              !n.keyword || (e !== u.dot && e !== u.questionDot)
                ? (t = n.updateContext)
                  ? t.call(this, e)
      ...
      te = (function(e) {
        function t(t, n) {
          ...
          return (
            (t = (function(e) {
              var t = {};
              for (var n in V) t[n] = e && null != e[n] ? e[n] : V[n];
              return t;
            })(t)),
            ((r = e.call(this, t, n) || this).options = t),
            (r.inModule = 'module' === r.options.sourceType),
            (r.input = n),
            (r.plugins = (function(e) {
        ...
        (function(e) {
          ...
          return (
            ...
            (n.stmtToDirective = function(e) {
              ...
              return (
                this.addExtra(n, 'raw', i),
                this.addExtra(n, 'rawValue', a),
            ...
            (n.parseStatementContent = function(e, t) {
              ...
              switch (n) {
                ...
                case u._import:
                  var i,
                    a = this.lookahead();
                  if (a.type === u.parenL || a.type === u.dot) break;
                  return (
                    ...
                    this.next(),
                    n == u._import
                      ? 'ImportDeclaration' !== (i = this.parseImport(r)).type ||
                        (i.importKind && 'value' !== i.importKind) ||
                        (this.sawUnambiguousESM = !0)
                      : (('ExportNamedDeclaration' !== (i = this.parseExport(r)).type ||
                ...
                case u.name:
                  if (this.isContextual('async')) {
                    ...
                    if ((this.next(), this.match(u._function) && !this.canInsertSemicolon()))
                      return this.expect(u._function), this.parseFunction(r, !0, !1, !0);
                    this.state = s;
                  }
              }
              var o = this.state.value,
                l = this.parseExpression();
              return n === u.name && 'Identifier' === l.type && this.eat(u.colon)
                ? this.parseLabeledStatement(r, o, l)
            ...
            (n.parseDecorator = function() {
              ...
              if ((this.next(), this.hasPlugin('decorators'))) {
                ...
                if (this.eat(u.parenL)) (t = this.parseExpression()), this.expect(u.parenR);
                else
                  for (t = this.parseIdentifier(!1); this.eat(u.dot); ) {
                ...
                if (this.eat(u.parenL)) {
                  ...
                  (a.callee = t),
                    (a.arguments = this.parseCallExpressionArguments(u.parenR, !1)),
            ...
            (n.parseBreakContinueStatement = function(e, t) {
              ...
              return (
                n === this.state.labels.length && this.raise(e.start, 'Unsyntactic ' + t),
            ...
            (n.parseForStatement = function(e) {
              ...
              if (
                (this.state.inAsync &&
                  ...
                  (this.expectPlugin('asyncGenerators'), (t = !0), this.next()),
                this.expect(u.parenL),
                this.match(u.semi))
              )
                return t && this.unexpected(), this.parseFor(e, null);
              if (this.match(u._var) || this.match(u._let) || this.match(u._const)) {
                ...
                if (
                  ...
                  (this.match(u._in) || this.isContextual('of')) && 1 === n.declarations.length)
                ) {
                  var i = n.declarations[0],
                    a =
                      r === u._var &&
                      i.init &&
                      'ObjectPattern' != i.id.type &&
                      'ArrayPattern' != i.id.type &&
                      !this.isContextual('of');
                  if (this.state.strict && a)
                    this.raise(this.state.start, 'for-in initializer in strict mode');
                  else if (a || !i.init) return this.parseForIn(e, n, t);
                }
              ...
              if (this.match(u._in) || this.isContextual('of')) {
                ...
                return (
                  this.toAssignable(o, void 0, l),
                  this.checkLVal(o, void 0, void 0, l),
                  this.parseForIn(e, o, t)
                );
              }
              return (
                s.start && this.unexpected(s.start), t && this.unexpected(), this.parseFor(e, o)
              );
            }),
            ...
            (n.parseIfStatement = function(e) {
              return (
                ...
                (e.alternate = this.eat(u._else) ? this.parseStatement(!1) : null),
            ...
            (n.parseSwitchStatement = function(e) {
              ...
              var t,
                n,
                r = (e.cases = []);
              for (this.expect(u.braceL), this.state.labels.push(ee); !this.match(u.braceR); )
                if (this.match(u._case) || this.match(u._default)) {
                  var i = this.match(u._case);
                  t && this.finishNode(t, 'SwitchCase'),
                    ...
                    i
                      ...
                      : (n && this.raise(this.state.lastTokStart, 'Multiple default clauses'),
                        (n = !0),
                        (t.test = null)),
                    this.expect(u.colon);
                } else t ? t.consequent.push(this.parseStatement(!0)) : this.unexpected();
              return (
                t && this.finishNode(t, 'SwitchCase'),
                this.next(),
                this.state.labels.pop(),
            ...
            (n.parseTryStatement = function(e) {
              if (
                ...
                if ((this.next(), this.match(u.parenL))) {
                  ...
                  this.checkLVal(t.param, !0, n, 'catch clause'), this.expect(u.parenR);
                } else this.expectPlugin('optionalCatchBinding'), (t.param = null);
                (t.body = this.parseBlock()), (e.handler = this.finishNode(t, 'CatchClause'));
              }
              return (
                (e.guardedHandlers = $),
            ...
            (n.parseLabeledStatement = function(e, t, n) {
              for (var r = 0, i = this.state.labels; r < i.length; r++) {
                i[r].name === t && this.raise(n.start, "Label '" + t + "' is already declared");
              }
              for (
                var a = this.state.type.isLoop ? 'loop' : this.match(u._switch) ? 'switch' : null,
                  s = this.state.labels.length - 1;
                s >= 0;
                s--
              ) {
                var o = this.state.labels[s];
              ...
              return (
                ...
                ('ClassDeclaration' == e.body.type ||
                  ...
                  ('FunctionDeclaration' == e.body.type &&
                    (this.state.strict || e.body.generator || e.body.async))) &&
            ...
            (n.parseBlock = function(e) {
              ...
              return (
                ...
                this.parseBlockBody(t, e, !1, u.braceR),
            ...
            (n.parseBlockBody = function(e, t, n, r) {
              var i = (e.body = []),
                a = (e.directives = []);
              this.parseBlockOrModuleBlockBody(i, t ? a : void 0, n, r);
            }),
            (n.parseBlockOrModuleBlockBody = function(e, t, n, r) {
              for (var i, a, s = !1; !this.eat(r); ) {
                s || !this.state.containsOctal || a || (a = this.state.octalPosition);
                var o = this.parseStatement(!0, n);
                if (t && !s && this.isValidDirective(o)) {
                  var l = this.stmtToDirective(o);
                  t.push(l),
                    void 0 === i &&
                      'use strict' === l.value.value &&
                      ((i = this.state.strict),
                      this.setStrict(!0),
            ...
            (n.parseFor = function(e, t) {
              return (
                ...
                this.expect(u.semi),
                (e.update = this.match(u.parenR) ? null : this.parseExpression()),
            ...
            (n.parseForIn = function(e, t, n) {
              var r = this.match(u._in) ? 'ForInStatement' : 'ForOfStatement';
              return (
                n ? this.eatContextual('of') : this.next(),
                'ForOfStatement' === r && (e.await = !!n),
                (e.left = t),
              ...
              for (e.kind = n.keyword; ; ) {
                ...
                if (
                  ...
                  this.eat(u.eq)
                    ...
                    : (n !== u._const || this.match(u._in) || this.isContextual('of')
                        ? 'Identifier' === i.id.type ||
                          (t && (this.match(u._in) || this.isContextual('of'))) ||
                          this.raise(
                      ...
                      (i.init = null)),
                  r.push(this.finishNode(i, 'VariableDeclarator')),
                  !this.eat(u.comma))
                )
                  break;
              }
            ...
            (n.parseFunction = function(e, t, n, r, i) {
              var a = this.state.inFunction,
                s = this.state.inMethod,
                o = this.state.inGenerator,
                l = this.state.inClassProperty;
              return (
                ...
                this.match(u.star) &&
                  ...
                  (e.generator = !0),
                  this.next()),
                !t || i || this.match(u.name) || this.match(u._yield) || this.unexpected(),
                t || (this.state.inGenerator = e.generator),
                (this.match(u.name) || this.match(u._yield)) &&
            ...
            (n.parseClassBody = function(e) {
              ...
              var n = { hadConstructor: !1 },
                r = [],
                i = this.startNode();
              for (i.body = [], this.expect(u.braceL); !this.eat(u.braceR); )
                if (this.eat(u.semi))
                  r.length > 0 &&
                    this.raise(
                      this.state.lastTokEnd,
                ...
                else if (this.match(u.at)) r.push(this.parseDecorator());
                else {
                  var a = this.startNode();
                  r.length &&
                    ((a.decorators = r), this.resetStartLocationFromNode(a, r[0]), (r = [])),
                    this.parseClassMember(i, a, n),
                    'constructor' === a.kind &&
                      a.decorators &&
              ...
              if (this.match(u.name) && 'static' === this.state.value) {
                ...
                if (this.isClassMethod()) {
                  ...
                  return (
                    ...
                    (s.key = a),
                    (s.static = !1),
                    void this.pushClassMethod(e, s, !1, !1, !1)
                  );
                }
                if (this.isClassProperty()) {
                  ...
                  return (
                    ...
                    (o.key = a),
                    (o.static = !1),
                    void e.body.push(this.parseClassProperty(o))
                  );
                }
                if (i) throw this.unexpected();
                r = !0;
              }
              this.parseClassMemberWithIsStatic(e, t, n, r);
            }),
            (n.parseClassMemberWithIsStatic = function(e, t, n, r) {
              var i = t,
                a = t,
                s = t,
                o = t,
                l = i,
                c = i;
              if (((t.static = r), this.eat(u.star)))
                return (
                  (l.kind = 'method'),
                  this.parseClassPropertyName(l),
                  'PrivateName' === l.key.type
                    ? void this.pushClassPrivateMethod(e, a, !0, !1)
                    : (this.isNonstaticConstructor(i) &&
                        this.raise(i.key.start, "Constructor can't be a generator"),
                      void this.pushClassMethod(e, i, !0, !1, !1))
                );
              var p = this.parseClassPropertyName(t),
                f = 'PrivateName' === p.type,
                d = 'Identifier' === p.type;
              if ((this.parsePostMemberNameModifiers(c), this.isClassMethod())) {
                if (((l.kind = 'method'), f)) return void this.pushClassPrivateMethod(e, a, !1, !1);
                var h = this.isNonstaticConstructor(i);
                h &&
                  ((i.kind = 'constructor'),
                  i.decorators &&
                    this.raise(i.start, "You can't attach decorators to a class constructor"),
                  n.hadConstructor &&
                    !this.hasPlugin('typescript') &&
                    this.raise(p.start, 'Duplicate constructor in the same class'),
                  (n.hadConstructor = !0)),
                  this.pushClassMethod(e, i, !1, !1, h);
              } else if (this.isClassProperty())
                f ? this.pushClassPrivateProperty(e, o) : this.pushClassProperty(e, s);
              else if (d && 'async' === p.name && !this.isLineTerminator()) {
                var m = this.match(u.star);
                m && (this.expectPlugin('asyncGenerators'), this.next()),
                  (l.kind = 'method'),
                  this.parseClassPropertyName(l),
                  'PrivateName' === l.key.type
                    ? this.pushClassPrivateMethod(e, a, m, !0)
                    : (this.isNonstaticConstructor(i) &&
                        this.raise(i.key.start, "Constructor can't be an async function"),
                      this.pushClassMethod(e, i, m, !0, !1));
              } else
                !d ||
                ('get' !== p.name && 'set' !== p.name) ||
                (this.isLineTerminator() && this.match(u.star))
                  ? this.isLineTerminator()
                    ? f
                  ...
                  : ((l.kind = p.name),
                    ...
                    'PrivateName' === l.key.type
                      ...
                      : (this.isNonstaticConstructor(i) &&
                        ...
                        this.pushClassMethod(e, i, !1, !1, !1)),
            ...
            (n.parseClassPropertyName = function(e) {
              ...
              return (
                e.computed ||
                  ...
                  this.raise(t.start, 'Classes may not have static property named prototype'),
                'PrivateName' === t.type &&
                  'constructor' === t.id.name &&
                  this.raise(t.start, "Classes may not have a private field named '#constructor'"),
                t
              );
            }),
            ...
            (n.pushClassMethod = function(e, t, n, r, i) {
              e.body.push(this.parseMethod(t, n, r, i, 'ClassMethod'));
            }),
            (n.pushClassPrivateMethod = function(e, t, n, r) {
              this.expectPlugin('classPrivateMethods', t.key.start),
                e.body.push(this.parseMethod(t, n, r, !1, 'ClassPrivateMethod'));
            }),
            ...
            (n.parseExport = function(e) {
              if (this.shouldParseExportStar()) {
                if ((this.parseExportStar(e), 'ExportAllDeclaration' === e.type)) return e;
              } else if (this.isExportDefaultSpecifier()) {
                this.expectPlugin('exportDefaultFrom');
                var t = this.startNode();
                t.exported = this.parseIdentifier(!0);
                var n = [this.finishNode(t, 'ExportDefaultSpecifier')];
                if (((e.specifiers = n), this.match(u.comma) && this.lookahead().type === u.star)) {
                  this.expect(u.comma);
                  var r = this.startNode();
                  this.expect(u.star),
                    this.expectContextual('as'),
                    (r.exported = this.parseIdentifier()),
                    n.push(this.finishNode(r, 'ExportNamespaceSpecifier'));
            ...
            (n.parseExportDefaultExpression = function() {
              var e = this.startNode();
              if (this.eat(u._function)) return this.parseFunction(e, !0, !1, !1, !0);
              if (this.isContextual('async') && this.lookahead().type === u._function)
                return (
              ...
              if (this.match(u._let) || this.match(u._const) || this.match(u._var))
                return this.raise(
                  this.state.start,
            ...
            (n.isExportDefaultSpecifier = function() {
              if (this.match(u.name)) return 'async' !== this.state.value;
            ...
            (n.parseExportFrom = function(e, t) {
              this.eatContextual('from')
                ? ((e.source = this.match(u.string) ? this.parseExprAtom() : this.unexpected()),
                  this.checkExport(e))
                : t
                ? this.unexpected()
                : (e.source = null),
            ...
            (n.shouldParseExportStar = function() {
              return this.match(u.star);
            }),
            (n.parseExportStar = function(e) {
              this.expect(u.star),
                this.isContextual('as')
                  ? this.parseExportNamespace(e)
                  : (this.parseExportFrom(e, !0), this.finishNode(e, 'ExportAllDeclaration'));
            }),
            ...
            (n.checkExport = function(e, t, n) {
              if (t)
                if (n) this.checkDuplicateExports(e, 'default');
                  ...
                  for (var r = 0, i = e.specifiers; r < i.length; r++) {
                    var a = i[r];
                  ...
                  if (
                    ...
                    var s = e.declaration.id;
                    if (!s) throw new Error('Assertion failure');
                    this.checkDuplicateExports(e, s.name);
                  } else if ('VariableDeclaration' === e.declaration.type)
                    for (var o = 0, l = e.declaration.declarations; o < l.length; o++) {
                      var u = l[o];
            ...
            (n.checkDeclaration = function(e) {
              if ('ObjectPattern' === e.type)
                ...
                for (var i = 0, a = e.elements; i < a.length; i++) {
                  var s = a[i];
                ...
                'ObjectProperty' === e.type
                  ...
                  : 'Identifier' === e.type && this.checkDuplicateExports(e, e.name);
            }),
            ...
            (n.parseExportSpecifiers = function() {
              ...
              return e && !this.isContextual('from') && this.unexpected(), t;
            }),
            ...
            (n.parseImportSpecifierLocal = function(e, t, n, r) {
              (t.local = this.parseIdentifier()),
                this.checkLVal(t.local, !0, void 0, r),
            ...
            return (
              (n.checkPropClash = function(e, t) {
                if (!e.computed && !e.kind) {
                  var n = e.key;
                  '__proto__' === ('Identifier' === n.type ? n.name : String(n.value)) &&
                    (t.proto && this.raise(n.start, 'Redefinition of __proto__ property'),
                    (t.proto = !0));
                }
              }),
              (n.getExpression = function() {
                ...
                return (
                  this.match(u.eof) || this.unexpected(), (e.comments = this.state.comments), e
                );
              }),
              (n.parseExpression = function(e, t) {
                ...
                if (this.match(u.comma)) {
                  var a = this.startNodeAt(n, r);
                  for (a.expressions = [i]; this.eat(u.comma); )
                    a.expressions.push(this.parseMaybeAssign(e, t));
                  return (
                    this.toReferencedList(a.expressions), this.finishNode(a, 'SequenceExpression')
                  );
                }
                return i;
              }),
              (n.parseMaybeAssign = function(e, t, n, r) {
                var i,
                  a = this.state.start,
                  s = this.state.startLoc;
                if (this.match(u._yield) && this.state.inGenerator) {
                  var o = this.parseYield();
                  return n && (o = n.call(this, o, a, s)), o;
                }
                t ? (i = !1) : ((t = { start: 0 }), (i = !0)),
                  (this.match(u.parenL) || this.match(u.name) || this.match(u._yield)) &&
                    (this.state.potentialArrowAt = this.state.start);
                var l = this.parseMaybeConditional(e, t, r);
                if ((n && (l = n.call(this, l, a, s)), this.state.type.isAssign)) {
                  var c,
                    p = this.startNodeAt(a, s),
                    f = this.state.value;
                  if (
                    ((p.operator = f),
                    '??=' === f &&
                    ...
                    ('||=' !== f && '&&=' !== f) || this.expectPlugin('logicalAssignment'),
                    (p.left = this.match(u.eq)
                    ...
                    'ObjectPattern' === l.type
                      ? (c = '`({a}) = 0` use `({a} = 0)`')
                      : 'ArrayPattern' === l.type && (c = '`([a]) = 0` use `([a] = 0)`'),
                      c &&
                        this.raise(
                          l.start,
                ...
                return i && t.start && this.unexpected(t.start), l;
              }),
              (n.parseMaybeConditional = function(e, t, n) {
                ...
                return 'ArrowFunctionExpression' === s.type && s.start === a
                  ? s
                  : t && t.start
                  ? s
                  : this.parseConditional(s, e, r, i, n);
              }),
              (n.parseConditional = function(e, t, n, r, i) {
              ...
              (n.parseExprOps = function(e, t) {
                var n = this.state.start,
                  ...
                  a = this.parseMaybeUnary(t);
                return 'ArrowFunctionExpression' === a.type && a.start === i
                  ? a
                  : t && t.start
                  ? a
                  : this.parseExprOp(a, n, r, -1, e);
              }),
              (n.parseExprOp = function(e, t, n, r, i) {
                var a = this.state.type.binop;
                if (!(null == a || (i && this.match(u._in))) && a > r) {
                  ...
                  var l = this.state.type;
                  l === u.nullishCoalescing
                    ? this.expectPlugin('nullishCoalescingOperator')
                    : l === u.pipeline && this.expectPlugin('pipelineOperator'),
                    this.next();
                  ...
                  return (
                    (s.right = this.parseExprOp(
                      this.parseMaybeUnary(),
                      c,
                      p,
                      l.rightAssociative ? a - 1 : a,
                      i,
                    )),
                    this.finishNode(
                      s,
                      l === u.logicalOR || l === u.logicalAND || l === u.nullishCoalescing
                        ? 'LogicalExpression'
                        : 'BinaryExpression',
                    ),
                    this.parseExprOp(s, t, n, r, i)
                  );
                }
                return e;
              }),
              (n.parseMaybeUnary = function(e) {
                if (this.state.type.prefix) {
                  ...
                  if (
                    ...
                    (t.prefix = !0),
                    'throw' === t.operator && this.expectPlugin('throwExpressions'),
                    this.next(),
                    ...
                    'Identifier' === r.type
                      ...
                      : 'MemberExpression' === r.type &&
                        'PrivateName' === r.property.type &&
                        this.raise(t.start, 'Deleting a private field is not allowed');
                  }
                ...
                for (; this.state.type.postfix && !this.canInsertSemicolon(); ) {
                  ...
                  (o.operator = this.state.value),
                    (o.prefix = !1),
                    (o.argument = s),
                    this.checkLVal(s, void 0, void 0, 'postfix operation'),
                    this.next(),
              ...
              (n.parseExprSubscripts = function(e) {
                ...
                return 'ArrowFunctionExpression' === i.type && i.start === r
                  ...
                  : e && e.start
                  ? i
                  : this.parseSubscripts(i, t, n);
              }),
              (n.parseSubscripts = function(e, t, n, r) {
                var i = { optionalChainMember: !1, stop: !1 };
                do {
                  e = this.parseSubscript(e, t, n, r, i);
                } while (!i.stop);
                return e;
              }),
              (n.parseSubscript = function(e, t, n, r, i) {
                if (!r && this.eat(u.doubleColon)) {
                  ...
                  return (
                    ...
                    (i.stop = !0),
                    this.parseSubscripts(this.finishNode(a, 'BindExpression'), t, n, r)
                  );
                }
                if (this.match(u.questionDot)) {
                  if (
                    ...
                    r && this.lookahead().type == u.parenL)
                  )
                    return (i.stop = !0), e;
                  this.next();
                  var s = this.startNodeAt(t, n);
                  ...
                  if (this.eat(u.parenL)) {
                    var o = this.atPossibleAsync(e);
                    return (
                      (s.callee = e),
                      (s.arguments = this.parseCallExpressionArguments(u.parenR, o)),
                      (s.optional = !0),
                ...
                if (this.eat(u.dot)) {
                  ...
                  return (
                    (l.object = e),
                    (l.property = this.parseMaybePrivateName()),
                    (l.computed = !1),
                ...
                if (!r && this.match(u.parenL)) {
                  var p = this.atPossibleAsync(e);
                  this.next();
                  var f = this.startNodeAt(t, n);
                  f.callee = e;
                  var d = { start: -1 };
                  return (
                    (f.arguments = this.parseCallExpressionArguments(u.parenR, p, d)),
                    i.optionalChainMember
                      ? this.finishOptionalCallExpression(f)
                      : this.finishCallExpression(f),
                    p && this.shouldParseAsyncArrow()
                      ? ((i.stop = !0),
                        d.start > -1 &&
                          this.raise(
                            d.start,
                        ...
                        this.parseAsyncArrowFromCallExpression(this.startNodeAt(t, n), f))
                      : (this.toReferencedList(f.arguments), f)
                  );
                }
                return this.match(u.backQuote)
                  ? this.parseTaggedTemplateExpression(t, n, e, i)
                  : ((i.stop = !0), e);
              }),
              (n.parseTaggedTemplateExpression = function(e, t, n, r, i) {
                var a = this.startNodeAt(e, t);
                return (
                  (a.tag = n),
                  (a.quasi = this.parseTemplate(!0)),
                  i && (a.typeParameters = i),
                  r.optionalChainMember &&
                    this.raise(e, 'Tagged Template Literals are not allowed in optionalChain'),
              ...
              (n.parseCallExpressionArguments = function(e, t, n) {
                for (var r, i = [], a = !0; !this.eat(e); ) {
                  if (a) a = !1;
                  else if ((this.expect(u.comma), this.eat(e))) break;
                  this.match(u.parenL) && !r && (r = this.state.start),
                    i.push(
                ...
                return t && r && this.shouldParseAsyncArrow() && this.unexpected(), i;
              }),
              (n.shouldParseAsyncArrow = function() {
                return this.match(u.arrow);
              }),
              ...
              (n.parseExprAtom = function(e) {
                ...
                switch (this.state.type) {
                  ...
                  case u._import:
                    return this.lookahead().type === u.dot
                  ...
                  case u._this:
                    return (
                      (t = this.startNode()), this.next(), this.finishNode(t, 'ThisExpression')
                    );
                  case u._yield:
                  ...
                  case u.name:
                    ...
                    if ('await' === s.name) {
                      ...
                      if (n && 'async' === s.name && this.match(u.name)) {
                        var o = this.state.yieldInPossibleArrowParameters;
                        this.state.yieldInPossibleArrowParameters = null;
                        var l = [this.parseIdentifier()];
                        return (
                          this.expect(u.arrow),
                          this.parseArrowExpression(t, l, !0),
                          (this.state.yieldInPossibleArrowParameters = o),
                          t
                        );
                      }
                    }
                    if (n && !this.canInsertSemicolon() && this.eat(u.arrow)) {
                      var c = this.state.yieldInPossibleArrowParameters;
                      return (
                        (this.state.yieldInPossibleArrowParameters = null),
                        this.parseArrowExpression(t, [s]),
                        (this.state.yieldInPossibleArrowParameters = c),
                        t
                      );
                    }
                    return s;
                  case u._do:
                    ...
                    return (
                      ...
                      (p.body = this.parseBlock(!1)),
                      (this.state.inFunction = f),
                      (this.state.labels = d),
                      this.finishNode(p, 'DoExpression')
                    );
                  case u.regexp:
                    var h = this.state.value;
                    return (
                      ((t = this.parseLiteral(h.value, 'RegExpLiteral')).pattern = h.pattern),
                      (t.flags = h.flags),
                      t
                    );
                  case u.num:
                  ...
                  case u.bracketL:
                    return (
                      (t = this.startNode()),
                      this.next(),
                      (t.elements = this.parseExprList(u.bracketR, !0, e)),
                  ...
                  case u.doubleColon:
                    ...
                    var m = (t.callee = this.parseNoCallExpr());
                    if ('MemberExpression' === m.type) return this.finishNode(t, 'BindExpression');
              ...
              (n.parseBooleanLiteral = function() {
                var e = this.startNode();
                return (
                  (e.value = this.match(u._true)), this.next(), this.finishNode(e, 'BooleanLiteral')
                );
              }),
              ...
              (n.parseFunctionExpression = function() {
                ...
                return this.state.inGenerator && this.eat(u.dot)
              ...
              (n.parseMetaProperty = function(e, t, n) {
                ...
                return (
                  ...
                  (e.property.name !== n || r) &&
                    this.raise(
                      e.property.start,
                      'The only valid meta property for ' + t.name + ' is ' + t.name + '.' + n,
                    ),
                  ...
                  'import' === t.name &&
                    (this.isContextual('meta')
                      ...
                      : this.hasPlugin('importMeta') ||
                        this.raise(t.start, "Dynamic imports require a parameter: import('a.js')")),
                  this.inModule ||
                    this.raise(
                      t.start,
              ...
              (n.parseLiteral = function(e, t, n, r) {
              ...
              (n.parseParenAndDistinguishExpression = function(e) {
                ...
                for (
                  ...
                  if (h) h = !1;
                  else if ((this.expect(u.comma, d.start || null), this.match(u.parenR))) {
                    o = this.state.start;
                    break;
                  }
                  if (this.match(u.ellipsis)) {
                    ...
                    (s = this.state.start),
                      p.push(this.parseParenItem(this.parseRest(), m, y)),
                      this.match(u.comma) &&
                        this.lookahead().type === u.parenR &&
                        this.raise(
                          this.state.start,
                          'A trailing comma is not permitted after the rest element',
                        );
                  ...
                  p.push(this.parseMaybeAssign(!1, f, this.parseParenItem, d));
                }
                var v = this.state.start,
                  T = this.state.startLoc;
                this.expect(u.parenR), (this.state.maybeInArrowParameters = i);
                var g = this.startNodeAt(n, r);
                if (e && this.shouldParseArrow() && (g = this.parseArrow(g))) {
                  for (var S = 0; S < p.length; S++) {
                    var x = p[S];
                    x.extra && x.extra.parenthesized && this.unexpected(x.extra.parenStart);
                  }
                  return (
                    this.parseArrowExpression(g, p),
                    (this.state.yieldInPossibleArrowParameters = a),
                    g
                  );
                }
                return (
                  ...
                  p.length > 1
                    ? (((t = this.startNodeAt(l, c)).expressions = p),
                      this.toReferencedList(t.expressions),
                      this.finishNodeAt(t, 'SequenceExpression', v, T))
                    : (t = p[0]),
              ...
              (n.parseNew = function() {
                ...
                if (this.eat(u.dot)) {
                  ...
                  if (!this.state.inFunction && !this.state.inClassProperty) {
                    var r = 'new.target can only be used in functions';
                    this.hasPlugin('classProperties') && (r += ' or class properties'),
                      this.raise(n.start, r);
                  }
                  return n;
                }
                return (
              ...
              (n.parseNewArguments = function(e) {
                if (this.eat(u.parenL)) {
                  var t = this.parseExprList(u.parenR);
              ...
              (n.parseObj = function(e, t) {
                ...
                for (var s = null; !this.eat(u.braceR); ) {
                  if (i) i = !1;
                  else if ((this.expect(u.comma), this.eat(u.braceR))) break;
                  if (this.match(u.at))
                    ...
                    else for (; this.match(u.at); ) n.push(this.parseDecorator());
                  var o = this.startNode(),
                    l = !1,
                    c = !1,
                    p = void 0,
                    f = void 0;
                  if ((n.length && ((o.decorators = n), (n = [])), this.match(u.ellipsis))) {
                    if (
                      (this.expectPlugin('objectRestSpread'),
                      (o = this.parseSpread(e ? { start: 0 } : void 0)),
                      e && this.toAssignable(o, !0, 'object pattern'),
                      a.properties.push(o),
                      !e)
                    )
                      continue;
                    ...
                    if (null !== s)
                      ...
                      if (this.eat(u.braceR)) break;
                      if (!this.match(u.comma) || this.lookahead().type !== u.braceR) {
                        s = d;
                        continue;
                      }
                      this.unexpected(
                  ...
                  (o.method = !1),
                    (e || t) && ((p = this.state.start), (f = this.state.startLoc)),
                    e || (l = this.eat(u.star));
                  var h = this.state.containsEsc;
                  if (!e && this.isContextual('async')) {
                    ...
                    this.match(u.eq) ||
                    this.match(u.comma)
                      ? ((o.key = m), (o.computed = !1))
                      : ((c = !0),
                        this.match(u.star) &&
                          (this.expectPlugin('asyncGenerators'), this.next(), (l = !0)),
                        this.parsePropertyName(o));
                  } else this.parsePropertyName(o);
                  this.parseObjPropValue(o, p, f, l, c, e, t, h),
                    this.checkPropClash(o, r),
                ...
                return (
                  ...
                  this.finishNode(a, e ? 'ObjectPattern' : 'ObjectExpression')
                );
              }),
              ...
              (n.checkGetterSetterParams = function(e) {
                ...
                e.params.length !== t &&
                  ('get' === e.kind
                    ? this.raise(n, 'getter must not have any formal parameters')
                    : this.raise(n, 'setter must have exactly one formal parameter')),
                  'set' === e.kind &&
                    'RestElement' === e.params[0].type &&
                    this.raise(n, 'setter function argument must not be a rest parameter');
              }),
              (n.parseObjectMethod = function(e, t, n, r, i) {
                return n || t || this.match(u.parenL)
                  ? (r && this.unexpected(),
                    (e.kind = 'method'),
                    (e.method = !0),
                    this.parseMethod(e, t, n, !1, 'ObjectMethod'))
                  : !i && this.isGetterOrSetterMethod(e, r)
                  ? ((t || n) && this.unexpected(),
                    (e.kind = e.key.name),
              ...
              (n.parseObjectProperty = function(e, t, n, r, i) {
                return (
                  (e.shorthand = !1),
                  this.eat(u.colon)
                    ? ((e.value = r
                    ...
                    : (this.checkReservedWord(e.key.name, e.key.start, !0, !0),
                      r
                        ? (e.value = this.parseMaybeDefault(t, n, e.key.__clone()))
                        : this.match(u.eq) && i
              ...
              (n.parseObjPropValue = function(e, t, n, r, i, a, s, o) {
                var l =
                  this.parseObjectMethod(e, r, i, a, o) || this.parseObjectProperty(e, t, n, a, s);
                return l || this.unexpected(), l;
              }),
              (n.parsePropertyName = function(e) {
                if (this.eat(u.bracketL))
                  (e.computed = !0), (e.key = this.parseMaybeAssign()), this.expect(u.bracketR);
                else {
              ...
              (n.parseMethod = function(e, t, n, r, i) {
                var a = this.state.inFunction,
                  s = this.state.inMethod,
                  o = this.state.inGenerator;
                (this.state.inFunction = !0),
                ...
                return (
                  ...
                  this.parseFunctionBodyAndFinish(e, i),
                  (this.state.inFunction = a),
                  (this.state.inMethod = s),
                  (this.state.inGenerator = o),
                  e
              ...
              (n.checkFunctionNameAndParams = function(e, t) {
                var n = this.isStrictBody(e),
                  r = this.state.strict || n || t,
                  i = this.state.strict;
                if ((n && (this.state.strict = n), r)) {
                  var a = Object.create(null);
                  e.id && this.checkLVal(e.id, !0, void 0, 'function name');
                  for (var s = 0, o = e.params; s < o.length; s++) {
                    var l = o[s];
                    n &&
                      'Identifier' !== l.type &&
                      this.raise(l.start, 'Non-simple parameter in strict mode'),
                      this.checkLVal(l, !0, a, 'function parameter list');
                  }
                }
                this.state.strict = i;
              }),
              ...
              (n.parseExprListItem = function(e, t, n, r) {
                var i;
                if (e && this.match(u.comma)) i = null;
                else if (this.match(u.ellipsis)) {
                  var a = this.state.start,
                    s = this.state.startLoc;
                  (i = this.parseParenItem(this.parseSpread(t, n), a, s)),
                    r && this.match(u.comma) && (r.start = this.state.start);
              ...
              (n.parseIdentifier = function(e) {
                ...
                return (t.name = n), (t.loc.identifierName = n), this.finishNode(t, 'Identifier');
              }),
              (n.parseIdentifierName = function(e, t) {
                ...
                return (
                  !t &&
                    'await' === n &&
                    this.state.inAsync &&
                    this.raise(e, 'invalid use of await inside of an async function'),
                  this.next(),
                  n
                );
              }),
              (n.checkReservedWord = function(e, t, n, r) {
                this.state.strict &&
                  (d.strict(e) || (r && d.strictBind(e))) &&
                  this.raise(t, e + ' is a reserved word in strict mode'),
                  this.state.inGenerator &&
                    'yield' === e &&
                    this.raise(t, 'yield is a reserved word inside generator functions'),
                  this.state.inClassProperty &&
                    'arguments' === e &&
                    this.raise(t, "'arguments' is not allowed in class field initializer"),
              ...
              (n.parseYield = function() {
                ...
                return (
                  this.state.inParameters &&
                    this.raise(e.start, 'yield is not allowed in generator parameters'),
                  ...
                  (!this.match(u.star) && !this.state.type.startsExpr)
                    ...
                    : ((e.delegate = this.eat(u.star)), (e.argument = this.parseMaybeAssign())),
            ...
            (function(e) {
              ...
              return (
                  ...
                  if (e)
                    switch (e.type) {
                      ...
                      case 'ObjectExpression':
                        ...
                        for (var r = 0; r < e.properties.length; r++) {
                          var i = e.properties[r],
                            a = r === e.properties.length - 1;
                          this.toAssignableObjectExpressionProp(i, t, a);
                        }
                        break;
                      case 'ObjectProperty':
                      ...
                      case 'MemberExpression':
                        if (!t) break;
                      default:
                        var o = 'Invalid left-hand side' + (n ? ' in ' + n : 'expression');
                        this.raise(e.start, o);
                    }
                  return e;
                }),
                      ...
                      this.toAssignable(a, t, n),
                        -1 ===
                          [
                            ...
                            'ArrayPattern',
                            'ObjectPattern',
                          ].indexOf(a.type) && this.unexpected(a.start),
                        --r;
                    }
                  }
                  for (var s = 0; s < r; s++) {
                ...
                (n.shouldAllowYieldIdentifier = function() {
                  return this.match(u._yield) && !this.state.strict && !this.state.inGenerator;
                }),
                ...
                (n.parseBindingList = function(e, t, n) {
                  for (var r = [], i = !0; !this.eat(e); )
                    if ((i ? (i = !1) : this.expect(u.comma), t && this.match(u.comma)))
                      r.push(null);
                    else {
                      if (this.eat(e)) break;
                      if (this.match(u.ellipsis)) {
                      ...
                      r.push(this.parseAssignableListItem(n, a));
                    }
                  return r;
                }),
                ...
                (n.checkLVal = function(e, t, n, r) {
                  switch (e.type) {
                    ...
                    case 'MemberExpression':
                      ...
                      break;
                    case 'ObjectPattern':
                      for (var a = 0, s = e.properties; a < s.length; a++) {
                        var o = s[a];
                        'ObjectProperty' === o.type && (o = o.value),
                          this.checkLVal(o, t, n, 'object destructuring pattern');
                      }
                      break;
                    case 'ArrayPattern':
                      for (var l = 0, u = e.elements; l < u.length; l++) {
                        var c = u[l];
                        c && this.checkLVal(c, t, n, 'array destructuring pattern');
                      }
                      break;
                    case 'AssignmentPattern':
                    ...
                    default:
                      var p =
                        ...
                        ' left-hand side' +
                        (r ? ' in ' + r : 'expression');
                      this.raise(e.start, p);
                  }
                }),
                (n.checkToRestConversion = function(e) {
                  -1 === ['Identifier', 'MemberExpression'].indexOf(e.argument.type) &&
                    this.raise(e.argument.start, "Invalid rest operator's argument");
                }),
                t
              );
            })(
              (function(e) {
                ...
                return (
                  ...
                  (n.finishNodeAt = function(e, t, n, r) {
                    return (
                      (e.type = t),
                      (e.end = n),
                      (e.loc.end = r),
    ...
    var se = ['minimal'];
    var oe = ['estree', 'jsx', 'flow', 'typescript'],
      le = {
        estree: function(e) {
          return (function(e) {
            function t() {
            ...
            var n = t.prototype;
            return (
              (n.estreeParseRegExpLiteral = function(e) {
                var t = e.pattern,
                  n = e.flags,
                  r = null;
                try {
                ...
                return (i.regex = { pattern: t, flags: n }), i;
              }),
              (n.estreeParseLiteral = function(e) {
                return this.parseLiteral(e, 'Literal');
              }),
              (n.directiveToStmt = function(e) {
                var t = e.value,
              ...
              (n.initFunction = function(t, n) {
                e.prototype.initFunction.call(this, t, n), (t.expression = !1);
              }),
              (n.checkDeclaration = function(t) {
                p(t) ? this.checkDeclaration(t.value) : e.prototype.checkDeclaration.call(this, t);
              }),
              (n.checkGetterSetterParams = function(e) {
                var t = e,
                  n = 'get' === t.kind ? 0 : 1,
              ...
              (n.checkLVal = function(t, n, r, i) {
                ...
                switch (t.type) {
                  case 'ObjectPattern':
                    ...
                    break;
                  default:
                    e.prototype.checkLVal.call(this, t, n, r, i);
                }
              }),
              (n.checkPropClash = function(e, t) {
                if (!e.computed && p(e)) {
              ...
              (n.isStrictBody = function(e) {
                if ('BlockStatement' === e.body.type && e.body.body.length > 0)
                  for (var t = 0, n = e.body.body; t < n.length; t++) {
                    var r = n[t];
                    if ('ExpressionStatement' !== r.type || 'Literal' !== r.expression.type) break;
                    if ('use strict' === r.expression.value) return !0;
                  }
                return !1;
              }),
              (n.isValidDirective = function(e) {
              ...
              (n.stmtToDirective = function(t) {
                var n = e.prototype.stmtToDirective.call(this, t),
                  r = t.expression.value;
                return (n.value.value = r), n;
              }),
              (n.parseBlockBody = function(t, n, r, i) {
                var a = this;
                e.prototype.parseBlockBody.call(this, t, n, r, i);
                var s = t.directives.map(function(e) {
                  return a.directiveToStmt(e);
                });
                (t.body = s.concat(t.body)), delete t.directives;
              }),
              (n.pushClassMethod = function(e, t, n, r, i) {
                this.parseMethod(t, n, r, i, 'MethodDefinition'),
                  t.typeParameters &&
                    ((t.value.typeParameters = t.typeParameters), delete t.typeParameters),
                  e.body.push(t);
              }),
              (n.parseExprAtom = function(t) {
                switch (this.state.type) {
                  case u.regexp:
                  ...
                  default:
                    return e.prototype.parseExprAtom.call(this, t);
                }
              }),
              (n.parseLiteral = function(t, n, r, i) {
                var a = e.prototype.parseLiteral.call(this, t, n, r, i);
                return (a.raw = a.extra.raw), delete a.extra, a;
              }),
              (n.parseFunctionBody = function(t, n) {
                e.prototype.parseFunctionBody.call(this, t, n),
                  (t.expression = 'BlockStatement' !== t.body.type);
              }),
              (n.parseMethod = function(t, n, r, i, a) {
                var s = this.startNode();
                return (
                  (s.kind = t.kind),
                  delete (s = e.prototype.parseMethod.call(this, s, n, r, i, 'FunctionExpression'))
                    .kind,
                  (t.value = s),
                  this.finishNode(t, a)
                );
              }),
              (n.parseObjectMethod = function(t, n, r, i, a) {
                var s = e.prototype.parseObjectMethod.call(this, t, n, r, i, a);
                return (
                  s &&
                    ((s.type = 'Property'),
              ...
              (n.parseObjectProperty = function(t, n, r, i, a) {
                var s = e.prototype.parseObjectProperty.call(this, t, n, r, i, a);
                return s && ((s.kind = 'init'), (s.type = 'Property')), s;
              }),
              (n.toAssignable = function(t, n, r) {
                return p(t)
                  ? (this.toAssignable(t.value, n, r), t)
                  : e.prototype.toAssignable.call(this, t, n, r);
              }),
              (n.toAssignableObjectExpressionProp = function(t, n, r) {
                'get' === t.kind || 'set' === t.kind
                  ? this.raise(t.key.start, "Object pattern can't contain getter or setter")
                  : t.method
                  ? this.raise(t.key.start, "Object pattern can't contain methods")
                  : e.prototype.toAssignableObjectExpressionProp.call(this, t, n, r);
              }),
              t
            );
          })(e);
        ...
        jsx: function(e) {
          return (function(e) {
            ...
            return (
              ...
              (n.jsxReadEntity = function() {
                for (
                  var e, t = '', n = 0, r = this.input[this.state.pos], i = ++this.state.pos;
                  ...
                  if (';' === (r = this.input[this.state.pos++])) {
                    '#' === t[0]
                      ? 'x' === t[1]
                        ? ((t = t.substr(2)),
                          M.test(t) && (e = String.fromCodePoint(parseInt(t, 16))))
                        : ((t = t.substr(1)),
                          j.test(t) && (e = String.fromCodePoint(parseInt(t, 10))))
                      : (e = C[t]);
                    break;
                  }
                  t += r;
              ...
              (n.jsxParseNamespacedName = function() {
                var e = this.state.start,
                  t = this.state.startLoc,
              ...
              (n.jsxParseElementName = function() {
                for (
                  var e = this.state.start,
                    t = this.state.startLoc,
              ...
              (n.jsxParseAttributeValue = function() {
                var e;
                switch (this.state.type) {
                  case u.braceL:
                    if (
                      'JSXEmptyExpression' ===
                      (e = this.jsxParseExpressionContainer()).expression.type
                    )
                      throw this.raise(
                        e.start,
              ...
              (n.jsxParseEmptyExpression = function() {
              ...
              (n.jsxParseSpreadChild = function() {
                var e = this.startNode();
                return (
                  this.expect(u.braceL),
              ...
              (n.jsxParseExpressionContainer = function() {
                var e = this.startNode();
                return (
                  this.next(),
                  this.match(u.braceR)
              ...
              (n.jsxParseAttribute = function() {
                ...
                return this.eat(u.braceL)
                  ...
                  : ((e.name = this.jsxParseNamespacedName()),
                    (e.value = this.eat(u.eq) ? this.jsxParseAttributeValue() : null),
                    this.finishNode(e, 'JSXAttribute'));
              }),
              (n.jsxParseOpeningElementAt = function(e, t) {
                var n = this.startNodeAt(e, t);
                return this.match(u.jsxTagEnd)
                  ? (this.expect(u.jsxTagEnd), this.finishNode(n, 'JSXOpeningFragment'))
                  : ((n.name = this.jsxParseElementName()),
                    this.jsxParseOpeningElementAfterName(n));
              }),
              (n.jsxParseOpeningElementAfterName = function(e) {
                for (var t = []; !this.match(u.slash) && !this.match(u.jsxTagEnd); )
              ...
              (n.jsxParseClosingElementAt = function(e, t) {
                var n = this.startNodeAt(e, t);
                return this.match(u.jsxTagEnd)
                  ? (this.expect(u.jsxTagEnd), this.finishNode(n, 'JSXClosingFragment'))
                  : ((n.name = this.jsxParseElementName()),
                    this.expect(u.jsxTagEnd),
                    this.finishNode(n, 'JSXClosingElement'));
              }),
              (n.jsxParseElementAt = function(e, t) {
                var n = this.startNodeAt(e, t),
                  r = [],
                  ...
                  e: for (;;)
                    switch (this.state.type) {
                      ...
                      case u.jsxText:
                        ...
                        break;
                      case u.braceL:
                        this.lookahead().type === u.ellipsis
                          ? r.push(this.jsxParseSpreadChild())
                          : r.push(this.jsxParseExpressionContainer());
                        break;
                      default:
                        throw this.unexpected();
                    }
                  R(i) && !R(a)
                    ? this.raise(a.start, 'Expected corresponding JSX closing tag for <>')
                    : !R(i) && R(a)
                    ? this.raise(
                        a.start,
                        'Expected corresponding JSX closing tag for <' + B(i.name) + '>',
                      )
                    : R(i) ||
                      R(a) ||
                      (B(a.name) !== B(i.name) &&
                ...
                return (
                  R(i)
                    ? ((n.openingFragment = i), (n.closingFragment = a))
                    : ((n.openingElement = i), (n.closingElement = a)),
                  (n.children = r),
                  ...
                  R(i) ? this.finishNode(n, 'JSXFragment') : this.finishNode(n, 'JSXElement')
                );
              }),
              (n.jsxParseElement = function() {
                var e = this.state.start,
                  t = this.state.startLoc;
              ...
              (n.readToken = function(t) {
                if (this.state.inPropertyName) return e.prototype.readToken.call(this, t);
                var n = this.curContext();
                if (n === F.j_expr) return this.jsxReadToken();
                if (n === F.j_oTag || n === F.j_cTag) {
                  if (b(t)) return this.jsxReadWord();
                  if (62 === t) return ++this.state.pos, this.finishToken(u.jsxTagEnd);
                  if ((34 === t || 39 === t) && n === F.j_oTag) return this.jsxReadString(t);
                }
                return 60 === t && this.state.exprAllowed
                  ? (++this.state.pos, this.finishToken(u.jsxTagStart))
                  : e.prototype.readToken.call(this, t);
              }),
              (n.updateContext = function(t) {
                if (this.match(u.braceL)) {
                  var n = this.curContext();
                  n === F.j_oTag
                    ? this.state.context.push(F.braceExpression)
                    : n === F.j_expr
                    ? this.state.context.push(F.templateQuasi)
                    : e.prototype.updateContext.call(this, t),
                    (this.state.exprAllowed = !0);
                } else {
                  if (!this.match(u.slash) || t !== u.jsxTagStart)
                    return e.prototype.updateContext.call(this, t);
                  (this.state.context.length -= 2),
                    this.state.context.push(F.j_cTag),
                    (this.state.exprAllowed = !1);
                }
              }),
              t
        ...
        flow: function(e) {
          return (function(e) {
            function t(t, n) {
              var r;
              return ((r = e.call(this, t, n) || this).flowPragma = void 0), r;
            }
            i(t, e);
            var n = t.prototype;
            return (
              (n.shouldParseTypes = function() {
                return this.getPluginOption('flow', 'all') || 'flow' === this.flowPragma;
              }),
              (n.addComment = function(t) {
                if (void 0 === this.flowPragma) {
                  var n = N.exec(t.value);
                  if (n)
                    if ('flow' === n[1]) this.flowPragma = 'flow';
                    else {
                      if ('noflow' !== n[1]) throw new Error('Unexpected flow pragma');
                      this.flowPragma = 'noflow';
                    }
                  else this.flowPragma = null;
                }
                return e.prototype.addComment.call(this, t);
              }),
              (n.flowParseTypeInitialiser = function(e) {
              ...
              (n.flowParsePredicate = function() {
                ...
                return (
                  ...
                  (t.line === r.line && t.column === r.column - 1) ||
                    this.raise(n, 'Spaces between ´%´ and ´checks´ are not allowed here.'),
                  this.eat(u.parenL)
              ...
              (n.flowParseTypeAndPredicateInitialiser = function() {
                ...
                return (
                  this.match(u.modulo)
                    ...
                    : ((t = this.flowParseType()),
                      (this.state.inType = e),
                      this.match(u.modulo) && (n = this.flowParsePredicate())),
                  [t, n]
                );
              }),
              (n.flowParseDeclareClass = function(e) {
                return (
                  this.next(), this.flowParseInterfaceish(e, !0), this.finishNode(e, 'DeclareClass')
                );
              }),
              (n.flowParseDeclareFunction = function(e) {
                this.next();
              ...
              (n.flowParseDeclare = function(e, t) {
              ...
              (n.flowParseDeclareVariable = function(e) {
                return (
                  this.next(),
              ...
              (n.flowParseDeclareModule = function(e) {
                var t = this;
                this.next(),
                  this.match(u.string)
                ...
                this.expect(u.braceR), this.finishNode(n, 'BlockStatement');
                var s = null,
                  o = !1,
                  l =
                  ...
                  r.forEach(function(e) {
                    !(function(e) {
                      ...
                      ? 'DeclareModuleExports' === e.type &&
                        (o && t.unexpected(e.start, 'Duplicate `declare module.exports` statement'),
                        'ES' === s && t.unexpected(e.start, l),
                        (s = 'CommonJS'),
                        (o = !0))
                      : ('CommonJS' === s && t.unexpected(e.start, l), (s = 'ES'));
                  }),
                  (e.kind = s || 'CommonJS'),
                  this.finishNode(e, 'DeclareModule')
                );
              }),
              (n.flowParseDeclareExportDeclaration = function(e, t) {
                ...
                if (
                  this.match(u._const) ||
                  this.match(u._let) ||
                  ((this.isContextual('type') || this.isContextual('interface')) && !t)
                ) {
                  var n = this.state.value,
                    r = k[n];
                  this.unexpected(
                    this.state.start,
                    '`declare export ' + n + '` is not supported. Use `' + r + '` instead',
                  );
                }
                if (
                  this.match(u._var) ||
              ...
              (n.flowParseDeclareModuleExports = function(e) {
                return (
              ...
              (n.flowParseDeclareTypeAlias = function(e) {
                return (
                  this.next(), this.flowParseTypeAlias(e), this.finishNode(e, 'DeclareTypeAlias')
                );
              }),
              (n.flowParseDeclareOpaqueType = function(e) {
                return (
                  this.next(),
              ...
              (n.flowParseDeclareInterface = function(e) {
                return (
                  this.next(), this.flowParseInterfaceish(e), this.finishNode(e, 'DeclareInterface')
                );
              }),
              (n.flowParseInterfaceish = function(e, t) {
                if (
                  (void 0 === t && (t = !1),
              ...
              (n.flowParseInterfaceExtends = function() {
                var e = this.startNode();
                return (
              ...
              (n.flowParseInterface = function(e) {
                return this.flowParseInterfaceish(e), this.finishNode(e, 'InterfaceDeclaration');
              }),
              (n.checkReservedType = function(e, t) {
                P.indexOf(e) > -1 && this.raise(t, 'Cannot overwrite primitive type ' + e);
              }),
              (n.flowParseRestrictedIdentifier = function(e) {
                return (
                  this.checkReservedType(this.state.value, this.state.start),
                  this.parseIdentifier(e)
                );
              }),
              (n.flowParseTypeAlias = function(e) {
                return (
              ...
              (n.flowParseOpaqueType = function(e, t) {
                return (
                  ...
                  this.isRelational('<')
                    ...
                    : (e.typeParameters = null),
                  (e.supertype = null),
                  this.match(u.colon) && (e.supertype = this.flowParseTypeInitialiser(u.colon)),
                  (e.impltype = null),
              ...
              (n.flowParseTypeParameter = function(e, t) {
              ...
              (n.flowParseTypeParameterDeclaration = function(e) {
                void 0 === e && (e = !0);
                var t = this.state.inType,
                  n = this.startNode();
                (n.params = []),
                ...
                var r = !1;
                do {
                  var i = this.flowParseTypeParameter(e, r);
                  n.params.push(i),
                    i.default && (r = !0),
              ...
              (n.flowParseTypeParameterInstantiation = function() {
                var e = this.startNode(),
                  t = this.state.inType;
                for (
              ...
              (n.flowParseInterfaceType = function() {
                var e = this.startNode();
              ...
              (n.flowParseObjectPropertyKey = function() {
                return this.match(u.num) || this.match(u.string)
                  ? this.parseExprAtom()
                  : this.parseIdentifier(!0);
              }),
              (n.flowParseObjectTypeIndexer = function(e, t, n) {
                return (
                  (e.static = t),
              ...
              (n.flowParseObjectTypeInternalSlot = function(e, t) {
                return (
                  (e.static = t),
                  (e.id = this.flowParseObjectPropertyKey()),
                  this.expect(u.bracketR),
              ...
              (n.flowParseObjectTypeMethodish = function(e) {
                for (
                  e.params = [],
                    e.rest = null,
                    e.typeParameters = null,
                    this.isRelational('<') &&
                      (e.typeParameters = this.flowParseTypeParameterDeclaration(!1)),
                    this.expect(u.parenL);
                ...
                return (
                  this.eat(u.ellipsis) && (e.rest = this.flowParseFunctionTypeParam()),
                  this.expect(u.parenR),
                  (e.returnType = this.flowParseTypeInitialiser()),
                  this.finishNode(e, 'FunctionTypeAnnotation')
                );
              }),
              (n.flowParseObjectTypeCallProperty = function(e, t) {
                var n = this.startNode();
                return (
                  (e.static = t),
              ...
              (n.flowParseObjectType = function(e, t, n, r) {
                ...
                for (
                  o.callProperties = [],
                    ...
                    t && this.match(u.braceBarL)
                      ? (this.expect(u.braceBarL), (a = u.braceBarR), (s = !0))
                      : (this.expect(u.braceL), (a = u.braceR), (s = !1)),
                    o.exact = s;
                  !this.match(a);
                  ...
                  if (r && this.isContextual('proto')) {
                    ...
                    f.type !== u.colon &&
                      f.type !== u.question &&
                      (this.next(), (c = this.state.start), (e = !1));
                  }
                  if (e && this.isContextual('static')) {
                    var d = this.lookahead();
                    d.type !== u.colon && d.type !== u.question && (this.next(), (l = !0));
                  }
                  var h = this.flowParseVariance();
                  if (this.eat(u.bracketL))
                    null != c && this.unexpected(c),
                      this.eat(u.bracketL)
                        ? (h && this.unexpected(h.start),
                          o.internalSlots.push(this.flowParseObjectTypeInternalSlot(p, l)))
                        : o.indexers.push(this.flowParseObjectTypeIndexer(p, l, h));
                  else if (this.match(u.parenL) || this.isRelational('<'))
                    null != c && this.unexpected(c),
                      h && this.unexpected(h.start),
                      o.callProperties.push(this.flowParseObjectTypeCallProperty(p, l));
                  else {
                    var m = 'init';
                    if (this.isContextual('get') || this.isContextual('set')) {
                      var y = this.lookahead();
                      (y.type !== u.name && y.type !== u.string && y.type !== u.num) ||
                        ((m = this.state.value), this.next());
                    }
                    o.properties.push(this.flowParseObjectTypeProperty(p, l, c, h, m, n));
                  }
                  this.flowObjectTypeSemicolon();
                }
                this.expect(a);
                var v = this.finishNode(o, 'ObjectTypeAnnotation');
                return (this.state.inType = i), v;
              }),
              (n.flowParseObjectTypeProperty = function(e, t, n, r, i, a) {
                if (this.match(u.ellipsis))
                  return (
                    a ||
                      this.unexpected(
                    ...
                    r && this.unexpected(r.start, 'Spread properties cannot have variance'),
                    this.expect(u.ellipsis),
              ...
              (n.flowCheckGetterSetterParams = function(e) {
                var t = 'get' === e.kind ? 0 : 1,
                  n = e.start;
              ...
              (n.flowObjectTypeSemicolon = function() {
                this.eat(u.semi) ||
                  this.eat(u.comma) ||
                  this.match(u.braceR) ||
              ...
              (n.flowParseQualifiedTypeIdentifier = function(e, t, n) {
                (e = e || this.state.start), (t = t || this.state.startLoc);
                for (var r = n || this.parseIdentifier(); this.eat(u.dot); ) {
              ...
              (n.flowParseGenericType = function(e, t, n) {
                var r = this.startNodeAt(e, t);
                return (
              ...
              (n.flowParseTypeofType = function() {
                var e = this.startNode();
                return (
              ...
              (n.flowParseTupleType = function() {
                var e = this.startNode();
                for (
                  e.types = [], this.expect(u.bracketL);
                  this.state.pos < this.input.length &&
                  !this.match(u.bracketR) &&
                  (e.types.push(this.flowParseType()), !this.match(u.bracketR));

                )
                  this.expect(u.comma);
                return this.expect(u.bracketR), this.finishNode(e, 'TupleTypeAnnotation');
              }),
              (n.flowParseFunctionTypeParam = function() {
                var e = null,
                  t = !1,
                  n = null,
                  r = this.startNode(),
              ...
              (n.reinterpretTypeAsFunctionTypeParam = function(e) {
              ...
              (n.flowParseFunctionTypeParams = function(e) {
                void 0 === e && (e = []);
                for (var t = null; !this.match(u.parenR) && !this.match(u.ellipsis); )
                  e.push(this.flowParseFunctionTypeParam()),
                    this.match(u.parenR) || this.expect(u.comma);
                return (
                  this.eat(u.ellipsis) && (t = this.flowParseFunctionTypeParam()),
                  { params: e, rest: t }
                );
              }),
              (n.flowIdentToTypeAnnotation = function(e, t, n, r) {
                switch (r.name) {
                  case 'any':
              ...
              (n.flowParsePrimaryType = function() {
                var e,
                  t,
                  n = this.state.start,
                  r = this.state.startLoc,
                ...
                switch (this.state.type) {
                  case u.name:
                    return this.isContextual('interface')
                      ...
                      : this.flowIdentToTypeAnnotation(n, r, i, this.parseIdentifier());
                  case u.braceL:
                  ...
                  case u.relational:
                    if ('<' === this.state.value)
                      return (
                        (i.typeParameters = this.flowParseTypeParameterDeclaration(!1)),
                        this.expect(u.parenL),
                    ...
                    if (a) {
                      if (
                        ...
                        this.state.noAnonFunctionType ||
                          !(
                            this.match(u.comma) ||
                            (this.match(u.parenR) && this.lookahead().type === u.arrow)
                          ))
                      )
              ...
              (n.flowParsePostfixType = function() {
                for (
                  var e = this.state.start,
                    t = this.state.startLoc,
                    n = this.flowParsePrimaryType();
                  !this.canInsertSemicolon() && this.match(u.bracketL);
              ...
              (n.flowParsePrefixType = function() {
                var e = this.startNode();
              ...
              (n.flowParseAnonFunctionWithoutParens = function() {
              ...
              (n.flowParseIntersectionType = function() {
                var e = this.startNode();
              ...
              (n.flowParseTypeAnnotation = function() {
                var e = this.startNode();
                return (
              ...
              (n.flowParseTypeAnnotatableIdentifier = function(e) {
              ...
              (n.typeCastToParameter = function(e) {
                return (
              ...
              (n.parseFunctionBody = function(t, n) {
                var r = this;
                return n
                  ? this.forwardNoArrowParamsConversionAt(t, function() {
                      return e.prototype.parseFunctionBody.call(r, t, !0);
                    })
                  : e.prototype.parseFunctionBody.call(this, t, !1);
              }),
              (n.parseFunctionBodyAndFinish = function(t, n, r) {
                if (!r && this.match(u.colon)) {
                  var i = this.startNode(),
                    a = this.flowParseTypeAndPredicateInitialiser();
                  (i.typeAnnotation = a[0]),
                    (t.predicate = a[1]),
                    (t.returnType = i.typeAnnotation ? this.finishNode(i, 'TypeAnnotation') : null);
                }
                e.prototype.parseFunctionBodyAndFinish.call(this, t, n, r);
              }),
              (n.parseStatement = function(t, n) {
                if (this.state.strict && this.match(u.name) && 'interface' === this.state.value) {
                  var r = this.startNode();
                  return this.next(), this.flowParseInterface(r);
                }
                var i = e.prototype.parseStatement.call(this, t, n);
                return (
              ...
              (n.parseExpressionStatement = function(t, n) {
                ...
                return e.prototype.parseExpressionStatement.call(this, t, n);
              }),
              (n.shouldParseExportDeclaration = function() {
                return (
                  this.isContextual('type') ||
              ...
              (n.parseConditional = function(t, n, r, i, a) {
                var s = this;
                if (!this.match(u.question)) return t;
                if (a) {
                  var o = this.state.clone();
                  try {
                    return e.prototype.parseConditional.call(this, t, n, r, i);
                  } catch (e) {
                    if (e instanceof SyntaxError)
                      return (this.state = o), (a.start = e.pos || this.state.start), t;
                    throw e;
                  }
                }
                ...
                var l = this.state.clone(),
                  ...
                  p = this.startNodeAt(r, i),
                  f = this.tryParseConditionalConsequent(),
                  d = f.consequent,
                  h = f.failed,
                ...
                if (h || v.length > 0) {
                  var T = c.concat();
                  if (v.length > 0) {
                    (this.state = l), (this.state.noArrowAt = T);
                    for (var g = 0; g < v.length; g++) T.push(v[g].start);
                    var S = this.tryParseConditionalConsequent();
                    (d = S.consequent), (h = S.failed);
                    var x = this.getArrowLikeExpressions(d);
                    (y = x[0]), (v = x[1]);
                  }
                  if (
                    (h &&
                    ...
                    (this.state = l), (this.state.noArrowAt = T.concat(y[0].start));
                    var b = this.tryParseConditionalConsequent();
                    (d = b.consequent), (h = b.failed);
                  }
                  this.getArrowLikeExpressions(d, !0);
                }
                return (
                  (this.state.noArrowAt = c),
                  this.expect(u.colon),
                  (p.test = t),
                  (p.consequent = d),
                  (p.alternate = this.forwardNoArrowParamsConversionAt(p, function() {
                    return s.parseMaybeAssign(n, void 0, void 0, void 0);
                  })),
                  this.finishNode(p, 'ConditionalExpression')
                );
              }),
              (n.tryParseConditionalConsequent = function() {
              ...
              (n.getArrowLikeExpressions = function(t, n) {
                for (var r = this, i = [t], a = []; 0 !== i.length; ) {
                  var s = i.pop();
                  'ArrowFunctionExpression' === s.type
                    ? (s.typeParameters || !s.returnType
                        ? (this.toAssignableList(s.params, !0, 'arrow function parameters'),
                          e.prototype.checkFunctionNameAndParams.call(this, s, !0))
                        : a.push(s),
                      i.push(s.body))
                    : 'ConditionalExpression' === s.type &&
                      (i.push(s.consequent), i.push(s.alternate));
                }
                if (n) {
                  for (var o = 0; o < a.length; o++)
                    this.toAssignableList(t.params, !0, 'arrow function parameters');
                  return [a, []];
                }
                return (function(e, t) {
                  for (var n = [], r = [], i = 0; i < e.length; i++)
                  ...
                  try {
                    return r.toAssignableList(e.params, !0, 'arrow function parameters'), !0;
                  } catch (e) {
                    return !1;
                  }
                });
              }),
              (n.forwardNoArrowParamsConversionAt = function(e, t) {
                var n;
                return (
              ...
              (n.parseParenItem = function(t, n, r) {
                if (
                  ((t = e.prototype.parseParenItem.call(this, t, n, r)),
                  this.eat(u.question) && (t.optional = !0),
                  this.match(u.colon))
                ) {
                  var i = this.startNodeAt(n, r);
                  return (
              ...
              (n.assertModuleNodeAllowed = function(t) {
                ('ImportDeclaration' === t.type &&
                  ...
                  e.prototype.assertModuleNodeAllowed.call(this, t);
              }),
              (n.parseExport = function(t) {
                return (
                  ('ExportNamedDeclaration' !== (t = e.prototype.parseExport.call(this, t)).type &&
                    'ExportAllDeclaration' !== t.type) ||
                    (t.exportKind = t.exportKind || 'value'),
                  t
                );
              }),
              (n.parseExportDeclaration = function(t) {
                ...
                return e.prototype.parseExportDeclaration.call(this, t);
              }),
              (n.shouldParseExportStar = function() {
                return (
                  e.prototype.shouldParseExportStar.call(this) ||
                  (this.isContextual('type') && this.lookahead().type === u.star)
                );
              }),
              (n.parseExportStar = function(t) {
                return (
                  this.eatContextual('type') && (t.exportKind = 'type'),
                  e.prototype.parseExportStar.call(this, t)
                );
              }),
              (n.parseExportNamespace = function(t) {
                return (
                  'type' === t.exportKind && this.unexpected(),
                  e.prototype.parseExportNamespace.call(this, t)
                );
              }),
              (n.parseClassId = function(t, n, r) {
                e.prototype.parseClassId.call(this, t, n, r),
                  this.isRelational('<') &&
                    (t.typeParameters = this.flowParseTypeParameterDeclaration());
              }),
              (n.isKeyword = function(t) {
                return (!this.state.inType || 'void' !== t) && e.prototype.isKeyword.call(this, t);
              }),
              (n.readToken = function(t) {
                var n = this.input.charCodeAt(this.state.pos + 1);
                return !this.state.inType || (62 !== t && 60 !== t)
                  ? (function(e, t) {
                      return 64 === e && 64 === t;
                    })(t, n)
                    ? ((this.state.isIterator = !0), e.prototype.readWord.call(this))
                    : e.prototype.readToken.call(this, t)
                  : this.finishOp(u.relational, 1);
              }),
              (n.toAssignable = function(t, n, r) {
                return 'TypeCastExpression' === t.type
                  ? e.prototype.toAssignable.call(this, this.typeCastToParameter(t), n, r)
                  : e.prototype.toAssignable.call(this, t, n, r);
              }),
              (n.toAssignableList = function(t, n, r) {
                for (var i = 0; i < t.length; i++) {
                  var a = t[i];
                  a && 'TypeCastExpression' === a.type && (t[i] = this.typeCastToParameter(a));
                }
                return e.prototype.toAssignableList.call(this, t, n, r);
              }),
              (n.toReferencedList = function(e) {
              ...
              (n.parseExprListItem = function(t, n, r) {
                var i = this.startNode(),
                  a = e.prototype.parseExprListItem.call(this, t, n, r);
              ...
              (n.checkLVal = function(t, n, r, i) {
                if ('TypeCastExpression' !== t.type)
                  return e.prototype.checkLVal.call(this, t, n, r, i);
              }),
              (n.parseClassProperty = function(t) {
                return (
                  this.match(u.colon) && (t.typeAnnotation = this.flowParseTypeAnnotation()),
                  e.prototype.parseClassProperty.call(this, t)
                );
              }),
              (n.parseClassPrivateProperty = function(t) {
                return (
                  this.match(u.colon) && (t.typeAnnotation = this.flowParseTypeAnnotation()),
                  e.prototype.parseClassPrivateProperty.call(this, t)
                );
              }),
              (n.isClassMethod = function() {
                return this.isRelational('<') || e.prototype.isClassMethod.call(this);
              }),
              (n.isClassProperty = function() {
                return this.match(u.colon) || e.prototype.isClassProperty.call(this);
              }),
              (n.isNonstaticConstructor = function(t) {
                return !this.match(u.colon) && e.prototype.isNonstaticConstructor.call(this, t);
              }),
              (n.pushClassMethod = function(t, n, r, i, a) {
                n.variance && this.unexpected(n.variance.start),
                  delete n.variance,
                  this.isRelational('<') &&
                    (n.typeParameters = this.flowParseTypeParameterDeclaration(!1)),
                  e.prototype.pushClassMethod.call(this, t, n, r, i, a);
              }),
              (n.pushClassPrivateMethod = function(t, n, r, i) {
                n.variance && this.unexpected(n.variance.start),
                  delete n.variance,
                  this.isRelational('<') &&
                    (n.typeParameters = this.flowParseTypeParameterDeclaration()),
                  e.prototype.pushClassPrivateMethod.call(this, t, n, r, i);
              }),
              (n.parseClassSuper = function(t) {
                if (
                  (e.prototype.parseClassSuper.call(this, t),
                  t.superClass &&
                    this.isRelational('<') &&
                  ...
                  do {
                    ...
                    (r.id = this.flowParseRestrictedIdentifier(!0)),
                      this.isRelational('<')
                        ? (r.typeParameters = this.flowParseTypeParameterInstantiation())
                        : (r.typeParameters = null),
                      n.push(this.finishNode(r, 'ClassImplements'));
                  } while (this.eat(u.comma));
                }
              }),
              (n.parsePropertyName = function(t) {
                var n = this.flowParseVariance(),
                  r = e.prototype.parsePropertyName.call(this, t);
                return (t.variance = n), r;
              }),
              (n.parseObjPropValue = function(t, n, r, i, a, s, o, l) {
                var c;
                t.variance && this.unexpected(t.variance.start),
                  delete t.variance,
                  this.isRelational('<') &&
                    ((c = this.flowParseTypeParameterDeclaration(!1)),
                    this.match(u.parenL) || this.unexpected()),
                  e.prototype.parseObjPropValue.call(this, t, n, r, i, a, s, o, l),
              ...
              (n.parseAssignableListItemTypes = function(e) {
                ...
                return (
                  this.match(u.colon) && (e.typeAnnotation = this.flowParseTypeAnnotation()),
                  this.finishNode(e, e.type),
                  e
                );
              }),
              (n.parseMaybeDefault = function(t, n, r) {
              ...
              (n.shouldParseDefaultImport = function(t) {
                return A(t) ? w(this.state) : e.prototype.shouldParseDefaultImport.call(this, t);
              }),
              (n.parseImportSpecifierLocal = function(e, t, n, r) {
                (t.local = A(e) ? this.flowParseRestrictedIdentifier(!0) : this.parseIdentifier()),
                  this.checkLVal(t.local, !0, void 0, r),
                  e.specifiers.push(this.finishNode(t, n));
              }),
              (n.parseImportSpecifiers = function(t) {
                t.importKind = 'value';
                var n = null;
                if (
                  (this.match(u._typeof)
                    ? (n = 'typeof')
                    : this.isContextual('type') && (n = 'type'),
                  n)
                ) {
                  var r = this.lookahead();
                  'type' === n && r.type === u.star && this.unexpected(r.start),
                    (w(r) || r.type === u.braceL || r.type === u.star) &&
                      (this.next(), (t.importKind = n));
                }
                e.prototype.parseImportSpecifiers.call(this, t);
              }),
              (n.parseImportSpecifier = function(e) {
                var t = this.startNode(),
                  n = this.state.start,
                ...
                if (this.isContextual('as') && !this.isLookaheadContextual('as')) {
                  ...
                  null === i || this.match(u.name) || this.state.type.keyword
                    ? ((t.imported = r), (t.importKind = null), (t.local = this.parseIdentifier()))
                    : ((t.imported = s), (t.importKind = i), (t.local = s.__clone()));
                } else
                  null !== i && (this.match(u.name) || this.state.type.keyword)
                    ? ((t.imported = this.parseIdentifier(!0)),
                      (t.importKind = i),
                      this.eatContextual('as')
                        ? (t.local = this.parseIdentifier())
                        : ((a = !0), (t.local = t.imported.__clone())))
                    : ((a = !0),
                      (t.imported = r),
                      (t.importKind = null),
                      (t.local = t.imported.__clone()));
                ...
                o &&
                  ...
                  (o || l) && this.checkReservedType(t.local.name, t.local.start),
                  !a || o || l || this.checkReservedWord(t.local.name, t.start, !0, !0),
                  this.checkLVal(t.local, !0, void 0, 'import specifier'),
                  e.specifiers.push(this.finishNode(t, 'ImportSpecifier'));
              }),
              (n.parseFunctionParams = function(t) {
                var n = t.kind;
                'get' !== n &&
                  'set' !== n &&
                  this.isRelational('<') &&
                  (t.typeParameters = this.flowParseTypeParameterDeclaration(!1)),
                  e.prototype.parseFunctionParams.call(this, t);
              }),
              (n.parseVarHead = function(t) {
                e.prototype.parseVarHead.call(this, t),
                  this.match(u.colon) &&
                    ((t.id.typeAnnotation = this.flowParseTypeAnnotation()),
                    this.finishNode(t.id, t.id.type));
              }),
              (n.parseAsyncArrowFromCallExpression = function(t, n) {
                ...
                return e.prototype.parseAsyncArrowFromCallExpression.call(this, t, n);
              }),
              (n.shouldParseAsyncArrow = function() {
                return this.match(u.colon) || e.prototype.shouldParseAsyncArrow.call(this);
              }),
              (n.parseMaybeAssign = function(t, n, r, i) {
                var a = this,
                  s = null;
                if (u.jsxTagStart && this.match(u.jsxTagStart)) {
                  var o = this.state.clone();
                  try {
                    return e.prototype.parseMaybeAssign.call(this, t, n, r, i);
                  } catch (e) {
                    if (!(e instanceof SyntaxError)) throw e;
                    (this.state = o), (this.state.context.length -= 2), (s = e);
                  }
                }
                if (null != s || this.isRelational('<')) {
                  var l, c;
                  try {
                    (c = this.flowParseTypeParameterDeclaration()),
                      ((l = this.forwardNoArrowParamsConversionAt(c, function() {
                        return e.prototype.parseMaybeAssign.call(a, t, n, r, i);
                      })).typeParameters = c),
                      this.resetStartLocationFromNode(l, c);
                  } catch (e) {
                    throw s || e;
                  }
                  if ('ArrowFunctionExpression' === l.type) return l;
                  if (null != s) throw s;
                  this.raise(
                    c.start,
              ...
              (n.parseArrow = function(t) {
                ...
                return e.prototype.parseArrow.call(this, t);
              }),
              (n.shouldParseArrow = function() {
                return this.match(u.colon) || e.prototype.shouldParseArrow.call(this);
              }),
              (n.setArrowFunctionParameters = function(t, n) {
                -1 !== this.state.noArrowParamsConversionAt.indexOf(t.start)
                  ? (t.params = n)
                  : e.prototype.setArrowFunctionParameters.call(this, t, n);
              }),
              (n.checkFunctionNameAndParams = function(t, n) {
                if (!n || -1 === this.state.noArrowParamsConversionAt.indexOf(t.start))
                  return e.prototype.checkFunctionNameAndParams.call(this, t, n);
              }),
              (n.parseParenAndDistinguishExpression = function(t) {
                return e.prototype.parseParenAndDistinguishExpression.call(
                  this,
                  t && -1 === this.state.noArrowAt.indexOf(this.state.start),
                );
              }),
              (n.parseSubscripts = function(t, n, r, i) {
                if (
                  'Identifier' === t.type &&
                  'async' === t.name &&
                  -1 !== this.state.noArrowAt.indexOf(n)
                ) {
                  this.next();
                  var a = this.startNodeAt(n, r);
                  (a.callee = t),
                  ...
                  var s,
                    o = this.state.clone();
                  try {
                    var l = this.parseAsyncArrowWithTypeParameters(n, r);
                    if (l) return l;
                  } catch (e) {
                    s = e;
                  }
                  this.state = o;
                  try {
                    return e.prototype.parseSubscripts.call(this, t, n, r, i);
                  } catch (e) {
                    throw s || e;
                  }
                }
              ...
              (n.parseSubscript = function(t, n, r, i, a) {
                if (this.match(u.questionDot) && this.isLookaheadRelational('<')) {
                  if ((this.expectPlugin('optionalChaining'), (a.optionalChainMember = !0), i))
                    return (a.stop = !0), t;
                  this.next();
                  ...
                  return (
                    ...
                    this.expect(u.parenL),
                    (s.arguments = this.parseCallExpressionArguments(u.parenR, !1)),
                    (s.optional = !0),
                    this.finishNode(s, 'OptionalCallExpression')
                  );
                }
                if (!i && this.shouldParseTypes() && this.isRelational('<')) {
                  ...
                  try {
                    return (
                      ...
                      this.expect(u.parenL),
                      (o.arguments = this.parseCallExpressionArguments(u.parenR, !1)),
                      a.optionalChainMember
                        ? ((o.optional = !1), this.finishNode(o, 'OptionalCallExpression'))
                ...
                return e.prototype.parseSubscript.call(this, t, n, r, i, a);
              }),
              (n.parseNewArguments = function(t) {
                var n = null;
                if (this.shouldParseTypes() && this.isRelational('<')) {
                  var r = this.state.clone();
                  try {
                    n = this.flowParseTypeParameterInstantiation();
                  } catch (e) {
                    if (!(e instanceof SyntaxError)) throw e;
                    this.state = r;
                  }
                }
                (t.typeArguments = n), e.prototype.parseNewArguments.call(this, t);
              }),
              (n.parseAsyncArrowWithTypeParameters = function(e, t) {
                var n = this.startNodeAt(e, t);
                if ((this.parseFunctionParams(n), this.parseArrow(n)))
                  return this.parseArrowExpression(n, void 0, !0);
              }),
              (n.readToken_mult_modulo = function(t) {
                var n = this.input.charCodeAt(this.state.pos + 1);
                if (42 === t && 47 === n && this.state.hasFlowComment)
                  return (
                    (this.state.hasFlowComment = !1), (this.state.pos += 2), void this.nextToken()
                  );
                e.prototype.readToken_mult_modulo.call(this, t);
              }),
              (n.skipBlockComment = function() {
        ...
        typescript: function(e) {
          return (function(e) {
            ...
            var n = t.prototype;
            return (
              (n.tsIsIdentifier = function() {
                return this.match(u.name);
              }),
              (n.tsNextTokenCanFollowModifier = function() {
                return (
                  this.next(),
                  !(
              ...
              (n.tsIsListTerminator = function(e) {
                switch (e) {
                  case 'EnumMembers':
                  case 'TypeMembers':
              ...
              (n.tsParseList = function(e, t) {
                for (var n = []; !this.tsIsListTerminator(e); ) n.push(t());
                return n;
              }),
              (n.tsParseDelimitedList = function(e, t) {
                return ne(this.tsParseDelimitedListWorker(e, t, !0));
              }),
              (n.tsTryParseDelimitedList = function(e, t) {
                return this.tsParseDelimitedListWorker(e, t, !1);
              }),
              (n.tsParseDelimitedListWorker = function(e, t, n) {
                for (var r = []; !this.tsIsListTerminator(e); ) {
                  var i = t();
                  if (null == i) return;
              ...
              (n.tsParseBracketedList = function(e, t, n, r) {
                r || (n ? this.expect(u.bracketL) : this.expectRelational('<'));
                var i = this.tsParseDelimitedList(e, t);
                return n ? this.expect(u.bracketR) : this.expectRelational('>'), i;
              }),
              (n.tsParseEntityName = function(e) {
                for (var t = this.parseIdentifier(); this.eat(u.dot); ) {
              ...
              (n.tsParseTypeReference = function() {
                var e = this.startNode();
                return (
              ...
              (n.tsParseThisTypePredicate = function(e) {
                this.next();
                var t = this.startNode();
                return (
                  (t.parameterName = e),
              ...
              (n.tsParseThisTypeNode = function() {
                var e = this.startNode();
                return this.next(), this.finishNode(e, 'TSThisType');
              }),
              (n.tsParseTypeQuery = function() {
                var e = this.startNode();
                return (
                  this.expect(u._typeof),
              ...
              (n.tsParseTypeParameter = function() {
                var e = this.startNode();
                return (
              ...
              (n.tsTryParseTypeParameters = function() {
                if (this.isRelational('<')) return this.tsParseTypeParameters();
              }),
              (n.tsParseTypeParameters = function() {
                var e = this.startNode();
                return (
                  this.isRelational('<') || this.match(u.jsxTagStart)
                    ? this.next()
              ...
              (n.tsFillSignature = function(e, t) {
                var n = e === u.arrow;
              ...
              (n.tsParseBindingListForSignature = function() {
                var e = this;
                return this.parseBindingList(u.parenR).map(function(t) {
                  if ('Identifier' !== t.type && 'RestElement' !== t.type)
                    throw e.unexpected(t.start, 'Name in a signature must be an Identifier.');
                  return t;
                });
              }),
              (n.tsParseTypeMemberSemicolon = function() {
                this.eat(u.comma) || this.semicolon();
              }),
              (n.tsParseSignatureMember = function(e) {
                var t = this.startNode();
                return (
                  'TSConstructSignatureDeclaration' === e && this.expect(u._new),
                  this.tsFillSignature(u.colon, t),
                  this.tsParseTypeMemberSemicolon(),
                  this.finishNode(t, e)
                );
              }),
              (n.tsIsUnambiguouslyIndexSignature = function() {
                return this.next(), this.eat(u.name) && this.match(u.colon);
              }),
              (n.tsTryParseIndexSignature = function(e) {
                if (
                  this.match(u.bracketL) &&
              ...
              (n.tsParsePropertyOrMethodSignature = function(e, t) {
                this.parsePropertyName(e), this.eat(u.question) && (e.optional = !0);
                var n = e;
                ...
                var a = n;
                return (
                  this.tsFillSignature(u.colon, a),
                  this.tsParseTypeMemberSemicolon(),
                  this.finishNode(a, 'TSMethodSignature')
                );
              }),
              (n.tsParseTypeMember = function() {
              ...
              (n.tsIsStartOfConstructSignature = function() {
                return this.next(), this.match(u.parenL) || this.isRelational('<');
              }),
              (n.tsParseTypeLiteral = function() {
                var e = this.startNode();
                return (
                  (e.members = this.tsParseObjectTypeMembers()), this.finishNode(e, 'TSTypeLiteral')
                );
              }),
              (n.tsParseObjectTypeMembers = function() {
                this.expect(u.braceL);
                var e = this.tsParseList('TypeMembers', this.tsParseTypeMember.bind(this));
                return this.expect(u.braceR), e;
              }),
              (n.tsIsStartOfMappedType = function() {
                return (
                  this.next(),
                  this.eat(u.plusMin)
                    ...
                    : (this.isContextual('readonly') && this.next(),
                      !!this.match(u.bracketL) &&
                        (this.next(), !!this.tsIsIdentifier() && (this.next(), this.match(u._in))))
                );
              }),
              (n.tsParseMappedTypeParameter = function() {
                var e = this.startNode();
                return (
                  (e.name = this.parseIdentifierName(e.start)),
              ...
              (n.tsParseMappedType = function() {
                ...
                return (
                  ...
                  this.expect(u.bracketR),
                  this.match(u.plusMin)
                    ? ((e.optional = this.state.value), this.next(), this.expect(u.question))
                    : this.eat(u.question) && (e.optional = !0),
              ...
              (n.tsParseParenthesizedType = function() {
                var e = this.startNode();
                return (
                  this.expect(u.parenL),
              ...
              (n.tsParseFunctionOrConstructorType = function(e) {
                var t = this.startNode();
                return (
              ...
              (n.tsParseLiteralTypeNode = function() {
                var e = this,
                  t = this.startNode();
                return (
                  (t.literal = (function() {
                    switch (e.state.type) {
                      case u.num:
                        return e.parseLiteral(e.state.value, 'NumericLiteral');
                      case u.string:
                        return e.parseLiteral(e.state.value, 'StringLiteral');
                      case u._true:
                      case u._false:
              ...
              (n.tsParseNonArrayType = function() {
                switch (this.state.type) {
                  case u.name:
                  case u._void:
                  case u._null:
                    var e = this.match(u._void)
                      ? 'TSVoidKeyword'
                      : this.match(u._null)
                      ? 'TSNullKeyword'
                      : (function(e) {
                  ...
                  case u.plusMin:
                    if ('-' === this.state.value) {
                      var n = this.startNode();
                      if ((this.next(), !this.match(u.num))) throw this.unexpected();
                      return (
                  ...
                  case u._this:
                    ...
                    return this.isContextual('is') && !this.hasPrecedingLineBreak()
                      ? this.tsParseThisTypePredicate(r)
                      : r;
                  case u._typeof:
              ...
              (n.tsParseArrayTypeOrHigher = function() {
                for (
              ...
              (n.tsParseTypeOperator = function(e) {
                var t = this.startNode();
                return (
              ...
              (n.tsParseTypeOperatorOrHigher = function() {
                var e = this,
                  t = ['keyof', 'unique'].find(function(t) {
                    return e.isContextual(t);
                  });
                return t
              ...
              (n.tsParseUnionOrIntersectionType = function(e, t, n) {
                this.eat(n);
                var r = t();
                if (this.match(n)) {
                  for (var i = [r]; this.eat(n); ) i.push(t());
                  var a = this.startNodeAtNode(r);
                  (a.types = i), (r = this.finishNode(a, e));
                }
                return r;
              }),
              (n.tsParseIntersectionTypeOrHigher = function() {
              ...
              (n.tsParseUnionTypeOrHigher = function() {
                return this.tsParseUnionOrIntersectionType(
                  'TSUnionType',
              ...
              (n.tsIsStartOfFunctionType = function() {
                return (
                  !!this.isRelational('<') ||
                  (this.match(u.parenL) &&
              ...
              (n.tsSkipParameterStart = function() {
                return !((!this.match(u.name) && !this.match(u._this)) || (this.next(), 0));
              }),
              (n.tsIsUnambiguouslyStartOfFunctionType = function() {
              ...
              (n.tsParseTypeOrTypePredicateAnnotation = function(e) {
                var t = this;
                return this.tsInType(function() {
                  var n = t.startNode();
                  t.expect(e);
                  var r = t.tsIsIdentifier() && t.tsTryParse(t.tsParseTypePredicatePrefix.bind(t));
                  if (!r) return t.tsParseTypeAnnotation(!1, n);
                  var i = t.tsParseTypeAnnotation(!1),
                    a = t.startNodeAtNode(r);
                  return (
                    (a.parameterName = r),
                    (a.typeAnnotation = i),
                    (n.typeAnnotation = t.finishNode(a, 'TSTypePredicate')),
                    t.finishNode(n, 'TSTypeAnnotation')
                  );
                });
              }),
              (n.tsTryParseTypeOrTypePredicateAnnotation = function() {
                return this.match(u.colon)
                  ? this.tsParseTypeOrTypePredicateAnnotation(u.colon)
                  : void 0;
              }),
              (n.tsTryParseTypeAnnotation = function() {
                return this.match(u.colon) ? this.tsParseTypeAnnotation() : void 0;
              }),
              (n.tsTryParseType = function() {
                return this.tsEatThenParseType(u.colon);
              }),
              (n.tsParseTypePredicatePrefix = function() {
                var e = this.parseIdentifier();
                if (this.isContextual('is') && !this.hasPrecedingLineBreak()) return this.next(), e;
              }),
              (n.tsParseTypeAnnotation = function(e, t) {
                var n = this;
                return (
                  void 0 === e && (e = !0),
                  void 0 === t && (t = this.startNode()),
                  this.tsInType(function() {
                    e && n.expect(u.colon), (t.typeAnnotation = n.tsParseType());
                  }),
                  this.finishNode(t, 'TSTypeAnnotation')
                );
              }),
              (n.tsParseType = function() {
                re(this.state.inType);
              ...
              (n.tsParseNonConditionalType = function() {
              ...
              (n.tsParseTypeAssertion = function() {
                var e = this,
                  t = this.startNode();
                return (
              ...
              (n.tsParseHeritageClause = function() {
                return this.tsParseDelimitedList(
                  'HeritageClauseElement',
                  this.tsParseExpressionWithTypeArguments.bind(this),
                );
              }),
              (n.tsParseExpressionWithTypeArguments = function() {
                var e = this.startNode();
                return (
              ...
              (n.tsParseInterfaceDeclaration = function(e) {
                (e.id = this.parseIdentifier()),
                  (e.typeParameters = this.tsTryParseTypeParameters()),
                  this.eat(u._extends) && (e.extends = this.tsParseHeritageClause());
                var t = this.startNode();
                return (
              ...
              (n.tsParseTypeAliasDeclaration = function(e) {
                return (
                  (e.id = this.parseIdentifier()),
                  (e.typeParameters = this.tsTryParseTypeParameters()),
              ...
              (n.tsEatThenParseType = function(e) {
                return this.match(e) ? this.tsNextThenParseType() : void 0;
              }),
              (n.tsExpectThenParseType = function(e) {
                var t = this;
                return this.tsDoThenParseType(function() {
                  return t.expect(e);
                });
              }),
              (n.tsNextThenParseType = function() {
                var e = this;
                return this.tsDoThenParseType(function() {
                  return e.next();
                });
              }),
              (n.tsDoThenParseType = function(e) {
                var t = this;
                return this.tsInType(function() {
                  return e(), t.tsParseType();
                });
              }),
              (n.tsParseEnumMember = function() {
                var e = this.startNode();
                return (
                  (e.id = this.match(u.string)
                    ? this.parseLiteral(this.state.value, 'StringLiteral')
                    : this.parseIdentifier(!0)),
                  this.eat(u.eq) && (e.initializer = this.parseMaybeAssign()),
                  this.finishNode(e, 'TSEnumMember')
                );
              }),
              (n.tsParseEnumDeclaration = function(e, t) {
                return (
                  t && (e.const = !0),
                  (e.id = this.parseIdentifier()),
                  this.expect(u.braceL),
              ...
              (n.tsParseModuleBlock = function() {
                var e = this.startNode();
                return (
                  this.expect(u.braceL),
                  this.parseBlockOrModuleBlockBody((e.body = []), void 0, !0, u.braceR),
                  this.finishNode(e, 'TSModuleBlock')
                );
              }),
              (n.tsParseModuleOrNamespaceDeclaration = function(e) {
                if (((e.id = this.parseIdentifier()), this.eat(u.dot))) {
                  var t = this.startNode();
                  this.tsParseModuleOrNamespaceDeclaration(t), (e.body = t);
                } else e.body = this.tsParseModuleBlock();
                return this.finishNode(e, 'TSModuleDeclaration');
              }),
              (n.tsParseAmbientExternalModuleDeclaration = function(e) {
                return (
                  this.isContextual('global')
                    ...
                    ? (e.id = this.parseExprAtom())
                    : this.unexpected(),
                  this.match(u.braceL) ? (e.body = this.tsParseModuleBlock()) : this.semicolon(),
                  this.finishNode(e, 'TSModuleDeclaration')
                );
              }),
              (n.tsParseImportEqualsDeclaration = function(e, t) {
                return (
                  (e.isExport = t || !1),
                  (e.id = this.parseIdentifier()),
                  this.expect(u.eq),
              ...
              (n.tsIsExternalModuleReference = function() {
                return this.isContextual('require') && this.lookahead().type === u.parenL;
              }),
              (n.tsParseModuleReference = function() {
                return this.tsIsExternalModuleReference()
                  ? this.tsParseExternalModuleReference()
                  : this.tsParseEntityName(!1);
              }),
              (n.tsParseExternalModuleReference = function() {
                var e = this.startNode();
                if (
                  (this.expectContextual('require'), this.expect(u.parenL), !this.match(u.string))
                )
                  throw this.unexpected();
                return (
                  (e.expression = this.parseLiteral(this.state.value, 'StringLiteral')),
                  this.expect(u.parenR),
                  this.finishNode(e, 'TSExternalModuleReference')
                );
              }),
              (n.tsLookAhead = function(e) {
                var t = this.state.clone(),
                  n = e();
                return (this.state = t), n;
              }),
              (n.tsTryParseAndCatch = function(e) {
                var t = this.state.clone();
                try {
                  return e();
                } catch (e) {
              ...
              (n.tsTryParse = function(e) {
                var t = this.state.clone(),
                  n = e();
                return void 0 !== n && !1 !== n ? n : void (this.state = t);
              }),
              (n.nodeWithSamePosition = function(e, t) {
                var n = this.startNodeAtNode(e);
                return (
                  (n.type = t),
                  (n.end = e.end),
                  (n.loc.end = e.loc.end),
                  e.leadingComments && (n.leadingComments = e.leadingComments),
                  e.trailingComments && (n.trailingComments = e.trailingComments),
                  e.innerComments && (n.innerComments = e.innerComments),
                  n
                );
              }),
              (n.tsTryParseDeclare = function(e) {
                switch (this.state.type) {
                  case u._function:
                    return this.next(), this.parseFunction(e, !0);
                  case u._class:
                  ...
                  case u._const:
                    if (this.match(u._const) && this.isLookaheadContextual('enum'))
                      return (
              ...
              (n.tsTryParseExportDeclaration = function() {
                return this.tsParseDeclaration(this.startNode(), this.state.value, !0);
              }),
              (n.tsParseExpressionStatement = function(e, t) {
                switch (t.name) {
                  case 'declare':
              ...
              (n.tsParseDeclaration = function(e, t, n) {
                switch (t) {
                  case 'abstract':
                    if (n || this.match(u._class)) {
                      var r = e;
                      return (r.abstract = !0), n && this.next(), this.parseClass(r, !0, !1);
                    }
                    break;
                  case 'enum':
                    if (n || this.match(u.name))
                      return n && this.next(), this.tsParseEnumDeclaration(e, !1);
                    break;
                  case 'interface':
                    if (n || this.match(u.name))
                      return n && this.next(), this.tsParseInterfaceDeclaration(e);
                    break;
                  case 'module':
                    if ((n && this.next(), this.match(u.string)))
                      return this.tsParseAmbientExternalModuleDeclaration(e);
                    if (n || this.match(u.name)) return this.tsParseModuleOrNamespaceDeclaration(e);
                    break;
                  case 'namespace':
                    if (n || this.match(u.name))
                      return n && this.next(), this.tsParseModuleOrNamespaceDeclaration(e);
                    break;
                  case 'type':
                    if (n || this.match(u.name))
                      return n && this.next(), this.tsParseTypeAliasDeclaration(e);
                }
              }),
              (n.tsTryParseGenericAsyncArrowFunction = function(t, n) {
                var r = this,
                  i = this.tsTryParseAndCatch(function() {
                    var i = r.startNodeAt(t, n);
                    return (
                      (i.typeParameters = r.tsParseTypeParameters()),
                      e.prototype.parseFunctionParams.call(r, i),
                ...
                if (i)
                  return (
                    ...
                    (i.expression = !0),
                    (i.async = !0),
                    this.parseFunctionBody(i, !0),
                    this.finishNode(i, 'ArrowFunctionExpression')
                  );
              }),
              (n.tsParseTypeArguments = function() {
                var e = this,
                  t = this.startNode();
                return (
                  (t.params = this.tsInType(function() {
                    return e.tsInNoContext(function() {
                      return (
                        e.expectRelational('<'),
                        e.tsParseDelimitedList('TypeParametersOrArguments', e.tsParseType.bind(e))
                      );
                    });
                  })),
                  (this.state.exprAllowed = !1),
              ...
              (n.tsIsDeclarationStart = function() {
                if (this.match(u.name))
              ...
              (n.isExportDefaultSpecifier = function() {
                return (
                  !this.tsIsDeclarationStart() && e.prototype.isExportDefaultSpecifier.call(this)
                );
              }),
              (n.parseAssignableListItem = function(e, t) {
                var n,
                  r = !1;
                e && ((n = this.parseAccessModifier()), (r = !!this.tsParseModifier(['readonly'])));
                var i = this.parseMaybeDefault();
                this.parseAssignableListItemTypes(i);
                var a = this.parseMaybeDefault(i.start, i.loc.start, i);
                if (n || r) {
                  ...
                  if (
                    ...
                    n && (s.accessibility = n),
                    r && (s.readonly = r),
                    'Identifier' !== a.type && 'AssignmentPattern' !== a.type)
                  )
                    throw this.raise(
                      s.start,
                      'A parameter property may not be declared using a binding pattern.',
                    );
                  return (s.parameter = a), this.finishNode(s, 'TSParameterProperty');
                }
                return t.length && (i.decorators = t), a;
              }),
              (n.parseFunctionBodyAndFinish = function(t, n, r) {
                !r &&
                  this.match(u.colon) &&
                  (t.returnType = this.tsParseTypeOrTypePredicateAnnotation(u.colon));
                var i =
                  'FunctionDeclaration' === n
                    ? 'TSDeclareFunction'
                    : 'ClassMethod' === n
                    ? 'TSDeclareMethod'
                    : void 0;
                i && !this.match(u.braceL) && this.isLineTerminator()
                  ? this.finishNode(t, i)
                  : e.prototype.parseFunctionBodyAndFinish.call(this, t, n, r);
              }),
              (n.parseSubscript = function(t, n, r, i, a) {
                ...
                var l = this.tsTryParseAndCatch(function() {
                  if (s.isRelational('<')) {
                    if (!i && s.atPossibleAsync(t)) {
                      var e = s.tsTryParseGenericAsyncArrowFunction(n, r);
                      if (e) return e;
                    }
                    var o = s.startNodeAt(n, r);
                    o.callee = t;
                    var l = s.tsParseTypeArguments();
                    if (l) {
                      if (!i && s.eat(u.parenL))
                        return (
                          (o.arguments = s.parseCallExpressionArguments(u.parenR, !1)),
                          (o.typeParameters = l),
                          s.finishCallExpression(o)
                        );
                      if (s.match(u.backQuote))
                        return s.parseTaggedTemplateExpression(n, r, t, a, l);
                    }
                  }
                  s.unexpected();
                });
                return l || e.prototype.parseSubscript.call(this, t, n, r, i, a);
              }),
              (n.parseNewArguments = function(t) {
                var n = this;
                if (this.isRelational('<')) {
                  var r = this.tsTryParseAndCatch(function() {
                    var e = n.tsParseTypeArguments();
                    return n.match(u.parenL) || n.unexpected(), e;
                  });
                  r && (t.typeParameters = r);
                }
                e.prototype.parseNewArguments.call(this, t);
              }),
              (n.parseExprOp = function(t, n, r, i, a) {
                if (
                  ne(u._in.binop) > i &&
                  !this.hasPrecedingLineBreak() &&
                  this.isContextual('as')
                  ...
                  return (
                    (s.expression = t),
                    (s.typeAnnotation = this.tsNextThenParseType()),
                    this.finishNode(s, 'TSAsExpression'),
                    this.parseExprOp(s, n, r, i, a)
                  );
                }
                return e.prototype.parseExprOp.call(this, t, n, r, i, a);
              }),
              (n.checkReservedWord = function(e, t, n, r) {}),
              (n.checkDuplicateExports = function() {}),
              (n.parseImport = function(t) {
                return this.match(u.name) && this.lookahead().type === u.eq
                  ? this.tsParseImportEqualsDeclaration(t)
                  : e.prototype.parseImport.call(this, t);
              }),
              (n.parseExport = function(t) {
                if (this.match(u._import))
                  return this.expect(u._import), this.tsParseImportEqualsDeclaration(t, !0);
                if (this.eat(u.eq)) {
                  var n = t;
                  return (
                    (n.expression = this.parseExpression()),
                    this.semicolon(),
                ...
                return e.prototype.parseExport.call(this, t);
              }),
              (n.isAbstractClass = function() {
              ...
              (n.parseExportDefaultExpression = function() {
                ...
                if ('interface' === this.state.value) {
                  var n = this.tsParseDeclaration(this.startNode(), this.state.value, !0);
                  if (n) return n;
                }
                return e.prototype.parseExportDefaultExpression.call(this);
              }),
              (n.parseStatementContent = function(t, n) {
                if (this.state.type === u._const) {
                  var r = this.lookahead();
                  if (r.type === u.name && 'enum' === r.value) {
                    var i = this.startNode();
                    return (
                      this.expect(u._const),
                      this.expectContextual('enum'),
                      this.tsParseEnumDeclaration(i, !0)
                    );
                  }
                }
                return e.prototype.parseStatementContent.call(this, t, n);
              }),
              (n.parseAccessModifier = function() {
                return this.tsParseModifier(['public', 'protected', 'private']);
              }),
              (n.parseClassMember = function(t, n, r) {
                var i = this.parseAccessModifier();
                i && (n.accessibility = i), e.prototype.parseClassMember.call(this, t, n, r);
              }),
              (n.parseClassMemberWithIsStatic = function(t, n, r, i) {
                var a = n,
                  s = n,
                  o = n,
                  l = !1,
                ...
                switch (this.tsParseModifier(['abstract', 'readonly'])) {
                  case 'readonly':
                    (u = !0), (l = !!this.tsParseModifier(['abstract']));
                    break;
                  case 'abstract':
                    (l = !0), (u = !!this.tsParseModifier(['readonly']));
                }
                if (
                  (l && (a.abstract = !0), u && (o.readonly = !0), !l && !i && !a.accessibility)
                ) {
                  var c = this.tsTryParseIndexSignature(n);
                  if (c) return void t.body.push(c);
                }
                if (u)
                  return (
                    (a.static = i),
                    this.parseClassPropertyName(s),
                    this.parsePostMemberNameModifiers(a),
                    void this.pushClassProperty(t, s)
                  );
                e.prototype.parseClassMemberWithIsStatic.call(this, t, n, r, i);
              }),
              (n.parsePostMemberNameModifiers = function(e) {
                this.eat(u.question) && (e.optional = !0);
              }),
              (n.parseExpressionStatement = function(t, n) {
                return (
                  ('Identifier' === n.type ? this.tsParseExpressionStatement(t, n) : void 0) ||
                  e.prototype.parseExpressionStatement.call(this, t, n)
                );
              }),
              (n.shouldParseExportDeclaration = function() {
                return (
              ...
              (n.parseConditional = function(t, n, r, i, a) {
                if (!a || !this.match(u.question))
                  return e.prototype.parseConditional.call(this, t, n, r, i, a);
                var s = this.state.clone();
                try {
                  return e.prototype.parseConditional.call(this, t, n, r, i);
                } catch (e) {
                  if (!(e instanceof SyntaxError)) throw e;
                  return (this.state = s), (a.start = e.pos || this.state.start), t;
                }
              }),
              (n.parseParenItem = function(t, n, r) {
                if (
              ...
              (n.parseExportDeclaration = function(t) {
                ...
                return (
                  this.match(u.name) && (n = this.tsTryParseExportDeclaration()),
                  n || (n = e.prototype.parseExportDeclaration.call(this, t)),
                  n && r && (n.declare = !0),
                  n
                );
              }),
              (n.parseClassId = function(t, n, r) {
                if ((n && !r) || !this.isContextual('implements')) {
                  e.prototype.parseClassId.apply(this, arguments);
                  var i = this.tsTryParseTypeParameters();
                  i && (t.typeParameters = i);
                }
              }),
              (n.parseClassProperty = function(t) {
                !t.optional && this.eat(u.bang) && (t.definite = !0);
                var n = this.tsTryParseTypeAnnotation();
                return n && (t.typeAnnotation = n), e.prototype.parseClassProperty.call(this, t);
              }),
              (n.pushClassMethod = function(t, n, r, i, a) {
                var s = this.tsTryParseTypeParameters();
                s && (n.typeParameters = s), e.prototype.pushClassMethod.call(this, t, n, r, i, a);
              }),
              (n.pushClassPrivateMethod = function(t, n, r, i) {
                var a = this.tsTryParseTypeParameters();
                a && (n.typeParameters = a),
                  e.prototype.pushClassPrivateMethod.call(this, t, n, r, i);
              }),
              (n.parseClassSuper = function(t) {
                e.prototype.parseClassSuper.call(this, t),
                  ...
                  this.eatContextual('implements') && (t.implements = this.tsParseHeritageClause());
              }),
              (n.parseObjPropValue = function(t) {
                var n;
                if (this.isRelational('<')) throw new Error('TODO');
                for (var r = arguments.length, i = new Array(r > 1 ? r - 1 : 0), a = 1; a < r; a++)
                  i[a - 1] = arguments[a];
                (n = e.prototype.parseObjPropValue).call.apply(n, [this, t].concat(i));
              }),
              (n.parseFunctionParams = function(t, n) {
                var r = this.tsTryParseTypeParameters();
                r && (t.typeParameters = r), e.prototype.parseFunctionParams.call(this, t, n);
              }),
              (n.parseVarHead = function(t) {
                e.prototype.parseVarHead.call(this, t),
                  'Identifier' === t.id.type && this.eat(u.bang) && (t.definite = !0);
                var n = this.tsTryParseTypeAnnotation();
                n && ((t.id.typeAnnotation = n), this.finishNode(t.id, t.id.type));
              }),
              (n.parseAsyncArrowFromCallExpression = function(t, n) {
                return (
                  this.match(u.colon) && (t.returnType = this.tsParseTypeAnnotation()),
                  e.prototype.parseAsyncArrowFromCallExpression.call(this, t, n)
                );
              }),
              (n.parseMaybeAssign = function() {
                for (var t, n, r, i, a = arguments.length, s = new Array(a), o = 0; o < a; o++)
                  s[o] = arguments[o];
                if (this.match(u.jsxTagStart)) {
                  re(this.curContext() === F.j_oTag),
                    re(this.state.context[this.state.context.length - 2] === F.j_expr);
                  var l = this.state.clone();
                  try {
                    var c;
                    return (c = e.prototype.parseMaybeAssign).call.apply(c, [this].concat(s));
                  } catch (e) {
                    if (!(e instanceof SyntaxError)) throw e;
                    (this.state = l),
                      re(this.curContext() === F.j_oTag),
                      this.state.context.pop(),
                      re(this.curContext() === F.j_expr),
                      this.state.context.pop(),
                      (t = e);
                  }
                }
                if (void 0 === t && !this.isRelational('<'))
                  return (n = e.prototype.parseMaybeAssign).call.apply(n, [this].concat(s));
                var p = this.state.clone();
                try {
                  var f;
                  (i = this.tsParseTypeParameters()),
                    'ArrowFunctionExpression' !==
                      (r = (f = e.prototype.parseMaybeAssign).call.apply(f, [this].concat(s)))
                  ...
                  if (t) throw t;
                  return (
                    re(!this.hasPlugin('jsx')),
                    (this.state = p),
                    (d = e.prototype.parseMaybeAssign).call.apply(d, [this].concat(s))
                  );
                }
                return (
                  i && 0 !== i.params.length && this.resetStartLocationFromNode(r, i.params[0]),
                  (r.typeParameters = i),
                  r
                );
              }),
              (n.parseMaybeUnary = function(t) {
                return !this.hasPlugin('jsx') && this.eatRelational('<')
                  ? this.tsParseTypeAssertion()
                  : e.prototype.parseMaybeUnary.call(this, t);
              }),
              (n.parseArrow = function(t) {
                if (this.match(u.colon)) {
                  var n = this.state.clone();
                  try {
                    var r = this.tsParseTypeOrTypePredicateAnnotation(u.colon);
                    this.canInsertSemicolon() && this.unexpected(),
                      this.match(u.arrow) || this.unexpected(),
                      (t.returnType = r);
                  } catch (e) {
              ...
              (n.parseAssignableListItemTypes = function(e) {
                ...
                return t && (e.typeAnnotation = t), this.finishNode(e, e.type);
              }),
              (n.toAssignable = function(t, n, r) {
                switch (t.type) {
                  case 'TSTypeCastExpression':
                    return e.prototype.toAssignable.call(this, this.typeCastToParameter(t), n, r);
                  case 'TSParameterProperty':
                    return e.prototype.toAssignable.call(this, t, n, r);
                  case 'TSAsExpression':
                  case 'TSNonNullExpression':
                  case 'TSTypeAssertion':
                    return (t.expression = this.toAssignable(t.expression, n, r)), t;
                  default:
                    return e.prototype.toAssignable.call(this, t, n, r);
                }
              }),
              (n.checkLVal = function(t, n, r, i) {
                switch (t.type) {
                  case 'TSTypeCastExpression':
                    return;
                  case 'TSParameterProperty':
                    return void this.checkLVal(t.parameter, n, r, 'parameter property');
                  case 'TSAsExpression':
                  case 'TSNonNullExpression':
                  case 'TSTypeAssertion':
                    return void this.checkLVal(t.expression, n, r, i);
                  default:
                    return void e.prototype.checkLVal.call(this, t, n, r, i);
                }
              }),
              (n.parseBindingAtom = function() {
                switch (this.state.type) {
                  case u._this:
                    return this.parseIdentifier(!0);
                  default:
                    return e.prototype.parseBindingAtom.call(this);
                }
              }),
              (n.isClassMethod = function() {
                return this.isRelational('<') || e.prototype.isClassMethod.call(this);
              ...
              (n.parseMaybeDefault = function() {
                for (var t, n = arguments.length, r = new Array(n), i = 0; i < n; i++)
                  r[i] = arguments[i];
                var a = (t = e.prototype.parseMaybeDefault).call.apply(t, [this].concat(r));
                return (
              ...
              (n.toAssignableList = function(t, n, r) {
                for (var i = 0; i < t.length; i++) {
                  var a = t[i];
                  a && 'TSTypeCastExpression' === a.type && (t[i] = this.typeCastToParameter(a));
                }
                return e.prototype.toAssignableList.call(this, t, n, r);
              }),
              (n.typeCastToParameter = function(e) {
              ...
              (n.toReferencedList = function(e) {
                for (var t = 0; t < e.length; t++) {
                  ...
                  n &&
                    ...
                    this.raise(n.start, 'Did not expect a type annotation here.');
                }
                return e;
              }),
              (n.shouldParseArrow = function() {
              ...
              (n.canHaveLeadingDecorator = function() {
                return e.prototype.canHaveLeadingDecorator.call(this) || this.isAbstractClass();
              }),
              (n.jsxParseOpeningElementAfterName = function(t) {
                var n = this,
                  r = this.tsTryParseAndCatch(function() {
                    return n.tsParseTypeArguments();
                  });
                return (
                  r && (t.typeParameters = r),
                  e.prototype.jsxParseOpeningElementAfterName.call(this, t)
                );
              }),
              t
            );
    ...
    function ue(e, t) {
      ...
      return (
        e &&
          ...
          (!(function(e) {
            if (ie(e, 'decorators')) {
              if (ie(e, 'decorators-legacy'))
                throw new Error('Cannot use the decorators and decorators-legacy plugin together');
              var t = ae(e, 'decorators', 'decoratorsBeforeExport');
              if (null == t)
                throw new Error(
            ...
            if (ie(e, 'flow') && ie(e, 'typescript'))
              throw new Error('Cannot combine flow and typescript plugins.');
            if (ie(e, 'pipelineOperator') && !se.includes(ae(e, 'pipelineOperator', 'proposal')))
              throw new Error(
    ...
    (t.parse = function(e, t) {
      if (!t || 'unambiguous' !== t.sourceType) return ue(t, e).parse();
      t = Object.assign({}, t);
      try {
        t.sourceType = 'module';
        var n = ue(t, e),
        ...
        try {
          return (t.sourceType = 'script'), ue(t, e).parse();
        } catch (e) {}
        throw n;
      }
    }),
  ...
  function(e, t, n) {
    'use strict';
    e.exports = {
      createUserError: function(e) {
        for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++)
          n[r - 1] = arguments[r];
        var i = 0,
          a = e.replace(/%s/g, function(e) {
            return n[i++];
          });
        return new Error(a);
      },
  ...
  function(e, t, n) {
    ...
    var r = n(96),
      i = (function() {
        ...
        var t = e.prototype;
        return (
          (t.reportMessage = function(e) {
            this._quiet || process.stdout.write(e + '\n');
          }),
          (t.reportTime = function(e, t) {
            if (this._verbose && !this.quiet) {
              var n =
                0 === t
                  ...
                  ? r.blue(
                      (function(e, t) {
                        return new Array(e - t.length + 1).join(' ') + t;
                      })(5, t + 'ms'),
                    )
                  : r.red(Math.floor(t / 10) / 100 + 's');
              process.stdout.write('  ' + n + ' ' + r.gray(e) + '\n');
            }
          }),
          (t.reportError = function(e, t) {
            if (
              !this._quiet &&
              (process.stdout.write(r.red('ERROR:\n' + t.message + '\n')), this._verbose)
            ) {
              var n = t.stack.match(/^ {4}at .*$/gm);
              n && process.stdout.write(r.gray('From: ' + e + '\n' + n.join('\n') + '\n'));
            }
          }),
          e
        );
  ...
  function(e, t, n) {
      ...
      leave: {
        Root: function(e) {
          return {
            kind: 'Operation',
            name: e.name,
            argumentDefinitions: e.argumentDefinitions,
            selections: T(e.selections),
          };
        },
        Request: function(e) {
          throw o('NormalizationCodeGenerator: unexpected Request node.');
        },
        Fragment: function(e) {
          throw o('NormalizationCodeGenerator: unexpected Fragment node.');
        },
        LocalArgumentDefinition: function(e) {
          return {
            kind: 'LocalArgument',
            name: e.name,
        ...
        RootArgumentDefinition: function(e) {
          return { kind: 'RootArgument', name: e.name, type: e.type ? e.type.toString() : null };
        },
        Condition: function(e, t, n, r) {
          if ('Variable' !== e.condition.kind)
            throw o(
              "NormalizationCodeGenerator: Expected 'Condition' with static value to be pruned or inlined",
              [e.condition.loc],
            );
          return {
            kind: 'Condition',
        ...
        Defer: function(e, t, n, r) {
          ...
          if (
            null != e.if &&
            'Variable' !== e.if.kind &&
            ('Literal' !== e.if.kind || !0 !== e.if.value)
          )
            throw o(
              'NormalizationCodeGenerator: Expected @defer `if` condition to be a variable, unspecified, or the literal `true`.',
              [
                null !== (a = null === (s = e.if) || void 0 === s ? void 0 : s.loc) && void 0 !== a
                  ? a
                  : e.loc,
              ],
            );
          return {
            if:
              'Variable' === (null === (i = e.if) || void 0 === i ? void 0 : i.kind)
                ? e.if.variableName
                : null,
            kind: 'Defer',
            label: e.label,
        ...
        LinkedField: function(e) {
          var t =
            ...
            i = {
              ...
              storageKey: null,
              args: v(g(e.args)),
              concreteType: h(n) ? null : n.toString(),
              plural: (function(e) {
                return m(e) instanceof u;
              })(e.type),
              selections: T(e.selections),
            },
            a = S(i, e.metadata);
          return a && (i = (0, r.default)({}, i, { storageKey: a })), [i].concat(t);
        },
        MatchField: function(e, t, n, i) {
          var a = {};
          T(e.selections).forEach(function(t) {
            var n;
            if ('ScalarField' !== t.kind || '__typename' !== t.name) {
              if ('MatchBranch' !== t.kind)
                throw o(
                  "NormalizationCodeGenerator: Expected selection for MatchField '"
                    .concat(e.name, "' to be a 'MatchBranch', got '")
                    .concat(t.kind, "'."),
                  [t.loc],
                );
              if (a.hasOwnProperty(t.type))
                throw o(
                  'NormalizationCodeGenerator: Each @match type can appear at-most ' +
                    "once. Type '".concat(String(t.type), "' was duplicated."),
                  t.type,
                  [t.loc],
                );
              var r = t.name,
                i = r.match(/^([a-zA-Z][a-zA-Z0-9]*)(?:_([a-zA-Z][_a-zA-Z0-9]*))?$/);
              if (!i)
                throw o(
                  'NormalizationCodeGenerator: @match fragments should be named ' +
                    "'FragmentName_propName', got '".concat(r, "'."),
                  [t.loc],
                );
              var s = null !== (n = i[2]) && void 0 !== n ? n : 'matchData';
              a[t.type] = { fragmentPropName: s, fragmentName: r };
            }
          });
          var s = {
              kind: 'MatchField',
            ...
            l = S(s, e.metadata);
          return l && (s = (0, r.default)({}, s, { storageKey: l })), s;
        },
        ScalarField: function(e) {
          var t =
            ...
            i = S(n, e.metadata);
          return i && (n = (0, r.default)({}, n, { storageKey: i })), [n].concat(t);
        },
        SplitOperation: function(e, t, n) {
          return {
            kind: 'SplitOperation',
            name: e.name,
            metadata: e.metadata,
        ...
        Stream: function(e, t, n, r) {
          ...
          if (
            ...
            throw o(
              'NormalizationCodeGenerator: Expected @stream `if` condition to be a variable, unspecified, or the literal `true`.',
              [
                null !== (a = null === (s = e.if) || void 0 === s ? void 0 : s.loc) && void 0 !== a
                  ? a
                  : e.loc,
        ...
        Variable: function(e, t, n) {
          return {
            ...
            type: n.type ? n.type.toString() : null,
          };
        },
        ...
        Argument: function(e, t, n, r) {
          if (!['Variable', 'Literal'].includes(e.value.kind))
            throw l(
              'RelayCodeGenerator: Complex argument values (Lists or InputObjects with nested variables) are not supported.',
              [e.value.loc],
            );
          return null !== e.value.value ? e.value : null;
        },
      },
    };
    function v(e) {
    ...
    function T(e) {
      return e ? Array.prototype.concat.apply([], e) : [];
    }
    function g(e) {
    ...
    function S(e, t) {
      var n = null === t || void 0 === t ? void 0 : t.storageKey;
    ...
    e.exports = {
      generate: function(e) {
        if ('Root' !== e.kind && 'SplitOperation' !== e.kind)
          throw o("NormalizationCodeGenerator: Unsupported AST kind '".concat(e.kind, "'."), [
            e.loc,
          ]);
        return i.visit(e, y);
      },
  ...
  function(e, t, n) {
    ...
    var v = {
      leave: {
        Request: function(e) {
          throw l('ReaderCodeGenerator: unexpeted Request node.');
        },
        Fragment: function(e) {
          var t = null;
          if (null != e.metadata) {
            var n,
              ...
              c = o.connection,
              p = o.refetch;
            if (Array.isArray(c)) (t = null !== (n = t) && void 0 !== n ? n : {}).connection = c;
            if ('boolean' == typeof l) (t = null !== (r = t) && void 0 !== r ? r : {}).mask = l;
            if ('boolean' == typeof u) (t = null !== (a = t) && void 0 !== a ? a : {}).plural = u;
            if ('object' == typeof p)
              (t = null !== (s = t) && void 0 !== s ? s : {}).refetch = {
                connection: p.connection,
                operation: i.moduleDependency(p.operation + '.graphql'),
                fragmentPathInResult: p.fragmentPathInResult,
              };
          }
          return {
            kind: 'Fragment',
        ...
        Condition: function(e, t, n, r) {
          if ('Variable' !== e.condition.kind)
            throw l(
              "ReaderCodeGenerator: Expected 'Condition' with static value to be pruned or inlined",
              [e.condition.loc],
            );
          return {
            kind: 'Condition',
        ...
        FragmentSpread: function(e) {
          return { kind: 'FragmentSpread', name: e.name, args: T(g(e.args)) };
        },
        InlineFragment: function(e) {
          return {
            kind: 'InlineFragment',
        ...
        LinkedField: function(e) {
          var t = h(e.type),
            n = {
              ...
              storageKey: null,
              args: T(g(e.args)),
              concreteType: m(t) ? null : t.toString(),
              plural: (function(e) {
                return y(e) instanceof c;
              })(e.type),
              selections: e.selections,
            },
            i = S(n, e.metadata);
          return i && (n = (0, r.default)({}, n, { storageKey: i })), n;
        },
        MatchField: function(e, t, n, i) {
          var a = {};
          e.selections.forEach(function(t) {
            var n;
            if ('ScalarField' !== t.kind || '__typename' !== t.name) {
              if ('MatchBranch' !== t.kind)
                throw l(
              ...
              if (a.hasOwnProperty(t.type))
                throw l(
                  'ReaderCodeGenerator: Each @match type can appear at-most once. ' +
                    "Type '".concat(String(t.type), "' was duplicated."),
                  t.type,
                  [t.loc],
                );
              var r = t.name,
          ...
          var s = {
            ...
            o = S(s, e.metadata);
          return o && (s = (0, r.default)({}, s, { storageKey: o })), s;
        },
        ScalarField: function(e) {
          var t = {
              kind: 'ScalarField',
            ...
            n = S(t, e.metadata);
          return n && (t = (0, r.default)({}, t, { storageKey: n })), t;
        },
        SplitOperation: function(e, t, n) {
          return { kind: 'SplitOperation', name: e.name, metadata: null, selections: e.selections };
        },
        Variable: function(e, t, n) {
          return {
            kind: 'Variable',
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      T = n(14),
      g = n(52),
      S = n(53).getReaderSourceDefinitionName,
      x = (n(20).Map, f.isExecutableDefinitionAST);
    e.exports = {
      writeAll: function(e) {
        var t = e.config,
          n = e.onlyValidate,
        ...
        return u.asyncContext(
          ...
          i(function*() {
            var e = (function(e) {
                e.baseDir;
                var t = e.baseDocuments,
                  n = e.baseSchema,
                  r = e.compilerTransforms,
                  i = e.documents,
                  o = e.extraValidationRules,
                  u = e.reporter,
                  f = e.schemaExtensions,
                  h = e.typeGenerator,
                  m = s.transformASTSchema(n, f),
                  y = s.extendASTSchema(m, (0, a.default)(t).concat((0, a.default)(i))),
                  v = (0, a.default)(p.LOCAL_RULES).concat((0, a.default)(p.GLOBAL_RULES));
                o &&
                  (v = (0, a.default)(v).concat(
                    (0, a.default)(o.LOCAL_RULES || []),
                    (0, a.default)(o.GLOBAL_RULES || []),
                  ));
                var T = s.convertASTDocumentsWithBase(y, t, i, v, c.transform),
                  g = new l(n, y).addAll(T),
                  S = g.applyTransforms(h.transforms, u),
                  x = g.applyTransforms(
                    (0, a.default)(r.commonTransforms).concat((0, a.default)(r.queryTransforms)),
                    u,
                  );
                return {
                  artifacts: d(g, r, u),
                  definitions: T,
                  transformedQueryContext: x,
                  transformedTypeContext: S,
                };
              })({
                baseDir: t.baseDir,
                baseDocuments: r.valueSeq().toArray(),
                baseSchema: b,
                compilerTransforms: t.compilerTransforms,
                documents: f.valueSeq().toArray(),
                extraValidationRules: t.validationRules,
                reporter: E,
                schemaExtensions: t.schemaExtensions,
                typeGenerator: t.typeGenerator,
              }),
              A = e.artifacts,
              w = e.definitions,
              k = e.transformedTypeContext,
              N = e.transformedQueryContext,
              C = new Set();
            r.forEach(function(e) {
              e.definitions.forEach(function(e) {
                x(e) && e.name && C.add(e.name.value);
              });
            });
            var _ = A.filter(function(e) {
              ...
              O = new Map(
                _.map(function(e) {
                  return ['Request' === e.kind ? e.params.name : e.name, e];
                }),
              ),
              D = new Set(
                w.map(function(e) {
              ...
              L = function(e) {
                ...
                return (
                  r ||
                    y(!1, 'RelayFileWriter: Could not determine source for definition: `%s`.', e),
                  r
                );
              };
            f.forEach(function(e, n) {
              e.definitions.forEach(function(e) {
                e.name && I.set(e.name.value, { dir: T.join(t.baseDir, T.dirname(n)), ast: e });
              });
            }),
            ...
            try {
              for (
                var q, U = (t.generatedDirectories || [])[Symbol.iterator]();
                !(R = (q = U.next()).done);
                R = !0
              ) {
                var K = q.value;
            ...
            t.outputDir && (F = j(t.outputDir));
            var J = function(e) {
                if (F) return F;
                var t = T.join(L(e).dir, '__generated__'),
                  n = M.get(t);
                return n || (n = j(t)), n;
              },
              X = u.instrument(t.formatModule, 'RelayFileWriter:formatModule'),
              Y = t.persistQuery
                ? u.instrumentWait(t.persistQuery, 'RelayFileWriter:persistQuery')
                : null;
            try {
              yield Promise.all(
                _.map(
                  (function() {
                    var e = i(function*(e) {
                      var n = 'Request' === e.kind ? e.params.name : e.name;
                      if (!C.has(n)) {
                        var r = k.get(n),
                          i = r
                            ? t.typeGenerator.generate(r, {
                                customScalars: t.customScalars,
                                enumsHasteModule: t.enumsHasteModule,
                                existingFragmentNames: D,
                                optionalInputFields: t.optionalInputFieldsForFlow,
                                useHaste: t.useHaste,
                                useSingleArtifactDirectory: !!t.outputDir,
                                noFutureProofEnums: t.noFutureProofEnums,
                              })
                            : '',
                          a = u.run('hashGraphQL', function() {
                            return (function(e) {
                              return h
                                .createHash('md5')
                                .update(e, 'utf8')
              ...
              var G = t.generateExtraFiles;
              G &&
                u.run('RelayFileWriter:generateExtraFiles', function() {
                  var e = t.outputDir;
                  G(
                    function(t) {
                      var n = t || e;
                      n ||
                        y(
                          !1,
                          'RelayFileWriter: cannot generate extra files without specifying an outputDir in the config or passing it in.',
                        );
                      var r = M.get(n);
                      return r || (r = j(n)), r;
                    },
                ...
                !0 !== t.experimental_noDeleteExtraFiles &&
                  M.forEach(function(e) {
                    e.deleteExtraFiles(t.experimental_extraFilesPatternToKeep);
                  }),
                P && !n && (yield o.sourceControlAddRemove(P, Array.from(M.values())));
            } catch (e) {
              var W;
              try {
                W = JSON.parse(e.message);
              } catch (e) {}
              if (W && 'GraphQL2Exception' === W.name && W.message)
  ...
  function(e, t, n) {
    'use strict';
    var r = n(6).getRawType,
      i = n(10).createCompilerError,
      a = n(1),
      s = a.assertAbstractType,
      o = a.GraphQLInterfaceType,
      l = a.GraphQLObjectType,
      u = a.GraphQLUnionType,
      c = a.isAbstractType,
      p = a.SchemaMetaFieldDef,
      f = a.TypeMetaFieldDef,
      d = a.TypeNameMetaFieldDef;
    function h(e, t, n, i) {
      var a,
        s = r(t),
        c = s === e.getQueryType(),
        h = s instanceof l || s instanceof o || s instanceof u;
      return (
        c && n === p.name
          ? (a = p)
          : c && n === f.name
          ...
          : h && n === d.name
          ? (a = d)
          : (s instanceof o || s instanceof l) && (a = s.getFields()[n]),
        a
      );
    }
    function m(e) {
      var t = e.name ? e.name.value : null;
      if ('string' != typeof t) throw i("Expected ast node to have a 'name'.", null, [e]);
      return t;
    }
    e.exports = {
      getFieldDefinitionLegacy: function(e, t, n, i) {
        var a = h(e, t, n);
        return (
          a ||
            (a = (function(e, t, n, r) {
              if (
                ...
                r.directives.some(function(e) {
                  return 'fixme_fat_interface' === m(e);
                })
              ) {
                for (
                  var i,
                    a = e.getPossibleTypes(s(t)),
                    o = function(e) {
                      var t = a[e].getFields()[n];
                      if (t && ((i = t), r && r.arguments)) {
                        var s = r.arguments.every(function(e) {
                          return t.args.find(function(t) {
                            return t.name === m(e);
                          });
                        });
                        if (s) return 'break';
    ...
    e.exports = function(e) {
      ...
      !(function e(r) {
        ...
        if (Array.isArray(r)) {
          ...
          for (var s in ((i = '{'), r))
            r.hasOwnProperty(s) && void 0 !== r[s] && (i += s + ':' + e(r[s]) + ',');
        var o = t.get(i);
        return o || ((o = { value: r, hash: i, isDuplicate: !1 }), t.set(i, o)), n.set(r, o), i;
      })(e),
        (function e(t) {
          if (null != t && 'object' == typeof t) {
            var r = n.get(t);
            if (r && r.value !== t && r.hash.length > 2) r.isDuplicate = !0;
            else if (Array.isArray(t)) for (var i = 0; i < t.length; i++) e(t[i]);
            else for (var a in t) t.hasOwnProperty(a) && void 0 !== t[a] && e(t[a]);
          }
        })(e);
      var i = (function e(t, i, a) {
        if (null == a || 'object' != typeof a) return JSON.stringify(a);
        if ('' !== i) {
          var s = n.get(a);
          if (s && s.isDuplicate) {
            if (!s.varName) {
              var o = e(!0, '', a);
              (s.varName = 'v' + r.length), r.push(s.varName + ' = ' + o);
            }
            return '(' + s.varName + '/*: any*/)';
          }
        }
        var l,
          u = !0,
        ...
        if (Array.isArray(a)) {
          ...
          for (var f in ((l = '{'), a))
            a.hasOwnProperty(f) &&
              void 0 !== a[f] &&
              ((l += (u ? '\n' : ',\n') + c + JSON.stringify(f) + ': ' + e(t, c, a[f])), (u = !1));
          l += u ? '}' : '\n'.concat(i, '}');
        }
        return l;
      })(!1, '', e);
  ...
  function(e, t, n) {
    ...
    e.exports = function(e, t) {
      ...
      !(function e(t, n, r) {
        !(function(e, t) {
          if (Array.isArray(e)) for (var n = 0; n < e.length; n++) t(e[n], n);
          else for (var r in e) e.hasOwnProperty(r) && t(e[r], r);
        })(r, function(r, i) {
          var a = n.concat(i);
          'object' == typeof r && null !== r ? e(t, a, r) : t.push({ path: a, value: r });
        });
      })(n, [], t);
      var r = n.map(function(t) {
        ...
        return (function(e, t, n) {
          var r = t
              ...
              .join(''),
            i = void 0 === n ? 'undefined' : JSON.stringify(n);
          return ''
            .concat(e)
            .concat(r, ' = ')
            .concat(i, ';');
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      m = n(26),
      y = n(11),
      v = n(6).isAbstractType,
      T = n(82),
      g = T.anyTypeAlias,
      S = T.exactObjectTypeAnnotation,
      x = T.exportType,
      b = T.importTypes,
      E = T.intersectionTypeAnnotation,
      P = T.lineComments,
      A = T.readOnlyArrayOfType,
      w = T.readOnlyObjectTypeProperty,
      k = T.unionTypeAnnotation,
      N = n(176),
      C = N.transformScalarType,
      _ = N.transformInputType,
      O = n(1),
      D = (O.GraphQLInputObjectType, O.GraphQLNonNull);
    function I(e, t, n, r) {
      var i = e.key,
        a = e.schemaName,
        s = e.value,
        ...
        l = e.nodeType,
        u = e.nodeSelections;
      l && (s = C(l, t, j([Array.from(m(u).values())], t, n))),
        '__typename' === a && r && (s = y.stringLiteralTypeAnnotation(r));
      var c = w(i, s);
      return o && (c.optional = !0), c;
    }
    var L = function(e) {
    ...
    function j(e, t, n, r) {
      ...
      q(e).forEach(function(e) {
        var t = e.concreteType;
        if (t) {
          var n;
          (o[t] = null !== (n = o[t]) && void 0 !== n ? n : []), o[t].push(e);
        } else {
          var r = s.get(e.key);
          s.set(e.key, r ? R(e, r) : e);
        }
      });
      var l = [];
      if (
        ...
        !(function() {
          var e = new Set(),
            r = function(r) {
              l.push(
                U((0, a.default)(Array.from(s.values())).concat((0, a.default)(o[r]))).map(function(
                  i,
                ) {
                  return '__typename' === i.schemaName && e.add(i.key), I(i, t, n, r);
                }),
              );
            };
          for (var i in o) r(i);
          l.push(
            Array.from(e).map(function(e) {
              var t = w(e, y.stringLiteralTypeAnnotation('%other'));
              return (
                (t.leadingComments = P(
        ...
        var u = V(Array.from(s.values()));
        for (var c in o)
          u = B(
            u,
            V(
              o[c].map(function(e) {
                return (0, i.default)({}, e, { conditional: !0 });
              }),
            ),
          );
        var p = U(Array.from(u.values())).map(function(e) {
          return L(e) && e.concreteType
            ? I((0, i.default)({}, e, { conditional: !1 }), t, n, e.concreteType)
            : I(e, t, n);
        });
        l.push(p);
      }
      return k(
        l.map(function(e) {
          return (
            r && e.push(w('$refType', y.genericTypeAnnotation(y.identifier(r)))),
            n ? y.objectTypeAnnotation(e) : S(e)
          );
        }),
      );
    }
    function R(e, t) {
      return e
        ? (0, i.default)({}, e, {
            nodeSelections: e.nodeSelections ? B(e.nodeSelections, m(t.nodeSelections)) : null,
            conditional: e.conditional && t.conditional,
          })
        : (0, i.default)({}, t, { conditional: !0 });
    }
    function B(e, t) {
      var n = new Map(),
        r = !0,
        ...
        a = void 0;
      try {
        for (var s, o = e.entries()[Symbol.iterator](); !(r = (s = o.next()).done); r = !0) {
          var l = s.value,
            u = l[0],
            c = l[1];
          n.set(u, c);
      ...
      var p = !0,
        ...
        d = void 0;
      try {
        for (var h, m = t.entries()[Symbol.iterator](); !(p = (h = m.next()).done); p = !0) {
          var y = h.value;
          (u = y[0]), (c = y[1]);
          n.set(u, R(e.get(u), c));
        }
    ...
    function q(e) {
      ...
      return (
        e.forEach(function(e) {
          return t.push.apply(t, (0, a.default)(e));
        }),
        t
      );
    }
    function U(e) {
      ...
      if (
        (e.forEach(function(e) {
          e.ref ? n.push(e.ref) : t.push(e);
        }),
        n.length > 0)
      ) {
        var r = E(
          n.map(function(e) {
            return y.genericTypeAnnotation(y.identifier(X(e)));
          }),
        );
        t.push({ key: '$fragmentRefs', conditional: !1, value: r });
      }
      return t;
    }
    function K(e) {
      ...
      if (e.usedFragments.size > 0) {
        var n = Array.from(e.usedFragments).sort(),
          r = !0,
          i = !1,
          a = void 0;
        try {
          for (var s, o = n[Symbol.iterator](); !(r = (s = o.next()).done); r = !0) {
            var l = s.value,
              u = X(l);
            e.generatedFragments.has(l) ||
              (e.useHaste && e.existingFragmentNames.has(l)
                ? t.push(b([u], l + '.graphql'))
                : e.useSingleArtifactDirectory && e.existingFragmentNames.has(l)
                ? t.push(b([u], './' + l + '.graphql'))
                : t.push(g(u)));
          }
        } catch (e) {
    ...
    function J(e) {
      ...
      return 0 === i.length
        ...
        ? [b(i, t)]
        : i.map(function(e) {
            var t = n[e].getValues().map(function(e) {
              return e.value;
            });
            return (
              t.sort(),
              r || t.push('%future added value'),
              x(
                e,
                y.unionTypeAnnotation(
                  t.map(function(e) {
                    return y.stringLiteralTypeAnnotation(e);
                  }),
                ),
              )
            );
    ...
    var Y = [d.transform, c.transform, p.transform, o.transformWithOptions({}), f.transform];
    e.exports = {
      generate: u.instrument(function(e, t) {
        var n = l.visit(
          e,
          (function(e) {
            var t = {
            ...
            return {
              leave: {
                Root: function(e) {
                  var r = (function(e, t) {
                      return x(
                        ''.concat(e.name, 'Variables'),
                        S(
                          e.argumentDefinitions.map(function(e) {
                            var n = y.objectTypeProperty(y.identifier(e.name), _(e.type, t));
                            return e.type instanceof D || (n.optional = !0), n;
                          }),
                        ),
                      );
                    })(e, t),
                    i = (function(e) {
                      return Object.keys(e.generatedInputObjectTypes).map(function(t) {
                        var n = e.generatedInputObjectTypes[t];
                        return (
                          'string' == typeof n &&
                            h(
                              !1,
                              'RelayCompilerFlowGenerator: Expected input object type to have been defined before calling `generateInputObjectTypes`',
                            ),
                          x(t, n)
                        );
                      });
                    })(t),
                    s = x(''.concat(e.name, 'Response'), j(e.selections, t, !1)),
                    o = x(
                      e.name,
                      S([
                        y.objectTypeProperty(
                          y.identifier('variables'),
                          y.genericTypeAnnotation(y.identifier(''.concat(e.name, 'Variables'))),
                        ),
                        y.objectTypeProperty(
                          y.identifier('response'),
                          y.genericTypeAnnotation(y.identifier(''.concat(e.name, 'Response'))),
                        ),
                      ]),
                    ),
                    l = [];
                  return (
                    n && l.push('MatchPointer'),
                    y.program(
                      (0, a.default)(K(t))
                        .concat(
                          (0, a.default)(J(t)),
                          [l.length ? b(l, 'relay-runtime') : null],
                          (0, a.default)(i),
                          [r, s, o],
                        )
                        .filter(Boolean),
                ...
                Fragment: function(e) {
                  var r = q(e.selections),
                    s = r.filter(function(e) {
                      return e.concreteType;
                    }).length;
                  (r = r.map(function(t) {
                    return s <= 1 && L(t) && !v(e.type)
                      ? [(0, i.default)({}, t, { concreteType: e.type.toString() })]
                      : [t];
                  })),
                    t.generatedFragments.add(e.name);
                  var o = X(e.name),
                    l = y.declareExportDeclaration(
                      y.declareOpaqueType(
                        y.identifier(o),
                        null,
                        y.genericTypeAnnotation(y.identifier('FragmentReference')),
                      ),
                    ),
                    u = e.metadata && !1 === e.metadata.mask,
                    c = j(r, t, u, u ? void 0 : o),
                    p = (function(e) {
                    ...
                    f = ['FragmentReference'];
                  return (
                    n && f.push('MatchPointer'),
                    y.program(
                      (0, a.default)(K(t)).concat((0, a.default)(J(t)), [
                        b(f, 'relay-runtime'),
                        l,
                        x(e.name, p),
                      ]),
                ...
                InlineFragment: function(e) {
                  ...
                  return q(e.selections).map(function(e) {
                    return v(t)
                      ? (0, i.default)({}, e, { conditional: !0 })
                      : (0, i.default)({}, e, { concreteType: t.toString() });
                  });
                },
                Condition: function(e) {
                  return q(e.selections).map(function(e) {
                ...
                ScalarField: function(e) {
                  ...
                  return [
                    {
                      key: null !== (n = e.alias) && void 0 !== n ? n : e.name,
                      schemaName: e.name,
                      value: C(e.type, t),
                    },
                  ];
                ...
                LinkedField: function(e) {
                  ...
                  return [
                    {
                      key: null !== (t = e.alias) && void 0 !== t ? t : e.name,
                      schemaName: e.name,
                      nodeType: e.type,
                      nodeSelections: V(q(e.selections)),
                    },
                  ];
                },
                MatchField: function(e) {
                  var t;
                  return (
                    (n = !0),
                    [
                      {
                        key: null !== (t = e.alias) && void 0 !== t ? t : e.name,
                        schemaName: e.name,
                        value: y.nullableTypeAnnotation(
                          y.genericTypeAnnotation(y.identifier('MatchPointer')),
                        ),
                      },
                    ]
                  );
                ...
                FragmentSpread: function(e) {
                  return (
                    t.usedFragments.add(e.name), [{ key: '__fragments_' + e.name, ref: e.name }]
                  );
                },
              },
            };
        ...
        super(
          (function(e, t) {
            const n = {
              ...
              jsescOption: Object.assign({ quotes: 'double', wrap: !0 }, t.jsescOption),
            };
            n.minified
              ? ((n.compact = !0),
                (n.shouldPrintComment = n.shouldPrintComment || (() => n.comments)))
              : (n.shouldPrintComment =
                  n.shouldPrintComment ||
                  (e => n.comments || e.indexOf('@license') >= 0 || e.indexOf('@preserve') >= 0));
            'auto' === n.compact &&
          ...
          t.sourceMaps ? new r.default(t, n) : null,
        ),
          (this.ast = e);
      }
      generate() {
        ...
        (this._lastGenLine !== e && null === n) ||
          ((s ||
            ...
            this._rawMappings.push({
              ...
              source: null == n ? void 0 : a || this._opts.sourceFileName,
              original: null == n ? void 0 : { line: n, column: r },
            })));
      }
    };
  },
  function(e, t) {
    e.exports = require('source-map');
  },
  function(e, t, n) {
    'use strict';
    function r() {
    ...
    class h {
      ...
      word(e) {
        (this._endsWithWord || (this.endsWith('/') && 0 === e.indexOf('/'))) && this._space(),
      ...
      endTerminatorless(e) {
        (this._noLineTerminator = !1),
          e && e.printed && (this.dedent(), this.newline(), this.token(')'));
      }
      print(e, t) {
        if (!e) return;
        ...
        const r = this._insideAux;
        (this._insideAux = !e.loc), this._maybeAddAuxComment(this._insideAux && !r);
        let i = s.needsParens(e, t, this._printStack);
        ...
        const a = o().isProgram(e) || o().isFile(e) ? null : e.loc;
      ...
      printJoin(e, t, n = {}) {
        ...
        const r = { addNewlines: n.addNewlines };
        for (let i = 0; i < e.length; i++) {
          const a = e[i];
          a &&
            (n.statement && this._printNewline(!0, a, t, r),
            this.print(a, t),
            n.iterator && n.iterator(a, i),
            n.separator && i < e.length - 1 && n.separator.call(this),
            n.statement && this._printNewline(!1, a, t, r));
        }
      ...
      printInnerComments(e, t = !0) {
        e.innerComments &&
          ...
          (t && this.indent(), this._printComments(e.innerComments), t && this.dedent());
      }
      printSequence(e, t, n = {}) {
        return (n.statement = !0), this.printJoin(e, t, n);
      }
      printList(e, t, n = {}) {
        return null == n.separator && (n.separator = m), this.printJoin(e, t, n);
      }
      _printNewline(e, t, n, r) {
        ...
        if (this._buf.hasContent()) {
          e || i++,
            ...
            (e ? s.needsWhitespaceBefore : s.needsWhitespaceAfter)(t, n) && i++;
        }
        this.newline(i);
      }
      _getComments(e, t) {
      ...
      _printComment(e) {
        ...
        this.newline(this._buf.hasContent() && !this._noLineTerminator && t ? 1 : 0),
    ...
    (t.default = h), Object.assign(h.prototype, l);
  },
  function(e, t) {
    e.exports = require('lodash/isInteger');
  },
  function(e, t) {
    e.exports = require('lodash/repeat');
  },
  function(e, t, n) {
    'use strict';
    function r() {
    ...
    t.default = class {
      ...
      queue(e) {
        ...
        this._queue.unshift([e, t, n, a, r, s]);
      }
      _flush() {
        let e;
      ...
      _append(e, t, n, r, i, a) {
        this._map &&
          '\n' !== e[0] &&
          this._map.mark(this._position.line, this._position.column, t, n, r, i, a),
          this._buf.push(e),
      ...
      withSource(e, t, n) {
        ...
        const r = this._sourcePosition.line,
          ...
          s = this._sourcePosition.identifierName;
        this.source(e, t),
          n(),
      ...
      _normalizePosition(e, t, n, r) {
        const i = t ? t[e] : null;
        void 0 === n &&
          (n = { identifierName: null, line: null, column: null, filename: null, force: !1 });
        const a = n.line,
          s = n.column,
          o = n.filename;
        return (
          (n.identifierName = ('start' === e && t && t.identifierName) || null),
          (n.line = i ? i.line : null),
          (n.column = i ? i.column : null),
          (n.filename = (t && t.filename) || null),
          (r || n.line !== a || n.column !== s || n.filename !== o) && (n.force = r),
          n
        );
      }
      getCurrentColumn() {
    ...
    function i(e, t = {}) {
      return (
        r().isMemberExpression(e)
          ...
          : r().isBinary(e) || r().isAssignmentExpression(e)
          ? (i(e.left, t), i(e.right, t))
          : r().isCallExpression(e)
          ? ((t.hasCall = !0), i(e.callee, t))
          : r().isFunction(e)
          ? (t.hasFunction = !0)
          : r().isIdentifier(e) && (t.hasHelper = t.hasHelper || a(e.callee)),
        t
      );
    }
    function a(e) {
      return r().isMemberExpression(e)
        ...
        ? a(e.callee)
        : !(!r().isBinary(e) && !r().isAssignmentExpression(e)) &&
          ((r().isIdentifier(e.left) && a(e.left)) || a(e.right));
    }
    function s(e) {
      return (
        r().isLiteral(e) ||
        r().isObjectExpression(e) ||
        r().isArrayExpression(e) ||
        r().isIdentifier(e) ||
        r().isMemberExpression(e)
      );
    }
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.list = t.nodes = void 0);
    const o = {
      ...
      LogicalExpression(e) {
        if (r().isFunction(e.left) || r().isFunction(e.right)) return { after: !0 };
      },
      Literal(e) {
        if ('use strict' === e.value) return { after: !0 };
      },
      CallExpression(e) {
        if (r().isFunction(e.callee) || a(e)) return { before: !0, after: !0 };
      },
      VariableDeclaration(e) {
        for (let t = 0; t < e.declarations.length; t++) {
          const n = e.declarations[t];
          let r = a(n.id) && !s(n.init);
          if (!r) {
            const e = i(n.init);
            r = (a(n.init) && e.hasCall) || e.hasFunction;
          }
          if (r) return { before: !0, after: !0 };
        }
      },
      IfStatement(e) {
        if (r().isBlockStatement(e.consequent)) return { before: !0, after: !0 };
      },
    };
    (t.nodes = o),
      (o.ObjectProperty = o.ObjectTypeProperty = o.ObjectMethod = function(e, t) {
        if (t.properties[0] === e) return { before: !0 };
      }),
      (o.ObjectTypeCallProperty = function(e, t) {
        if (!(t.callProperties[0] !== e || (t.properties && t.properties.length)))
          return { before: !0 };
      }),
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, ...t) {
        ...
        if (s > n.length)
          throw new Error(
            `${e}: Too many arguments passed. Received ${s} but can receive no more than ${n.length}`,
          );
        const o = { type: e };
        let l = 0;
        n.forEach(n => {
          ...
          let u;
          l < s && (u = t[l]), void 0 === u && (u = (0, r().default)(a.default)), (o[n] = u), l++;
        });
        for (const e in o) (0, a.default)(o, e, o[e]);
        return o;
      });
    var i = n(13),
      a = s(n(57));
  ...
  function(e, t) {
    e.exports = require('lodash/clone');
  },
  function(e, t) {
    e.exports = require('to-fast-properties');
  },
  function(e, t) {
    e.exports = require('esutils');
  },
  function(e, t, n) {
    'use strict';
    var r = (function(e) {
    ...
    (0, r.default)('AnyTypeAnnotation', { aliases: ['Flow', 'FlowType', 'FlowBaseAnnotation'] }),
      ...
      (0, r.default)('BooleanLiteralTypeAnnotation', {
        builder: ['value'],
        aliases: ['Flow', 'FlowType'],
        fields: { value: (0, r.validate)((0, r.assertValueType)('boolean')) },
      }),
      ...
      i('DeclareClass', 'TypeParameterInstantiation'),
      ...
      (0, r.default)('DeclareModuleExports', {
        visitor: ['typeAnnotation'],
        aliases: ['Flow', 'FlowDeclaration', 'Statement', 'Declaration'],
        fields: { typeAnnotation: (0, r.validateType)('TypeAnnotation') },
      }),
      ...
      (0, r.default)('DeclareExportDeclaration', {
        ...
        fields: {
          ...
          specifiers: (0, r.validateOptional)(
            (0, r.arrayOfType)(['ExportSpecifier', 'ExportNamespaceSpecifier']),
          ),
      ...
      (0, r.default)('ExistsTypeAnnotation', { aliases: ['Flow', 'FlowType'] }),
      ...
      (0, r.default)('InferredPredicate', { aliases: ['Flow', 'FlowPredicate'] }),
      ...
      (0, r.default)('IntersectionTypeAnnotation', {
        visitor: ['types'],
        aliases: ['Flow', 'FlowType'],
        fields: { types: (0, r.validate)((0, r.arrayOfType)('FlowType')) },
      }),
      ...
      (0, r.default)('NumberLiteralTypeAnnotation', {
        builder: ['value'],
        aliases: ['Flow', 'FlowType'],
        fields: { value: (0, r.validate)((0, r.assertValueType)('number')) },
      }),
      ...
      (0, r.default)('ObjectTypeAnnotation', {
        ...
        fields: {
          properties: (0, r.validate)(
            (0, r.arrayOfType)(['ObjectTypeProperty', 'ObjectTypeSpreadProperty']),
          ),
          ...
          exact: { validate: (0, r.assertValueType)('boolean'), default: !1 },
        },
      }),
      ...
      (0, r.default)('StringLiteralTypeAnnotation', {
        builder: ['value'],
        aliases: ['Flow', 'FlowType'],
        fields: { value: (0, r.validate)((0, r.assertValueType)('string')) },
      }),
      (0, r.default)('StringTypeAnnotation', {
        aliases: ['Flow', 'FlowType', 'FlowBaseAnnotation'],
      }),
      (0, r.default)('ThisTypeAnnotation', { aliases: ['Flow', 'FlowType', 'FlowBaseAnnotation'] }),
      ...
      (0, r.default)('TypeParameterDeclaration', {
        aliases: ['Flow'],
        visitor: ['params'],
        fields: { params: (0, r.validate)((0, r.arrayOfType)('TypeParameter')) },
      }),
      (0, r.default)('TypeParameterInstantiation', {
        aliases: ['Flow'],
        visitor: ['params'],
        fields: { params: (0, r.validate)((0, r.arrayOfType)('FlowType')) },
      }),
      ...
      (0, r.default)('Variance', {
        aliases: ['Flow'],
        builder: ['kind'],
        fields: { kind: (0, r.validate)((0, r.assertOneOf)('minus', 'plus')) },
      }),
      (0, r.default)('VoidTypeAnnotation', { aliases: ['Flow', 'FlowType', 'FlowBaseAnnotation'] });
  },
  function(e, t, n) {
    'use strict';
    var r = (function(e) {
    ...
    (0, r.default)('JSXAttribute', {
      ...
      fields: {
        name: { validate: (0, r.assertNodeType)('JSXIdentifier', 'JSXNamespacedName') },
        value: {
          optional: !0,
          validate: (0, r.assertNodeType)(
            'JSXElement',
      ...
      (0, r.default)('JSXClosingElement', {
        ...
        aliases: ['JSX', 'Immutable'],
        fields: {
          name: { validate: (0, r.assertNodeType)('JSXIdentifier', 'JSXMemberExpression') },
        },
      }),
      (0, r.default)('JSXElement', {
        ...
        fields: {
          openingElement: { validate: (0, r.assertNodeType)('JSXOpeningElement') },
          closingElement: { optional: !0, validate: (0, r.assertNodeType)('JSXClosingElement') },
          children: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)(
      ...
      (0, r.default)('JSXExpressionContainer', {
        visitor: ['expression'],
        aliases: ['JSX', 'Immutable'],
        fields: { expression: { validate: (0, r.assertNodeType)('Expression') } },
      }),
      ...
      (0, r.default)('JSXIdentifier', {
        builder: ['name'],
        aliases: ['JSX'],
        fields: { name: { validate: (0, r.assertValueType)('string') } },
      }),
      (0, r.default)('JSXMemberExpression', {
        visitor: ['object', 'property'],
        aliases: ['JSX'],
        fields: {
          object: { validate: (0, r.assertNodeType)('JSXMemberExpression', 'JSXIdentifier') },
          property: { validate: (0, r.assertNodeType)('JSXIdentifier') },
        },
      }),
      (0, r.default)('JSXNamespacedName', {
        ...
        aliases: ['JSX'],
        fields: {
          namespace: { validate: (0, r.assertNodeType)('JSXIdentifier') },
          name: { validate: (0, r.assertNodeType)('JSXIdentifier') },
        },
      }),
      (0, r.default)('JSXOpeningElement', {
        ...
        fields: {
          name: { validate: (0, r.assertNodeType)('JSXIdentifier', 'JSXMemberExpression') },
          selfClosing: { default: !1, validate: (0, r.assertValueType)('boolean') },
          attributes: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)((0, r.assertNodeType)('JSXAttribute', 'JSXSpreadAttribute')),
            ),
          },
          typeParameters: {
            validate: (0, r.assertNodeType)(
      ...
      (0, r.default)('JSXText', {
        aliases: ['JSX', 'Immutable'],
        builder: ['value'],
        fields: { value: { validate: (0, r.assertValueType)('string') } },
      }),
      (0, r.default)('JSXFragment', {
        ...
        aliases: ['JSX', 'Immutable', 'Expression'],
        fields: {
          openingFragment: { validate: (0, r.assertNodeType)('JSXOpeningFragment') },
          closingFragment: { validate: (0, r.assertNodeType)('JSXClosingFragment') },
          children: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)(
      ...
      (0, r.default)('JSXOpeningFragment', { aliases: ['JSX', 'Immutable'] }),
      (0, r.default)('JSXClosingFragment', { aliases: ['JSX', 'Immutable'] });
  },
  function(e, t, n) {
    'use strict';
    var r = (function(e) {
    ...
    (0, r.default)('AwaitExpression', {
      ...
      (0, r.default)('ClassProperty', {
        ...
        fields: Object.assign({}, i.classMethodOrPropertyCommon, {
          value: { validate: (0, r.assertNodeType)('Expression'), optional: !0 },
          definite: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
          typeAnnotation: {
          ...
          readonly: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
        }),
      }),
      (0, r.default)('OptionalMemberExpression', {
        ...
        fields: {
          ...
          computed: { default: !1 },
          optional: { validate: (0, r.assertValueType)('boolean') },
        },
      }),
        ...
        fields: {
          ...
          arguments: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)(
                (0, r.assertNodeType)('Expression', 'SpreadElement', 'JSXNamespacedName'),
              ),
            ),
          },
          optional: { validate: (0, r.assertValueType)('boolean') },
      ...
      (0, r.default)('DoExpression', {
        visitor: ['body'],
        aliases: ['Expression'],
        fields: { body: { validate: (0, r.assertNodeType)('BlockStatement') } },
      }),
      (0, r.default)('ExportDefaultSpecifier', {
        visitor: ['exported'],
        aliases: ['ModuleSpecifier'],
        fields: { exported: { validate: (0, r.assertNodeType)('Identifier') } },
      }),
      ...
      (0, r.default)('PrivateName', {
        visitor: ['id'],
        aliases: ['Private'],
        fields: { id: { validate: (0, r.assertNodeType)('Identifier') } },
      }),
  ...
  function(e, t, n) {
    ...
    const s = (0, r.assertValueType)('boolean'),
      o = {
        returnType: { validate: (0, r.assertNodeType)('TSTypeAnnotation', 'Noop'), optional: !0 },
        typeParameters: {
    ...
    (0, r.default)('TSParameterProperty', {
      ...
      fields: {
        ...
        readonly: { validate: (0, r.assertValueType)('boolean'), optional: !0 },
        parameter: { validate: (0, r.assertNodeType)('Identifier', 'AssignmentPattern') },
      },
    }),
      ...
      (0, r.default)('TSDeclareMethod', {
        ...
        fields: Object.assign({}, a.classMethodOrDeclareMethodCommon, o),
      }),
    ...
    (0, r.default)('TSCallSignatureDeclaration', u),
      (0, r.default)('TSConstructSignatureDeclaration', u);
    const c = {
    ...
    for (const e of p) (0, r.default)(e, { aliases: ['TSType'], visitor: [], fields: {} });
    (0, r.default)('TSThisType', { aliases: ['TSType'], visitor: [], fields: {} });
    const f = { aliases: ['TSType'], visitor: ['typeParameters', 'typeAnnotation'], fields: l };
    (0, r.default)('TSFunctionType', f),
      (0, r.default)('TSConstructorType', f),
      ...
      (0, r.default)('TSTypeQuery', {
        aliases: ['TSType'],
        visitor: ['exprName'],
        fields: { exprName: (0, r.validateType)('TSEntityName') },
      }),
      (0, r.default)('TSTypeLiteral', {
        aliases: ['TSType'],
        visitor: ['members'],
        fields: { members: (0, r.validateArrayOfType)('TSTypeElement') },
      }),
      ...
      (0, r.default)('TSTupleType', {
        ...
        fields: { elementTypes: (0, r.validateArrayOfType)('TSType') },
      });
    const d = {
      aliases: ['TSType'],
      visitor: ['types'],
    ...
    (0, r.default)('TSUnionType', d),
      (0, r.default)('TSIntersectionType', d),
      ...
      (0, r.default)('TSInferType', {
        ...
        fields: { typeParameter: (0, r.validateType)('TSTypeParameter') },
      }),
      ...
      (0, r.default)('TSInterfaceBody', {
        visitor: ['body'],
        fields: { body: (0, r.validateArrayOfType)('TSTypeElement') },
      }),
      ...
      (0, r.default)('TSExternalModuleReference', {
        visitor: ['expression'],
        fields: { expression: (0, r.validateType)('StringLiteral') },
      }),
      ...
      (0, r.default)('TSTypeAnnotation', {
        visitor: ['typeAnnotation'],
        fields: { typeAnnotation: { validate: (0, r.assertNodeType)('TSType') } },
      }),
      ...
      (0, r.default)('TSTypeParameterDeclaration', {
        ...
        fields: {
          params: {
            validate: (0, r.chain)(
              (0, r.assertValueType)('array'),
              (0, r.assertEach)((0, r.assertNodeType)('TSTypeParameter')),
            ),
          },
        },
      }),
      (0, r.default)('TSTypeParameter', {
        ...
        fields: {
          ...
          constraint: { validate: (0, r.assertNodeType)('TSType'), optional: !0 },
          default: { validate: (0, r.assertNodeType)('TSType'), optional: !0 },
        },
      });
  },
  function(e, t, n) {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t, n, i) {
        return (0, r.default)(e, t, [{ type: i ? 'CommentLine' : 'CommentBlock', value: n }]);
      });
    var r = (function(e) {
      return e && e.__esModule ? e : { default: e };
    })(n(61));
  ...
  function(e, t, n) {
    ...
    t.BINARY_TYPES = a;
    const s = r.FLIPPED_ALIAS_KEYS.Scopable;
    t.SCOPABLE_TYPES = s;
    const o = r.FLIPPED_ALIAS_KEYS.BlockParent;
    t.BLOCKPARENT_TYPES = o;
    ...
    t.IMMUTABLE_TYPES = w;
    const k = r.FLIPPED_ALIAS_KEYS.UserWhitespacable;
    t.USERWHITESPACABLE_TYPES = k;
    const N = r.FLIPPED_ALIAS_KEYS.Method;
    t.METHOD_TYPES = N;
    const C = r.FLIPPED_ALIAS_KEYS.ObjectMember;
    t.OBJECTMEMBER_TYPES = C;
    const _ = r.FLIPPED_ALIAS_KEYS.Property;
    t.PROPERTY_TYPES = _;
    const O = r.FLIPPED_ALIAS_KEYS.UnaryLike;
    t.UNARYLIKE_TYPES = O;
    const D = r.FLIPPED_ALIAS_KEYS.Pattern;
    t.PATTERN_TYPES = D;
    const I = r.FLIPPED_ALIAS_KEYS.Class;
    t.CLASS_TYPES = I;
    const L = r.FLIPPED_ALIAS_KEYS.ModuleDeclaration;
    t.MODULEDECLARATION_TYPES = L;
    const F = r.FLIPPED_ALIAS_KEYS.ExportDeclaration;
    t.EXPORTDECLARATION_TYPES = F;
    const M = r.FLIPPED_ALIAS_KEYS.ModuleSpecifier;
    t.MODULESPECIFIER_TYPES = M;
    const j = r.FLIPPED_ALIAS_KEYS.Flow;
    t.FLOW_TYPES = j;
    const R = r.FLIPPED_ALIAS_KEYS.FlowType;
    t.FLOWTYPE_TYPES = R;
    const B = r.FLIPPED_ALIAS_KEYS.FlowBaseAnnotation;
    t.FLOWBASEANNOTATION_TYPES = B;
    const V = r.FLIPPED_ALIAS_KEYS.FlowDeclaration;
    t.FLOWDECLARATION_TYPES = V;
    const q = r.FLIPPED_ALIAS_KEYS.FlowPredicate;
    t.FLOWPREDICATE_TYPES = q;
    const U = r.FLIPPED_ALIAS_KEYS.JSX;
    t.JSX_TYPES = U;
    const K = r.FLIPPED_ALIAS_KEYS.Private;
    t.PRIVATE_TYPES = K;
    const J = r.FLIPPED_ALIAS_KEYS.TSTypeElement;
    t.TSTYPEELEMENT_TYPES = J;
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function e(t, n, o) {
        ...
        let u = !0;
        for (const c of t)
          if (((u = !1), (0, i.isExpression)(c))) l.push(c);
            ...
            for (const e of c.declarations) {
              const t = (0, r.default)(e);
              for (const e in t) o.push({ kind: c.kind, id: (0, s.default)(t[e]) });
              e.init && l.push((0, a.assignmentExpression)('=', e.id, e.init));
            }
            u = !0;
          } else if ((0, i.isIfStatement)(c)) {
            const t = c.consequent ? e([c.consequent], n, o) : n.buildUndefinedNode(),
              r = c.alternate ? e([c.alternate], n, o) : n.buildUndefinedNode();
            if (!t || !r) return;
            l.push((0, a.conditionalExpression)(c.test, t, r));
          } else if ((0, i.isBlockStatement)(c)) {
            const t = e(c.body, n, o);
            if (!t) return;
            l.push(t);
          } else {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function e(t) {
        if (void 0 === t) return (0, s.identifier)('undefined');
        if (!0 === t || !1 === t) return (0, s.booleanLiteral)(t);
        if (null === t) return (0, s.nullLiteral)();
        if ('string' == typeof t) return (0, s.stringLiteral)(t);
        if ('number' == typeof t) {
          let e;
          if (Number.isFinite(t)) e = (0, s.numericLiteral)(Math.abs(t));
          else {
            let n;
            (n = Number.isNaN(t) ? (0, s.numericLiteral)(0) : (0, s.numericLiteral)(1)),
              (e = (0, s.binaryExpression)('/', n, (0, s.numericLiteral)(0)));
          }
          return (t < 0 || Object.is(t, -0)) && (e = (0, s.unaryExpression)('-', e)), e;
        }
        if ((0, i().default)(t)) {
          const e = t.source,
            n = t.toString().match(/\/([a-z]+|)$/)[1];
          return (0, s.regExpLiteral)(e, n);
        }
        if (Array.isArray(t)) return (0, s.arrayExpression)(t.map(e));
        if ((0, r().default)(t)) {
          const n = [];
          for (const r in t) {
            let i;
            (i = (0, a.default)(r) ? (0, s.identifier)(r) : (0, s.stringLiteral)(r)),
              n.push((0, s.objectProperty)(i, e(t[r])));
          }
          return (0, s.objectExpression)(n);
        }
  ...
  function(e, t) {
    e.exports = require('lodash/isRegExp');
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t) {
        ...
        for (const n in t) '_' === n[0] && '__clone' !== n && (e[n] = t[n]);
          ...
          for (const r of o) {
            ...
            if (Array.isArray(o))
              for (let l = 0; l < o.length; l++) {
                const u = o[l];
                u && (s.push({ node: t, key: r, index: l }), e(u, n, i, a, s), s.pop());
              }
            else o && (s.push({ node: t, key: r }), e(o, n, i, a, s), s.pop());
          }
          i && i(t, s, a);
        })(e, i, a, n, []);
      });
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function e(t, n) {
        ...
        for (const r of i) {
          ...
          } else if ('object' != typeof t[r] || (a && a.includes(r))) {
            if (!e(t[r], n[r])) return !1;
          } else for (const e in t[r]) if (t[r][e] !== n[r][e]) return !1;
        }
        return !0;
      });
    var r = n(13);
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t) {
        if ((0, r.isBlockStatement)(e) && (0, r.isFunction)(t, { body: e })) return !1;
        if ((0, r.isBlockStatement)(e) && (0, r.isCatchClause)(t, { body: e })) return !1;
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e) {
        return (
          ...
          (0, r.isIdentifier)(e.imported || e.exported, { name: 'default' })
        );
      });
    var r = n(8);
  },
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e) {
        return (0, r.isVariableDeclaration)(e, { kind: 'var' }) && !e[i.BLOCK_SCOPED_SYMBOL];
      });
    var r = n(8),
      i = n(18);
  },
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.FunctionTypeAnnotation = t.NullableTypeAnnotation = function(e, t) {
        return r().isArrayTypeAnnotation(t);
      }),
      (t.UpdateExpression = function(e, t) {
        return (
          r().isMemberExpression(t, { object: e }) ||
          r().isCallExpression(t, { callee: e }) ||
          r().isNewExpression(t, { callee: e }) ||
          a(e, t)
        );
      }),
      (t.ObjectExpression = function(e, t, n) {
        return l(n, { considerArrow: !0 });
      }),
      (t.DoExpression = function(e, t, n) {
        return l(n);
      }),
      (t.Binary = function(e, t) {
        if ('**' === e.operator && r().isBinaryExpression(t, { operator: '**' }))
          return t.left === e;
        if (a(e, t)) return !0;
        if (
          ((r().isCallExpression(t) || r().isNewExpression(t)) && t.callee === e) ||
          r().isUnaryLike(t) ||
          (r().isMemberExpression(t) && t.object === e) ||
          r().isAwaitExpression(t)
        )
          return !0;
        if (r().isBinary(t)) {
          const n = t.operator,
            ...
            s = e.operator,
            o = i[s];
          if ((a === o && t.right === e && !r().isLogicalExpression(t)) || a > o) return !0;
        }
        return !1;
      }),
      (t.IntersectionTypeAnnotation = t.UnionTypeAnnotation = function(e, t) {
        return (
          r().isArrayTypeAnnotation(t) ||
          r().isNullableTypeAnnotation(t) ||
          r().isIntersectionTypeAnnotation(t) ||
          r().isUnionTypeAnnotation(t)
        );
      }),
      ...
      (t.SequenceExpression = function(e, t) {
        if (
          r().isForStatement(t) ||
          r().isThrowStatement(t) ||
          r().isReturnStatement(t) ||
          (r().isIfStatement(t) && t.test === e) ||
          (r().isWhileStatement(t) && t.test === e) ||
          (r().isForInStatement(t) && t.right === e) ||
          (r().isSwitchStatement(t) && t.discriminant === e) ||
          (r().isExpressionStatement(t) && t.expression === e)
        )
          return !1;
        return !0;
      }),
      (t.AwaitExpression = t.YieldExpression = function(e, t) {
        return (
          ...
          r().isMemberExpression(t) ||
          r().isNewExpression(t) ||
          (r().isConditionalExpression(t) && e === t.test) ||
          a(e, t)
        );
      }),
      (t.ClassExpression = function(e, t, n) {
        return l(n, { considerDefaultExports: !0 });
      }),
      (t.UnaryLike = s),
      ...
      (t.ArrowFunctionExpression = function(e, t) {
        return r().isExportDeclaration(t) || o(e, t);
      }),
      (t.ConditionalExpression = o),
      (t.AssignmentExpression = function(e) {
        return !!r().isObjectPattern(e.left) || o(...arguments);
      }),
    ...
    const i = {
      ...
      a = (e, t) => (r().isClassDeclaration(t) || r().isClassExpression(t)) && t.superClass === e;
    function s(e, t) {
      return (
        r().isMemberExpression(t, { object: e }) ||
        r().isCallExpression(t, { callee: e }) ||
        r().isNewExpression(t, { callee: e }) ||
        r().isBinaryExpression(t, { operator: '**', left: e }) ||
        a(e, t)
      );
    }
    function o(e, t) {
      return (
        !!(
          r().isUnaryLike(t) ||
          r().isBinary(t) ||
          r().isConditionalExpression(t, { test: e }) ||
          r().isAwaitExpression(t) ||
          r().isTaggedTemplateExpression(t) ||
          r().isTSTypeAssertion(t) ||
          r().isTSAsExpression(t)
        ) || s(e, t)
      );
    }
    function l(e, { considerArrow: t = !1, considerDefaultExports: n = !1 } = {}) {
      let i = e.length - 1,
        a = e[i],
        s = e[--i];
      for (; i > 0; ) {
        if (
          r().isExpressionStatement(s, { expression: a }) ||
          r().isTaggedTemplateExpression(s) ||
          (n && r().isExportDefaultDeclaration(s, { declaration: a })) ||
          (t && r().isArrowFunctionExpression(s, { body: a }))
        )
          return !0;
        if (
          !(
            r().isCallExpression(s, { callee: a }) ||
            (r().isSequenceExpression(s) && s.expressions[0] === a) ||
            r().isMemberExpression(s, { object: a }) ||
            r().isConditional(s, { test: a }) ||
            r().isBinary(s, { left: a }) ||
            r().isAssignmentExpression(s, { left: a })
          )
        )
          return !1;
        (a = s), (s = e[--i]);
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.TemplateLiteral = function(e) {
        ...
        for (let n = 0; n < t.length; n++)
          this.print(t[n], e), n + 1 < t.length && this.print(e.expressions[n], e);
      });
  },
  function(e, t, n) {
    'use strict';
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.UnaryExpression = function(e) {
        'void' === e.operator || 'delete' === e.operator || 'typeof' === e.operator
      ...
      (t.OptionalMemberExpression = function(e) {
        if ((this.print(e.object, e), !e.computed && r().isMemberExpression(e.property)))
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.TryStatement = function(e) {
        ...
        e.finalizer &&
          (this.space(), this.word('finally'), this.space(), this.print(e.finalizer, e));
      }),
      (t.CatchClause = function(e) {
        this.word('catch'),
          this.space(),
          e.param && (this.token('('), this.print(e.param, e), this.token(')'), this.space());
        this.print(e.body, e);
      }),
      ...
      (t.SwitchCase = function(e) {
        e.test
          ? (this.word('case'), this.space(), this.print(e.test, e), this.token(':'))
      ...
      (t.VariableDeclaration = function(e, t) {
        ...
        let n,
          i = !1;
        if (!r().isFor(t)) for (const t of e.declarations) t.init && (i = !0);
        i && (n = 'const' === e.kind ? d : f);
        if (
          (this.printList(e.declarations, e, { separator: n }),
          r().isFor(t) && (t.left === e || t.init === e))
        )
          return;
        this.semicolon();
      }),
      (t.VariableDeclarator = function(e) {
        ...
        this.print(e.id.typeAnnotation, e),
          e.init && (this.space(), this.token('='), this.space(), this.print(e.init, e));
      }),
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.ClassExpression = t.ClassDeclaration = function(e, t) {
        (this.format.decoratorsBeforeExport &&
          (r().isExportDefaultDeclaration(t) || r().isExportNamedDeclaration(t))) ||
        ...
        e.implements &&
          (this.space(), this.word('implements'), this.space(), this.printList(e.implements, e));
      ...
      (t.ClassProperty = function(e) {
        ...
        this.print(e.typeAnnotation, e),
          e.value && (this.space(), this.token('='), this.space(), this.print(e.value, e));
        this.semicolon();
      }),
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t._parameters = function(e, t) {
        for (let n = 0; n < e.length; n++)
          this._param(e[n], t), n < e.length - 1 && (this.token(','), this.space());
      }),
      ...
      (t.ArrowFunctionExpression = function(e) {
        ...
        !(function(e, t) {
          return (
            e.typeParameters || e.returnType || t.typeAnnotation || t.optional || t.trailingComments
          );
        })(e, t)
          ? this.print(t, e)
          : this._params(e);
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.DeclareExportDeclaration = function(e) {
        ...
        (function(e) {
          if (e.declaration) {
            ...
            this.token('{'),
              e.specifiers.length && (this.space(), this.printList(e.specifiers, e), this.space()),
              this.token('}'),
              e.source && (this.space(), this.word('from'), this.space(), this.print(e.source, e)),
              this.semicolon();
        }.apply(this, arguments));
      ...
      (t._interfaceish = function(e) {
        this.print(e.id, e),
          this.print(e.typeParameters, e),
          e.extends.length &&
            (this.space(), this.word('extends'), this.space(), this.printList(e.extends, e));
        e.mixins &&
          e.mixins.length &&
          (this.space(), this.word('mixins'), this.space(), this.printList(e.mixins, e));
        e.implements &&
          e.implements.length &&
          (this.space(), this.word('implements'), this.space(), this.printList(e.implements, e));
        this.space(), this.print(e.body, e);
      ...
      (t.OpaqueType = function(e) {
        this.word('opaque'),
          ...
          this.print(e.id, e),
          this.print(e.typeParameters, e),
          e.supertype && (this.token(':'), this.space(), this.print(e.supertype, e));
      ...
      (t.ObjectTypeAnnotation = function(e) {
        ...
        t.length &&
          ...
          this.printJoin(t, e, {
            ...
            statement: !0,
            iterator: () => {
              1 !== t.length && (this.token(','), this.space());
            },
          }),
          this.space());
        e.exact ? this.token('|}') : this.token('}');
      ...
      (t.JSXOpeningElement = function(e) {
        this.token('<'),
          ...
          e.attributes.length > 0 &&
            (this.space(), this.printJoin(e.attributes, e, { separator: r }));
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.TSTypeParameter = function(e) {
        this.word(e.name),
          e.constraint &&
            (this.space(), this.word('extends'), this.space(), this.print(e.constraint, e));
        e.default && (this.space(), this.token('='), this.space(), this.print(e.default, e));
      }),
      ...
      (t.TSPropertySignature = function(e) {
        ...
        this.tsPrintPropertyOrMethodName(e),
          this.print(e.typeAnnotation, e),
          n && (this.space(), this.token('='), this.space(), this.print(n, e));
        this.token(';');
      }),
      ...
      (t.TSMappedType = function(e) {
        const { readonly: t, typeParameter: n, optional: i } = e;
      ...
      (t.TSInterfaceDeclaration = function(e) {
        const { declare: t, id: n, typeParameters: r, extends: i, body: a } = e;
        t && (this.word('declare'), this.space());
        this.word('interface'),
          this.space(),
          this.print(n, e),
          this.print(r, e),
          i && (this.space(), this.word('extends'), this.space(), this.printList(i, e));
      ...
      (t.TSModuleDeclaration = function(e) {
        ...
        for (; 'TSModuleDeclaration' === r.type; )
          this.token('.'), this.print(r.id, r), (r = r.body);
      ...
      function(e, t) {
        var n = r.length ? r.pop() : [],
          ...
          s = (function e(t, n, r, i) {
            ...
            for (var o = r.length; o--; ) if (r[o] === t) return i[o] === n;
            r.push(t), i.push(n);
            var l = 0;
            if ('[object Array]' === s) {
              ...
              if (t.hasOwnProperty('valueOf') && n.hasOwnProperty('valueOf'))
                return t.valueOf() === n.valueOf();
              var u = Object.keys(t);
              if (u.length !== Object.keys(n).length) return !1;
              for (var c = 0; c < u.length; c++)
                if (!('_owner' === u[c] || (n.hasOwnProperty(u[c]) && e(t[u[c]], n[u[c]], r, i))))
                  return !1;
            }
            return r.pop(), i.pop(), !0;
          })(e, t, n, a);
        return (n.length = 0), (a.length = 0), r.push(n), i.push(a), s;
      };
  },
  function(e, t, n) {
    'use strict';
    var r = n(11),
      i = n(82),
      a = i.exactObjectTypeAnnotation,
      s = i.readOnlyArrayOfType,
      o = n(1),
      l = o.GraphQLEnumType,
      u = o.GraphQLInputObjectType,
      c = o.GraphQLInterfaceType,
      p = o.GraphQLList,
      f = o.GraphQLNonNull,
      d = o.GraphQLObjectType,
      h = o.GraphQLScalarType,
      m = o.GraphQLUnionType;
    function y(e, t, n) {
      return e instanceof f ? v(e.ofType, t, n) : r.nullableTypeAnnotation(v(e, t, n));
    }
    function v(e, t, n) {
      if (e instanceof p) return s(y(e.ofType, t, n));
      if (e instanceof d || e instanceof m || e instanceof c) return n;
      if (e instanceof h) return T(e, t);
      if (e instanceof l) return g(e, t);
      throw new Error('Could not convert from GraphQL type '.concat(e.toString()));
    }
    function T(e, t) {
      var n = t.customScalars[e.name];
      switch (n || e.name) {
        case 'ID':
        case 'String':
        ...
        default:
          return null == n ? r.anyTypeAnnotation() : r.genericTypeAnnotation(r.identifier(n));
      }
    }
    function g(e, t) {
      return (t.usedEnums[e.name] = e), r.genericTypeAnnotation(r.identifier(e.name));
    }
    function S(e, t) {
      return e instanceof f ? x(e.ofType, t) : r.nullableTypeAnnotation(x(e, t));
    }
    function x(e, t) {
      if (e instanceof p) return s(S(e.ofType, t));
      if (e instanceof h) return T(e, t);
      if (e instanceof l) return g(e, t);
      if (e instanceof u) {
        var n = (function(e) {
        ...
        if (t.generatedInputObjectTypes[n]) return r.genericTypeAnnotation(r.identifier(n));
        t.generatedInputObjectTypes[n] = 'pending';
        var i = e.getFields(),
          o = Object.keys(i)
            .map(function(e) {
              return i[e];
            ...
            .map(function(e) {
              var n = r.objectTypeProperty(r.identifier(e.name), S(e.type, t));
              return (
                (!(t.optionalInputFields.indexOf(e.name) >= 0) && e.type instanceof f) ||
                  (n.optional = !0),
                n
              );
            });
        return (t.generatedInputObjectTypes[n] = a(o)), r.genericTypeAnnotation(r.identifier(n));
      }
      throw new Error('Could not convert from GraphQL type '.concat(e.toString()));
    }
    e.exports = { transformInputType: S, transformScalarType: y };
  },
  function(e, t, n) {
    'use strict';
    var r = n(178),
      ...
      x = n(194),
      b = n(195),
      E = [l.SCHEMA_EXTENSION, h.SCHEMA_EXTENSION, y.SCHEMA_EXTENSION, m.SCHEMA_EXTENSION],
      P = [l.transform, g.transform, y.transform, d.transform, h.transform, m.transform],
      A = [c.transform, i.transformWithOptions({ flattenAbstractTypes: !0 }), x.transform],
      w = [o.transform, S.transform, b.transform, p.transform],
      k = [
        T.transform,
        u.transform,
        a.transform,
        i.transformWithOptions({ flattenAbstractTypes: !0 }),
        x.transform,
        f.transform,
        r.transform,
      ],
      N = [i.transformWithOptions({}), f.transform, v.transform, r.transform, s.transform];
    e.exports = {
      commonTransforms: P,
      codegenTransforms: k,
      fragmentTransforms: A,
      printTransforms: N,
      queryTransforms: w,
      schemaExtensions: E,
    };
  ...
  function(e, t, n) {
    ...
    e.exports = {
      transform: function(e) {
        return r.transform(e, { Directive: i });
      },
    };
  },
  function(e, t, n) {
    ...
    function s(e) {
      0 !== e.args.length &&
        i(
          !1,
          'InlineFragmentsTransform: Cannot flatten fragment spread `%s` with arguments. Use the `ApplyFragmentArgumentTransform` before flattening',
          e.name,
        );
      var t = this.getContext().getFragment(e.name),
        n = {
          kind: 'InlineFragment',
          directives: e.directives,
          loc: { kind: 'Derived', source: e.loc },
    ...
    e.exports = {
      transform: function(e) {
        return r.transform(e, { Fragment: a, FragmentSpread: s });
      },
    };
  },
  function(e, t, n) {
    ...
    e.exports = {
      transform: function(e) {
        var t = i(e),
          n = e,
          a = l(e.documents(), function(e) {
            if ('Root' === e.kind) {
              var i = t.getRoot(e.name),
                a = u(e.argumentDefinitions),
                s = u(i.argumentDefinitions),
                l = [],
                c = !0,
                p = !1,
                f = void 0;
              try {
                for (var d, h = s.values()[Symbol.iterator](); !(c = (d = h.next()).done); c = !0) {
                  var m = d.value;
                  a.has(m.name) || l.push(m);
                }
              } catch (e) {
                (p = !0), (f = e);
              } finally {
              ...
              if (0 !== l.length)
                throw o(
                  "Operation '".concat(e.name, "' references undefined variable(s):\n").concat(
                    l
                      .map(function(e) {
              ...
              n = n.replace(
                (0, r.default)({}, e, {
                  argumentDefinitions: e.argumentDefinitions.filter(function(e) {
                    return s.has(e.name);
                  }),
                }),
              );
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      u = n(183),
      c = n(10),
      p = c.createCompilerError,
      f = c.createNonRecoverableUserError,
      d = o.getFragmentScope,
      h = o.getRootScope;
    function m(e, t, n, r, a) {
      var s = v(e, t, n, r.selections, a);
      if (!s) return null;
      if (r.hasOwnProperty('directives')) {
        var o = T(n, r.directives, a);
        return (0, i.default)({}, r, { directives: o, selections: s });
      }
      return (0, i.default)({}, r, { selections: s });
    }
    function y(e, t, n, r, s) {
      var o = T(n, r.directives, s),
        c = (function(e, t, n, r, s, o) {
          var c = e.getFragment(r.name),
            p = (function(e, t, n) {
              if (!e.length) return null;
              var r = (0, a.default)(e).sort(function(e, t) {
                  return e.name < t.name ? -1 : e.name > t.name ? 1 : 0;
                }),
                i = JSON.stringify(
                  r.map(function(e) {
                    ...
                    if ('Variable' === e.value.kind) {
                      if (null == (n = t[e.value.variableName]))
                        throw f("Variable '$".concat(e.value.variableName, "' is not in scope."), [
                          e.value.loc,
                        ]);
                    } else n = e.value;
                    return { name: e.name, value: l(n) };
                  }),
                );
              return u(i);
            })(s, n),
            h = p ? ''.concat(c.name, '_').concat(p) : c.name,
            m = t.get(h);
          if (m) return m;
          var y = d(c.argumentDefinitions, s, n, r);
          if (null === t.get(h))
            throw f(
              "Found a circular reference from fragment '".concat(c.name, "'."),
              o.map(function(e) {
                return e.loc;
              }),
            );
          t.set(h, null);
          var T = null,
            g = v(e, t, y, c.selections, o);
          g && (T = (0, i.default)({}, c, { selections: g, name: h, argumentDefinitions: [] }));
          return t.set(h, T), T;
        })(e, t, n, r, r.args, (0, a.default)(s).concat([r]));
      return c
        ? (0, i.default)({}, r, { kind: 'FragmentSpread', args: [], directives: o, name: c.name })
        : null;
    }
    function v(e, t, n, r, s) {
      ...
      return (
        r.forEach(function(r) {
          var l;
          if ('InlineFragment' === r.kind || 'MatchBranch' === r.kind) l = m(e, t, n, r, s);
          else if ('FragmentSpread' === r.kind) l = y(e, t, n, r, s);
          else if ('Condition' === r.kind) {
            var u,
              c = (function(e, t, n, r, a) {
                var s = S(n, r.condition, a);
                if ('Literal' !== s.kind && 'Variable' !== s.kind)
                  throw f(
                    'A non-scalar value was applied to an @include or @skip directive, the `if` argument value must be a variable or a literal Boolean.',
                    [s.loc],
                  );
                if ('Literal' === s.kind && s.value !== r.passingValue) return null;
                var o = v(e, t, n, r.selections, a);
                return o
                  ? 'Literal' === s.kind && s.value === r.passingValue
                    ? o
                    : [(0, i.default)({}, r, { condition: s, selections: o })]
                  : null;
              })(e, t, n, r, s);
            if (c) (u = o = o || []).push.apply(u, (0, a.default)(c));
          } else {
            if ('LinkedField' !== r.kind && 'ScalarField' !== r.kind && 'MatchField' !== r.kind)
              throw 'Defer' === r.kind || 'Stream' === r.kind
                ? p(
                    'RelayApplyFragmentArgumentTransform: Expected to be applied before processing @defer/@stream.',
                    [r.loc],
                  )
                : p(
                    "RelayApplyFragmentArgumentTransform: Unsupported kind '".concat(r.kind, "'."),
                    [r.loc],
                  );
            l = (function(e, t, n, r, a) {
              var s = g(n, r.args, a),
                o = T(n, r.directives, a);
              if ('LinkedField' === r.kind || 'MatchField' === r.kind) {
                var l = v(e, t, n, r.selections, a);
                return l ? (0, i.default)({}, r, { args: s, directives: o, selections: l }) : null;
              }
              return (0, i.default)({}, r, { args: s, directives: o });
            })(e, t, n, r, s);
          }
          l && (o = o || []).push(l);
        }),
    ...
    function T(e, t, n) {
      return t.map(function(t) {
        var r = g(e, t.args, n);
        return (0, i.default)({}, t, { args: r });
      });
    }
    function g(e, t, n) {
      return t.map(function(t) {
        var r = S(e, t.value, n);
        return r === t.value ? t : (0, i.default)({}, t, { value: r });
      });
    }
    function S(e, t, n) {
      if ('Variable' === t.kind) {
        var r = e[t.variableName];
        if (null == r) throw f("Variable '$".concat(t.variableName, "' is not in scope."), [t.loc]);
        return r;
      }
      return 'ListValue' === t.kind
        ...
        ? (0, i.default)({}, t, {
            fields: t.fields.map(function(t) {
              return (0, i.default)({}, t, { value: S(e, t.value, n) });
            }),
          })
        : t;
    }
    e.exports = {
      transform: function(e) {
        ...
        return Array.from(t.values()).reduce(function(e, t) {
          return t ? e.add(t) : e;
        }, n);
      },
    };
  ...
  function(e, t, n) {
    'use strict';
    var r = n(10),
      i = r.createCombinedError,
      a = r.createUserError,
      s = r.eachWithErrors,
      o = n(1).GraphQLNonNull;
    e.exports = {
      getFragmentScope: function(e, t, n, r) {
        var l = new Map();
        t.forEach(function(e) {
          'Literal' === e.value.kind
            ? l.set(e.name, e.value)
            : 'Variable' === e.value.kind && l.set(e.name, n[e.value.variableName]);
        });
        var u = {},
          c = s(e, function(e) {
            if ('RootArgumentDefinition' === e.kind) {
              if (l.has(e.name)) {
                ...
                throw a(
                  "Unexpected argument '"
                    .concat(e.name, "' supplied to fragment '")
                    .concat(
                      r.name,
                      "'. @arguments may only be provided for variables defined in the fragment's @argumentDefinitions.",
                    ),
                  [
                    null !== (n = null === i || void 0 === i ? void 0 : i.loc) && void 0 !== n
                      ? n
                      : r.loc,
                  ],
                );
              }
              u[e.name] = { kind: 'Variable', metadata: null, variableName: e.name, type: e.type };
            } else {
              var s = l.get(e.name);
              if (null == s || ('Literal' === s.kind && null == s.value)) {
                if (null == e.defaultValue && e.type instanceof o) {
                  var c,
                    p = t.find(function(t) {
                      return t.name === e.name;
                    });
                  throw a(
                    "No value found for required argument '"
                      .concat(e.name, ': ')
                      .concat(String(e.type), "' on fragment '")
                      .concat(r.name, "'."),
                    [
                      null !== (c = null === p || void 0 === p ? void 0 : p.loc) && void 0 !== c
                        ? c
                        : r.loc,
                    ],
                  );
                }
                u[e.name] = { kind: 'Literal', value: e.defaultValue };
              } else u[e.name] = s;
            }
          });
        if (null != c && c.length) throw i(c);
        return u;
      },
      getRootScope: function(e) {
        ...
        return (
          e.forEach(function(e) {
            t[e.name] = { kind: 'Variable', metadata: null, variableName: e.name, type: e.type };
          }),
          t
        );
      },
  ...
  function(e, t, n) {
    ...
    e.exports = function(e) {
      for (var t, n = e.length, i = 3 & n, a = n ^ i, s = 0, o = 0; o !== a; ) {
        var l = e.charCodeAt(o + 3);
        (t =
          e.charCodeAt(o) ^
          (e.charCodeAt(o + 1) << 8) ^
          (e.charCodeAt(o + 2) << 16) ^
          ...
          (s =
            (5 *
              (s =
                ((s ^= t =
                  (13715 *
                    (t = ((t = (11601 * t + 3432906752 * (65535 & t)) >>> 0) << 15) | (t >>> 17)) +
                    461832192 * (65535 & t)) >>>
                  0) <<
                  13) |
                (s >>> 19)) +
      ...
      switch (((t = 0), i)) {
        case 3:
          t ^= e.charCodeAt(a + 2) << 16;
        case 2:
          t ^= e.charCodeAt(a + 1) << 8;
        case 1:
          s ^= t =
            (13715 *
              (t =
                ((t = (11601 * (t ^= e.charCodeAt(a)) + 3432906752 * (65535 & t)) >>> 0) << 15) |
                (t >>> 17)) +
              461832192 * (65535 & t)) >>>
            0;
      }
      if (
        ((s ^= n),
        (s = (51819 * (s ^= s >>> 16) + 2246770688 * (65535 & s)) >>> 0),
        (s = (44597 * (s ^= s >>> 13) + 3266445312 * (65535 & s)) >>> 0),
        (s ^= s >>> 16),
        !(s >>>= 0))
      )
        return '0';
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      T = d.LAST,
      g = n(1),
      S = g.assertCompositeType,
      x = g.GraphQLInterfaceType,
      b = g.GraphQLList,
      E = g.GraphQLObjectType,
      P = g.GraphQLScalarType,
      A = g.GraphQLUnionType,
      w = g.parse,
      k = n(19).ConnectionInterface,
      N = 'connection',
      C = 'handler';
    function _(e, t) {
      var n = this.traverse(e, t),
        r = t.connectionMetadata;
      return r.length
        ? (0, i.default)({}, n, { metadata: (0, i.default)({}, n.metadata, { connection: r }) })
        : n;
    }
    function O(e, t) {
      var n,
        r = l.getNullableType(e.type) instanceof b;
      t.path.push(r ? null : e.alias || e.name);
      var s = this.traverse(e, t),
        c = e.directives.find(function(e) {
          return e.name === N;
        });
      if (!c) return t.path.pop(), s;
      var d = t.definitionName;
      !(function(e, t) {
        var n = k.get().EDGES;
        if (!D(t, y) && !D(t, T))
          throw f(
            'Expected field `'.concat(t.name, ': ') +
              ''
                .concat(String(t.type), '` to have a ')
                .concat(y, ' or ')
                .concat(T, ' argument in ') +
              'document `'.concat(e, '`.'),
            [t.loc],
          );
        if (
          ...
          throw f(
            'Expected field `'.concat(t.name, ': ') +
              ''.concat(String(t.type), '` to have a ').concat(n, ' selection in document ') +
              '`'.concat(e, '`.'),
            [t.loc],
          );
      })(d, s),
        (function(e, t) {
          var n = t.type,
            ...
            p = r.PAGE_INFO,
            d = r.START_CURSOR,
            h = l.assertTypeWithFields(l.getNullableType(n)).getFields(),
            m = h[a];
          if (null == m)
            throw f(
              "Expected type '"
                .concat(String(n), "' to have an '")
                .concat(a, "' field in document '")
                .concat(e, "'."),
              [t.loc],
            );
          var y = l.getNullableType(m.type);
          if (!(y instanceof b))
            throw f(
              "Expected '"
                .concat(a, "' field on type '")
                .concat(String(n), "' to be a list type in document '")
                .concat(e, "'."),
              [t.loc],
            );
          var v = l.getNullableType(y.ofType);
          if (!(v instanceof E))
            throw f(
              "Expected '"
                .concat(a, "' field on type '")
                .concat(String(n), "' to be a list of objects in document '")
                .concat(e, "'."),
              [t.loc],
            );
          var T = v.getFields()[c];
          if (null == T)
            throw f(
              "Expected type '"
                .concat(String(n), "' to have have a '")
                .concat(a, ' { ')
                .concat(c, " }' field in in document '")
                .concat(e, "'."),
              [t.loc],
            );
          var g = l.getNullableType(T.type);
          if (!(g instanceof x || g instanceof A || g instanceof E))
            throw f(
              "Expected type '"
                .concat(String(n), "' to have a '")
                .concat(a, ' { ')
                .concat(
                  c,
                  " }' field for which the type is an interface, object, or union in document '",
                )
                .concat(e, "'."),
              [t.loc],
            );
          var S = v.getFields()[i];
          if (null == S || !(l.getNullableType(S.type) instanceof P))
            throw f(
              "Expected type '"
                .concat(String(n), "' to have a '")
                .concat(a, ' { ')
                .concat(i, " }' scalar field in document '")
                .concat(e, "'."),
              [t.loc],
            );
          var w = h[p];
          if (null == w)
            throw f(
              "Expected type '"
                .concat(String(n), "' to have a '")
                .concat(a, ' { ')
                .concat(p, " }' field in document '")
                .concat(e, "'."),
              [t.loc],
            );
          var N = l.getNullableType(w.type);
          if (!(N instanceof E))
            throw f(
              "Expected type '"
                .concat(String(n), "' to have a '")
                .concat(a, ' { ')
                .concat(p, " }' field with object type in document '")
                .concat(e, "'."),
              [t.loc],
            );
          [s, o, u, d].forEach(function(n) {
            var r = N.getFields()[n];
            if (null == r || !(l.getNullableType(r.type) instanceof P))
              throw f(
                "Expected type '"
                  .concat(String(w.type), "' to have a '")
                  .concat(n, "' scalar field in document '")
                  .concat(e, "'."),
                [t.loc],
              );
          });
        })(d, s);
      var g = t.path.includes(null),
        _ = D(s, y),
        O = D(s, T),
        I = null,
        L = null,
        F = null;
      _ && !O
        ? ((I = 'forward'), (L = _), (F = D(s, h)))
        : O && !_
        ? ((I = 'backward'), (L = O), (F = D(s, m)))
        : O && _ && (I = 'bidirectional');
      var M = L && 'Variable' === L.value.kind ? L.value.variableName : null,
        j = F && 'Variable' === F.value.kind ? F.value.variableName : null;
      t.connectionMetadata.push({
        count: M,
        cursor: j,
        direction: I,
        path: g ? null : (0, a.default)(t.path),
      }),
        t.path.pop();
      var R = u(c.args),
        B = R.handler,
      ...
      if (null != B && 'string' != typeof B) {
        var U,
          K,
          J = c.args.find(function(e) {
            return 'key' === e.name;
          });
        throw f(
          'Expected the '.concat(C, ' argument to ') +
            '@'.concat(N, ' to be a string literal for field ').concat(e.name, '.'),
          [
            null !==
              (U =
                null === J || void 0 === J
                  ? void 0
                  : null === (K = J.value) || void 0 === K
                  ? void 0
                  : K.loc) && void 0 !== U
              ? U
              : c.loc,
      ...
      if ('string' != typeof V) {
        var X,
          Y,
          G = c.args.find(function(e) {
            return 'key' === e.name;
          });
        throw f(
          'Expected the '.concat(v, ' argument to ') +
            '@'.concat(N, ' to be a string literal for field ').concat(e.name, '.'),
          [
            null !==
              (X =
      ...
      var W = e.alias || e.name;
      if (!V.endsWith('_' + W)) {
        var Q,
          H,
          z = c.args.find(function(e) {
            return 'key' === e.name;
          });
        throw f(
          'Expected the '.concat(v, ' argument to ') +
            '@'
              .concat(N, ' to be of form <SomeName>_')
              .concat(W, ", got '")
              .concat(V, "'. ") +
            'For detailed explanation, check out https://facebook.github.io/relay/docs/en/pagination-container.html#connection',
          [
            null !==
              (Q =
                null === z || void 0 === z
                  ? void 0
                  : null === (H = z.value) || void 0 === H
                  ? void 0
                  : H.loc) && void 0 !== Q
              ? Q
              : c.loc,
      ...
      var $ = {
        ...
        filters:
          ...
          (function() {
            var t = e.args
              .filter(function(e) {
                return !k.isConnectionCall({ name: e.name, value: null });
              })
              .map(function(e) {
                return e.name;
              });
          ...
          v +=
            'forward' === r
              ...
              : '{\n      '
                  ...
                  .concat(f, '\n      ')
                  .concat(m, '\n    }');
          var T = 'fragment ConnectionFragment on '
              .concat(String(y), ' {\n      ')
              .concat(s, ' {\n        ')
              .concat(a, '\n        ')
              .concat(
              ...
              .concat(v, '\n    }'),
            g = w(T).definitions[0];
          if (null == g || 'FragmentDefinition' !== g.kind)
            throw p(
              'RelayConnectionTransform: Expected a fragment definition AST.',
              null,
              [g].filter(Boolean),
            );
          var x = o.transform(e.clientSchema, [g])[0];
          if (null == x || 'Fragment' !== x.kind)
            throw p(
              'RelayConnectionTransform: Expected a connection fragment.',
              [null === x || void 0 === x ? void 0 : x.loc].filter(Boolean),
            );
          return {
            directives: [],
            kind: 'InlineFragment',
            loc: { kind: 'Derived', source: t },
            metadata: null,
            selections: x.selections,
            typeCondition: y,
          };
        })(this.getContext(), s.loc, s.type, I);
        s = (0, i.default)({}, s, { selections: s.selections.concat(Z) });
      }
      return (0, i.default)({}, s, {
        directives: s.directives.filter(function(e) {
          return e.name !== N;
        }),
        handles: s.handles ? (0, a.default)(s.handles).concat([$]) : [$],
      });
    }
    function D(e, t) {
      return (
        e.args &&
        e.args.find(function(e) {
          return e.name === t;
        })
      );
    }
    e.exports = {
      ...
      transform: function(e) {
        return s.transform(e, { Fragment: _, LinkedField: O, MatchField: O, Root: _ }, function(e) {
          return { path: [], connectionMetadata: [], definitionName: e.name };
        });
      },
    };
  },
  function(e, t, n) {
    'use strict';
    e.exports = { AFTER: 'after', BEFORE: 'before', FIRST: 'first', KEY: 'key', LAST: 'last' };
  },
  function(e, t, n) {
    'use strict';
    var r = n(0)(n(4)),
      i = (n(3), n(5)),
      a = n(6).getNullableType,
      s = n(10).createUserError,
      o = n(1).GraphQLList;
    function l(e, t) {
      var n,
        i,
        l = this.traverse(e, t),
        u = l.directives.find(function(e) {
          return 'stream' === e.name;
        });
      if (null == u) return l;
      if (!(a(e.type) instanceof o))
        throw s("Invalid use of @stream on non-plural field '".concat(e.name, "'"), [u.loc]);
      l = (0, r.default)({}, l, {
        directives: l.directives.filter(function(e) {
          return 'stream' !== e.name;
        }),
      });
      ...
      if (h(c)) return l;
      var p = u.args.find(function(e) {
          return 'initial_count' === e.name;
        }),
        m = f(u, 'label'),
        y = d(t.documentName, 'stream', m);
      return {
        if: null !== (n = null === c || void 0 === c ? void 0 : c.value) && void 0 !== n ? n : null,
        initialCount:
          null !== (i = null === p || void 0 === p ? void 0 : p.value) && void 0 !== i ? i : null,
        kind: 'Stream',
        label: y,
        loc: { kind: 'Derived', source: u.loc },
        metadata: null,
        selections: [l],
      };
    }
    function u(e, t) {
      ...
      if (null != n)
        throw s("Invalid use of @stream on scalar field '".concat(e.name, "'"), [n.loc]);
      return this.traverse(e, t);
    }
    function c(e, t) {
      var n,
        i = this.traverse(e, t),
        a = i.directives.find(function(e) {
          return 'defer' === e.name;
        });
      if (null == a) return i;
      i = (0, r.default)({}, i, {
      ...
      var s = a.args.find(function(e) {
        return 'if' === e.name;
      });
      if (h(s)) return i;
      var o = f(a, 'label'),
        l = d(t.documentName, 'defer', o);
      return {
        if: null !== (n = null === s || void 0 === s ? void 0 : s.value) && void 0 !== n ? n : null,
        kind: 'Defer',
        label: l,
        loc: { kind: 'Derived', source: a.loc },
        metadata: null,
        selections: [i],
      };
    }
    ...
    function f(e, t) {
      var n,
        r = e.args.find(function(e) {
          return e.name === t;
        }),
        i = null != r && 'Literal' === r.value.kind ? r.value.value : null;
      if ('string' != typeof i)
        throw s(
          "Expected the '".concat(t, "' value to @").concat(e.name, ' to be a string literal.'),
          [
            null !== (n = null === r || void 0 === r ? void 0 : r.value.loc) && void 0 !== n
              ? n
              : e.loc,
          ],
        );
    ...
    e.exports = {
      transform: function(e) {
        return i.transform(
          e,
          { FragmentSpread: p, InlineFragment: c, LinkedField: l, ScalarField: u },
          function(e) {
            return { documentName: e.name };
          },
        );
      },
    };
  ...
  function(e, t, n) {
    ...
    function o(e) {
      ...
      1 !== t.length &&
        a(
          !1,
          'RelayFieldHandleTransform: Expected fields to have at most one "handle" property, got `%s`.',
          t.join(', '),
        );
      var n = e.alias || e.name,
        i = t[0],
        o = s(i.name, i.key, e.name),
        l = i.filters,
        u = l
          ...
          : [];
      return (0, r.default)({}, e, { args: u, alias: n, name: o, handles: null });
    }
    e.exports = {
      transform: function(e) {
        return i.transform(e, { LinkedField: o, MatchField: o, ScalarField: o });
      },
    };
  },
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      s = (n(3), n(5)),
      o = n(6),
      l = n(84).hasUnaliasedSelection,
      u = n(1),
      c = u.assertAbstractType,
      p = u.assertCompositeType,
      f = u.assertLeafType,
      d = o.canHaveSelections,
      h = o.getRawType,
      m = o.hasID,
      y = o.implementsInterface,
      v = o.isAbstractType,
      T = o.mayImplement,
      g = 'id',
      S = 'ID',
    ...
    function b(e, t) {
      ...
      if (d(s) && m(r, s))
        return (0, i.default)({}, n, {
          selections: (0, a.default)(n.selections).concat([t.idField]),
        });
      if (v(s)) {
        var o = (0, a.default)(n.selections);
        if (T(r, s, x)) {
          var u = p(r.getType(x));
          o.push(E(u, t.idField));
        }
        var f = c(s);
        return (
          r.getPossibleTypes(f).forEach(function(e) {
            !y(e, x) && m(r, e) && o.push(E(e, t.idField));
          }),
          (0, i.default)({}, n, { selections: o })
        );
      }
      return n;
    }
    ...
    e.exports = {
      transform: function(e) {
        var t = f(e.serverSchema.getType(S)),
          n = {
            idField: {
              kind: 'ScalarField',
              alias: null,
        ...
        return s.transform(e, { LinkedField: b, MatchField: b }, function() {
          return n;
        });
      },
    };
  ...
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      o = n(6),
      l = n(84).hasUnaliasedSelection,
      u = n(1).assertLeafType,
      c = o.isAbstractType,
      p = '__typename',
      f = 'String';
    function d(e, t) {
      var n = this.traverse(e, t);
      return c(n.type) && !l(n, p)
        ? (0, i.default)({}, n, {
            selections: [t.typenameField].concat((0, a.default)(n.selections)),
          })
        : n;
    }
    e.exports = {
      transform: function(e) {
        var t = u(e.serverSchema.getType(f)),
          n = {
            typenameField: {
              kind: 'ScalarField',
              alias: null,
        ...
        return s.transform(e, { LinkedField: d, MatchField: d }, function() {
          return n;
        });
      },
    };
  ...
  function(e, t, n) {
    ...
    var r = n(0)(n(4)),
      i = (n(3), n(5));
    function a(e) {
      var t = this.traverse(e);
      return t.handles ? (0, r.default)({}, t, { handles: null }) : t;
    }
    e.exports = {
      transform: function(e) {
        return i.transform(e, { LinkedField: a, MatchField: a, ScalarField: a });
      },
    };
  },
  function(e, t, n) {
    ...
    function a(e, t) {
      var n = this.traverse(e, t),
        r = {
          ...
          selections: n.selections,
          loc: { kind: 'Derived', source: e.loc },
          metadata: { derivedFrom: n.name },
          type: n.type,
        };
      return t.set(e.name, r), n;
    }
    e.exports = {
      transform: function(e) {
        var t = new Map();
        return r
          .transform(e, { MatchBranch: a }, function() {
            return t;
          })
          .addAll(Array.from(t.values()));
      },
    };
  },
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      s = (n(3), n(5)),
      o = n(6),
      l = n(1).GraphQLObjectType,
      u = n(19).DEFAULT_HANDLE_KEY,
      c = o.getRawType,
      p = 'id',
      f = 'viewer',
      d = 'Viewer';
    function h(e) {
      var t = this.traverse(e);
      if (c(e.type).name !== d) return t;
      var n = t.handles,
        r = { name: f, key: u, filters: null };
      return (
        n &&
        !n.find(function(e) {
          return e.name === f;
        })
          ? (n = (0, a.default)(n).concat([r]))
          : n || (n = [r]),
        n !== t.handles ? (0, i.default)({}, t, { handles: n }) : t
      );
    }
    e.exports = {
      transform: function(e) {
        var t = e.serverSchema.getType(d);
        return null != t && t instanceof l && null == t.getFields()[p]
          ? s.transform(e, { LinkedField: h, MatchField: h })
          : e;
      },
    };
  },
  function(e, t, n) {
    ...
    var r = n(5),
      i = n(2),
      a = n(6),
      s = a.assertTypeWithFields,
      o = a.canHaveSelections,
      l = a.getRawType,
      u = n(1),
      c = u.SchemaMetaFieldDef,
      p = u.TypeMetaFieldDef,
      f = u.TypeNameMetaFieldDef;
    function d(e, t) {
      if (
        (o(t) && s(t).getFields()[e.name]) ||
        e.name === c.name ||
        e.name === p.name ||
        e.name === f.name ||
        ...
        var n = l(e.type),
          r = this.getContext().serverSchema.getType(n.name);
        return (
          r ||
            i(
              !1,
              'SkipClientFieldTransform: Expected type `%s` to be defined in the server schema.',
              n.name,
            ),
          this.traverse(e, r)
        );
    ...
    function h(e, t) {
      var n = this.getContext(),
        r = n.getFragment(e.name);
      return n.serverSchema.getType(r.type.name) ? this.traverse(e, t) : null;
    }
    function m(e, t) {
      var n = this.getContext().serverSchema.getType(e.typeCondition.name);
      return n ? this.traverse(e, n) : null;
    }
    e.exports = {
      transform: function(e) {
        return r.transform(
          e,
          { FragmentSpread: h, InlineFragment: m, LinkedField: d, MatchField: d, ScalarField: d },
          function(t) {
            return (function(e, t) {
              var n = e.serverSchema;
              switch (t.kind) {
                case 'Fragment':
                  return n.getType(t.type.name);
                case 'Root':
                  switch (t.operation) {
                    case 'query':
                      return n.getQueryType();
                    case 'mutation':
                      return n.getMutationType();
                    case 'subscription':
  ...
  function(e, t, n) {
    ...
    function c(e) {
      return (function e(t, n) {
        var r = [];
        (function(e) {
          return (0, a.default)(e).sort(function(e, t) {
            return 'InlineFragment' === e.kind || 'Condition' === e.kind
              ? 1
              : 'InlineFragment' === t.kind || 'Condition' === t.kind
              ? -1
              : 0;
          });
        })(t.selections).forEach(function(t) {
          ...
          switch (t.kind) {
            case 'ScalarField':
            case 'FragmentSpread':
              n.has(i) || (r.push(t), (n = n.set(i, null)));
              break;
            case 'Defer':
            case 'Stream':
            case 'MatchBranch':
            case 'MatchField':
            case 'LinkedField':
              var a = e(t, n.get(i) || new o());
              a.node && (r.push(a.node), (n = n.set(i, a.selectionMap)));
              break;
            case 'InlineFragment':
            case 'Condition':
              var s = e(t, n.get(i) || n);
              s.node && (r.push(s.node), (n = n.set(i, s.selectionMap)));
              break;
            default:
              u(!1, 'SkipRedundantNodesTransform: Unexpected node kind `%s`.', t.kind);
          }
        });
        var s = r.length ? (0, i.default)({}, t, { selections: r }) : null;
        return { selectionMap: n, node: s };
      })(e, new o()).node;
    }
    e.exports = {
      transform: function(e) {
        return s.transform(e, { Root: c, Fragment: c });
      },
    };
  },
  function(e, t, n) {
    ...
    var r = n(0),
      ...
      c = 'variable';
    function p(e) {
      return 'Variable' === e.condition.kind ? c : e.condition.value === e.passingValue ? u : l;
    }
    e.exports = {
      transform: function(e) {
        var t = new Map(),
          n = s.transform(e, {
            Root: function(n) {
              return (function e(t, n, r) {
                for (var s, l = (0, a.default)(r.selections); l.length; ) {
                  var f = l.shift(),
                    d = void 0;
                  switch (f.kind) {
                    case 'Condition':
                      var h = p(f);
                      h === u
                        ? l.unshift.apply(l, (0, a.default)(f.selections))
                        : h === c && (d = e(t, n, f));
                      break;
                    case 'FragmentSpread':
                      if (!n.has(f.name)) {
                        var m = t.getFragment(f.name),
                          y = e(t, n, m);
                        n.set(f.name, y);
                      }
                      n.get(f.name) && (d = f);
                ...
                return s ? (0, i.default)({}, r, { selections: s }) : null;
              })(e, t, n);
            },
            Fragment: function(e) {
              return null;
  ...
  function(e, t, n) {
    ...
    var r = n(0)(n(7)),
      ...
      l = n(2),
      u = n(14),
      c = n(197).memoizedFind,
      p = s.instrument(a.parse, 'GraphQL.parse'),
      f = { validateNames: !0 };
    e.exports = function(e) {
      var t = c.bind(null, e);
      function n(e, t) {
        var n = s(e, t);
        if (n) return n.document;
      }
      function s(e, n) {
        var i = o.readFileSync(u.join(e, n.relPath), 'utf8');
        i.indexOf('graphql') >= 0 ||
          l(
            !1,
            'RelaySourceModuleParser: Files should be filtered before passed to the parser, got unfiltered file `%s`.',
            n.relPath,
          );
        var s = [],
          c = [];
        return (
          t(i, e, n, f).forEach(function(e) {
            var t = new a.Source(e, n.relPath),
              i = p(t);
            i.definitions.length ||
              l(
                !1,
                'RelaySourceModuleParser: Expected GraphQL text to contain at least one definition (fragment, mutation, query, subscription), got `%s`.',
                e,
              ),
              c.push(t.body),
              s.push.apply(s, (0, r.default)(i.definitions));
          }),
          { document: { kind: 'Document', definitions: s }, sources: c }
        );
      }
      return {
        getParser: function(e) {
          return new i({ baseDir: e, parse: n });
        },
        getFileFilter: function(e) {
          return function(t) {
            return o.readFileSync(u.join(e, t.relPath), 'utf8').indexOf('graphql') >= 0;
          };
        },
        parseFile: n,
        parseFileWithSources: s,
      };
    };
  },
  function(e, t, n) {
    ...
    var r = n(198),
      ...
      s = n(14),
      o = n(29),
      l = new r('RelayFindGraphQLTags', 'v1');
    function u(e, t, n, r) {
      var s = r.validateNames,
        o = e(t, n);
      if (s) {
        var l = i(n);
        o.forEach(function(e) {
          return (function(e, t, n) {
            var r = e.template,
              i = e.keyName,
              s = e.sourceLocationOffset;
            a.parse(new a.Source(r, n, s)).definitions.forEach(function(e) {
              e.name ||
                c(
                  !1,
              ...
              if ('OperationDefinition' === e.kind) {
                var r = n.match(/^(.*)(Mutation|Query|Subscription)$/);
                (r && n.startsWith(t)) ||
                  c(
                    !1,
                    'RelayFindGraphQLTags: Operation names in graphql tags must be prefixed with the module name and end in "Mutation", "Query", or "Subscription". Got `%s` in module `%s`.',
                    n,
                    t,
                  );
              } else 'FragmentDefinition' === e.kind && (i ? n !== t + '_' + i && c(!1, 'RelayFindGraphQLTags: Container fragment names must be `<ModuleName>_<propName>`. Got `%s`, expected `%s`.', n, t + '_' + i) : n.startsWith(t) || c(!1, 'RelayFindGraphQLTags: Fragment names in graphql tags must be prefixed with the module name. Got `%s` in module `%s`.', n, t));
            });
          })(e, l, n);
        });
      }
    ...
    function c(e, t) {
      if (!e) {
        for (var n = arguments.length, r = new Array(n > 2 ? n - 2 : 0), i = 2; i < n; i++)
          r[i - 2] = arguments[i];
        throw new Error(o.format.apply(o, [t].concat(r)));
      }
    }
    e.exports = {
      find: u,
      memoizedFind: function(e, t, n, r, i) {
        return (
          r.exists || c(!1, 'RelayFindGraphQLTags: Called with non-existent file `%s`', r.relPath),
          l.getOrCompute(
            r.hash + (i.validateNames ? '1' : '0'),
            u.bind(null, e, t, s.join(n, r.relPath), i),
          )
        );
      },
    };
  ...
  function(e, t, n) {
    ...
    var r = n(0)(n(46)),
      ...
      u = (function() {
        function e(e, t) {
          (0, r.default)(this, '_dir', null), (this._name = e), (this._cacheBreaker = t);
        }
        var t = e.prototype;
        return (
          (t._getFile = function(e) {
            if (null == this._dir) {
              var t = o.userInfo().username,
                n = a
                  .createHash('md5')
                  .update(this._cacheBreaker)
                  .update(t)
                  .digest('hex'),
                r = l.join(o.tmpdir(), ''.concat(this._name, '-').concat(n));
              if (!s.existsSync(r))
                try {
                  s.mkdirSync(r);
                } catch (e) {
          ...
          (t.getOrCompute = function(e, t) {
            var n = this;
            return i.run('RelayCompilerCache.getOrCompute', function() {
              var r = n._getFile(e);
              if (s.existsSync(r))
                try {
                  return JSON.parse(s.readFileSync(r, 'utf8'));
                } catch (e) {}
              var i = t();
              try {
                s.writeFileSync(r, JSON.stringify(i), 'utf8');
              } catch (e) {}
              return i;
            });
          }),
  ...
  function(e, t, n) {
    ...
    var r = n(14);
    e.exports = function(e) {
      var t = r.basename(e, r.extname(e)),
        n = 'index' === (t = t.replace(/(?:\.\w+)+/, '')) ? r.basename(r.dirname(e)) : t;
      return (n = (n = n.replace(/(?:\.\w+)+/, '')).replace(/[^a-zA-Z0-9]+(\w?)/g, function(e, t) {
  ...
  function(e, t, n) {
    ...
    e.exports = function(e) {
      e.moduleName;
      var t = e.documentType,
        n = e.docText,
        r = e.concreteText,
        i = e.typeText,
        a = e.hash,
        s = e.sourceHash,
        o = t ? 'import type { '.concat(t, " } from 'relay-runtime';") : '',
        l = n ? '\n/*\n' + n.trim() + '\n*/\n' : '',
        u = a ? '\n * '.concat(a) : '';
      return '/**\n * '
        .concat('@', 'flow', u, "\n */\n\n/* eslint-disable */\n\n'use strict';\n\n/*::\n")
  ...
  function(e, t, n) {
    ...
    var l = {
      addRemove: (function() {
        var e = i(function*(e, t) {
          e.length > 0 && (yield o('hg', ['add'].concat((0, a.default)(e)))),
            t.length > 0 && (yield o('hg', ['forget'].concat((0, a.default)(t))));
        });
        return function(t, n) {
          return e.apply(this, arguments);
        };
    ...
    e.exports = { SourceControlMercurial: l };
  },
  function(e, t) {
