    ...
    if (definition.kind === 'RootArgumentDefinition') {
      if (argMap.has(definition.name)) {
        ...
        throw createUserError(
          ...
          [
            (_ref = argNode === null || argNode === void 0 ? void 0 : argNode.loc) !== null &&
            _ref !== void 0
              ? _ref
              : spread.loc,
          ],
        ...
        if (definition.defaultValue == null && definition.type instanceof GraphQLNonNull) {
          ...
          throw createUserError(
            "No value found for required argument '"
              ...
              .concat(String(definition.type), "' on fragment '")
              .concat(spread.name, "'."),
            [
              (_ref2 = _argNode === null || _argNode === void 0 ? void 0 : _argNode.loc) !== null &&
              _ref2 !== void 0
                ? _ref2
                : spread.loc,
            ],
