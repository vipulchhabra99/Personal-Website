...
function createUserError(message, locations, nodes) {
  ...
  return new GraphQLError(
    messageWithLocations,
    (_nodes = nodes) !== null && _nodes !== void 0 ? _nodes : [],
  );
}
/**
...
function createNonRecoverableUserError(message, locations, nodes) {
  ...
  var error = new GraphQLError(
    messageWithLocations,
    (_nodes2 = nodes) !== null && _nodes2 !== void 0 ? _nodes2 : [],
  );
...
function createCompilerError(message, locations, nodes) {
  ...
  var error = new GraphQLError(
    ...
    (_nodes3 = nodes) !== null && _nodes3 !== void 0 ? _nodes3 : [],
  );
  return new Error(error.message);
}
/**
...
function createCombinedError(errors, maybePrefix) {
  ...
  return new Error(
    ''.concat(prefix, 'Encountered ').concat(errors.length, ' error(s):\n') +
      errors
        .map(function(error) {
          return String(error)
            .split('\n')
...
function printLocations(locations) {
  ...
  try {
    for (
      var _iterator2 = locations[Symbol.iterator](), _step2;
      ...
      switch (sourceLocation.kind) {
        ...
        default: {
          ...
          throw createCompilerError(
            "RelayCompilerError: cannot print location '".concat(String(sourceLocation), "'."),
          );
        }
      }
    }
