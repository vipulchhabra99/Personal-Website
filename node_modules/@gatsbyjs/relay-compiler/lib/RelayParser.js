...
var GraphQLDefinitionParser =
  ...
  (function() {
          ...
          if (
            ...
            throw createUserError(
              "Variable '$"
                ...
                .concat(String(usedAsType), "'. Source: ")
    ...
    _proto2._transformFragment = function _transformFragment(fragment) {
      ...
      try {
        for (
          var _iterator = this._unknownVariables[Symbol.iterator](), _step;
      ...
      switch (definition.operation) {
        ...
        default:
          ...
          throw createCompilerError(
            "Unknown ast kind '"
              .concat(definition.operation, "'. Source: ")
              .concat(this._getErrorContext(), '.'),
            null,
            [definition],
          );
    ...
    _proto2._transformSelections = function _transformSelections(selectionSet, parentType) {
      ...
      return selectionSet.selections.map(function(selection) {
        ...
        if (selection.kind === 'Field') {
          ...
          throw createCompilerError(
            "Unknown ast kind '"
              .concat(selection.kind, "'. Source: ")
              .concat(_this5._getErrorContext(), '.'),
            [selection],
          );
        }
        ...
        if (conditionalNodes.length !== 1) {
          throw createCompilerError(
            'Expected exactly one condition node. Source: '.concat(_this5._getErrorContext()),
            null,
    ...
    _proto2._transformInlineFragment = function _transformInlineFragment(fragment, parentType) {
      var typeCondition = assertCompositeType(
        fragment.typeCondition ? getTypeFromAST(this._schema, fragment.typeCondition) : parentType,
      );
    ...
    _proto2._transformFragmentSpread = function _transformFragmentSpread(
      ...
      var fragmentArgumentDefinitions =
        fragmentDefinition === null || fragmentDefinition === void 0
          ? void 0
      ...
      if (argumentDirectives.length) {
        args = (argumentDirectives[0].arguments || []).map(function(arg) {
          ...
          var argumentDefinition =
            fragmentArgumentDefinitions != null ? fragmentArgumentDefinitions.get(argName) : null;
          var argumentType =
            (_ref =
              argumentDefinition === null || argumentDefinition === void 0
                ? void 0
                : argumentDefinition.type) !== null && _ref !== void 0
              ? _ref
              : null;
          ...
          if (argValue.kind === 'Variable') {
            ...
            if (argumentType == null) {
              ...
              throw createUserError(
                ...
                [
                  arg.value,
                  (_this$_entries$get = _this6._entries.get(fragmentName)) === null ||
                  _this$_entries$get === void 0
                    ? void 0
                    : _this$_entries$get.definition,
                ].filter(Boolean),
              );
            }
    ...
    _proto2._transformField = function _transformField(field, parentType) {
      ...
      if (fieldDef == null) {
        throw createUserError(
          "Unknown field '"
            .concat(name, "' on type '")
            .concat(String(parentType), "'. Source: ")
            .concat(this._getErrorContext()),
          null,
          [field],
        );
          ...
          if (typeof maybeHandle !== 'string') {
            throw createUserError(
              'Expected a string literal argument for the @'.concat(CLIENT_FIELD, ' directive. ') +
                'Source: '.concat(_this7._getErrorContext()),
              null,
    ...
    _proto2._transformDirectives = function _transformDirectives(directives) {
      ...
      return directives.map(function(directive) {
        ...
        if (directiveDef == null) {
          throw createUserError(
            "Unknown directive '".concat(name, "'. Source: ").concat(_this8._getErrorContext()),
            null,
            [directive],
          );
        }
    ...
    _proto2._transformArguments = function _transformArguments(args, argumentDefinitions) {
      ...
      return args.map(function(arg) {
        ...
        if (argDef == null) {
          throw createUserError(
            "Unknown argument '".concat(argName, "'. Source: ").concat(_this9._getErrorContext()),
            null,
            [arg],
          );
        }
        ...
        if (arg == null || arg.name !== IF) {
          throw createUserError(
            "Expected an 'if' argument to @"
              .concat(directive.name, '. Source: ')
              .concat(_this10._getErrorContext()),
            [directive.loc],
          );
        }
        ...
        if (!(arg.value.kind === 'Variable' || arg.value.kind === 'Literal')) {
          throw createUserError(
            "Expected the 'if' argument to @"
              .concat(directive.name, ' to be a variable or literal. Source: ')
              .concat(_this10._getErrorContext()),
            [directive.loc],
          );
        }
    ...
    _proto2._transformNonNullLiteral = function _transformNonNullLiteral(ast, type) {
      ...
      if (nullableType instanceof GraphQLList) {
        ...
        ast.fields.forEach(function(field) {
          ...
          if (fieldConfig == null) {
            throw createUserError(
              "Uknown field '".concat(fieldName, "' on type '").concat(String(type), "'."),
              null,
              [field],
            );
          }
        ...
        if (ast.kind === 'IntValue') {
          ...
          throw createUserError(
            "Invalid value, expected a value matching type '".concat(String(type), "'."),
            null,
            [ast],
          );
        }
        ...
        nullableType;
        throw createCompilerError(
          "Unsupported type '".concat(String(type), "' for input value, expected a GraphQLList, ") +
