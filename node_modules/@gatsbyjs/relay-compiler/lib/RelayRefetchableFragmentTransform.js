  ...
  var errors = eachWithErrors(refetchOperations, function(_ref2) {
    ...
    if (isEquivalentType(fragment.type, queryType)) {
      ...
      (fragment.type instanceof GraphQLObjectType &&
        fragment.type.getInterfaces().some(function(interfaceType) {
      ...
      nextContext = nextContext.replace(
        (0, _objectSpread2['default'])({}, fragment, {
          metadata: (0, _objectSpread2['default'])({}, fragment.metadata || {}, {
            refetch: {
              connection:
                (_connectionMetadata = connectionMetadata) !== null &&
                _connectionMetadata !== void 0
                  ? _connectionMetadata
                  : null,
...
function buildRefetchMap(context) {
  ...
  return new Map(
    Array.from(refetchOperations.entries(), function(_ref3) {
      var name = _ref3[0],
        fragment = _ref3[1];
      ...
      enter: function enter(field) {
        ...
        if (
          ...
          path = fields.map(function(pathField) {
            ...
            return (_pathField$alias = pathField.alias) !== null && _pathField$alias !== void 0
              ? _pathField$alias
              : pathField.name;
          });
        }
...
function buildFragmentSpread(fragment) {
  ...
  try {
    for (
      var _iterator = fragment.argumentDefinitions[Symbol.iterator](), _step;
...
function buildRefetchOperationOnNodeType(schema, fragment, queryName) {
  ...
  if (
    !(
      ...
      isEquivalentType(getNullableType(nodeField.args[0].type), GraphQLID) && // the fragment must be on Node or on a type that implements Node
...
function getRefetchQueryName(fragment) {
  ...
  if (typeof queryName !== 'string') {
    ...
    throw createCompilerError(
      ...
      [
        (_ref = queryNameArg === null || queryNameArg === void 0 ? void 0 : queryNameArg.loc) !==
          null && _ref !== void 0
          ? _ref
