...
function compileRelayArtifacts(context, transforms, reporter) {
  return Profiler.run('GraphQLCompiler.compile', function() {
    ...
    var fragmentContext = context.applyTransforms(
      (0, _toConsumableArray2['default'])(transforms.commonTransforms).concat(
        (0, _toConsumableArray2['default'])(transforms.fragmentTransforms),
      ),
      reporter,
    ); // The unflattened query is used for printing, since flattening creates an
    // invalid query.

    var printContext = context.applyTransforms(
      (0, _toConsumableArray2['default'])(transforms.commonTransforms).concat(
        (0, _toConsumableArray2['default'])(transforms.queryTransforms),
        (0, _toConsumableArray2['default'])(transforms.printTransforms),
      ),
      reporter,
    ...
    var codeGenContext = context.applyTransforms(
      (0, _toConsumableArray2['default'])(transforms.commonTransforms).concat(
        (0, _toConsumableArray2['default'])(transforms.queryTransforms),
        (0, _toConsumableArray2['default'])(transforms.codegenTransforms),
      ),
      reporter,
    );
    ...
    try {
      for (
        var _iterator = codeGenContext.documents()[Symbol.iterator](), _step;
    ...
    try {
      for (
        var _iterator2 = fragmentContext.documents()[Symbol.iterator](), _step2;
