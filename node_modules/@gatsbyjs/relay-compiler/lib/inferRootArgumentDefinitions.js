...
function transformRoot(context, transformed, root) {
  ...
  try {
    for (
      var _iterator = root.argumentDefinitions.entries()[Symbol.iterator](), _step;
      ...
      return {
        defaultValue:
          (_ref =
            localDefinition === null || localDefinition === void 0
              ? void 0
              : localDefinition.defaultValue) !== null && _ref !== void 0
            ? _ref
            : null,
        ...
        type:
          (_ref2 =
            localDefinition === null || localDefinition === void 0
              ? void 0
              : localDefinition.type) !== null && _ref2 !== void 0
            ? _ref2
            : argDef.type,
      };
    }),
...
function visit(context, transformed, argumentDefinitions, node) {
  GraphQLIRVisitor.visit(node, {
    FragmentSpread: function FragmentSpread(fragmentSpread) {
      ...
      try {
        for (
          var _iterator2 = referencedFragmentArguments.values()[Symbol.iterator](), _step2;
