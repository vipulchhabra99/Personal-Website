...
function visitLinkedOrMatchField(field, options) {
  ...
  if (handler != null && typeof handler !== 'string') {
    ...
    throw createUserError(
      'Expected the '.concat(HANDLER, ' argument to ') +
        '@'.concat(CONNECTION, ' to be a string literal for field ').concat(field.name, '.'),
      [
        (_ref =
          handleArg === null || handleArg === void 0
            ...
            ? void 0
            : _handleArg$value.loc) !== null && _ref !== void 0
          ? _ref
  ...
  if (typeof key !== 'string') {
    ...
    throw createUserError(
      'Expected the '.concat(KEY, ' argument to ') +
        '@'.concat(CONNECTION, ' to be a string literal for field ').concat(field.name, '.'),
      [
        (_ref2 =
          keyArg === null || keyArg === void 0
            ...
            ? void 0
            : _keyArg$value.loc) !== null && _ref2 !== void 0
          ? _ref2
          : connectionDirective.loc,
      ],
    );
  ...
  if (!key.endsWith('_' + postfix)) {
    ...
    throw createUserError(
      'Expected the '.concat(KEY, ' argument to ') +
        '@'
          .concat(CONNECTION, ' to be of form <SomeName>_')
          .concat(postfix, ", got '")
          .concat(key, "'. ") +
      ...
      [
        (_ref3 =
          _keyArg === null || _keyArg === void 0
            ...
            ? void 0
            : _keyArg$value2.loc) !== null && _ref3 !== void 0
          ? _ref3
          : connectionDirective.loc,
      ],
    );
  ...
  var generateFilters = function generateFilters() {
    var filteredVariableArgs = field.args
      .filter(function(arg) {
  ...
  if (direction !== null) {
    var fragment = generateConnectionFragment(
      this.getContext(),
  ...
  return (0, _objectSpread2['default'])({}, transformedField, {
    ...
    handles: transformedField.handles
      ? (0, _toConsumableArray2['default'])(transformedField.handles).concat([handle])
      : [handle],
  });
}
/**
...
function generateConnectionFragment(context, loc, type, direction) {
  ...
  var fragmentString = 'fragment ConnectionFragment on '
    .concat(String(compositeType), ' {\n      ')
    .concat(EDGES, ' {\n        ')
    .concat(CURSOR, '\n        ')
    .concat(
      NODE,
  ...
  if (fragment == null || fragment.kind !== 'Fragment') {
    throw createCompilerError(
      ...
      [fragment === null || fragment === void 0 ? void 0 : fragment.loc].filter(Boolean),
    );
  }
...
function validateConnectionSelection(definitionName, field) {
  ...
  if (!findArg(field, FIRST) && !findArg(field, LAST)) {
    throw createUserError(
      'Expected field `'.concat(field.name, ': ') +
        ''
          .concat(String(field.type), '` to have a ')
          .concat(FIRST, ' or ')
          .concat(LAST, ' argument in ') +
        'document `'.concat(definitionName, '`.'),
      [field.loc],
    );
  }
  ...
  if (
    ...
    throw createUserError(
      'Expected field `'.concat(field.name, ': ') +
        ''.concat(String(field.type), '` to have a ').concat(EDGES, ' selection in document ') +
        '`'.concat(definitionName, '`.'),
      [field.loc],
    );
  }
}
...
function validateConnectionType(definitionName, field) {
  ...
  if (edges == null) {
    throw createUserError(
      "Expected type '"
        .concat(String(type), "' to have an '")
        .concat(EDGES, "' field in document '")
        .concat(definitionName, "'."),
      [field.loc],
    );
  }
  ...
  if (!(edgesType instanceof GraphQLList)) {
    throw createUserError(
      "Expected '"
        .concat(EDGES, "' field on type '")
        .concat(String(type), "' to be a list type in document '")
        .concat(definitionName, "'."),
      [field.loc],
    );
  }
  ...
  if (!(edgeType instanceof GraphQLObjectType)) {
    throw createUserError(
      "Expected '"
        .concat(EDGES, "' field on type '")
        .concat(String(type), "' to be a list of objects in document '")
        .concat(definitionName, "'."),
      [field.loc],
    );
  }
  ...
  if (node == null) {
    throw createUserError(
      "Expected type '"
        .concat(String(type), "' to have have a '")
        .concat(EDGES, ' { ')
        .concat(NODE, " }' field in in document '")
        .concat(definitionName, "'."),
      [field.loc],
    );
  }
  ...
  if (cursor == null || !(SchemaUtils.getNullableType(cursor.type) instanceof GraphQLScalarType)) {
    throw createUserError(
      "Expected type '"
        .concat(String(type), "' to have a '")
        .concat(EDGES, ' { ')
        .concat(CURSOR, " }' scalar field in document '")
        .concat(definitionName, "'."),
      [field.loc],
    );
  }
  ...
  if (pageInfo == null) {
    throw createUserError(
      "Expected type '"
        .concat(String(type), "' to have a '")
        .concat(EDGES, ' { ')
        .concat(PAGE_INFO, " }' field in document '")
        .concat(definitionName, "'."),
      [field.loc],
    );
  }
  ...
  if (!(pageInfoType instanceof GraphQLObjectType)) {
    throw createUserError(
      "Expected type '"
        .concat(String(type), "' to have a '")
        .concat(EDGES, ' { ')
        .concat(PAGE_INFO, " }' field with object type in document '")
        .concat(definitionName, "'."),
      [field.loc],
    );
  }
  ...
  [END_CURSOR, HAS_NEXT_PAGE, HAS_PREV_PAGE, START_CURSOR].forEach(function(fieldName) {
    ...
    if (
      pageInfoField == null ||
      !(SchemaUtils.getNullableType(pageInfoField.type) instanceof GraphQLScalarType)
    ) {
      throw createUserError(
        "Expected type '"
          .concat(String(pageInfo.type), "' to have a '")
          .concat(fieldName, "' scalar field in document '")
          .concat(definitionName, "'."),
        [field.loc],
      );
    }
