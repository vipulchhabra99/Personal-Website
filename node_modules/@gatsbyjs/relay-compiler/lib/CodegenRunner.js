  ...
  (function() {
    ...
    function CodegenRunner(options) {
      ...
      var _loop = function _loop(_writer) {
        ...
        config.baseParsers &&
          config.baseParsers.forEach(function(parser) {
      ...
      return Profiler.asyncContext(
        ...
        _asyncToGenerator(function*() {
          ...
          for (var configName in _this3.writerConfigs) {
            ...
            try {
              for (
                var _iterator = filePaths[Symbol.iterator](), _step;
          ...
          yield Promise.all(
            Object.keys(_this3.parserConfigs).map(function(parserConfigName) {
    ...
    _proto.parseEverything =
      ...
      (function() {
        var _parseEverything = _asyncToGenerator(function*(parserName) {
          ...
          var filter = parserConfig.getFileFilter
        ...
        _asyncToGenerator(function*() {
          try {
            ...
            if (generatedDirectoriesWatchmanExpression) {
              var relativePaths = yield CodegenWatcher.queryDirectories(
                _baseDir,
                generatedDirectoriesWatchmanExpression,
              );
            ...
            try {
              for (
                var _iterator2 = outputDirectories.values()[Symbol.iterator](), _step2;
                !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
                _iteratorNormalCompletion2 = true
              ) {
                var dir = _step2.value;
                var all = (0, _toConsumableArray2['default'])(dir.changes.created).concat(
                ...
                try {
                  for (
                    var _iterator3 = all[Symbol.iterator](), _step3;
            ...
            var combinedChanges = CodegenDirectory.combineChanges(
    ...
    _proto.watch =
      ...
      (function() {
        var _watch = _asyncToGenerator(function*(parserName) {
          ...
          yield CodegenWatcher.watchCompile(
            parserConfig.baseDir,
            parserConfig.watchmanExpression,
            ...
            (function() {
              var _ref4 = _asyncToGenerator(function*(files) {
                ...
                try {
                  ...
                  yield Promise.all(
                    dependentWriters.map(function(writer) {
                ...
                _this6._reporter.reportMessage(
                  'Watching for changes to '.concat(parserName, '...'),
                );
              });
