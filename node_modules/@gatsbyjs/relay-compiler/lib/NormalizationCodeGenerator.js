...
var NormalizationCodeGenVisitor = {
  leave: {
    ...
    Defer: function Defer(node, key, parent, ancestors) {
      ...
      return {
        if:
          ((_node$if2 = node['if']) === null || _node$if2 === void 0 ? void 0 : _node$if2.kind) ===
          'Variable'
    ...
    MatchField: function MatchField(node, key, parent, ancestors) {
      ...
      selections.forEach(function(selection) {
        ...
        if (selection.kind !== 'MatchBranch') {
          throw createCompilerError(
            "NormalizationCodeGenerator: Expected selection for MatchField '"
              .concat(node.name, "' to be a 'MatchBranch', got '")
              .concat(selection.kind, "'."),
            [selection.loc],
          );
        }
        ...
        if (matchesByType.hasOwnProperty(selection.type)) {
          throw createCompilerError(
            'NormalizationCodeGenerator: Each @match type can appear at-most ' +
              "once. Type '".concat(String(selection.type), "' was duplicated."),
            selection.type,
            [selection.loc],
          );
        }
        ...
        var regExpMatch = fragmentName.match(
        ...
        var fragmentPropName =
          (_regExpMatch$ = regExpMatch[2]) !== null && _regExpMatch$ !== void 0
            ? _regExpMatch$
            : 'matchData';
    ...
    Stream: function Stream(node, key, parent, ancestors) {
      ...
      if (
        ...
        throw createCompilerError(
          ...
          [
            (_ref2 =
              (_node$if3 = node['if']) === null || _node$if3 === void 0
                ? void 0
                : _node$if3.loc) !== null && _ref2 !== void 0
              ? _ref2
              : node.loc,
          ],
        );
      ...
      return {
        if:
          ((_node$if4 = node['if']) === null || _node$if4 === void 0 ? void 0 : _node$if4.kind) ===
          'Variable'
            ? node['if'].variableName
            : null,
        kind: 'Stream',
