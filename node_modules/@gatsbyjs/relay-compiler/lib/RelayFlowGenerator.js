...
function makeProp(_ref, state, unmasked, concreteType) {
  ...
  if (nodeType) {
    value = transformScalarType(
      nodeType,
      state,
      selectionsToBabel([Array.from(nullthrows(nodeSelections).values())], state, unmasked),
    );
  }
  ...
  if (
    ...
    (function() {
      ...
      var _loop = function _loop(concreteType) {
        types.push(
          groupRefs(
            (0, _toConsumableArray2['default'])(Array.from(baseFields.values())).concat(
...
function mergeSelections(a, b) {
  ...
  try {
    for (
      var _iterator = a.entries()[Symbol.iterator](), _step;
  ...
  try {
    for (
      var _iterator2 = b.entries()[Symbol.iterator](), _step2;
  ...
  return {
    leave: {
      Root: function Root(node) {
        ...
        var responseType = exportType(
          ''.concat(node.name, 'Response'),
          selectionsToBabel(node.selections, state, false),
        );
        var operationType = exportType(
          node.name,
        ...
        return t.program(
          (0, _toConsumableArray2['default'])(getFragmentImports(state))
            .concat(
              (0, _toConsumableArray2['default'])(getEnumDefinitions(state)),
              [importedTypes.length ? importTypes(importedTypes, 'relay-runtime') : null],
              (0, _toConsumableArray2['default'])(inputObjectTypes),
              [inputVariablesType, responseType, operationType],
            )
            .filter(Boolean),
        );
      },
      Fragment: function Fragment(node) {
        ...
        var refType = t.declareExportDeclaration(
          t.declareOpaqueType(
        ...
        return t.program(
          (0, _toConsumableArray2['default'])(getFragmentImports(state)).concat(
            (0, _toConsumableArray2['default'])(getEnumDefinitions(state)),
            [importTypes(importedTypes, 'relay-runtime'), refType, exportType(node.name, type)],
          ),
        );
      },
      ...
      ScalarField: function ScalarField(node) {
        ...
        return [
          {
            key:
              (_node$alias = node.alias) !== null && _node$alias !== void 0
                ? _node$alias
                : node.name,
      ...
      LinkedField: function LinkedField(node) {
        ...
        return [
          {
            key:
              (_node$alias2 = node.alias) !== null && _node$alias2 !== void 0
                ? _node$alias2
                : node.name,
            schemaName: node.name,
            nodeType: node.type,
      ...
      MatchField: function MatchField(node) {
        ...
        return [
          {
            key:
              (_node$alias3 = node.alias) !== null && _node$alias3 !== void 0
                ? _node$alias3
                : node.name,
            schemaName: node.name,
...
function getFragmentImports(state) {
  ...
  if (state.usedFragments.size > 0) {
    ...
    try {
      for (
        var _iterator3 = usedFragments[Symbol.iterator](), _step3;
