...
const types = new Map([
  ...
  [
    'error',
    {
      ...
      fixtures: [new Error('🦄'), new ErrorSubclassFixture()],
    },
  ],
  [
    'nativePromise',
  ...
  [
    'uint8ClampedArray',
    {
      ...
      fixtures: [new Uint8ClampedArray(0)],
    },
  ],
  [
    'int16Array',
  ...
  [
    'safeInteger',
    {
      ...
      fixtures: [Math.pow(2, 53) - 1, -Math.pow(2, 53) + 1],
    },
  ],
  [
    'domElement',
    {
      ...
      fixtures: ['div', 'input', 'span', 'img', 'canvas', 'script'].map(createDomElement),
    },
  ],
  [
    'non-domElements',
...
ava_1.default('is.primitive', t => {
  const primitives = [undefined, null, '🦄', 6, Infinity, -Infinity, true, false, Symbol('🦄')];
