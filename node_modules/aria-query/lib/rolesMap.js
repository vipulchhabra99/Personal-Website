...
[_ariaAbstractRoles2.default, _ariaLiteralRoles2.default, _ariaDpubRoles2.default].forEach(function(
  roleSet,
) {
      ...
      try {
        for (
          ...
          if (superClassDefinition) {
            ...
            try {
              for (
                var _iterator3 = Object.keys(superClassDefinition.props)[Symbol.iterator](), _step3;
