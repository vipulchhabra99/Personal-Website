...
async function createTextImage(width, height, font, { x = 0, y = 0, text, maxWidth, maxHeight }) {
...
describe('Write text over image', function() {
    ...
    if (hasOwnProp(fontDefs, fontName))
      ((fontName, conf) => {
        it('Jimp preset ' + fontName + ' bitmap font', async () => {
          ...
          const expected = getTestDir(__dirname) + '/images/' + fontName + '.png';
  ...
  it('Jimp preset SANS_16_BLACK bitmap font positioned', async () => {
    ...
    const expected = getTestDir(__dirname) + '/images/SANS_16_BLACK-positioned.png';
    const expectedImg = await Jimp.read(expected);
  ...
  it('Jimp can print numbers too', async () => {
    ...
    image.print(font, 0, 0, 12345678, 100).bitmap.data.should.be.deepEqual(expectedImg.bitmap.data);
  });

  it('left-align text by default', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/left-aligned.png');
  ...
  it('center-align text when passing object with alignmentX', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/center-aligned.png');
    const textImage = await createTextImage(320, 240, Jimp.FONT_SANS_16_BLACK, {
      text: {
        text: 'This is only a test.',
  ...
  it('right-align text when passing object with alignmentX', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/right-aligned.png');
    const textImage = await createTextImage(320, 240, Jimp.FONT_SANS_16_BLACK, {
      text: {
        text: 'This is only a test.',
  ...
  it('middle-align text when passing object with alignmentY', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/middle-aligned.png');
    const textImage = await createTextImage(320, 240, Jimp.FONT_SANS_16_BLACK, {
      text: {
        text: 'This is only a test.',
  ...
  it('middle-align text when passing object with alignmentY can offset y', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/middle-aligned-y.png');
    const textImage = await createTextImage(320, 240, Jimp.FONT_SANS_16_BLACK, {
      y: 50,
  ...
  it('bottom-align text when passing object with alignmentY', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/bottom-aligned.png');
    const textImage = await createTextImage(320, 240, Jimp.FONT_SANS_16_BLACK, {
      text: {
        text: 'This is only a test.',
  ...
  it('bottom-align text when passing object with alignmentY offset y', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/bottom-aligned-y.png');
    const textImage = await createTextImage(320, 240, Jimp.FONT_SANS_16_BLACK, {
      y: 100,
  ...
  it('exposes print y position in cb', async () => {
    const expectedImage = await Jimp.read(getTestDir(__dirname) + '/images/spacing.png');
