...
for (var i = 2; i < 65; i++) {
  var maxHash = (0, _anyBase.default)(_anyBase.default.BIN, alphabet.slice(0, i))(
...
function loadFromURL(options, cb) {
  (0, _request.default)(options, function(err, response, data) {
    ...
    var msg =
      'Could not load Buffer from <' + options.url + '> ' + '(HTTP: ' + response.statusCode + ')';
...
var Jimp =
  ...
  (function(_EventEmitter) {
    ...
    function Jimp() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), 'writeAsync', function(
        path,
      ) {
        ...
        if (extraConstructor) {
          new Promise(function(resolve, reject) {
            ...
            return (_extraConstructor$run = extraConstructor.run).call.apply(
              ...
              [_assertThisInitialized(_assertThisInitialized(_this)), resolve, reject].concat(args),
            );
          })
            .then(function() {
      ...
      },
      {
        ...
        value: function setPixelColor(hex, x, y, cb) {
          if (typeof hex !== 'number' || typeof x !== 'number' || typeof y !== 'number')
            return _utils.throwError.call(this, 'hex, x and y must be numbers', cb); // round input
