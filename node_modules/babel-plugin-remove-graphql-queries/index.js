          ...
          JSXIdentifier(path2) {
            if (
              ...
              path2.parent.attributes.push(
                t.jSXAttribute(t.jSXIdentifier(`data`), t.jSXExpressionContainer(identifier)),
              ); // Add import
              ...
              const importDeclaration = t.importDeclaration(
                ...
                t.stringLiteral(
                  filename
                    ? nodePath.relative(nodePath.parse(filename).dir, resultPath)
                    : shortResultPath,
                ),
              );
        ...
        const nestedHookVisitor = {
          CallExpression(path2) {
            if (
              ...
              if (importPath.isImportSpecifier())
                if (parent.node.specifiers.length === 1) parent.remove();
                else importPath.remove(); // Add query
