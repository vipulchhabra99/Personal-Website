!(function(t, e) {
  ...
  var u = a;
  var c = function(t, e, n, o, r, i, a, u) {
      if (!t) {
        var c;
        if (void 0 === e)
          c = new Error(
    ...
    g = r(function(t, n) {
      ...
      (n.default =
        ...
        function(t, n) {
            ...
            f = (function(t) {
              function e() {
                ...
                for (var a = arguments.length, s = Array(a), p = 0; p < a; p++)
                  s[p] = arguments[p];
                return (
                  (n = o = c(this, t.call.apply(t, [this].concat(s)))),
                  (o.emitter =
                    ((r = o.props.value),
                    (i = []),
                    {
          ...
          f.childContextTypes =
            (((o = {})[s] = r.default.object.isRequired), o);
          var h = (function(e) {
            function n() {
              var t, o;
              u(this, n);
              for (var r = arguments.length, i = Array(r), a = 0; a < r; a++)
                i[a] = arguments[a];
              return (
                (t = o = c(this, e.call.apply(e, [this].concat(i)))),
          ...
          return (
            (h.contextTypes = (((a = {})[s] = r.default.object), a)),
  ...
  var E = function(t, e) {
    ...
    x = function(t, e) {
      for (
        ...
        var p = !1,
          l = u[c].route;
        if (l.default) o = { route: l, params: {}, uri: e };
        else {
          for (
            var f = F(l.path), h = {}, d = Math.max(i.length, f.length), m = 0;
            m < d;
            m++
          ) {
            var y = f[m],
          ...
          if (!p) {
            n = { route: l, params: h, uri: "/" + i.slice(0, m).join("/") };
            break;
          }
        }
      }
    ...
    O = function(t, e) {
      ...
      for (var s = u.concat(a), p = [], l = 0, f = s.length; l < f; l++) {
        var h = s[l];
        ".." === h ? p.pop() : "." !== h && p.push(h);
      }
      return T("/" + p.join("/"), r);
    ...
    B = function() {
      ...
      return {
        ...
        history: {
          ...
          pushState: function(o, r, i) {
            var a = i.split("?"),
              u = a[0],
              c = a[1],
              s = void 0 === c ? "" : c;
            t++, e.push({ pathname: u, search: s }), n.push(o);
          },
          replaceState: function(o, r, i) {
            var a = i.split("?"),
              u = a[0],
              c = a[1],
              s = void 0 === c ? "" : c;
            (e[t] = { pathname: u, search: s }), (n[t] = o);
          }
        }
      };
    },
    ...
    $ = function(t) {
      ...
      return e.createElement(K.Consumer, null, function(t) {
        return t ? n(t) : e.createElement(Y, null, n);
      });
    },
    Y = (function(t) {
      function n() {
        ...
        for (var r = arguments.length, i = Array(r), a = 0; a < r; a++)
          i[a] = arguments[a];
        return (
          (e = o = I(this, t.call.apply(t, [this].concat(i)))),
          (o.state = { context: o.getContext(), refs: { unlisten: null } }),
          I(o, e)
        );
      }
      return (
  ...
  Y.defaultProps = { history: L };
  var z = H("Base", { baseuri: "/", basepath: "/" }),
    G = function(t) {
      return e.createElement(z.Consumer, null, function(n) {
        return e.createElement($, null, function(o) {
          return e.createElement(J, M({}, n, o, t));
        });
      });
    },
    J = (function(t) {
      function n() {
        return W(this, n), I(this, t.apply(this, arguments));
      }
      return (
        k(n, t),
        (n.prototype.render = function() {
          ...
          if (f) {
            ...
            var y = M({}, h, {
              ...
              g = e.cloneElement(
                ...
                y,
                m.props.children
                  ? e.createElement(G, { primary: i }, m.props.children)
                  : void 0
              ),
              b = i ? X : c,
              w = i ? M({ uri: d, location: n, component: c }, s) : s;
            return e.createElement(
              z.Provider,
              { value: { baseuri: d, basepath: r } },
              e.createElement(b, w, g)
            );
          }
          return null;
        }),
  ...
  var Q = H("Focus"),
    X = function(t) {
      var n = t.uri,
        o = t.location,
        r = t.component,
        i = A(t, ["uri", "location", "component"]);
      return e.createElement(Q.Consumer, null, function(t) {
        return e.createElement(
          et,
          M({}, i, { component: r, requestFocus: t, uri: n, location: o })
        );
      });
    },
    Z = !0,
    ...
    et = (function(t) {
      function n() {
        ...
        return (
          (e = o = I(this, t.call.apply(t, [this].concat(i)))),
          (o.state = {}),
          (o.requestFocus = function(t) {
            o.state.shouldFocus || t.focus();
          }),
          I(o, e)
        );
      }
      return (
        ...
        (n.getDerivedStateFromProps = function(t, e) {
          if (null == e.uri) return M({ shouldFocus: !0 }, t);
          var n = t.uri !== e.uri,
            o =
              e.location.pathname !== t.location.pathname &&
              t.location.pathname === t.uri;
          return M({ shouldFocus: n || o }, t);
        }),
        (n.prototype.componentDidMount = function() {
          tt++, this.focus();
        }),
  ...
  !(function(t) {
    ...
    if (
      ("function" == typeof t.getDerivedStateFromProps &&
        ((e.componentWillMount = w), (e.componentWillReceiveProps = _)),
      "function" == typeof e.getSnapshotBeforeUpdate)
    ) {
  ...
  var rt = ot(function(t, n) {
    var o = t.innerRef,
      r = A(t, ["innerRef"]);
    return e.createElement(z.Consumer, null, function(t) {
      t.basepath;
      var i = t.baseuri;
      return e.createElement($, null, function(t) {
        var a = t.location,
          u = t.navigate,
          c = r.to,
          s = r.state,
          ...
          l = r.getProps,
          f = void 0 === l ? nt : l,
          h = A(r, ["to", "state", "replace", "getProps"]),
          d = O(c, i),
          v = a.pathname === d,
          m = E(a.pathname, d);
        return e.createElement(
          "a",
          M(
            { ref: n || o, "aria-current": v ? "page" : void 0 },
            h,
            f({ isCurrent: v, isPartiallyCurrent: m, href: d, location: a }),
            {
              href: d,
              onClick: function(t) {
                h.onClick && h.onClick(t),
                  ft(t) && (t.preventDefault(), u(d, { state: s, replace: p }));
              }
            }
          )
        );
  ...
  var at = function(t) {
    ...
    ct = (function(t) {
      function e() {
        return W(this, e), I(this, t.apply(this, arguments));
      }
      return (
        k(e, t),
        (e.prototype.componentDidMount = function() {
          var t = this.props,
            ...
            a =
              (t.noThrow,
              A(t, ["navigate", "to", "from", "replace", "state", "noThrow"]));
          Promise.resolve().then(function() {
            e(C(n, a), { replace: r, state: i });
          });
        }),
        (e.prototype.render = function() {
          var t = this.props,
            ...
            o = A(t, ["navigate", "to", "from", "replace", "state", "noThrow"]);
          return n || ut(C(e, o)), null;
        }),
        e
      );
    })(e.Component),
    st = function(t) {
      return e.createElement($, null, function(n) {
        return e.createElement(ct, M({}, n, t));
      });
    },
    pt = function(t) {
      return t.replace(/(^\/+|\/+$)/g, "");
    ...
    lt = function(t) {
      return function(e) {
        ...
        var n, o, r;
        if (
          (e.props.path || e.props.default || e.type === st || v(!1),
          e.type !== st || (e.props.from && e.props.to) || v(!1),
          e.type === st &&
            ((n = e.props.from),
            (o = e.props.to),
            (r = function(t) {
        ...
        var i = e.type === st ? e.props.from : e.props.path,
          a = "/" === i ? t : pt(t) + "/" + pt(i);
        return {
          value: e,
          default: e.props.default,
          path: e.props.children ? pt(a) + "/*" : a
        };
      };
    },
    ft = function(t) {
      ...
      return e.createElement(z.Consumer, null, function(t) {
        ...
        return e.createElement($, null, function(t) {
          ...
          return o({
            navigate: e,
            location: i,
            match: a ? M({}, a.params, { uri: a.uri, path: n }) : null
          });
        });
      });
    }),
