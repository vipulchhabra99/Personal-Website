        ...
        function(e, t, n) {
          ...
          (r.prototype.convert = function(e) {
            var t,
              ...
              f = this.dstAlphabet.length,
              s = e.length,
              u = 'string' == typeof e ? '' : [];
            if (this.srcAlphabet === this.dstAlphabet) return e;
            for (t = 0; t < s; t++) o[t] = this.srcAlphabet.indexOf(e[t]);
            do {
              for (n = 0, r = 0, t = 0; t < s; t++)
                (n = n * i + o[t]),
                  n >= f ? ((o[r++] = parseInt(n / f, 10)), (n %= f)) : r > 0 && (o[r++] = 0);
              (s = r), (u = this.dstAlphabet.slice(n, n + 1).concat(u));
            } while (0 !== r);
            return u;
          }),
            (t.exports = r);
