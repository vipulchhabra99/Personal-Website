...
module.exports = (global, loadImplementation) => {
  return (implementation, opts) => {
    ...
    if (registered && implementation && registered.implementation !== implementation) {
      throw new Error(
        `any-observable already defined as "${registered.implementation}". You can only register an implementation before the first call to require('any-observable') and an implementation cannot be changed`,
      );
    }
