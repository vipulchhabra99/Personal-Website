declare class Promise<R> implements Promise.Thenable<R> {
  ...
  constructor(
    callback: (
      resolve: (value?: R | Promise.Thenable<R>) => void,
   ...
   */
  then<U>(
    onFulfilled?: (value: R) => U | Promise.Thenable<U>,
  ...
  static all<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
    values: [
      T1 | Promise.Thenable<T1>,
      T2 | Promise.Thenable<T2>,
      T3 | Promise.Thenable<T3>,
      T4 | Promise.Thenable<T4>,
      T5 | Promise.Thenable<T5>,
      T6 | Promise.Thenable<T6>,
      T7 | Promise.Thenable<T7>,
      T8 | Promise.Thenable<T8>,
      T9 | Promise.Thenable<T9>,
      T10 | Promise.Thenable<T10>,
    ],
  ...
  static all<T1, T2, T3>(
    values: [T1 | Promise.Thenable<T1>, T2 | Promise.Thenable<T2>, T3 | Promise.Thenable<T3>],
  ): Promise<[T1, T2, T3]>;
  static all<T1, T2>(
    values: [T1 | Promise.Thenable<T1>, T2 | Promise.Thenable<T2>],
  ): Promise<[T1, T2]>;
