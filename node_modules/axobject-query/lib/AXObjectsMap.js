...
var AXObjectsMap = new Map([
  ['AbbrRole', _AbbrRole2.default],
  ['AlertDialogRole', _AlertDialogRole2.default],
  ['AlertRole', _AlertRole2.default],
  ['AnnotationRole', _AnnotationRole2.default],
  ['ApplicationRole', _ApplicationRole2.default],
  ['ArticleRole', _ArticleRole2.default],
  ['AudioRole', _AudioRole2.default],
  ['BannerRole', _BannerRole2.default],
  ['BlockquoteRole', _BlockquoteRole2.default],
  ['BusyIndicatorRole', _BusyIndicatorRole2.default],
  ['ButtonRole', _ButtonRole2.default],
  ['CanvasRole', _CanvasRole2.default],
  ['CaptionRole', _CaptionRole2.default],
  ['CellRole', _CellRole2.default],
  ['CheckBoxRole', _CheckBoxRole2.default],
  ['ColorWellRole', _ColorWellRole2.default],
  ['ColumnHeaderRole', _ColumnHeaderRole2.default],
  ['ColumnRole', _ColumnRole2.default],
  ['ComboBoxRole', _ComboBoxRole2.default],
  ['ComplementaryRole', _ComplementaryRole2.default],
  ['ContentInfoRole', _ContentInfoRole2.default],
  ['DateRole', _DateRole2.default],
  ['DateTimeRole', _DateTimeRole2.default],
  ['DefinitionRole', _DefinitionRole2.default],
  ['DescriptionListDetailRole', _DescriptionListDetailRole2.default],
  ['DescriptionListRole', _DescriptionListRole2.default],
  ['DescriptionListTermRole', _DescriptionListTermRole2.default],
  ['DetailsRole', _DetailsRole2.default],
  ['DialogRole', _DialogRole2.default],
  ['DirectoryRole', _DirectoryRole2.default],
  ['DisclosureTriangleRole', _DisclosureTriangleRole2.default],
  ['DivRole', _DivRole2.default],
  ['DocumentRole', _DocumentRole2.default],
  ['EmbeddedObjectRole', _EmbeddedObjectRole2.default],
  ['FeedRole', _FeedRole2.default],
  ['FigcaptionRole', _FigcaptionRole2.default],
  ['FigureRole', _FigureRole2.default],
  ['FooterRole', _FooterRole2.default],
  ['FormRole', _FormRole2.default],
  ['GridRole', _GridRole2.default],
  ['GroupRole', _GroupRole2.default],
  ['HeadingRole', _HeadingRole2.default],
  ['IframePresentationalRole', _IframePresentationalRole2.default],
  ['IframeRole', _IframeRole2.default],
  ['IgnoredRole', _IgnoredRole2.default],
  ['ImageMapLinkRole', _ImageMapLinkRole2.default],
  ['ImageMapRole', _ImageMapRole2.default],
  ['ImageRole', _ImageRole2.default],
  ['InlineTextBoxRole', _InlineTextBoxRole2.default],
  ['InputTimeRole', _InputTimeRole2.default],
  ['LabelRole', _LabelRole2.default],
  ['LegendRole', _LegendRole2.default],
  ['LineBreakRole', _LineBreakRole2.default],
  ['LinkRole', _LinkRole2.default],
  ['ListBoxOptionRole', _ListBoxOptionRole2.default],
  ['ListBoxRole', _ListBoxRole2.default],
  ['ListItemRole', _ListItemRole2.default],
  ['ListMarkerRole', _ListMarkerRole2.default],
  ['ListRole', _ListRole2.default],
  ['LogRole', _LogRole2.default],
  ['MainRole', _MainRole2.default],
  ['MarkRole', _MarkRole2.default],
  ['MarqueeRole', _MarqueeRole2.default],
  ['MathRole', _MathRole2.default],
  ['MenuBarRole', _MenuBarRole2.default],
  ['MenuButtonRole', _MenuButtonRole2.default],
  ['MenuItemRole', _MenuItemRole2.default],
  ['MenuItemCheckBoxRole', _MenuItemCheckBoxRole2.default],
  ['MenuItemRadioRole', _MenuItemRadioRole2.default],
  ['MenuListOptionRole', _MenuListOptionRole2.default],
  ['MenuListPopupRole', _MenuListPopupRole2.default],
  ['MenuRole', _MenuRole2.default],
  ['MeterRole', _MeterRole2.default],
  ['NavigationRole', _NavigationRole2.default],
  ['NoneRole', _NoneRole2.default],
  ['NoteRole', _NoteRole2.default],
  ['OutlineRole', _OutlineRole2.default],
  ['ParagraphRole', _ParagraphRole2.default],
  ['PopUpButtonRole', _PopUpButtonRole2.default],
  ['PreRole', _PreRole2.default],
  ['PresentationalRole', _PresentationalRole2.default],
  ['ProgressIndicatorRole', _ProgressIndicatorRole2.default],
  ['RadioButtonRole', _RadioButtonRole2.default],
  ['RadioGroupRole', _RadioGroupRole2.default],
  ['RegionRole', _RegionRole2.default],
  ['RootWebAreaRole', _RootWebAreaRole2.default],
  ['RowHeaderRole', _RowHeaderRole2.default],
  ['RowRole', _RowRole2.default],
  ['RubyRole', _RubyRole2.default],
  ['RulerRole', _RulerRole2.default],
  ['ScrollAreaRole', _ScrollAreaRole2.default],
  ['ScrollBarRole', _ScrollBarRole2.default],
  ['SeamlessWebAreaRole', _SeamlessWebAreaRole2.default],
  ['SearchRole', _SearchRole2.default],
  ['SearchBoxRole', _SearchBoxRole2.default],
  ['SliderRole', _SliderRole2.default],
  ['SliderThumbRole', _SliderThumbRole2.default],
  ['SpinButtonRole', _SpinButtonRole2.default],
  ['SpinButtonPartRole', _SpinButtonPartRole2.default],
  ['SplitterRole', _SplitterRole2.default],
  ['StaticTextRole', _StaticTextRole2.default],
  ['StatusRole', _StatusRole2.default],
  ['SVGRootRole', _SVGRootRole2.default],
  ['SwitchRole', _SwitchRole2.default],
  ['TabGroupRole', _TabGroupRole2.default],
  ['TabRole', _TabRole2.default],
  ['TableHeaderContainerRole', _TableHeaderContainerRole2.default],
  ['TableRole', _TableRole2.default],
  ['TabListRole', _TabListRole2.default],
  ['TabPanelRole', _TabPanelRole2.default],
  ['TermRole', _TermRole2.default],
  ['TextFieldRole', _TextFieldRole2.default],
  ['TimeRole', _TimeRole2.default],
  ['TimerRole', _TimerRole2.default],
  ['ToggleButtonRole', _ToggleButtonRole2.default],
  ['ToolbarRole', _ToolbarRole2.default],
  ['TreeRole', _TreeRole2.default],
  ['TreeGridRole', _TreeGridRole2.default],
  ['TreeItemRole', _TreeItemRole2.default],
  ['UserInterfaceTooltipRole', _UserInterfaceTooltipRole2.default],
  ['VideoRole', _VideoRole2.default],
  ['WebAreaRole', _WebAreaRole2.default],
  ['WindowRole', _WindowRole2.default],
]);
