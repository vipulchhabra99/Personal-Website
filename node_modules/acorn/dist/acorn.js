(function(global, factory) {
  ...
  pp$3.parseMaybeAssign = function(noIn, refDestructuringErrors, afterLeftParse) {
    ...
    if (this.type.isAssign) {
      ...
      node.left =
        this.type === types.eq ? this.toAssignable(left, false, refDestructuringErrors) : left;
  ...
  var unicodeScriptValues = {
    ...
    10:
      ecma9ScriptValues +
      ' Dogra Dogr Elymaic Elym Gunjala_Gondi Gong Hanifi_Rohingya Rohg Makasar Maka Medefaidrin Medf Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Old_Sogdian Sogo Sogdian Sogd Wancho Wcho',
  };
  ...
  var RegExpValidationState = function RegExpValidationState(parser) {
    ...
    this.unicodeProperties =
      data[parser.options.ecmaVersion >= 10 ? 10 : parser.options.ecmaVersion];
    this.source = '';
    this.flags = '';
    this.start = 0;
    this.switchU = false;
