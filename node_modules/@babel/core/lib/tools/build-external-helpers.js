...
function buildUmd(whitelist) {
  ...
  const body = [];
  body.push(
    t().variableDeclaration('var', [t().variableDeclarator(namespace, t().identifier('global'))]),
  );
  buildHelpers(body, namespace, whitelist);
  return t().program([
    buildUmdWrapper({
...
function buildVar(whitelist) {
  ...
  const body = [];
  body.push(
    t().variableDeclaration('var', [t().variableDeclarator(namespace, t().objectExpression([]))]),
  );
