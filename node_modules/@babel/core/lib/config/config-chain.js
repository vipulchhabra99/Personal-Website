...
function buildRootChain(opts, context) {
  ...
  const pkgData =
    typeof context.filename === 'string' ? (0, _files.findPackageData)(context.filename) : null;
  ...
  if (
    ...
    ({ ignore: ignoreFile, config: babelrcFile } = (0, _files.findRelativeConfig)(
      pkgData,
      context.envName,
      context.caller,
    ));
...
function configIsApplicable({ options }, dirname, context) {
  return (
    (options.test === undefined || configFieldIsApplicable(context, options.test, dirname)) &&
    (options.include === undefined || configFieldIsApplicable(context, options.include, dirname)) &&
    (options.exclude === undefined || !configFieldIsApplicable(context, options.exclude, dirname))
  );
}
