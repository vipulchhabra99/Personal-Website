      ...
      (t.prototype._version = 3),
        ...
        (t.prototype.addMapping = function(e) {
          ...
          this._skipValidation || this._validateMapping(n, r, t, o),
            null != t && ((t = String(t)), this._sources.has(t) || this._sources.add(t)),
        ...
        (t.prototype._validateMapping = function(e, n, r, t) {
          ...
          if (
            (!(e && 'line' in e && 'column' in e && e.line > 0 && e.column >= 0) || n || r || t) &&
            !(
              e &&
              'line' in e &&
              'column' in e &&
        ...
        for (var s, a = n.isAbsolute(r), u = r.split(/\/+/), l = 0, c = u.length - 1; c >= 0; c--)
          (s = u[c]),
            '.' === s
              ...
              : '..' === s
              ? l++
              : l > 0 && ('' === s ? (u.splice(c + 1, l), (l = 0)) : (u.splice(c, 2), l--));
              ...
              : ((t = e.originalColumn - n.originalColumn),
                0 !== t || r
                  ...
                  : ((t = e.generatedColumn - n.generatedColumn),
                    0 !== t
                      ? t
                      : ((t = e.generatedLine - n.generatedLine), 0 !== t ? t : e.name - n.name))));
      }
      function h(e, n, r) {
    ...
    function(e, n, r) {
      ...
      (o.prototype.unsortedForEach = function(e, n) {
        ...
        (o.prototype.toArray = function() {
          return (
            this._sorted ||
              (this._array.sort(i.compareByGeneratedPositionsInflated), (this._sorted = !0)),
            this._array
          );
        }),
        (n.MappingList = o);
    ...
    function(e, n, r) {
      function t(e) {
        ...
        return (
          ...
          null != n.sections ? new s(n) : new o(n)
        );
      }
      function o(e) {
        var n = e;
        ...
        (t = t
          ...
          (this._names = l.fromArray(o.map(String), !0)),
      ...
      (t.fromSourceMap = function(e) {
        ...
        (t.prototype.allGeneratedPositionsFor = function(e) {
          ...
          if (
            (null != this.sourceRoot && (r.source = a.relative(this.sourceRoot, r.source)),
          ...
          if (o >= 0) {
            ...
            if (void 0 === e.column)
              ...
              for (var l = i.originalColumn; i && i.originalLine === n && i.originalColumn == l; )
                t.push({
                  line: a.getArg(i, 'generatedLine', null),
                  column: a.getArg(i, 'generatedColumn', null),
                  lastColumn: a.getArg(i, 'lastGeneratedColumn', null),
          ...
          for (
            ...
            if (';' === e.charAt(v)) l++, v++, (p = 0);
              ...
              (r.generatedColumn = p + o[0]),
                ...
                S.push(r),
                'number' == typeof r.originalLine && A.push(r);
            }
          g(S, a.compareByGeneratedPositionsDeflated),
            (this.__generatedMappings = S),
            g(A, a.compareByOriginalPositions),
          ...
          if (r >= 0) {
            ...
            if (o.generatedLine === n.generatedLine) {
              ...
              null !== i &&
                ...
                null != this.sourceRoot && (i = a.join(this.sourceRoot, i)));
        ...
        (o.prototype.sourceContentFor = function(e, n) {
          ...
          if (
            (null != this.sourceRoot && (e = a.relative(this.sourceRoot, e)), this._sources.has(e))
          )
        ...
        (o.prototype.generatedPositionFor = function(e) {
          ...
          if (
            (null != this.sourceRoot && (n = a.relative(this.sourceRoot, n)), !this._sources.has(n))
          )
        ...
        (s.prototype._parseMappings = function(e, n) {
          ...
          for (var r = 0; r < this._sections.length; r++)
            for (
              ...
              null !== t.consumer.sourceRoot && (u = a.join(t.consumer.sourceRoot, u)),
                this._sources.add(u),
    ...
    function(e, n, r) {
      ...
      (t.fromStringWithSourceMap = function(e, n, r) {
        ...
        (t.prototype.prepend = function(e) {
          if (Array.isArray(e)) for (var n = e.length - 1; n >= 0; n--) this.prepend(e[n]);
          else {
            if (!e[u] && 'string' != typeof e)
              throw new TypeError(
                'Expected a SourceNode, string, or an array of SourceNodes and strings. Got ' + e,
            ...
            this.walk(function(e, o) {
              (n.code += e),
                null !== o.source && null !== o.line && null !== o.column
                  ? ((i === o.source && s === o.line && u === o.column && l === o.name) ||
                      r.addMapping({
                        source: o.source,
                    ...
                    (t = !0))
                  : t &&
                    (r.addMapping({ generated: { line: n.line, column: n.column } }),
                    (i = null),
                    (t = !1));
