...
})()(
  {
    ...
    112: [
      function(_dereq_, module, exports) {
        ...
        module.exports =
          1 / $parseFloat(_dereq_(135) + '-0') !== -Infinity
            ...
            ('__proto__' in {} // eslint-disable-line
              ? (function(test, buggy, set) {
                  try {
                    set = _dereq_(54)(
                      Function.call,
                      _dereq_(101).f(Object.prototype, '__proto__').set,
                      2,
                    );
                    set(test, []);
    ...
    165: [
      function(_dereq_, module, exports) {
        ...
        $export(
          $export.P + $export.F * (_dereq_(77) != Object || !_dereq_(128)(arrayJoin)),
          'Array',
          {
            join: function join(separator) {
      ...
      function(_dereq_, module, exports) {
        ...
        var USE_NATIVE = !!(function() {
          try {
            ...
            var FakePromise = ((promise.constructor = {})[_dereq_(152)('species')] = function(
              exec,
            ) {
              exec(empty, empty);
            });
    ...
    249: [
      function(_dereq_, module, exports) {
        // 21.2.5.3 get RegExp.prototype.flags()
        if (_dereq_(58) && /./g.flags != 'g')
          _dereq_(99).f(RegExp.prototype, 'flags', {
            configurable: true,
            get: _dereq_(66),
          });
      },
    ...
    278: [
      function(_dereq_, module, exports) {
        ...
        $Symbol[PROTOTYPE][TO_PRIMITIVE] ||
          _dereq_(72)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
