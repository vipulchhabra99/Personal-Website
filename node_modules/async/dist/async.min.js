!(function() {
  ...
  'object' == typeof process && 'function' == typeof process.nextTick
    ? (P.nextTick = process.nextTick)
    : (P.nextTick = D),
    (P.setImmediate = B ? D : P.nextTick),
    (P.forEach = P.each = function(n, t, e) {
    ...
    (P.mapSeries = k(b)),
    (P.mapLimit = g(b)),
    (P.inject = P.foldl = P.reduce = function(n, t, e, r) {
      P.eachOfSeries(
        n,
        function(n, r, u) {
          e(t, n, function(n, e) {
    ...
    (P.select = P.filter = d(w)),
    (P.selectLimit = P.filterLimit = g(w)),
    (P.selectSeries = P.filterSeries = k(w)),
    (P.reject = d(O)),
    (P.rejectLimit = g(O)),
    (P.rejectSeries = k(O)),
    (P.any = P.some = S(P.eachOf, e, t)),
    (P.someLimit = S(P.eachOfLimit, e, t)),
    (P.all = P.every = S(P.eachOf, r, r)),
    (P.everyLimit = S(P.eachOfLimit, r, r)),
    (P.detect = S(P.eachOf, t, E)),
    (P.detectSeries = S(P.eachOfSeries, t, E)),
    (P.detectLimit = S(P.eachOfLimit, t, E)),
    (P.sortBy = function(n, t, e) {
      function r(n, t) {
        var e = n.criteria,
          r = t.criteria;
    ...
    (P.times = A(P.map)),
    (P.timesSeries = A(P.mapSeries)),
    (P.timesLimit = function(n, t, e, r) {
    ...
    (P.applyEach = T(P.eachOf)),
    (P.applyEachSeries = T(P.eachOfSeries)),
    (P.forever = function(t, e) {
      function r(n) {
