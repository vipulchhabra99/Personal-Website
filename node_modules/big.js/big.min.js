...
!(function(e) {
  ...
  function R(e, r, t, n) {
    ...
    if (s < i.length) {
      if (1 === t) n = 5 <= i[s];
        ...
        n = 5 < i[s] || (5 == i[s] && (n || s < 0 || i[s + 1] !== D || 1 & i[s - 1]));
      else if (3 === t) n = n || !!i[0];
  ...
  function t(e, r, t, n) {
    ...
    if (t !== D) {
      ...
      for (
        t = n - (e = new o(e)).e, e.c.length > ++n && R(e, t, o.RM), 2 == r && (n = e.e + t + 1);
        e.c.length < n;
    ...
    if (
      ...
      s = s.charAt(0) + (1 < t ? '.' + s.slice(1) : '') + (i < 0 ? 'e' : 'e+') + i;
    else if (i < 0) {
      for (; ++i; ) s = '0' + s;
      s = '0.' + s;
    } else if (0 < i)
  ...
  (l.abs = function() {
    ...
    (l.minus = l.sub = function(e) {
      ...
      if ((f = h - a)) {
        ...
        for (t = ((i = u.length < l.length) ? u : l).length, f = c = 0; c < t; c++)
          if (u[c] != l[c]) {
            i = u[c] < l[c];
            break;
          }
      if (
        (i && ((n = u), (u = l), (l = n), (e.s = -e.s)), 0 < (c = (t = l.length) - (r = u.length)))
      )
        for (; c--; ) u[r++] = 0;
      for (c = r; f < t; ) {
        if (u[--t] < l[t]) {
    ...
    (l.plus = l.add = function(e) {
      ...
      for (
        f.length - u.length < 0 && ((r = u), (u = f), (f = r)), i = u.length, s = 0;
        i;
        f[i] %= 10
      )
    ...
    ((r = (function t() {
      ...
      return (
        (n.prototype = l), (n.DP = i), (n.RM = s), (n.NE = o), (n.PE = f), (n.version = '5.2.2'), n
      );
    })()).default = r.Big = r),
