  ...
  function en(r) {
    ...
    function D(n) {
      ...
      (x.progress = a((d / e) * 100, 0, 100)),
        ...
        d > r && d < l
          ? (x.changeBegan || ((x.changeBegan = !0), (x.changeCompleted = !1), B('changeBegin')),
            B('change'),
            I(d))
          : x.changeBegan && ((x.changeCompleted = !0), (x.changeBegan = !1), B('changeComplete')),
        ...
        n >= e &&
          ...
          x.remaining
            ? ((o = u), B('loopComplete'), B('loopBegin'), 'alternate' === x.direction && k())
            : ((x.paused = !0),
              x.completed ||
                ((x.completed = !0),
                B('loopComplete'),
