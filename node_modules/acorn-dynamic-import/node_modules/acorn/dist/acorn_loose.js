(function(global, factory) {
  ...
  lp$2.parseMaybeAssign = function(noIn) {
    ...
    if (this.tok.type.isAssign) {
      ...
      node$1.left =
        this.tok.type === __acorn.tokTypes.eq ? this.toAssignable(left) : this.checkLVal(left);
      this.next();
  ...
  lp$2.parseSubscripts = function(base, start, noCalls, startIndent, line) {
    ...
    for (;;) {
      ...
      var maybeAsyncArrow =
        base.type === 'Identifier' && base.name === 'async' && !this$1.canInsertSemicolon();
  ...
  lp$2.parsePropertyName = function(prop) {
    ...
    var key =
      this.tok.type === __acorn.tokTypes.num || this.tok.type === __acorn.tokTypes.string
        ? this.parseExprAtom()
        : this.parseIdent();
