...
pp$1.parseVar = function(node, isFor, kind) {
  ...
  for (;;) {
    ...
    if (this$1.eat(types.eq)) {
      ...
      kind === 'const' &&
      !(this$1.type === types._in || (this$1.options.ecmaVersion >= 6 && this$1.isContextual('of')))
    ) {
      this$1.unexpected();
    } else if (
...
pp$1.parseClassId = function(node, isStatement) {
  node.id =
    this.type === types.name ? this.parseIdent() : isStatement === true ? this.unexpected() : null;
};
  ...
  if (this.options.ecmaVersion >= 6) {
    ...
    while (this.type !== types.parenR) {
      ...
      if (allowTrailingComma && this$1.afterTrailingComma(types.parenR, true)) {
        ...
        exprList.push(
          this$1.parseMaybeAssign(false, refDestructuringErrors, this$1.parseParenItem),
        );
      }
    }
...
pp$3.parseFunctionBody = function(node, isArrowFunction) {
  ...
  if (isExpression) {
    ...
    this.checkParams(
      node,
      !oldStrict && !useStrict && !isArrowFunction && this.isSimpleParamList(node.params),
    );
  ...
  for (;;) {
    ...
    if (ch === 96 || (ch === 36 && this$1.input.charCodeAt(this$1.pos + 1) === 123)) {
      ...
      if (
        ...
        (this$1.type === types.template || this$1.type === types.invalidTemplate)
      ) {
        if (ch === 36) {
          this$1.pos += 2;
