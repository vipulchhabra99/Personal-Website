...
var minify = function minify(linebreakPattern) {
  ...
  return function(code) {
    ...
    var eliminatedExpressionIndices = (0, _difference.default)(
      code.match(_placeholderUtils.placeholderRegex),
      newCode.match(_placeholderUtils.placeholderRegex),
    ).map(function(x) {
...
var minifyRawValues = function minifyRawValues(rawValues) {
  return (0, _placeholderUtils.splitByPlaceholders)(
