...
function numberLiteralFromRaw(rawValue) {
  ...
  if (typeof rawValue === 'number') {
    ...
    switch (instructionType) {
      ...
      case 'f32': {
        return (0, _nodes.floatLiteral)(
          (0, _wastParser.parse32F)(rawValue),
          (0, _wastParser.isNanLiteral)(rawValue),
          (0, _wastParser.isInfLiteral)(rawValue),
          String(original),
        );
      }
      // f64
      ...
      default: {
        return (0, _nodes.floatLiteral)(
          (0, _wastParser.parse64F)(rawValue),
          (0, _wastParser.isNanLiteral)(rawValue),
          (0, _wastParser.isInfLiteral)(rawValue),
          String(original),
        );
