...
export function module(id, fields, metadata) {
  if (id !== null && id !== undefined) {
    if (!(typeof id === 'string')) {
      throw new Error(
        'typeof id === "string"' +
          ' error: ' +
          ('Argument id must be of type string, given: ' + _typeof(id) || 'unknown'),
      );
    }
  }
  ...
  if (!(_typeof(fields) === 'object' && typeof fields.length !== 'undefined')) {
    throw new Error(
      'typeof fields === "object" && typeof fields.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function moduleMetadata(sections, functionNames, localNames) {
  ...
  if (functionNames !== null && functionNames !== undefined) {
    if (!(_typeof(functionNames) === 'object' && typeof functionNames.length !== 'undefined')) {
      throw new Error(
        'typeof functionNames === "object" && typeof functionNames.length !== "undefined"' +
          ' error: ' +
          (undefined || 'unknown'),
      );
    }
...
export function moduleNameMetadata(value) {
  if (!(typeof value === 'string')) {
    throw new Error(
      'typeof value === "string"' +
        ' error: ' +
        ('Argument value must be of type string, given: ' + _typeof(value) || 'unknown'),
    );
  }
...
export function functionNameMetadata(value, index) {
  ...
  if (!(typeof index === 'number')) {
    throw new Error(
      'typeof index === "number"' +
        ' error: ' +
        ('Argument index must be of type number, given: ' + _typeof(index) || 'unknown'),
    );
  }
  ...
  if (!(typeof localIndex === 'number')) {
    throw new Error(
      'typeof localIndex === "number"' +
        ' error: ' +
        ('Argument localIndex must be of type number, given: ' + _typeof(localIndex) || 'unknown'),
    );
  }
  ...
  if (!(typeof functionIndex === 'number')) {
    throw new Error(
      'typeof functionIndex === "number"' +
        ' error: ' +
        ('Argument functionIndex must be of type number, given: ' + _typeof(functionIndex) ||
          'unknown'),
    );
  }
...
export function binaryModule(id, blob) {
  ...
  if (!(_typeof(blob) === 'object' && typeof blob.length !== 'undefined')) {
    throw new Error(
      'typeof blob === "object" && typeof blob.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function quoteModule(id, string) {
  ...
  if (!(_typeof(string) === 'object' && typeof string.length !== 'undefined')) {
    throw new Error(
      'typeof string === "object" && typeof string.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
  ...
  if (!(typeof startOffset === 'number')) {
    throw new Error(
      'typeof startOffset === "number"' +
        ' error: ' +
        ('Argument startOffset must be of type number, given: ' + _typeof(startOffset) ||
          'unknown'),
    );
  }
...
export function loopInstruction(label, resulttype, instr) {
  if (!(_typeof(instr) === 'object' && typeof instr.length !== 'undefined')) {
    throw new Error(
      'typeof instr === "object" && typeof instr.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function instr(id, object, args, namedArgs) {
  ...
  if (!(_typeof(args) === 'object' && typeof args.length !== 'undefined')) {
    throw new Error(
      'typeof args === "object" && typeof args.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function ifInstruction(testLabel, test, result, consequent, alternate) {
  if (!(_typeof(test) === 'object' && typeof test.length !== 'undefined')) {
    throw new Error(
      'typeof test === "object" && typeof test.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function numberLiteral(value, raw) {
  if (!(typeof value === 'number')) {
    throw new Error(
      'typeof value === "number"' +
        ' error: ' +
        ('Argument value must be of type number, given: ' + _typeof(value) || 'unknown'),
    );
  }
  ...
  if (!(typeof raw === 'string')) {
    throw new Error(
      'typeof raw === "string"' +
        ' error: ' +
        ('Argument raw must be of type string, given: ' + _typeof(raw) || 'unknown'),
    );
  }
  ...
  if (nan !== null && nan !== undefined) {
    if (!(typeof nan === 'boolean')) {
      throw new Error(
        'typeof nan === "boolean"' +
          ' error: ' +
          ('Argument nan must be of type boolean, given: ' + _typeof(nan) || 'unknown'),
      );
    }
  }
  ...
  if (inf !== null && inf !== undefined) {
    if (!(typeof inf === 'boolean')) {
      throw new Error(
        'typeof inf === "boolean"' +
          ' error: ' +
          ('Argument inf must be of type boolean, given: ' + _typeof(inf) || 'unknown'),
      );
    }
  }
...
export function elem(table, offset, funcs) {
  if (!(_typeof(offset) === 'object' && typeof offset.length !== 'undefined')) {
    throw new Error(
      'typeof offset === "object" && typeof offset.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
  ...
  if (!(_typeof(funcs) === 'object' && typeof funcs.length !== 'undefined')) {
    throw new Error(
      'typeof funcs === "object" && typeof funcs.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function global(globalType, init, name) {
  if (!(_typeof(init) === 'object' && typeof init.length !== 'undefined')) {
    throw new Error(
      'typeof init === "object" && typeof init.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function table(elementType, limits, name, elements) {
  if (!(limits.type === 'Limit')) {
    throw new Error(
      'limits.type === "Limit"' +
        ' error: ' +
        ('Argument limits must be of type Limit, given: ' + limits.type || 'unknown'),
    );
  }
...
export function moduleImport(module, name, descr) {
  if (!(typeof module === 'string')) {
    throw new Error(
      'typeof module === "string"' +
        ' error: ' +
        ('Argument module must be of type string, given: ' + _typeof(module) || 'unknown'),
    );
  }
  ...
  if (!(typeof name === 'string')) {
    throw new Error(
      'typeof name === "string"' +
        ' error: ' +
        ('Argument name must be of type string, given: ' + _typeof(name) || 'unknown'),
    );
  }
...
export function limit(min, max) {
  if (!(typeof min === 'number')) {
    throw new Error(
      'typeof min === "number"' +
        ' error: ' +
        ('Argument min must be of type number, given: ' + _typeof(min) || 'unknown'),
    );
  }
  ...
  if (max !== null && max !== undefined) {
    if (!(typeof max === 'number')) {
      throw new Error(
        'typeof max === "number"' +
          ' error: ' +
          ('Argument max must be of type number, given: ' + _typeof(max) || 'unknown'),
      );
    }
  }
...
export function signature(params, results) {
  if (!(_typeof(params) === 'object' && typeof params.length !== 'undefined')) {
    throw new Error(
      'typeof params === "object" && typeof params.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
  ...
  if (!(_typeof(results) === 'object' && typeof results.length !== 'undefined')) {
    throw new Error(
      'typeof results === "object" && typeof results.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function program(body) {
  if (!(_typeof(body) === 'object' && typeof body.length !== 'undefined')) {
    throw new Error(
      'typeof body === "object" && typeof body.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
...
export function callIndirectInstruction(signature, intrs) {
  if (intrs !== null && intrs !== undefined) {
    if (!(_typeof(intrs) === 'object' && typeof intrs.length !== 'undefined')) {
      throw new Error(
        'typeof intrs === "object" && typeof intrs.length !== "undefined"' +
          ' error: ' +
          (undefined || 'unknown'),
      );
    }
...
export function byteArray(values) {
  if (!(_typeof(values) === 'object' && typeof values.length !== 'undefined')) {
    throw new Error(
      'typeof values === "object" && typeof values.length !== "undefined"' +
        ' error: ' +
        (undefined || 'unknown'),
    );
  }
    ...
    if (!(typeof isExternal === 'boolean')) {
      throw new Error(
        'typeof isExternal === "boolean"' +
          ' error: ' +
          ('Argument isExternal must be of type boolean, given: ' + _typeof(isExternal) ||
            'unknown'),
      );
    }
  }
