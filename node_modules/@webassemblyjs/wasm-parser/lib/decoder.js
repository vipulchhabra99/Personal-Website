...
function decode(ab, opts) {
  ...
  function parseVec(cast) {
    ...
    for (var i = 0; i < length; i++) {
      ...
      if (typeof value === 'undefined') {
        throw new _helperApiError.CompileError(
    ...
    for (var i = 0; i < numberOfTypes; i++) {
      ...
      if (type == _helperWasmBytecode.default.types.func) {
        ...
        typeInstructionNodes.push(
          t.withLoc(t.typeInstruction(undefined, t.signature(params, result)), endLoc, startLoc),
        );
    ...
    for (var i = 0; i < numberOfImports; i++) {
      ...
      if (descrType === 'func') {
        ...
        if (typeof signature === 'undefined') {
          throw new _helperApiError.CompileError(
            'function signature not found ('.concat(typeindex, ')'),
          );
        }
      ...
      var endLoc = getPosition();
      imports.push(
        t.withLoc(t.moduleImport(moduleName.value, name.value, importDescr), endLoc, startLoc),
      );
    }
    ...
    for (var i = 0; i < numberOfExport; i++) {
      ...
      if (_helperWasmBytecode.default.exportTypes[typeIndex] === 'Func') {
        ...
        if (typeof func === 'undefined') {
          throw new _helperApiError.CompileError(
            'entry not found at index '.concat(index, ' in function section'),
          );
        }
        ...
        if (typeof table === 'undefined') {
          throw new _helperApiError.CompileError(
            'entry not found at index '.concat(index, ' in table section'),
          );
        }
        ...
        if (typeof memNode === 'undefined') {
          throw new _helperApiError.CompileError(
            'entry not found at index '.concat(index, ' in memory section'),
          );
        }
        ...
        if (typeof global === 'undefined') {
          throw new _helperApiError.CompileError(
            'entry not found at index '.concat(index, ' in global section'),
          );
        }
  ...
  function parseInstructionBlock(code) {
    while (true) {
      ...
      if (instruction.name === 'loop') {
        ...
        if (typeof signature === 'undefined') {
          throw new _helperApiError.CompileError(
            'call_indirect signature not found ('.concat(typeindex, ')'),
          );
        }

        var _callNode = t.callIndirectInstruction(
  ...
  function parseSection(sectionIndex) {
    ...
    var sectionSizeInBytesNode = t.withLoc(
    ...
    switch (sectionId) {
      case _helperWasmBytecode.default.sections.type: {
        ...
        var _metadata = t.sectionMetadata(
          'type',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfTypes), endPosition, _startPosition),
        );
      ...
      case _helperWasmBytecode.default.sections.table: {
        ...
        var _metadata2 = t.sectionMetadata(
          'table',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfTable), _endPosition, _startPosition2),
        );
      ...
      case _helperWasmBytecode.default.sections.import: {
        ...
        var _metadata3 = t.sectionMetadata(
          'import',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfImports), _endPosition2, _startPosition3),
        );
      ...
      case _helperWasmBytecode.default.sections.func: {
        ...
        var _metadata4 = t.sectionMetadata(
          'func',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfFunctions), _endPosition3, _startPosition4),
        );
      ...
      case _helperWasmBytecode.default.sections.export: {
        ...
        var _metadata5 = t.sectionMetadata(
          'export',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfExport), _endPosition4, _startPosition5),
        );
      ...
      case _helperWasmBytecode.default.sections.code: {
        ...
        var _metadata6 = t.sectionMetadata(
          'code',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfFuncs), _endPosition5, _startPosition6),
        );
      ...
      case _helperWasmBytecode.default.sections.element: {
        ...
        var _metadata8 = t.sectionMetadata(
          'element',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfElements), _endPosition6, _startPosition7),
        );
      ...
      case _helperWasmBytecode.default.sections.global: {
        ...
        var _metadata9 = t.sectionMetadata(
          'global',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(numberOfGlobals), _endPosition7, _startPosition8),
        );
      ...
      case _helperWasmBytecode.default.sections.memory: {
        ...
        var _metadata10 = t.sectionMetadata(
          'memory',
          startOffset,
          sectionSizeInBytesNode,
          t.withLoc(t.numberLiteralFromRaw(_numberOfElements), _endPosition8, _startPosition9),
        );
      ...
      case _helperWasmBytecode.default.sections.data: {
        ...
        _metadata11.vectorOfSize = t.withLoc(
          t.numberLiteralFromRaw(_numberOfElements2),
          _endPosition9,
          _startPosition10,
        );
      ...
      case _helperWasmBytecode.default.sections.custom: {
        ...
        if (sectionName.value === 'name') {
          try {
            _metadata12.push.apply(
              _metadata12,
              _toConsumableArray(parseNameSection(_remainingBytes2)),
            );
          } catch (e) {
            console.warn(
              'Failed to decode custom "name" section @'
                .concat(offset, '; ignoring (')
                .concat(e.message, ').'),
            );
