...
var numberLiteralFSM = new _helperFsm.FSM(
  {
    START: [
      (0, _helperFsm.makeTransition)(/-|\+/, 'AFTER_SIGN'),
      (0, _helperFsm.makeTransition)(/nan:0x/, 'NAN_HEX', {
        n: 6,
      }),
      ...
      (0, _helperFsm.makeTransition)(/[0-9]/, 'DEC'),
      (0, _helperFsm.makeTransition)(/\./, 'DEC_FRAC'),
    ],
    AFTER_SIGN: [
      (0, _helperFsm.makeTransition)(/nan:0x/, 'NAN_HEX', {
        n: 6,
    ...
    DEC_FRAC: [
      (0, _helperFsm.makeTransition)(/[0-9]/, 'DEC_FRAC', {
    ...
    DEC_SIGNED_EXP: [
      (0, _helperFsm.makeTransition)(/\+|-/, 'DEC_EXP'),
      (0, _helperFsm.makeTransition)(/[0-9]/, 'DEC_EXP'),
    ],
    DEC_EXP: [
      (0, _helperFsm.makeTransition)(/[0-9]/, 'DEC_EXP', {
        allowedSeparator: NUMERIC_SEPARATOR,
    ...
    HEX: [
      (0, _helperFsm.makeTransition)(/[0-9|A-F|a-f]/, 'HEX', {
        allowedSeparator: NUMERIC_SEPARATOR,
      }),
      (0, _helperFsm.makeTransition)(/\./, 'HEX_FRAC'),
      (0, _helperFsm.makeTransition)(/p|P/, 'HEX_SIGNED_EXP'),
    ],
    HEX_FRAC: [
      (0, _helperFsm.makeTransition)(/[0-9|A-F|a-f]/, 'HEX_FRAC', {
        allowedSeparator: NUMERIC_SEPARATOR,
      }),
      (0, _helperFsm.makeTransition)(/p|P|/, 'HEX_SIGNED_EXP'),
    ],
    ...
    HEX_EXP: [
      (0, _helperFsm.makeTransition)(/[0-9]/, 'HEX_EXP', {
        allowedSeparator: NUMERIC_SEPARATOR,
      }),
    ],
    NAN_HEX: [
      (0, _helperFsm.makeTransition)(/[0-9|A-F|a-f]/, 'NAN_HEX', {
        allowedSeparator: NUMERIC_SEPARATOR,
      }),
    ],
    STOP: [],
...
function tokenize(input) {
  ...
  while (current < input.length) {
    ...
    if (
      ...
      if (_value === '') {
        throw new Error(
          getCodeFrame(input, line, column) + 'Unexpected character ' + JSON.stringify(char),
        );
      }
