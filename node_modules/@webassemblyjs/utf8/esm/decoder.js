...
function _decode(bytes) {
...

  {
    ...
    if (_b2 < 0xf0) {
      return [code(0x800, ((_b2 & 0x0f) << 12) + (con(_b3) << 6) + con(b3))].concat(
        _toConsumableArray(_decode(_bs2)),
      );
    }
  }
  /**
...

  {
    ...
    if (_b4 < 0xf8) {
      return [
        code(0x10000, ((((_b4 & 0x07) << 18) + con(_b5)) << 12) + (con(_b6) << 6) + con(b4)),
      ].concat(_toConsumableArray(_decode(_bs3)));
    }
  }
  throw new Error('invalid UTF-8 encoding');
}
