...
describe('none store', function() {
  ...
  describe('with promise', function() {
    ...
    it('set()', function(done) {
      noneCache.set(key, value).then(function(result) {
    ...
    it('mset()', function(done) {
      noneCache.mset(key, value, key2, value2).then(function(result) {
    ...
    it('get()', function(done) {
      noneCache.get(key).then(function(result) {
        assert.strictEqual(result, undefined);
        done();
      });
    });
    ...
    it('mget()', function(done) {
      noneCache.mget(key, key2).then(function(result) {
        assert.deepEqual(result, [undefined, undefined]);
        done();
      });
    });
    ...
    it('keys()', function(done) {
      noneCache.keys().then(function(result) {
